...
var G__16286 = devtools.prefs.pref.call(null,v);
v = G__16286;
continue;
} else {
return v;
...
}catch (e16289){var _e__15540__auto__ = e16289;
return false;
}})();
...
}catch (e16293){var _e__15540__auto__ = e16293;
return false;
}})();
...
}catch (e16295){var _e__15540__auto__ = e16295;
return false;
}}
}
});
...
var vec__16297 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__16297,(0),null);
var name = cljs.core.nth.call(null,vec__16297,(1),null);
...
return cljs.core.some.call(null,(function (p1__16300_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16300_SHARP_);
}),template);
});
