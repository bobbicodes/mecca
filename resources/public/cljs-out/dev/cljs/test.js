...
var G__13939 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__13939,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__13939;
}
});
...
var len__4531__auto___13944 = arguments.length;
var i__4532__auto___13945 = (0);
while(true){
if((i__4532__auto___13945 < len__4531__auto___13944)){
args__4534__auto__.push((arguments[i__4532__auto___13945]));

var G__13946 = (i__4532__auto___13945 + (1));
i__4532__auto___13945 = G__13946;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq13941){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13942,G__13943,seq13941__$2);
});
...
var map__13948 = m;
var map__13948__$1 = ((((!((map__13948 == null)))?(((((map__13948.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__13948.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__13948):map__13948);
var file = cljs.core.get.call(null,map__13948__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__13948__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__13948__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__13948,map__13948__$1,file,line,column){
return (function (p1__13947_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__13947_SHARP_));
});})(map__13948,map__13948__$1,file,line,column))
...
var temp__5457__auto___13950 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13950)){
var message_13951 = temp__5457__auto___13950;
cljs.core.println.call(null,message_13951);
} else {
}
...
var temp__5457__auto___13952 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13952)){
var message_13953 = temp__5457__auto___13952;
cljs.core.println.call(null,message_13953);
} else {
}
...
var output_dir__$1 = (function (){var G__13954 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13954),"/"].join('');
} else {
return G__13954;
}
})();
...
var G__13956 = exception.stack;
var G__13956__$1 = (((G__13956 == null))?null:clojure.string.split_lines.call(null,G__13956));
var G__13956__$2 = (((G__13956__$1 == null))?null:cljs.core.get.call(null,G__13956__$1,depth));
if((G__13956__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__13956__$2);
}
} else {
...
var vec__13957 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__13957,(0),null);
var column = cljs.core.nth.call(null,vec__13957,(1),null);
var vec__13960 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__13960,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__13960,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__13960,(2),null);
...
var m__$1 = (function (){var G__13963 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__13963__$1 = (((G__13963 instanceof cljs.core.Keyword))?G__13963.fqn:null);
switch (G__13963__$1) {
case "fail":
...
var G__13967 = (function (){var G__13966 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__13966);
} else {
return G__13966;
}
})();
...
return cljs.core.vary_meta.call(null,G__13968,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__13972 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__13972,(0),null);
var types = vec__13972;
...
return cljs.core.map.call(null,(function (p__13975){
var vec__13976 = p__13975;
var ns = cljs.core.nth.call(null,vec__13976,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__13976,(1),null);
return ((function (vec__13976,ns,vars__$1){
return (function (){
...
var G__13979 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__13979,G__13979__$1,env,once_fixtures,each_fixtures,vec__13976,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__13979,G__13979__$1,env,once_fixtures,each_fixtures,vec__13976,ns,vars__$1){
return (function (){
var seq__13980 = cljs.core.seq.call(null,vars__$1);
var chunk__13981 = null;
var count__13982 = (0);
var i__13983 = (0);
while(true){
if((i__13983 < count__13982)){
var v = cljs.core._nth.call(null,chunk__13981,i__13983);
var temp__5457__auto___13985 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13985)){
var t_13986 = temp__5457__auto___13985;
each_fixture_fn.call(null,((function (seq__13980,chunk__13981,count__13982,i__13983,t_13986,temp__5457__auto___13985,v,each_fixture_fn,G__13979,G__13979__$1,env,once_fixtures,each_fixtures,vec__13976,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13986)));
});})(seq__13980,chunk__13981,count__13982,i__13983,t_13986,temp__5457__auto___13985,v,each_fixture_fn,G__13979,G__13979__$1,env,once_fixtures,each_fixtures,vec__13976,ns,vars__$1))
);
} else {
}


var G__13987 = seq__13980;
var G__13988 = chunk__13981;
var G__13989 = count__13982;
var G__13990 = (i__13983 + (1));
seq__13980 = G__13987;
chunk__13981 = G__13988;
count__13982 = G__13989;
i__13983 = G__13990;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__13980);
if(temp__5457__auto__){
var seq__13980__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__13980__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__13980__$1);
var G__13991 = cljs.core.chunk_rest.call(null,seq__13980__$1);
var G__13992 = c__4351__auto__;
var G__13993 = cljs.core.count.call(null,c__4351__auto__);
var G__13994 = (0);
seq__13980 = G__13991;
chunk__13981 = G__13992;
count__13982 = G__13993;
i__13983 = G__13994;
continue;
} else {
var v = cljs.core.first.call(null,seq__13980__$1);
var temp__5457__auto___13995__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13995__$1)){
var t_13996 = temp__5457__auto___13995__$1;
each_fixture_fn.call(null,((function (seq__13980,chunk__13981,count__13982,i__13983,t_13996,temp__5457__auto___13995__$1,v,seq__13980__$1,temp__5457__auto__,each_fixture_fn,G__13979,G__13979__$1,env,once_fixtures,each_fixtures,vec__13976,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13996)));
});})(seq__13980,chunk__13981,count__13982,i__13983,t_13996,temp__5457__auto___13995__$1,v,seq__13980__$1,temp__5457__auto__,each_fixture_fn,G__13979,G__13979__$1,env,once_fixtures,each_fixtures,vec__13976,ns,vars__$1))
);
} else {
}


var G__13997 = cljs.core.next.call(null,seq__13980__$1);
var G__13998 = null;
var G__13999 = (0);
var G__14000 = (0);
seq__13980 = G__13997;
chunk__13981 = G__13998;
count__13982 = G__13999;
i__13983 = G__14000;
continue;
}
} else {
...
});})(each_fixture_fn,G__13979,G__13979__$1,env,once_fixtures,each_fixtures,vec__13976,ns,vars__$1))
);
});})(each_fixture_fn,G__13979,G__13979__$1,env,once_fixtures,each_fixtures,vec__13976,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13979__$1)].join('')));

}
})());
});
;})(vec__13976,ns,vars__$1))
