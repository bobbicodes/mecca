...
var len__4531__auto___22749 = arguments.length;
var i__4532__auto___22750 = (0);
while(true){
if((i__4532__auto___22750 < len__4531__auto___22749)){
args__4534__auto__.push((arguments[i__4532__auto___22750]));

var G__22751 = (i__4532__auto___22750 + (1));
i__4532__auto___22750 = G__22751;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq22746){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22747,G__22748,seq22746__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__22752_SHARP_){
return !((cljs.core.meta.call(null,p1__22752_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__22753__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e22757){var _e__21957__auto__ = e22757;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e22759){var _e__21957__auto__ = e22759;
return false;
}}
})())){
...
var _STAR_current_state_STAR_22761 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__22762 = opts;
...
var markup_db = cljs.core.get.call(null,map__22762__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_22761;
}});
...
;
var temp__5455__auto___22766 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___22766)){
var managed_print_level_22767 = temp__5455__auto___22766;
var _STAR_print_level_STAR_22765_22768 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_22767;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_22765_22768,managed_print_level_22767,temp__5455__auto___22766,writer,opts,job_fn){
return (function (p1__22764_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__22764_SHARP_,null);
});})(_STAR_print_level_STAR_22765_22768,managed_print_level_22767,temp__5455__auto___22766,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_22765_22768;
}} else {
job_fn.call(null);
}
