...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__21250_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(tag,cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__21250_SHARP_,cljs.core.cst$kw$tag));
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(voice,mecca.xml.get_voice(p1__21251_SHARP_));
...
return new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$time,time,cljs.core.cst$kw$pitch,((mecca.xml.pitch__GT_midi(mecca.xml.get_pitch(note)) + (function (){var G__21252 = mecca.xml.get_voice(note);
switch (G__21252) {
case (5):
return (12);
...
})()) + (6)),cljs.core.cst$kw$instrument,(function (){var G__21253 = mecca.xml.get_voice(note);
switch (G__21253) {
case (5):
return (15);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21253)].join('')));
...
var G__21256 = (time + (mecca.xml.get_duration(cljs.core.first(notes)) / (6)));
var G__21257 = cljs.core.rest(notes);
var G__21258 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,mecca.xml.parse_note(cljs.core.first(notes),time));
time = G__21256;
notes = G__21257;
result = G__21258;
continue;
...
return mecca.xml.extract_voice(p1__21259_SHARP_,voice);
});})(time))
...
var G__21260 = (time + (mecca.xml.get_duration(cljs.core.first(notes)) / (6)));
var G__21261 = cljs.core.rest(notes);
var G__21262 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,mecca.xml.parse_note(cljs.core.first(notes),time));
time = G__21260;
notes = G__21261;
result = G__21262;
continue;
