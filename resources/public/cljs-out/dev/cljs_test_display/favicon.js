...
return cljs.core.map.call(null,(function (p1__20994_SHARP_){
return html_coll.item(p1__20994_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__20995_SHARP_);
...
var ctx_20996 = cvs.getContext("2d");
ctx_20996.fillStyle = color;

ctx_20996.fillRect((0),(0),size,size);
