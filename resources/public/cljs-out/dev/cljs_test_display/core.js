...
var len__4531__auto___14414 = arguments.length;
var i__4532__auto___14415 = (0);
while(true){
if((i__4532__auto___14415 < len__4531__auto___14414)){
args__4534__auto__.push((arguments[i__4532__auto___14415]));

var G__14416 = (i__4532__auto___14415 + (1));
i__4532__auto___14415 = G__14416;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq14411){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14412,G__14413,seq14411__$2);
});
...
var vec__14417 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__14417,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__14417,(1),null);
var G__14420 = cljs.core.PersistentArrayMap.EMPTY;
var G__14420__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__14420,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__14420);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__14420__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__14420__$1;
}
} else {
...
return (function() { 
var G__14424__delegate = function (klass,contents){
var vec__14421 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__14421,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__14421,(1),null);
...
var G__14424 = function (klass,var_args){
var contents = null;
...
while (G__14425__i < G__14425__a.length) {G__14425__a[G__14425__i] = arguments[G__14425__i + 1]; ++G__14425__i;}
  contents = new cljs.core.IndexedSeq(G__14425__a,0,null);
} 
return G__14424__delegate.call(this,klass,contents);};
G__14424.cljs$lang$maxFixedArity = 1;
G__14424.cljs$lang$applyTo = (function (arglist__14426){
var klass = cljs.core.first(arglist__14426);
var contents = cljs.core.rest(arglist__14426);
return G__14424__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__14430){
...
var ns = cljs.core.get.call(null,map__14431__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__14431__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__14433){
var map__14434 = p__14433;
var map__14434__$1 = ((((!((map__14434 == null)))?(((((map__14434.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14434.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14434):map__14434);
var actual = cljs.core.get.call(null,map__14434__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__14434__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__14436){
...
var expected = cljs.core.get.call(null,map__14437__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__14437__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__14439_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__14441 = cljs_test_display.core.current_var_info.call(null);
var map__14441__$1 = ((((!((map__14441 == null)))?(((((map__14441.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14441.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14441):map__14441);
var info = map__14441__$1;
var name = cljs.core.get.call(null,map__14441__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__14441__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__14441__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__14441,map__14441__$1,info,name,line,file,node){
return (function (p1__14440_SHARP_){
return cljs.core.cons.call(null,node,p1__14440_SHARP_);
});})(curr_node,map__14441,map__14441__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__14443){
var map__14444 = p__14443;
var map__14444__$1 = ((((!((map__14444 == null)))?(((((map__14444.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14444.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14444):map__14444);
var m = map__14444__$1;
var fail = cljs.core.get.call(null,map__14444__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__14444__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__14444__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__14444__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5457__auto___14446 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___14446)){
var message_14447 = temp__5457__auto___14446;
cljs.core.println.call(null,message_14447);
} else {
}
...
var temp__5457__auto___14448 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___14448)){
var message_14449 = temp__5457__auto___14448;
cljs.core.println.call(null,message_14449);
} else {
}
