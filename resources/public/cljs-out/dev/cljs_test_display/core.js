...
var len__4531__auto___21210 = arguments.length;
var i__4532__auto___21211 = (0);
while(true){
if((i__4532__auto___21211 < len__4531__auto___21210)){
args__4534__auto__.push((arguments[i__4532__auto___21211]));

var G__21212 = (i__4532__auto___21211 + (1));
i__4532__auto___21211 = G__21212;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq21207){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21208,G__21209,seq21207__$2);
});
...
var vec__21213 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__21213,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__21213,(1),null);
var G__21216 = cljs.core.PersistentArrayMap.EMPTY;
var G__21216__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__21216,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21216);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__21216__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__21216__$1;
}
} else {
...
return (function() { 
var G__21220__delegate = function (klass,contents){
var vec__21217 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__21217,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__21217,(1),null);
...
var G__21220 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__21221__i = 0, G__21221__a = new Array(arguments.length -  1);
while (G__21221__i < G__21221__a.length) {G__21221__a[G__21221__i] = arguments[G__21221__i + 1]; ++G__21221__i;}
  contents = new cljs.core.IndexedSeq(G__21221__a,0,null);
} 
return G__21220__delegate.call(this,klass,contents);};
G__21220.cljs$lang$maxFixedArity = 1;
G__21220.cljs$lang$applyTo = (function (arglist__21222){
var klass = cljs.core.first(arglist__21222);
var contents = cljs.core.rest(arglist__21222);
return G__21220__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__21226){
...
var ns = cljs.core.get.call(null,map__21227__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__21227__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__21229){
var map__21230 = p__21229;
var map__21230__$1 = ((((!((map__21230 == null)))?(((((map__21230.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21230.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21230):map__21230);
var actual = cljs.core.get.call(null,map__21230__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__21230__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__21232){
var map__21233 = p__21232;
var map__21233__$1 = ((((!((map__21233 == null)))?(((((map__21233.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21233.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21233):map__21233);
var expected = cljs.core.get.call(null,map__21233__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__21233__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__21235_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__21237 = cljs_test_display.core.current_var_info.call(null);
var map__21237__$1 = ((((!((map__21237 == null)))?(((((map__21237.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21237.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21237):map__21237);
var info = map__21237__$1;
var name = cljs.core.get.call(null,map__21237__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__21237__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__21237__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__21237,map__21237__$1,info,name,line,file,node){
return (function (p1__21236_SHARP_){
return cljs.core.cons.call(null,node,p1__21236_SHARP_);
});})(curr_node,map__21237,map__21237__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__21239){
var map__21240 = p__21239;
var map__21240__$1 = ((((!((map__21240 == null)))?(((((map__21240.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21240.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21240):map__21240);
var m = map__21240__$1;
var fail = cljs.core.get.call(null,map__21240__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__21240__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__21240__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__21240__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5457__auto___21242 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21242)){
var message_21243 = temp__5457__auto___21242;
cljs.core.println.call(null,message_21243);
} else {
}
...
var temp__5457__auto___21244 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21244)){
var message_21245 = temp__5457__auto___21244;
cljs.core.println.call(null,message_21245);
} else {
}
