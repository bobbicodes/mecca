...
var G__13869 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__13869,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__13869;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq13871){
var G__13872 = cljs.core.first.call(null,seq13871);
var seq13871__$1 = cljs.core.next.call(null,seq13871);
var G__13873 = cljs.core.first.call(null,seq13871__$1);
var seq13871__$2 = cljs.core.next.call(null,seq13871__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13872,G__13873,seq13871__$2);
});
...
var map__13878 = m;
var map__13878__$1 = ((((!((map__13878 == null)))?(((((map__13878.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__13878.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__13878):map__13878);
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__13878,map__13878__$1,file,line,column){
return (function (p1__13877_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__13877_SHARP_));
});})(map__13878,map__13878__$1,file,line,column))
...
var temp__5457__auto___13880 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13880)){
var message_13881 = temp__5457__auto___13880;
cljs.core.println.call(null,message_13881);
} else {
}
...
var output_dir__$1 = (function (){var G__13884 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13884),"/"].join('');
} else {
return G__13884;
}
})();
...
var G__13886 = exception.stack;
var G__13886__$1 = (((G__13886 == null))?null:clojure.string.split_lines.call(null,G__13886));
var G__13886__$2 = (((G__13886__$1 == null))?null:cljs.core.get.call(null,G__13886__$1,depth));
if((G__13886__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__13886__$2);
}
} else {
...
var vec__13887 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__13887,(0),null);
var column = cljs.core.nth.call(null,vec__13887,(1),null);
var vec__13890 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__13890,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__13890,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__13890,(2),null);
...
var m__$1 = (function (){var G__13893 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__13897 = (function (){var G__13896 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__13896);
} else {
return G__13896;
}
})();
...
return cljs.core.vary_meta.call(null,G__13898,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__13902 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__13902,(0),null);
var types = vec__13902;
...
return cljs.core.map.call(null,(function (p__13905){
var vec__13906 = p__13905;
var ns = cljs.core.nth.call(null,vec__13906,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__13906,(1),null);
return ((function (vec__13906,ns,vars__$1){
return (function (){
...
var G__13909 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__13909,G__13909__$1,env,once_fixtures,each_fixtures,vec__13906,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__13909,G__13909__$1,env,once_fixtures,each_fixtures,vec__13906,ns,vars__$1){
return (function (){
var seq__13910 = cljs.core.seq.call(null,vars__$1);
var chunk__13911 = null;
var count__13912 = (0);
var i__13913 = (0);
while(true){
if((i__13913 < count__13912)){
var v = cljs.core._nth.call(null,chunk__13911,i__13913);
var temp__5457__auto___13915 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13915)){
var t_13916 = temp__5457__auto___13915;
each_fixture_fn.call(null,((function (seq__13910,chunk__13911,count__13912,i__13913,t_13916,temp__5457__auto___13915,v,each_fixture_fn,G__13909,G__13909__$1,env,once_fixtures,each_fixtures,vec__13906,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13916)));
});})(seq__13910,chunk__13911,count__13912,i__13913,t_13916,temp__5457__auto___13915,v,each_fixture_fn,G__13909,G__13909__$1,env,once_fixtures,each_fixtures,vec__13906,ns,vars__$1))
);
} else {
}
...
var temp__5457__auto__ = cljs.core.seq.call(null,seq__13910);
if(temp__5457__auto__){
var seq__13910__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__13910__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__13910__$1);
var G__13921 = cljs.core.chunk_rest.call(null,seq__13910__$1);
var G__13922 = c__4351__auto__;
var G__13923 = cljs.core.count.call(null,c__4351__auto__);
var G__13924 = (0);
seq__13910 = G__13921;
...
var v = cljs.core.first.call(null,seq__13910__$1);
var temp__5457__auto___13925__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13925__$1)){
var t_13926 = temp__5457__auto___13925__$1;
each_fixture_fn.call(null,((function (seq__13910,chunk__13911,count__13912,i__13913,t_13926,temp__5457__auto___13925__$1,v,seq__13910__$1,temp__5457__auto__,each_fixture_fn,G__13909,G__13909__$1,env,once_fixtures,each_fixtures,vec__13906,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13926)));
});})(seq__13910,chunk__13911,count__13912,i__13913,t_13926,temp__5457__auto___13925__$1,v,seq__13910__$1,temp__5457__auto__,each_fixture_fn,G__13909,G__13909__$1,env,once_fixtures,each_fixtures,vec__13906,ns,vars__$1))
);
} else {
}


var G__13927 = cljs.core.next.call(null,seq__13910__$1);
var G__13928 = null;
var G__13929 = (0);
var G__13930 = (0);
seq__13910 = G__13927;
chunk__13911 = G__13928;
count__13912 = G__13929;
i__13913 = G__13930;
continue;
}
} else {
...
});})(each_fixture_fn,G__13909,G__13909__$1,env,once_fixtures,each_fixtures,vec__13906,ns,vars__$1))
);
});})(each_fixture_fn,G__13909,G__13909__$1,env,once_fixtures,each_fixtures,vec__13906,ns,vars__$1))
], null);
