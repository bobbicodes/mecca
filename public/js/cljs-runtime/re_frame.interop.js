...
return [(function (){var pred__54479 = cljs.core.instance_QMARK_;
var expr__54480 = reactive_val;
if(cljs.core.truth_((pred__54479.cljs$core$IFn$_invoke$arity$2 ? pred__54479.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__54480) : pred__54479.call(null,reagent.ratom.RAtom,expr__54480)))){
return "ra";
} else {
if(cljs.core.truth_((pred__54479.cljs$core$IFn$_invoke$arity$2 ? pred__54479.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__54480) : pred__54479.call(null,reagent.ratom.RCursor,expr__54480)))){
return "rc";
} else {
if(cljs.core.truth_((pred__54479.cljs$core$IFn$_invoke$arity$2 ? pred__54479.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__54480) : pred__54479.call(null,reagent.ratom.Reaction,expr__54480)))){
return "rx";
} else {
if(cljs.core.truth_((pred__54479.cljs$core$IFn$_invoke$arity$2 ? pred__54479.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__54480) : pred__54479.call(null,reagent.ratom.Track,expr__54480)))){
return "tr";
} else {
return "other";
}
