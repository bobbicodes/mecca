...
return cljs.core.assoc.call(null,G__13940,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__13940;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq13942){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13943,G__13944,seq13942__$2);
});
...
var file = cljs.core.get.call(null,map__13949__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__13949__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__13949__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__13949,map__13949__$1,file,line,column){
return (function (p1__13948_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__13948_SHARP_));
});})(map__13949,map__13949__$1,file,line,column))
...
var temp__5457__auto___13951 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13951)){
var message_13952 = temp__5457__auto___13951;
cljs.core.println.call(null,message_13952);
} else {
}
...
var temp__5457__auto___13953 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13953)){
var message_13954 = temp__5457__auto___13953;
cljs.core.println.call(null,message_13954);
} else {
}
...
var output_dir__$1 = (function (){var G__13955 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13955),"/"].join('');
} else {
return G__13955;
}
})();
...
var G__13957 = exception.stack;
var G__13957__$1 = (((G__13957 == null))?null:clojure.string.split_lines.call(null,G__13957));
var G__13957__$2 = (((G__13957__$1 == null))?null:cljs.core.get.call(null,G__13957__$1,depth));
if((G__13957__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__13957__$2);
}
} else {
...
var vec__13958 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__13958,(0),null);
var column = cljs.core.nth.call(null,vec__13958,(1),null);
var vec__13961 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__13961,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__13961,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__13961,(2),null);
...
var m__$1 = (function (){var G__13964 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__13968 = (function (){var G__13967 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__13967);
} else {
return G__13967;
}
})();
...
return cljs.core.vary_meta.call(null,G__13969,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e13970){var e = e13970;
var G__13971 = e;
var G__13971__$1 = (((G__13971 instanceof cljs.core.Keyword))?G__13971.fqn:null);
switch (G__13971__$1) {
...
var vec__13973 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__13973,(0),null);
var types = vec__13973;
...
return cljs.core.map.call(null,(function (p__13976){
var vec__13977 = p__13976;
var ns = cljs.core.nth.call(null,vec__13977,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__13977,(1),null);
return ((function (vec__13977,ns,vars__$1){
return (function (){
...
var G__13980 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__13980,G__13980__$1,env,once_fixtures,each_fixtures,vec__13977,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__13980,G__13980__$1,env,once_fixtures,each_fixtures,vec__13977,ns,vars__$1){
return (function (){
var seq__13981 = cljs.core.seq.call(null,vars__$1);
...
var temp__5457__auto___13986 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13986)){
var t_13987 = temp__5457__auto___13986;
each_fixture_fn.call(null,((function (seq__13981,chunk__13982,count__13983,i__13984,t_13987,temp__5457__auto___13986,v,each_fixture_fn,G__13980,G__13980__$1,env,once_fixtures,each_fixtures,vec__13977,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13987)));
});})(seq__13981,chunk__13982,count__13983,i__13984,t_13987,temp__5457__auto___13986,v,each_fixture_fn,G__13980,G__13980__$1,env,once_fixtures,each_fixtures,vec__13977,ns,vars__$1))
);
} else {
}
...
var temp__5457__auto__ = cljs.core.seq.call(null,seq__13981);
if(temp__5457__auto__){
var seq__13981__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__13981__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__13981__$1);
var G__13992 = cljs.core.chunk_rest.call(null,seq__13981__$1);
var G__13993 = c__4351__auto__;
var G__13994 = cljs.core.count.call(null,c__4351__auto__);
var G__13995 = (0);
seq__13981 = G__13992;
...
var temp__5457__auto___13996__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13996__$1)){
var t_13997 = temp__5457__auto___13996__$1;
each_fixture_fn.call(null,((function (seq__13981,chunk__13982,count__13983,i__13984,t_13997,temp__5457__auto___13996__$1,v,seq__13981__$1,temp__5457__auto__,each_fixture_fn,G__13980,G__13980__$1,env,once_fixtures,each_fixtures,vec__13977,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13997)));
});})(seq__13981,chunk__13982,count__13983,i__13984,t_13997,temp__5457__auto___13996__$1,v,seq__13981__$1,temp__5457__auto__,each_fixture_fn,G__13980,G__13980__$1,env,once_fixtures,each_fixtures,vec__13977,ns,vars__$1))
);
} else {
}


var G__13998 = cljs.core.next.call(null,seq__13981__$1);
var G__13999 = null;
var G__14000 = (0);
var G__14001 = (0);
seq__13981 = G__13998;
chunk__13982 = G__13999;
count__13983 = G__14000;
i__13984 = G__14001;
continue;
}
} else {
...
});})(each_fixture_fn,G__13980,G__13980__$1,env,once_fixtures,each_fixtures,vec__13977,ns,vars__$1))
);
});})(each_fixture_fn,G__13980,G__13980__$1,env,once_fixtures,each_fixtures,vec__13977,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13980__$1)].join('')));

}
})());
});
;})(vec__13977,ns,vars__$1))
