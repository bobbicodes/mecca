...
var o21317 = temp__5455__auto__;
var temp__5455__auto____$1 = (o21317["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o21318 = temp__5455__auto____$1;
return (o21318["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21137__auto__ = f;
return (o__21137__auto__["toString"]).call(o__21137__auto__);
} else {
return "";
}
...
try{var o__21137__auto___21321 = t;
(o__21137__auto___21321["cljs$lang$ctorPrWriter"]).call(o__21137__auto___21321,t,writer);
}catch (e21320){var __21322 = e21320;
}
...
var char_code = (function (){var o__21137__auto__ = (new String(char$));
return (o__21137__auto__["charCodeAt"]).call(o__21137__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21137__auto__ = String;
return (o__21137__auto__["fromCharCode"]).call(o__21137__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21323 = num_code;
switch (G__21323) {
case (1):
return (185);
...
var o__21137__auto__ = String;
return (o__21137__auto__["fromCharCode"]).call(o__21137__auto__,superscript_code);
});
/**
...
}catch (e21325){var _e__21144__auto__ = e21325;
return false;
}})())){
...
var vec__21326 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21326,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o21329 = temp__5455__auto__;
var temp__5455__auto____$1 = (o21329["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o21330 = temp__5455__auto____$1;
return (o21330["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___21337 = arguments.length;
var i__4532__auto___21338 = (0);
while(true){
if((i__4532__auto___21338 < len__4531__auto___21337)){
args__4534__auto__.push((arguments[i__4532__auto___21338]));

var G__21339 = (i__4532__auto___21338 + (1));
i__4532__auto___21338 = G__21339;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21333){
var vec__21334 = p__21333;
var ns_detector = cljs.core.nth.call(null,vec__21334,(0),null);
...
var G__21340 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21341 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21340;
remaining_tokens = G__21341;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21331){
var G__21332 = cljs.core.first.call(null,seq21331);
var seq21331__$1 = cljs.core.next.call(null,seq21331);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21332,seq21331__$1);
});
...
var vec__21345 = cljs.core.split_with.call(null,(function (p1__21344_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21344_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21345,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21345,(1),null);
...
var vec__21348 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21348,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21348,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__21351 = cljs.core.rest.call(null,remaining_tokens);
var G__21352 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__21351;
name_tokens = G__21352;
continue;
} else {
...
var vec__21355 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__21355,(0),null);
var arity = cljs.core.nth.call(null,vec__21355,(1),null);
var vec__21358 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__21358,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__21358,(1),null);
var vec__21361 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__21361,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__21361,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__21361,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__21361,(3),null);
...
var vec__21367 = result;
var munged_ns = cljs.core.nth.call(null,vec__21367,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__21367,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__21367,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__21367,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__21367,(4),null);
var arity = cljs.core.nth.call(null,vec__21367,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__21371 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__21371,(0),null);
var args = cljs.core.nth.call(null,vec__21371,(1),null);
var vec__21374 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__21374,(0),null);
var name = cljs.core.nth.call(null,vec__21374,(1),null);
...
var G__21377 = (arity + (1));
var G__21378 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21379){
var vec__21380 = p__21379;
var arity = cljs.core.nth.call(null,vec__21380,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__21380,(1),null);
...
return cljs.core.get.call(null,arities,p1__21383_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__21384_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___21391 = arguments.length;
var i__4532__auto___21392 = (0);
while(true){
if((i__4532__auto___21392 < len__4531__auto___21391)){
args__4534__auto__.push((arguments[i__4532__auto___21392]));

var G__21393 = (i__4532__auto___21392 + (1));
i__4532__auto___21392 = G__21393;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21387){
var vec__21388 = p__21387;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__21388,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21385){
var G__21386 = cljs.core.first.call(null,seq21385);
var seq21385__$1 = cljs.core.next.call(null,seq21385);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21386,seq21385__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__21396__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__21396__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__21396__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__21396__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21397 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__21397,(0),null);
var fn_name = cljs.core.nth.call(null,vec__21397,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__21397,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__21397,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__21397,(4),null);
var arity = cljs.core.nth.call(null,vec__21397,(5),null);
...
var o__21137__auto__ = f;
return (o__21137__auto__["getBasis"]).call(o__21137__auto__);
});
/**
...
}catch (e21401){var _e__21144__auto__ = e21401;
...
var G__21402 = (obj[cljs.core.first.call(null,path)]);
var G__21403 = cljs.core.rest.call(null,path);
obj = G__21402;
path = G__21403;
continue;
} else {
...
return (function (accum,p__21404){
var vec__21405 = p__21404;
var bit = cljs.core.nth.call(null,vec__21405,(0),null);
var protocol = cljs.core.nth.call(null,vec__21405,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21408){
var vec__21409 = p__21408;
var ns = cljs.core.nth.call(null,vec__21409,(0),null);
var name = cljs.core.nth.call(null,vec__21409,(1),null);
var selector = cljs.core.nth.call(null,vec__21409,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__21414,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__21414,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__21414,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__21412_SHARP_){
return (obj[cljs.core.first.call(null,p1__21412_SHARP_)]);
});})(name,sorted_matches,vec__21414,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
