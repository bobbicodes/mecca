...
var G__36273 = o;
(G__36273[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__36275 = o;
(G__36275[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__36285 = props;
var G__36285__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36285,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36285);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36285__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__36286){
...
var props = map__36287__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36287__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__36298){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36299__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var G__36303 = jsprops;
(G__36303["defaultValue"] = value);

(G__36303["onChange"] = (function (p1__36302_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__36302_SHARP_);
}));
...
var vec__36306 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36306,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36306,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36306,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___36356 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___36356 == null)){
} else {
var key_36357 = temp__5739__auto___36356;
(jsprops["key"] = key_36357);
}
...
var temp__5739__auto___36359 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___36359 == null)){
} else {
var key_36361 = temp__5739__auto___36359;
reagent.impl.template.oset(jsprops,"key",key_36361);
}
...
var G__36311 = reagent.impl.template.__GT_NativeWrapper();
(G__36311["name"] = c);
...
var G__36314 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__36314) : reagent.impl.template.as_element.call(null,G__36314));
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq36319){
...
break;
default:
var G__36371 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__36371;
continue;
...
var n__4666__auto___36385 = a.length;
var i_36386 = (0);
while(true){
if((i_36386 < n__4666__auto___36385)){
(a[i_36386] = reagent.impl.template.as_element((a[i_36386])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4666__auto___36388 = a.length;
var i_36390 = (0);
while(true){
if((i_36390 < n__4666__auto___36388)){
var val_36392 = (a[i_36390]);
if(((cljs.core.vector_QMARK_(val_36392)) && ((reagent.impl.template.key_from_vec(val_36392) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_36390] = reagent.impl.template.as_element(val_36392));

var G__36399 = (i_36390 + (1));
i_36390 = G__36399;
continue;
} else {
}
...
var ctx = ({});
var vec__36325 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36325,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36325,(1),null);
...
var G__36328 = (cljs.core.count(argv) - first_child);
switch (G__36328) {
case (0):
...
case (1):
var G__36329 = comp;
var G__36330 = jsprops;
var G__36331 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__36329,G__36330,G__36331);
