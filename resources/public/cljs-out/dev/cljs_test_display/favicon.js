...
return cljs.core.map.call(null,(function (p1__21972_SHARP_){
return html_coll.item(p1__21972_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__21973_SHARP_);
...
var ctx_21974 = cvs.getContext("2d");
ctx_21974.fillStyle = color;

ctx_21974.fillRect((0),(0),size,size);
