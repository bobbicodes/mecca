...
return [(function (){var pred__39870 = cljs.core.instance_QMARK_;
var expr__39871 = reactive_val;
if(cljs.core.truth_((pred__39870.cljs$core$IFn$_invoke$arity$2 ? pred__39870.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__39871) : pred__39870.call(null,reagent.ratom.RAtom,expr__39871)))){
return "ra";
} else {
if(cljs.core.truth_((pred__39870.cljs$core$IFn$_invoke$arity$2 ? pred__39870.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__39871) : pred__39870.call(null,reagent.ratom.RCursor,expr__39871)))){
return "rc";
} else {
if(cljs.core.truth_((pred__39870.cljs$core$IFn$_invoke$arity$2 ? pred__39870.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__39871) : pred__39870.call(null,reagent.ratom.Reaction,expr__39871)))){
return "rx";
} else {
if(cljs.core.truth_((pred__39870.cljs$core$IFn$_invoke$arity$2 ? pred__39870.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__39871) : pred__39870.call(null,reagent.ratom.Track,expr__39871)))){
return "tr";
} else {
return "other";
}
