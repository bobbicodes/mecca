...
var o21485 = temp__5455__auto__;
var temp__5455__auto____$1 = (o21485["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o21486 = temp__5455__auto____$1;
return (o21486["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21305__auto__ = f;
return (o__21305__auto__["toString"]).call(o__21305__auto__);
} else {
return "";
}
}catch (e21487){var _ = e21487;
return "";
}});
...
try{var o__21305__auto___21489 = t;
(o__21305__auto___21489["cljs$lang$ctorPrWriter"]).call(o__21305__auto___21489,t,writer);
}catch (e21488){var __21490 = e21488;
}
...
var char_code = (function (){var o__21305__auto__ = (new String(char$));
return (o__21305__auto__["charCodeAt"]).call(o__21305__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21305__auto__ = String;
return (o__21305__auto__["fromCharCode"]).call(o__21305__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21491 = num_code;
switch (G__21491) {
case (1):
return (185);
...
var o__21305__auto__ = String;
return (o__21305__auto__["fromCharCode"]).call(o__21305__auto__,superscript_code);
});
/**
...
}catch (e21493){var _e__21312__auto__ = e21493;
return false;
}})())){
...
var vec__21494 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21494,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o21497 = temp__5455__auto__;
var temp__5455__auto____$1 = (o21497["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o21498 = temp__5455__auto____$1;
return (o21498["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___21505 = arguments.length;
var i__4532__auto___21506 = (0);
while(true){
if((i__4532__auto___21506 < len__4531__auto___21505)){
args__4534__auto__.push((arguments[i__4532__auto___21506]));

var G__21507 = (i__4532__auto___21506 + (1));
i__4532__auto___21506 = G__21507;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21501){
var vec__21502 = p__21501;
var ns_detector = cljs.core.nth.call(null,vec__21502,(0),null);
...
var G__21508 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21509 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21508;
remaining_tokens = G__21509;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21499){
var G__21500 = cljs.core.first.call(null,seq21499);
var seq21499__$1 = cljs.core.next.call(null,seq21499);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21500,seq21499__$1);
});
...
var vec__21513 = cljs.core.split_with.call(null,(function (p1__21512_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21512_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21513,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21513,(1),null);
...
var vec__21516 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21516,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21516,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__21519 = cljs.core.rest.call(null,remaining_tokens);
var G__21520 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__21519;
name_tokens = G__21520;
continue;
} else {
...
var vec__21523 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__21523,(0),null);
var arity = cljs.core.nth.call(null,vec__21523,(1),null);
var vec__21526 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__21526,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__21526,(1),null);
var vec__21529 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__21529,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__21529,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__21529,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__21529,(3),null);
...
var vec__21535 = result;
var munged_ns = cljs.core.nth.call(null,vec__21535,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__21535,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__21535,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__21535,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__21535,(4),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__21539 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__21539,(0),null);
var args = cljs.core.nth.call(null,vec__21539,(1),null);
var vec__21542 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__21542,(0),null);
var name = cljs.core.nth.call(null,vec__21542,(1),null);
...
var G__21545 = (arity + (1));
var G__21546 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21547){
var vec__21548 = p__21547;
var arity = cljs.core.nth.call(null,vec__21548,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__21548,(1),null);
...
return cljs.core.get.call(null,arities,p1__21551_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__21552_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21555){
var vec__21556 = p__21555;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__21556,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21553){
var G__21554 = cljs.core.first.call(null,seq21553);
var seq21553__$1 = cljs.core.next.call(null,seq21553);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21554,seq21553__$1);
});
...
var map__21564 = options;
var map__21564__$1 = ((((!((map__21564 == null)))?(((((map__21564.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21564.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21564):map__21564);
var include_ns_QMARK_ = cljs.core.get.call(null,map__21564__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__21564__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__21564__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__21564__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21565 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__21565,(0),null);
var fn_name = cljs.core.nth.call(null,vec__21565,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__21565,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__21565,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__21565,(4),null);
var arity = cljs.core.nth.call(null,vec__21565,(5),null);
...
var o__21305__auto__ = f;
return (o__21305__auto__["getBasis"]).call(o__21305__auto__);
});
/**
...
}catch (e21569){var _e__21312__auto__ = e21569;
...
var G__21570 = (obj[cljs.core.first.call(null,path)]);
var G__21571 = cljs.core.rest.call(null,path);
obj = G__21570;
path = G__21571;
continue;
} else {
...
return (function (accum,p__21572){
var vec__21573 = p__21572;
var bit = cljs.core.nth.call(null,vec__21573,(0),null);
var protocol = cljs.core.nth.call(null,vec__21573,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21576){
var vec__21577 = p__21576;
var ns = cljs.core.nth.call(null,vec__21577,(0),null);
var name = cljs.core.nth.call(null,vec__21577,(1),null);
var selector = cljs.core.nth.call(null,vec__21577,(2),null);
...
return (function (p__21581){
var vec__21582 = p__21581;
var munged_name = cljs.core.nth.call(null,vec__21582,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__21582,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__21582,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__21580_SHARP_){
return (obj[cljs.core.first.call(null,p1__21580_SHARP_)]);
});})(name,sorted_matches,vec__21582,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
