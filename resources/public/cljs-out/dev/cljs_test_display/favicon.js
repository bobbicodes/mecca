...
return cljs.core.map.call(null,(function (p1__21954_SHARP_){
return html_coll.item(p1__21954_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__21955_SHARP_);
...
var ctx_21956 = cvs.getContext("2d");
ctx_21956.fillStyle = color;

ctx_21956.fillRect((0),(0),size,size);
