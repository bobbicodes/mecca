...
var G__20270 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__20270,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__20270;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq20272){
var G__20273 = cljs.core.first.call(null,seq20272);
var seq20272__$1 = cljs.core.next.call(null,seq20272);
var G__20274 = cljs.core.first.call(null,seq20272__$1);
var seq20272__$2 = cljs.core.next.call(null,seq20272__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20273,G__20274,seq20272__$2);
});
...
var file = cljs.core.get.call(null,map__20279__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__20279__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__20279__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__20279,map__20279__$1,file,line,column){
return (function (p1__20278_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__20278_SHARP_));
});})(map__20279,map__20279__$1,file,line,column))
...
var temp__5457__auto___20281 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20281)){
var message_20282 = temp__5457__auto___20281;
cljs.core.println.call(null,message_20282);
} else {
}
...
var temp__5457__auto___20283 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20283)){
var message_20284 = temp__5457__auto___20283;
cljs.core.println.call(null,message_20284);
} else {
}
...
var output_dir__$1 = (function (){var G__20285 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20285),"/"].join('');
} else {
return G__20285;
}
})();
...
var G__20287 = exception.stack;
var G__20287__$1 = (((G__20287 == null))?null:clojure.string.split_lines.call(null,G__20287));
var G__20287__$2 = (((G__20287__$1 == null))?null:cljs.core.get.call(null,G__20287__$1,depth));
if((G__20287__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__20287__$2);
}
} else {
...
var vec__20288 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__20288,(0),null);
var column = cljs.core.nth.call(null,vec__20288,(1),null);
var vec__20291 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__20291,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__20291,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__20291,(2),null);
...
var m__$1 = (function (){var G__20294 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__20294__$1 = (((G__20294 instanceof cljs.core.Keyword))?G__20294.fqn:null);
switch (G__20294__$1) {
case "fail":
...
var G__20298 = (function (){var G__20297 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__20297);
} else {
return G__20297;
}
})();
...
return cljs.core.vary_meta.call(null,G__20299,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__20303 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__20303,(0),null);
var types = vec__20303;
...
return cljs.core.map.call(null,(function (p__20306){
var vec__20307 = p__20306;
var ns = cljs.core.nth.call(null,vec__20307,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__20307,(1),null);
return ((function (vec__20307,ns,vars__$1){
return (function (){
...
var G__20310 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__20310,G__20310__$1,env,once_fixtures,each_fixtures,vec__20307,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__20310,G__20310__$1,env,once_fixtures,each_fixtures,vec__20307,ns,vars__$1){
return (function (){
var seq__20311 = cljs.core.seq.call(null,vars__$1);
var chunk__20312 = null;
var count__20313 = (0);
var i__20314 = (0);
while(true){
if((i__20314 < count__20313)){
var v = cljs.core._nth.call(null,chunk__20312,i__20314);
var temp__5457__auto___20316 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20316)){
var t_20317 = temp__5457__auto___20316;
each_fixture_fn.call(null,((function (seq__20311,chunk__20312,count__20313,i__20314,t_20317,temp__5457__auto___20316,v,each_fixture_fn,G__20310,G__20310__$1,env,once_fixtures,each_fixtures,vec__20307,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20317)));
});})(seq__20311,chunk__20312,count__20313,i__20314,t_20317,temp__5457__auto___20316,v,each_fixture_fn,G__20310,G__20310__$1,env,once_fixtures,each_fixtures,vec__20307,ns,vars__$1))
);
} else {
}


var G__20318 = seq__20311;
var G__20319 = chunk__20312;
var G__20320 = count__20313;
var G__20321 = (i__20314 + (1));
seq__20311 = G__20318;
chunk__20312 = G__20319;
count__20313 = G__20320;
i__20314 = G__20321;
continue;
} else {
...
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__20311__$1);
var G__20322 = cljs.core.chunk_rest.call(null,seq__20311__$1);
var G__20323 = c__4351__auto__;
var G__20324 = cljs.core.count.call(null,c__4351__auto__);
var G__20325 = (0);
seq__20311 = G__20322;
chunk__20312 = G__20323;
count__20313 = G__20324;
i__20314 = G__20325;
continue;
} else {
var v = cljs.core.first.call(null,seq__20311__$1);
var temp__5457__auto___20326__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20326__$1)){
var t_20327 = temp__5457__auto___20326__$1;
each_fixture_fn.call(null,((function (seq__20311,chunk__20312,count__20313,i__20314,t_20327,temp__5457__auto___20326__$1,v,seq__20311__$1,temp__5457__auto__,each_fixture_fn,G__20310,G__20310__$1,env,once_fixtures,each_fixtures,vec__20307,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20327)));
});})(seq__20311,chunk__20312,count__20313,i__20314,t_20327,temp__5457__auto___20326__$1,v,seq__20311__$1,temp__5457__auto__,each_fixture_fn,G__20310,G__20310__$1,env,once_fixtures,each_fixtures,vec__20307,ns,vars__$1))
);
} else {
}


var G__20328 = cljs.core.next.call(null,seq__20311__$1);
var G__20329 = null;
var G__20330 = (0);
var G__20331 = (0);
seq__20311 = G__20328;
chunk__20312 = G__20329;
count__20313 = G__20330;
i__20314 = G__20331;
continue;
}
} else {
...
});})(each_fixture_fn,G__20310,G__20310__$1,env,once_fixtures,each_fixtures,vec__20307,ns,vars__$1))
);
});})(each_fixture_fn,G__20310,G__20310__$1,env,once_fixtures,each_fixtures,vec__20307,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20310__$1)].join('')));

}
})());
});
;})(vec__20307,ns,vars__$1))
