...
var G__21845 = devtools.prefs.pref.call(null,v);
v = G__21845;
continue;
} else {
return v;
...
}catch (e21848){var _e__21099__auto__ = e21848;
return false;
}})();
...
}catch (e21852){var _e__21099__auto__ = e21852;
return false;
}})();
...
}catch (e21854){var _e__21099__auto__ = e21854;
return false;
}}
}
});
...
var vec__21856 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21856,(0),null);
var name = cljs.core.nth.call(null,vec__21856,(1),null);
...
return cljs.core.some.call(null,(function (p1__21859_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21859_SHARP_);
}),template);
});
