...
var G__54274 = o;
goog.object.set(G__54274,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__54327__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__54327 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__54328__i = 0, G__54328__a = new Array(arguments.length -  0);
while (G__54328__i < G__54328__a.length) {G__54328__a[G__54328__i] = arguments[G__54328__i + 0]; ++G__54328__i;}
  args = new cljs.core.IndexedSeq(G__54328__a,0,null);
} 
return G__54327__delegate.call(this,args);};
G__54327.cljs$lang$maxFixedArity = 0;
G__54327.cljs$lang$applyTo = (function (arglist__54329){
var args = cljs.core.seq(arglist__54329);
return G__54327__delegate(args);
});
...
var G__54275 = o;
goog.object.set(G__54275,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__54331__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__54331 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__54332__i = 0, G__54332__a = new Array(arguments.length -  0);
while (G__54332__i < G__54332__a.length) {G__54332__a[G__54332__i] = arguments[G__54332__i + 0]; ++G__54332__i;}
  args = new cljs.core.IndexedSeq(G__54332__a,0,null);
} 
return G__54331__delegate.call(this,args);};
G__54331.cljs$lang$maxFixedArity = 0;
G__54331.cljs$lang$applyTo = (function (arglist__54333){
var args = cljs.core.seq(arglist__54333);
return G__54331__delegate(args);
});
G__54331.cljs$core$IFn$_invoke$arity$variadic = G__54331__delegate;
return G__54331;
})()
;
} else {
...
var G__54276 = props;
var G__54276__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54276,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__54276);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54276__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4223__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__54277 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54277,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__54277;
}
})(),id_class);
...
var G__54278 = (cljs.core.count(argv) - first_child);
switch (G__54278) {
case (0):
...
var vec__54279 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54279,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54279,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54279,(2),null);
...
var temp__5757__auto___54426 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___54426 == null)){
} else {
var key_54427 = temp__5757__auto___54426;
(jsprops.key = key_54427);
}
...
var temp__5757__auto___54428 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___54428 == null)){
} else {
var key_54429 = temp__5757__auto___54428;
(jsprops.key = key_54429);
}
...
var temp__5757__auto___54432 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___54432 == null)){
} else {
var key_54433 = temp__5757__auto___54432;
(jsprops.key = key_54433);
}
...
var temp__5757__auto___54434 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___54434 == null)){
} else {
var key_54435 = temp__5757__auto___54434;
(jsprops.key = key_54435);
}
...
var temp__5757__auto___54436 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___54436 == null)){
} else {
var key_54437 = temp__5757__auto___54436;
(jsprops.key = key_54437);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__54282_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__54282_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__54283 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54283,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54283,(1),null);
...
break;
default:
var G__54440 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__54441 = compiler;
v = G__54440;
compiler = G__54441;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template54289 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template54289 = (function (opts,id,fn_to_element,parse_fn,meta54290){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta54290 = meta54290;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template54289.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_54291,meta54290__$1){
var self__ = this;
var _54291__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template54289(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta54290__$1));
}));

(reagent.impl.template.t_reagent$impl$template54289.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_54291){
var self__ = this;
var _54291__$1 = this;
return self__.meta54290;
}));

(reagent.impl.template.t_reagent$impl$template54289.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template54289.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template54289.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template54289.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template54289.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template54289.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta54290","meta54290",1431941545,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template54289.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template54289.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template54289");

(reagent.impl.template.t_reagent$impl$template54289.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write(writer__4462__auto__,"reagent.impl.template/t_reagent$impl$template54289");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template54289.
 */
reagent.impl.template.__GT_t_reagent$impl$template54289 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template54289(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta54290){
return (new reagent.impl.template.t_reagent$impl$template54289(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta54290));
});

}

return (new reagent.impl.template.t_reagent$impl$template54289(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
