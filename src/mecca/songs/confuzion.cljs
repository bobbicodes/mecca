...
(map (fn [m] (update m :time #(+ % 440)))
[{:time 18, :instrument 14, :pitch 74} {:time 18.5, :instrument 14, :pitch 74} {:time 19.5, :instrument 14, :pitch 74} {:time 21, :instrument 14, :pitch 76} {:time 24, :instrument 14, :pitch 83} {:time 25.5, :instrument 14, :pitch 80} {:time 28, :instrument 14, :pitch 78} {:time 29.5, :instrument 14, :pitch 80} {:time 32, :instrument 14, :pitch 76} {:time 32.5, :instrument 14, :pitch 74} {:time 33.5, :instrument 14, :pitch 71} {:time 36, :instrument 14, :pitch 69} {:time 36.5, :instrument 14, :pitch 71} {:time 37.5, :instrument 14, :pitch 69} {:time 40, :instrument 14, :pitch 66} {:time 41.5, :instrument 14, :pitch 64}])
