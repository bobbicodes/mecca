...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq22668){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22669,G__22670,seq22668__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__22674_SHARP_){
return !((cljs.core.meta.call(null,p1__22674_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__22675__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e22679){var _e__21434__auto__ = e22679;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e22681){var _e__21434__auto__ = e22681;
return false;
}}
})())){
...
var _STAR_current_state_STAR_22683 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__22684 = opts;
...
var markup_db = cljs.core.get.call(null,map__22684__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_22683;
}});
...
;
var temp__5455__auto___22688 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___22688)){
var managed_print_level_22689 = temp__5455__auto___22688;
var _STAR_print_level_STAR_22687_22690 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_22689;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_22687_22690,managed_print_level_22689,temp__5455__auto___22688,writer,opts,job_fn){
return (function (p1__22686_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__22686_SHARP_,null);
});})(_STAR_print_level_STAR_22687_22690,managed_print_level_22689,temp__5455__auto___22688,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_22687_22690;
}} else {
job_fn.call(null);
}
