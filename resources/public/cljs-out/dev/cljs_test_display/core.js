...
var len__4531__auto___20983 = arguments.length;
var i__4532__auto___20984 = (0);
while(true){
if((i__4532__auto___20984 < len__4531__auto___20983)){
args__4534__auto__.push((arguments[i__4532__auto___20984]));

var G__20985 = (i__4532__auto___20984 + (1));
i__4532__auto___20984 = G__20985;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq20980){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20981,G__20982,seq20980__$2);
});
...
var vec__20986 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__20986,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__20986,(1),null);
var G__20989 = cljs.core.PersistentArrayMap.EMPTY;
var G__20989__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__20989,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__20989);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__20989__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__20989__$1;
}
} else {
...
return (function() { 
var G__20993__delegate = function (klass,contents){
var vec__20990 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__20990,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__20990,(1),null);
...
var G__20993 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__20994__i = 0, G__20994__a = new Array(arguments.length -  1);
while (G__20994__i < G__20994__a.length) {G__20994__a[G__20994__i] = arguments[G__20994__i + 1]; ++G__20994__i;}
  contents = new cljs.core.IndexedSeq(G__20994__a,0,null);
} 
return G__20993__delegate.call(this,klass,contents);};
G__20993.cljs$lang$maxFixedArity = 1;
G__20993.cljs$lang$applyTo = (function (arglist__20995){
var klass = cljs.core.first(arglist__20995);
var contents = cljs.core.rest(arglist__20995);
return G__20993__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__20999){
...
var ns = cljs.core.get.call(null,map__21000__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__21000__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__21002){
...
var actual = cljs.core.get.call(null,map__21003__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__21003__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__21005){
var map__21006 = p__21005;
var map__21006__$1 = ((((!((map__21006 == null)))?(((((map__21006.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21006.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21006):map__21006);
var expected = cljs.core.get.call(null,map__21006__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__21006__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__21008_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__21010 = cljs_test_display.core.current_var_info.call(null);
var map__21010__$1 = ((((!((map__21010 == null)))?(((((map__21010.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21010.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21010):map__21010);
var info = map__21010__$1;
var name = cljs.core.get.call(null,map__21010__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__21010__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__21010__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__21010,map__21010__$1,info,name,line,file,node){
return (function (p1__21009_SHARP_){
return cljs.core.cons.call(null,node,p1__21009_SHARP_);
});})(curr_node,map__21010,map__21010__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__21012){
var map__21013 = p__21012;
var map__21013__$1 = ((((!((map__21013 == null)))?(((((map__21013.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21013.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21013):map__21013);
var m = map__21013__$1;
var fail = cljs.core.get.call(null,map__21013__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__21013__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__21013__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__21013__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5457__auto___21015 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21015)){
var message_21016 = temp__5457__auto___21015;
cljs.core.println.call(null,message_21016);
} else {
}
...
var temp__5457__auto___21017 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21017)){
var message_21018 = temp__5457__auto___21017;
cljs.core.println.call(null,message_21018);
} else {
}
