...
if((i < len)){
var k = (ks[i]);
var G__36326 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__36327 = (i + (1));
m = G__36326;
i = G__36327;
continue;
...
var temp__5737__auto__ = (p["argv"]);
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__36197 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__36197);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36209 = c;
var G__36209__$1 = (((G__36209 == null))?null:G__36209.prototype);
if((G__36209__$1 == null)){
return null;
} else {
return (G__36209__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36223 = c;
var G__36223__$1 = (((G__36223 == null))?null:G__36223.prototype);
if((G__36223__$1 == null)){
return null;
} else {
return (G__36223__$1["render"]);
}
})() == null)))));
});
...
var G__36225 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__36225) : reagent.impl.component.as_element.call(null,G__36225));
};
...
while (G__36334__i < G__36334__a.length) {G__36334__a[G__36334__i] = arguments[G__36334__i + 0]; ++G__36334__i;}
  args = new cljs.core.IndexedSeq(G__36334__a,0,null);
} 
...
var args = cljs.core.seq(arglist__36335);
...
var _STAR_current_component_STAR__orig_val__36236 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__36237 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__36237);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__36236);
}});
...
var c = this;
var G__36286_36338 = (c["cljsRatom"]);
if((G__36286_36338 == null)){
} else {
reagent.ratom.dispose_BANG_(G__36286_36338);
}
...
var renders_36339 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_36340 = cljs.core.first(cljs.core.vals(renders_36339));
if((cljs.core.count(renders_36339) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36339))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36340)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36340], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__36294 = name;
switch (G__36294) {
case "":
...
var G__36301 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__36301);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__36306 = fiber;
var G__36306__$1 = (((G__36306 == null))?null:(G__36306["type"]));
if((G__36306__$1 == null)){
return null;
} else {
return (G__36306__$1["displayName"]);
}
})();
var parent = (function (){var G__36307 = fiber;
if((G__36307 == null)){
return null;
} else {
return (G__36307["return"]);
}
})();
var path = (function (){var G__36308 = parent;
var G__36308__$1 = (((G__36308 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__36308) : reagent.impl.component.fiber_component_path.call(null,G__36308)));
if((G__36308__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36308__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__36310 = c;
if((G__36310 == null)){
return null;
} else {
return (G__36310["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__36311._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__36313 = c;
if((G__36313 == null)){
return null;
} else {
return (G__36313["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__36315 = c;
if((G__36315 == null)){
return null;
} else {
return G__36315._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4185__auto__ = (function (){var G__36317 = instance;
if((G__36317 == null)){
return null;
} else {
return (G__36317["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__36318 = instance;
if((G__36318 == null)){
return null;
} else {
return G__36318._currentElement;
}
}
})();
var name = (function (){var G__36319 = elem;
var G__36319__$1 = (((G__36319 == null))?null:(G__36319["type"]));
if((G__36319__$1 == null)){
return null;
} else {
return (G__36319__$1["displayName"]);
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__36321 = elem;
if((G__36321 == null)){
return null;
} else {
return (G__36321["_owner"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__36322._owner;
}
}
})();
var path = (function (){var G__36323 = owner;
var G__36323__$1 = (((G__36323 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__36323) : reagent.impl.component.component_path.call(null,G__36323)));
if((G__36323__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36323__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__36324 = c;
var G__36324__$1 = (((G__36324 == null))?null:G__36324.constructor);
if((G__36324__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__36324__$1);
}
}
})();
