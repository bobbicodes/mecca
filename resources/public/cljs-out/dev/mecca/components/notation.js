...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$line,new cljs.core.PersistentArrayMap(null, 7, [cljs.core.cst$kw$transform,"translate(3.825,-0.09)",cljs.core.cst$kw$x1,x,cljs.core.cst$kw$x2,x,cljs.core.cst$kw$y1,(8),cljs.core.cst$kw$y2,28.25,cljs.core.cst$kw$stroke,"black",cljs.core.cst$kw$stroke_DASH_width,0.35], null)], null);
});
mecca.components.notation.bar_number = (function mecca$components$notation$bar_number(n){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$path,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$transform,["translate(",cljs.core.str.cljs$core$IFn$_invoke$arity$1((0.3 + ((24) * (n - (1))))),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1(6.3),")"].join(''),cljs.core.cst$kw$d,(function (){var G__12978 = n;
switch (G__12978) {
case (0):
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12978)].join('')));
...
mecca.components.notation.drum_hit = (function mecca$components$notation$drum_hit(duration,p__12980){
var vec__12981 = p__12980;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12981,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12981,(1),null);
var mouseover_QMARK_ = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false);
return ((function (mouseover_QMARK_,vec__12981,x,y){
return (function (color,p__12984){
var vec__12985 = p__12984;
var x__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12985,(0),null);
var y__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12985,(1),null);
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$on_DASH_mouse_DASH_over,((function (vec__12985,x__$1,y__$1,mouseover_QMARK_,vec__12981,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,true);
});})(vec__12985,x__$1,y__$1,mouseover_QMARK_,vec__12981,x,y))
,cljs.core.cst$kw$on_DASH_mouse_DASH_out,((function (vec__12985,x__$1,y__$1,mouseover_QMARK_,vec__12981,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,false);
});})(vec__12985,x__$1,y__$1,mouseover_QMARK_,vec__12981,x,y))
,cljs.core.cst$kw$on_DASH_click,((function (vec__12985,x__$1,y__$1,mouseover_QMARK_,vec__12981,x,y){
return (function (){
var G__12988 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$remove_DASH_note,x__$1,y__$1], null);
...
;})(mouseover_QMARK_,vec__12981,x,y))
});
mecca.components.notation.ledger_line = (function mecca$components$notation$ledger_line(p__12989){
var vec__12990 = p__12989;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12990,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12990,(1),null);
...
mecca.components.notation.note = (function mecca$components$notation$note(value,p__12993){
var vec__12994 = p__12993;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12994,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12994,(1),null);
var mouseover_QMARK_ = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false);
return ((function (mouseover_QMARK_,vec__12994,x,y){
return (function (value__$1,p__12997){
var vec__12998 = p__12997;
var x__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12998,(0),null);
var y__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12998,(1),null);
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$on_DASH_mouse_DASH_over,((function (vec__12998,x__$1,y__$1,mouseover_QMARK_,vec__12994,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,true);
});})(vec__12998,x__$1,y__$1,mouseover_QMARK_,vec__12994,x,y))
,cljs.core.cst$kw$on_DASH_mouse_DASH_out,((function (vec__12998,x__$1,y__$1,mouseover_QMARK_,vec__12994,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,false);
});})(vec__12998,x__$1,y__$1,mouseover_QMARK_,vec__12994,x,y))
,cljs.core.cst$kw$on_DASH_click,((function (vec__12998,x__$1,y__$1,mouseover_QMARK_,vec__12994,x,y){
return (function (){
var G__13001 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$remove_DASH_note,x__$1,y__$1], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__13001) : re_frame.core.dispatch.call(null,G__13001));
});})(vec__12998,x__$1,y__$1,mouseover_QMARK_,vec__12994,x,y))
...
;})(mouseover_QMARK_,vec__12994,x,y))
});
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g_SHARP_lines,cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4324__auto__ = (function mecca$components$notation$staff_lines_$_iter__13002(s__13003){
return (new cljs.core.LazySeq(null,(function (){
var s__13003__$1 = s__13003;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__13003__$1);
if(temp__5457__auto__){
var s__13003__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__13003__$2)){
var c__4322__auto__ = cljs.core.chunk_first(s__13003__$2);
var size__4323__auto__ = cljs.core.count(c__4322__auto__);
var b__13005 = cljs.core.chunk_buffer(size__4323__auto__);
if((function (){var i__13004 = (0);
while(true){
if((i__13004 < size__4323__auto__)){
var y = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4322__auto__,i__13004);
cljs.core.chunk_append(b__13005,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$line,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$stroke_DASH_dasharray,cljs.core.cst$kw$stroke,cljs.core.cst$kw$stroke_DASH_linejoin,cljs.core.cst$kw$y1,cljs.core.cst$kw$stroke_DASH_linecap,cljs.core.cst$kw$stroke_DASH_width,cljs.core.cst$kw$x1,cljs.core.cst$kw$y2,cljs.core.cst$kw$x2,cljs.core.cst$kw$visibility],[((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.25:null),"black","bevel",y,"butt",((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.06:0.15),2.25,y,(63),(((((y > (7))) && (cljs.core.even_QMARK_(y)) && ((y < (42)))))?"visible":"hidden")])], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,y], null)));

var G__13006 = (i__13004 + (1));
i__13004 = G__13006;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__13005),mecca$components$notation$staff_lines_$_iter__13002(cljs.core.chunk_rest(s__13003__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__13005),null);
}
} else {
var y = cljs.core.first(s__13003__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$line,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$stroke_DASH_dasharray,cljs.core.cst$kw$stroke,cljs.core.cst$kw$stroke_DASH_linejoin,cljs.core.cst$kw$y1,cljs.core.cst$kw$stroke_DASH_linecap,cljs.core.cst$kw$stroke_DASH_width,cljs.core.cst$kw$x1,cljs.core.cst$kw$y2,cljs.core.cst$kw$x2,cljs.core.cst$kw$visibility],[((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.25:null),"black","bevel",y,"butt",((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.06:0.15),2.25,y,(63),(((((y > (7))) && (cljs.core.even_QMARK_(y)) && ((y < (42)))))?"visible":"hidden")])], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,y], null)),mecca$components$notation$staff_lines_$_iter__13002(cljs.core.rest(s__13003__$2)));
}
} else {
return null;
}
...
return iter__4324__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$1((29)));
})())], null);
});
