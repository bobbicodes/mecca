...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4205__auto__,k18756,else__4206__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k18756,else__4206__auto__);
...
ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__18755){
var self__ = this;
var G__18755__$1 = this;
return (new cljs.core.RecordIter((0),G__18755__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$status,cljs.core.cst$kw$body,cljs.core.cst$kw$status_DASH_text,cljs.core.cst$kw$headers,cljs.core.cst$kw$was_DASH_aborted], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
var h__4061__auto____$1 = (function (){var fexpr__18761 = ((function (h__4061__auto__,this__4199__auto____$1){
return (function (coll__4200__auto__){
return (-473222333 ^ cljs.core.hash_unordered_coll(coll__4200__auto__));
});})(h__4061__auto__,this__4199__auto____$1))
;
return fexpr__18761(this__4199__auto____$1);
})();
...
ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this18757,other18758){
var self__ = this;
var this18757__$1 = this;
return ((!((other18758 == null))) && ((this18757__$1.constructor === other18758.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18757__$1.status,other18758.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18757__$1.body,other18758.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18757__$1.status_text,other18758.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18757__$1.headers,other18758.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18757__$1.was_aborted,other18758.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18757__$1.__extmap,other18758.__extmap)));
});
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4210__auto__,k__4211__auto__,G__18755){
var self__ = this;
var this__4210__auto____$1 = this;
var pred__18762 = cljs.core.keyword_identical_QMARK_;
var expr__18763 = k__4211__auto__;
if(cljs.core.truth_((function (){var G__18765 = cljs.core.cst$kw$status;
var G__18766 = expr__18763;
return (pred__18762.cljs$core$IFn$_invoke$arity$2 ? pred__18762.cljs$core$IFn$_invoke$arity$2(G__18765,G__18766) : pred__18762.call(null,G__18765,G__18766));
})())){
return (new ajax.protocols.Response(G__18755,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__18767 = cljs.core.cst$kw$body;
var G__18768 = expr__18763;
return (pred__18762.cljs$core$IFn$_invoke$arity$2 ? pred__18762.cljs$core$IFn$_invoke$arity$2(G__18767,G__18768) : pred__18762.call(null,G__18767,G__18768));
})())){
return (new ajax.protocols.Response(self__.status,G__18755,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__18769 = cljs.core.cst$kw$status_DASH_text;
var G__18770 = expr__18763;
return (pred__18762.cljs$core$IFn$_invoke$arity$2 ? pred__18762.cljs$core$IFn$_invoke$arity$2(G__18769,G__18770) : pred__18762.call(null,G__18769,G__18770));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,G__18755,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__18771 = cljs.core.cst$kw$headers;
var G__18772 = expr__18763;
return (pred__18762.cljs$core$IFn$_invoke$arity$2 ? pred__18762.cljs$core$IFn$_invoke$arity$2(G__18771,G__18772) : pred__18762.call(null,G__18771,G__18772));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__18755,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__18773 = cljs.core.cst$kw$was_DASH_aborted;
var G__18774 = expr__18763;
return (pred__18762.cljs$core$IFn$_invoke$arity$2 ? pred__18762.cljs$core$IFn$_invoke$arity$2(G__18773,G__18774) : pred__18762.call(null,G__18773,G__18774));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__18755,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4211__auto__,G__18755),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4202__auto__,G__18755){
var self__ = this;
var this__4202__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__18755,self__.__extmap,self__.__hash));
});
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__18759){
var extmap__4236__auto__ = (function (){var G__18775 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__18759,cljs.core.cst$kw$status,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$body,cljs.core.cst$kw$status_DASH_text,cljs.core.cst$kw$headers,cljs.core.cst$kw$was_DASH_aborted], 0));
if(cljs.core.record_QMARK_(G__18759)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__18775);
} else {
return G__18775;
}
})();
return (new ajax.protocols.Response(cljs.core.cst$kw$status.cljs$core$IFn$_invoke$arity$1(G__18759),cljs.core.cst$kw$body.cljs$core$IFn$_invoke$arity$1(G__18759),cljs.core.cst$kw$status_DASH_text.cljs$core$IFn$_invoke$arity$1(G__18759),cljs.core.cst$kw$headers.cljs$core$IFn$_invoke$arity$1(G__18759),cljs.core.cst$kw$was_DASH_aborted.cljs$core$IFn$_invoke$arity$1(G__18759),null,cljs.core.not_empty(extmap__4236__auto__),null));
});
