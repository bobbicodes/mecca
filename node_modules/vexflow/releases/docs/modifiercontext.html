...
<span class="hljs-keyword">import</span> { Vibrato } <span class="hljs-keyword">from</span> <span class="hljs-string">'./vibrato'</span>;</pre></div>
        ...
        <p>To enable logging for this class. Set <code>Vex.Flow.ModifierContext.DEBUG</code> to <code>true</code>.</p>
          ...
          <div class='highlight'><pre><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">L</span>(<span class="hljs-params">...args</span>) </span>{ <span class="hljs-keyword">if</span> (ModifierContext.DEBUG) Vex.L(<span class="hljs-string">'Vex.Flow.ModifierContext'</span>, args); }
...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">ModifierContext</span> </span>{
  <span class="hljs-keyword">constructor</span>() {</pre></div>
    ...
    <span class="hljs-keyword">this</span>.state = {
      <span class="hljs-attr">left_shift</span>: <span class="hljs-number">0</span>,
      <span class="hljs-attr">right_shift</span>: <span class="hljs-number">0</span>,
      <span class="hljs-attr">text_line</span>: <span class="hljs-number">0</span>,
      <span class="hljs-attr">top_text_line</span>: <span class="hljs-number">0</span>,
    };</pre></div>
...
modifiers are formatted and rendered before higher ones.</p>
  ...
  addModifier(modifier) {
    <span class="hljs-keyword">const</span> type = modifier.getCategory();
  ...
  getMetrics() {
    <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>.formatted) {
      <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(<span class="hljs-string">'UnformattedModifier'</span>, <span class="hljs-string">'Unformatted modifier has no metrics.'</span>);
    }

    <span class="hljs-keyword">return</span> {
      <span class="hljs-attr">width</span>: <span class="hljs-keyword">this</span>.state.left_shift + <span class="hljs-keyword">this</span>.state.right_shift + <span class="hljs-keyword">this</span>.spacing,
      <span class="hljs-attr">spacing</span>: <span class="hljs-keyword">this</span>.spacing,
      <span class="hljs-attr">extra_left_px</span>: <span class="hljs-keyword">this</span>.state.left_shift,
      <span class="hljs-attr">extra_right_px</span>: <span class="hljs-keyword">this</span>.state.right_shift,
    };
  }

  preFormat() {
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.preFormatted) <span class="hljs-keyword">return</span>;
    <span class="hljs-keyword">this</span>.PREFORMAT.forEach(<span class="hljs-function">(<span class="hljs-params">modifier</span>) =&gt;</span> {
  ...
  postFormat() {
    ...
    <span class="hljs-keyword">this</span>.POSTFORMAT.forEach(<span class="hljs-function">(<span class="hljs-params">modifier</span>) =&gt;</span> {
