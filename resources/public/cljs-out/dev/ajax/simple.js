...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__19397){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19398__$1,cljs.core.cst$kw$handler);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__3949__auto__ = p1__19400_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__19401){
var map__19402 = p__19401;
var map__19402__$1 = ((((!((map__19402 == null)))?(((((map__19402.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19402.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__19402):map__19402);
var request = map__19402__$1;
var interceptors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19402__$1,cljs.core.cst$kw$interceptors);
