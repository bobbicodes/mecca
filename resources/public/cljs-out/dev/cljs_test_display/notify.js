...
cljs_test_display.notify.failure = (function cljs_test_display$notify$failure(p__21291){
var map__21292 = p__21291;
var map__21292__$1 = ((((!((map__21292 == null)))?(((((map__21292.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21292.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21292):map__21292);
var error = cljs.core.get.call(null,map__21292__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var fail = cljs.core.get.call(null,map__21292__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
return cljs_test_display.notify.with_permission.call(null,"granted",((function (map__21292,map__21292__$1,error,fail){
return (function (){
...
});})(map__21292,map__21292__$1,error,fail))
);
});
