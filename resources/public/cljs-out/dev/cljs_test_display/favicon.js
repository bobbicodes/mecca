...
return cljs.core.map.call(null,(function (p1__20948_SHARP_){
return html_coll.item(p1__20948_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__20949_SHARP_);
...
var ctx_20950 = cvs.getContext("2d");
ctx_20950.fillStyle = color;

ctx_20950.fillRect((0),(0),size,size);
