...
}catch (e26204){var _e = e26204;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___26207 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___26207)){
var seen_errors_26208 = temp__5455__auto___26207;
if(cljs.core.truth_(seen_errors_26208.has(self))){
} else {
seen_errors_26208.add(self);

var temp__5457__auto___26209 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___26209)){
var sense_26210 = temp__5457__auto___26209;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_26210)].join('');
} else {
}
}
} else {
