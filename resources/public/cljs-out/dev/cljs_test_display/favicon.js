...
return cljs.core.map.call(null,(function (p1__15331_SHARP_){
return html_coll.item(p1__15331_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__15332_SHARP_);
...
var ctx_15333 = cvs.getContext("2d");
ctx_15333.fillStyle = color;

ctx_15333.fillRect((0),(0),size,size);
