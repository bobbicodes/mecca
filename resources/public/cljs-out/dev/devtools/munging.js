...
var o22122 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22122["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22123 = temp__5455__auto____$1;
return (o22123["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21052__auto__ = f;
return (o__21052__auto__["toString"]).call(o__21052__auto__);
} else {
return "";
}
}catch (e22124){var _ = e22124;
return "";
}});
...
try{var o__21052__auto___22126 = t;
(o__21052__auto___22126["cljs$lang$ctorPrWriter"]).call(o__21052__auto___22126,t,writer);
}catch (e22125){var __22127 = e22125;
}
...
var char_code = (function (){var o__21052__auto__ = (new String(char$));
return (o__21052__auto__["charCodeAt"]).call(o__21052__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21052__auto__ = String;
return (o__21052__auto__["fromCharCode"]).call(o__21052__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22128 = num_code;
switch (G__22128) {
case (1):
return (185);
...
var o__21052__auto__ = String;
return (o__21052__auto__["fromCharCode"]).call(o__21052__auto__,superscript_code);
});
/**
...
}catch (e22130){var _e__21059__auto__ = e22130;
return false;
}})())){
...
var vec__22131 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22131,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o22134 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22134["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22135 = temp__5455__auto____$1;
return (o22135["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___22142 = arguments.length;
var i__4532__auto___22143 = (0);
while(true){
if((i__4532__auto___22143 < len__4531__auto___22142)){
args__4534__auto__.push((arguments[i__4532__auto___22143]));

var G__22144 = (i__4532__auto___22143 + (1));
i__4532__auto___22143 = G__22144;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22138){
var vec__22139 = p__22138;
var ns_detector = cljs.core.nth.call(null,vec__22139,(0),null);
...
var G__22145 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22146 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22145;
remaining_tokens = G__22146;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22136){
...
var vec__22150 = cljs.core.split_with.call(null,(function (p1__22149_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22149_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22150,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22150,(1),null);
...
var vec__22153 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22153,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22153,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22156 = cljs.core.rest.call(null,remaining_tokens);
var G__22157 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22156;
name_tokens = G__22157;
continue;
} else {
...
var vec__22160 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22160,(0),null);
var arity = cljs.core.nth.call(null,vec__22160,(1),null);
var vec__22163 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22163,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22163,(1),null);
var vec__22166 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22166,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22166,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22166,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22166,(3),null);
...
var vec__22172 = result;
var munged_ns = cljs.core.nth.call(null,vec__22172,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22172,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22172,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22172,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22172,(4),null);
var arity = cljs.core.nth.call(null,vec__22172,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__22176 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__22176,(0),null);
var args = cljs.core.nth.call(null,vec__22176,(1),null);
var vec__22179 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22179,(0),null);
var name = cljs.core.nth.call(null,vec__22179,(1),null);
...
var G__22182 = (arity + (1));
var G__22183 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22184){
var vec__22185 = p__22184;
var arity = cljs.core.nth.call(null,vec__22185,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22185,(1),null);
...
return cljs.core.get.call(null,arities,p1__22188_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22189_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22192){
var vec__22193 = p__22192;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22193,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22190){
...
var map__22201 = options;
var map__22201__$1 = ((((!((map__22201 == null)))?(((((map__22201.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22201.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22201):map__22201);
var include_ns_QMARK_ = cljs.core.get.call(null,map__22201__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22201__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22201__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22201__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22202 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22202,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22202,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22202,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22202,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22202,(4),null);
var arity = cljs.core.nth.call(null,vec__22202,(5),null);
...
var o__21052__auto__ = f;
return (o__21052__auto__["getBasis"]).call(o__21052__auto__);
});
/**
...
}catch (e22206){var _e__21059__auto__ = e22206;
...
var G__22207 = (obj[cljs.core.first.call(null,path)]);
var G__22208 = cljs.core.rest.call(null,path);
obj = G__22207;
path = G__22208;
continue;
} else {
...
return (function (accum,p__22209){
var vec__22210 = p__22209;
var bit = cljs.core.nth.call(null,vec__22210,(0),null);
var protocol = cljs.core.nth.call(null,vec__22210,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22213){
var vec__22214 = p__22213;
var ns = cljs.core.nth.call(null,vec__22214,(0),null);
var name = cljs.core.nth.call(null,vec__22214,(1),null);
var selector = cljs.core.nth.call(null,vec__22214,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__22219,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22219,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22219,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22217_SHARP_){
return (obj[cljs.core.first.call(null,p1__22217_SHARP_)]);
});})(name,sorted_matches,vec__22219,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
