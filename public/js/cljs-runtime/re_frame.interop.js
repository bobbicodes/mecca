...
return [(function (){var pred__42678 = cljs.core.instance_QMARK_;
var expr__42679 = reactive_val;
if(cljs.core.truth_((pred__42678.cljs$core$IFn$_invoke$arity$2 ? pred__42678.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__42679) : pred__42678.call(null,reagent.ratom.RAtom,expr__42679)))){
return "ra";
} else {
if(cljs.core.truth_((pred__42678.cljs$core$IFn$_invoke$arity$2 ? pred__42678.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__42679) : pred__42678.call(null,reagent.ratom.RCursor,expr__42679)))){
return "rc";
} else {
if(cljs.core.truth_((pred__42678.cljs$core$IFn$_invoke$arity$2 ? pred__42678.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__42679) : pred__42678.call(null,reagent.ratom.Reaction,expr__42679)))){
return "rx";
} else {
if(cljs.core.truth_((pred__42678.cljs$core$IFn$_invoke$arity$2 ? pred__42678.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__42679) : pred__42678.call(null,reagent.ratom.Track,expr__42679)))){
return "tr";
} else {
return "other";
}
