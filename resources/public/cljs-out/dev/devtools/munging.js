...
var o22497 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22497["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22498 = temp__5455__auto____$1;
return (o22498["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21427__auto__ = f;
return (o__21427__auto__["toString"]).call(o__21427__auto__);
} else {
return "";
}
}catch (e22499){var _ = e22499;
return "";
}});
...
try{var o__21427__auto___22501 = t;
(o__21427__auto___22501["cljs$lang$ctorPrWriter"]).call(o__21427__auto___22501,t,writer);
}catch (e22500){var __22502 = e22500;
}
...
var char_code = (function (){var o__21427__auto__ = (new String(char$));
return (o__21427__auto__["charCodeAt"]).call(o__21427__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21427__auto__ = String;
return (o__21427__auto__["fromCharCode"]).call(o__21427__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22503 = num_code;
switch (G__22503) {
case (1):
return (185);
...
var o__21427__auto__ = String;
return (o__21427__auto__["fromCharCode"]).call(o__21427__auto__,superscript_code);
});
/**
...
}catch (e22505){var _e__21434__auto__ = e22505;
return false;
}})())){
...
var vec__22506 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22506,(0),null);
...
var temp__5455__auto____$1 = (o22509["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22510 = temp__5455__auto____$1;
return (o22510["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___22517 = arguments.length;
var i__4532__auto___22518 = (0);
while(true){
if((i__4532__auto___22518 < len__4531__auto___22517)){
args__4534__auto__.push((arguments[i__4532__auto___22518]));

var G__22519 = (i__4532__auto___22518 + (1));
i__4532__auto___22518 = G__22519;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22513){
var vec__22514 = p__22513;
var ns_detector = cljs.core.nth.call(null,vec__22514,(0),null);
...
var G__22520 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22521 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22520;
remaining_tokens = G__22521;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22511){
var G__22512 = cljs.core.first.call(null,seq22511);
var seq22511__$1 = cljs.core.next.call(null,seq22511);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22512,seq22511__$1);
});
...
var vec__22525 = cljs.core.split_with.call(null,(function (p1__22524_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22524_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22525,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22525,(1),null);
...
var vec__22528 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22528,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22528,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22531 = cljs.core.rest.call(null,remaining_tokens);
var G__22532 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22531;
name_tokens = G__22532;
continue;
} else {
...
var vec__22535 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22535,(0),null);
var arity = cljs.core.nth.call(null,vec__22535,(1),null);
var vec__22538 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22538,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22538,(1),null);
var vec__22541 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22541,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22541,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22541,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22541,(3),null);
...
var vec__22547 = result;
var munged_ns = cljs.core.nth.call(null,vec__22547,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22547,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22547,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22547,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22547,(4),null);
var arity = cljs.core.nth.call(null,vec__22547,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__22551 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__22551,(0),null);
var args = cljs.core.nth.call(null,vec__22551,(1),null);
var vec__22554 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22554,(0),null);
var name = cljs.core.nth.call(null,vec__22554,(1),null);
...
var G__22557 = (arity + (1));
var G__22558 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22559){
var vec__22560 = p__22559;
var arity = cljs.core.nth.call(null,vec__22560,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22560,(1),null);
...
return cljs.core.get.call(null,arities,p1__22563_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22564_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___22571 = arguments.length;
var i__4532__auto___22572 = (0);
while(true){
if((i__4532__auto___22572 < len__4531__auto___22571)){
args__4534__auto__.push((arguments[i__4532__auto___22572]));

var G__22573 = (i__4532__auto___22572 + (1));
i__4532__auto___22572 = G__22573;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22567){
var vec__22568 = p__22567;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22568,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22565){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22576__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22576__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22576__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22576__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22577 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22577,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22577,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22577,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22577,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22577,(4),null);
var arity = cljs.core.nth.call(null,vec__22577,(5),null);
...
var o__21427__auto__ = f;
return (o__21427__auto__["getBasis"]).call(o__21427__auto__);
});
/**
...
}catch (e22581){var _e__21434__auto__ = e22581;
...
var G__22582 = (obj[cljs.core.first.call(null,path)]);
var G__22583 = cljs.core.rest.call(null,path);
obj = G__22582;
path = G__22583;
continue;
} else {
...
return (function (accum,p__22584){
var vec__22585 = p__22584;
var bit = cljs.core.nth.call(null,vec__22585,(0),null);
var protocol = cljs.core.nth.call(null,vec__22585,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22588){
var vec__22589 = p__22588;
var ns = cljs.core.nth.call(null,vec__22589,(0),null);
var name = cljs.core.nth.call(null,vec__22589,(1),null);
var selector = cljs.core.nth.call(null,vec__22589,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__22594,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22594,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22594,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22592_SHARP_){
return (obj[cljs.core.first.call(null,p1__22592_SHARP_)]);
});})(name,sorted_matches,vec__22594,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
