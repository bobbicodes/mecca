...
var len__4531__auto___21199 = arguments.length;
var i__4532__auto___21200 = (0);
while(true){
if((i__4532__auto___21200 < len__4531__auto___21199)){
args__4534__auto__.push((arguments[i__4532__auto___21200]));

var G__21201 = (i__4532__auto___21200 + (1));
i__4532__auto___21200 = G__21201;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq21196){
var G__21197 = cljs.core.first.call(null,seq21196);
var seq21196__$1 = cljs.core.next.call(null,seq21196);
var G__21198 = cljs.core.first.call(null,seq21196__$1);
var seq21196__$2 = cljs.core.next.call(null,seq21196__$1);
...
var vec__21202 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__21202,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__21202,(1),null);
var G__21205 = cljs.core.PersistentArrayMap.EMPTY;
var G__21205__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__21205,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21205);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__21205__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__21205__$1;
}
} else {
...
return (function() { 
var G__21209__delegate = function (klass,contents){
var vec__21206 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__21206,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__21206,(1),null);
...
var G__21209 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__21210__i = 0, G__21210__a = new Array(arguments.length -  1);
while (G__21210__i < G__21210__a.length) {G__21210__a[G__21210__i] = arguments[G__21210__i + 1]; ++G__21210__i;}
  contents = new cljs.core.IndexedSeq(G__21210__a,0,null);
} 
return G__21209__delegate.call(this,klass,contents);};
G__21209.cljs$lang$maxFixedArity = 1;
G__21209.cljs$lang$applyTo = (function (arglist__21211){
var klass = cljs.core.first(arglist__21211);
var contents = cljs.core.rest(arglist__21211);
return G__21209__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__21215){
...
var ns = cljs.core.get.call(null,map__21216__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__21216__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__21218){
var map__21219 = p__21218;
var map__21219__$1 = ((((!((map__21219 == null)))?(((((map__21219.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21219.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21219):map__21219);
var actual = cljs.core.get.call(null,map__21219__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__21219__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__21221){
var map__21222 = p__21221;
var map__21222__$1 = ((((!((map__21222 == null)))?(((((map__21222.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21222.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21222):map__21222);
var expected = cljs.core.get.call(null,map__21222__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__21222__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__21224_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__21226 = cljs_test_display.core.current_var_info.call(null);
...
var info = map__21226__$1;
var name = cljs.core.get.call(null,map__21226__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__21226__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__21226__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__21226,map__21226__$1,info,name,line,file,node){
return (function (p1__21225_SHARP_){
return cljs.core.cons.call(null,node,p1__21225_SHARP_);
});})(curr_node,map__21226,map__21226__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__21228){
var map__21229 = p__21228;
var map__21229__$1 = ((((!((map__21229 == null)))?(((((map__21229.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21229.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21229):map__21229);
var m = map__21229__$1;
var fail = cljs.core.get.call(null,map__21229__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__21229__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__21229__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__21229__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5457__auto___21231 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21231)){
var message_21232 = temp__5457__auto___21231;
cljs.core.println.call(null,message_21232);
} else {
}
...
var temp__5457__auto___21233 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21233)){
var message_21234 = temp__5457__auto___21233;
cljs.core.println.call(null,message_21234);
} else {
}
