...
var G__16258 = devtools.prefs.pref.call(null,v);
v = G__16258;
continue;
} else {
return v;
...
}catch (e16261){var _e__15512__auto__ = e16261;
return false;
}})();
...
}catch (e16265){var _e__15512__auto__ = e16265;
return false;
}})();
...
}catch (e16267){var _e__15512__auto__ = e16267;
return false;
}}
}
});
...
var vec__16269 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__16269,(0),null);
var name = cljs.core.nth.call(null,vec__16269,(1),null);
...
return cljs.core.some.call(null,(function (p1__16272_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16272_SHARP_);
}),template);
});
