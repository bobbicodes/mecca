...
var G__15262 = devtools.prefs.pref.call(null,v);
v = G__15262;
continue;
} else {
return v;
...
}catch (e15265){var _e__14516__auto__ = e15265;
return false;
}})();
...
}catch (e15269){var _e__14516__auto__ = e15269;
return false;
}})();
...
}catch (e15271){var _e__14516__auto__ = e15271;
return false;
}}
}
});
...
var vec__15273 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__15273,(0),null);
var name = cljs.core.nth.call(null,vec__15273,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15276_SHARP_);
}),template);
});
