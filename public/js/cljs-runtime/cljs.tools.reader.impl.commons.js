...
var G__26101 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__26101;
continue;
} else {
return ch;
...
var vec__26086 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26086,(0),null);
return (match === s);
});
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq26095){
var G__26096 = cljs.core.first(seq26095);
var seq26095__$1 = cljs.core.next(seq26095);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26096,seq26095__$1);
}));
...
while (G__26114__i < G__26114__a.length) {G__26114__a[G__26114__i] = arguments[G__26114__i + 1]; ++G__26114__i;}
  _ = new cljs.core.IndexedSeq(G__26114__a,0,null);
} 
return G__26112__delegate.call(this,rdr,_);};
G__26112.cljs$lang$maxFixedArity = 1;
G__26112.cljs$lang$applyTo = (function (arglist__26115){
var rdr = cljs.core.first(arglist__26115);
var _ = cljs.core.rest(arglist__26115);
