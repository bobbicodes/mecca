...
var len__4531__auto___14512 = arguments.length;
var i__4532__auto___14513 = (0);
while(true){
if((i__4532__auto___14513 < len__4531__auto___14512)){
args__4534__auto__.push((arguments[i__4532__auto___14513]));

var G__14514 = (i__4532__auto___14513 + (1));
i__4532__auto___14513 = G__14514;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq14509){
var G__14510 = cljs.core.first.call(null,seq14509);
var seq14509__$1 = cljs.core.next.call(null,seq14509);
var G__14511 = cljs.core.first.call(null,seq14509__$1);
var seq14509__$2 = cljs.core.next.call(null,seq14509__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14510,G__14511,seq14509__$2);
});
...
var vec__14515 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__14515,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__14515,(1),null);
var G__14518 = cljs.core.PersistentArrayMap.EMPTY;
var G__14518__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__14518,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__14518);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__14518__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__14518__$1;
}
} else {
...
return (function() { 
var G__14522__delegate = function (klass,contents){
var vec__14519 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__14519,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__14519,(1),null);
...
var G__14522 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__14523__i = 0, G__14523__a = new Array(arguments.length -  1);
while (G__14523__i < G__14523__a.length) {G__14523__a[G__14523__i] = arguments[G__14523__i + 1]; ++G__14523__i;}
  contents = new cljs.core.IndexedSeq(G__14523__a,0,null);
} 
return G__14522__delegate.call(this,klass,contents);};
G__14522.cljs$lang$maxFixedArity = 1;
G__14522.cljs$lang$applyTo = (function (arglist__14524){
var klass = cljs.core.first(arglist__14524);
var contents = cljs.core.rest(arglist__14524);
return G__14522__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__14528){
...
var ns = cljs.core.get.call(null,map__14529__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__14529__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__14531){
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__14534){
...
var expected = cljs.core.get.call(null,map__14535__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__14535__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__14537_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__14539 = cljs_test_display.core.current_var_info.call(null);
...
var info = map__14539__$1;
var name = cljs.core.get.call(null,map__14539__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__14539__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__14539__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__14539,map__14539__$1,info,name,line,file,node){
return (function (p1__14538_SHARP_){
return cljs.core.cons.call(null,node,p1__14538_SHARP_);
});})(curr_node,map__14539,map__14539__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__14541){
var map__14542 = p__14541;
var map__14542__$1 = ((((!((map__14542 == null)))?(((((map__14542.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14542.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14542):map__14542);
var m = map__14542__$1;
var fail = cljs.core.get.call(null,map__14542__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__14542__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__14542__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__14542__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5457__auto___14544 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___14544)){
var message_14545 = temp__5457__auto___14544;
cljs.core.println.call(null,message_14545);
} else {
}
...
var temp__5457__auto___14546 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___14546)){
var message_14547 = temp__5457__auto___14546;
cljs.core.println.call(null,message_14547);
} else {
}
