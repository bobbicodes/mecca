...
var G__16269 = devtools.prefs.pref.call(null,v);
v = G__16269;
continue;
} else {
return v;
...
}catch (e16272){var _e__15523__auto__ = e16272;
return false;
}})();
...
}catch (e16276){var _e__15523__auto__ = e16276;
return false;
}})();
...
}catch (e16278){var _e__15523__auto__ = e16278;
return false;
}}
}
});
...
var vec__16280 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__16280,(0),null);
var name = cljs.core.nth.call(null,vec__16280,(1),null);
...
return cljs.core.some.call(null,(function (p1__16283_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__16283_SHARP_);
}),template);
});
