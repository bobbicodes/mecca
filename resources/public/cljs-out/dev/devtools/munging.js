...
var o15757 = temp__5455__auto__;
var temp__5455__auto____$1 = (o15757["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o15758 = temp__5455__auto____$1;
return (o15758["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__15577__auto__ = f;
return (o__15577__auto__["toString"]).call(o__15577__auto__);
} else {
return "";
}
}catch (e15759){var _ = e15759;
return "";
}});
...
try{var o__15577__auto___15761 = t;
(o__15577__auto___15761["cljs$lang$ctorPrWriter"]).call(o__15577__auto___15761,t,writer);
}catch (e15760){var __15762 = e15760;
}
...
var char_code = (function (){var o__15577__auto__ = (new String(char$));
return (o__15577__auto__["charCodeAt"]).call(o__15577__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__15577__auto__ = String;
return (o__15577__auto__["fromCharCode"]).call(o__15577__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__15763 = num_code;
switch (G__15763) {
case (1):
return (185);
...
var o__15577__auto__ = String;
return (o__15577__auto__["fromCharCode"]).call(o__15577__auto__,superscript_code);
});
/**
...
}catch (e15765){var _e__15584__auto__ = e15765;
return false;
}})())){
...
var vec__15766 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__15766,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o15769 = temp__5455__auto__;
var temp__5455__auto____$1 = (o15769["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o15770 = temp__5455__auto____$1;
return (o15770["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___15777 = arguments.length;
var i__4532__auto___15778 = (0);
while(true){
if((i__4532__auto___15778 < len__4531__auto___15777)){
args__4534__auto__.push((arguments[i__4532__auto___15778]));

var G__15779 = (i__4532__auto___15778 + (1));
i__4532__auto___15778 = G__15779;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15773){
var vec__15774 = p__15773;
var ns_detector = cljs.core.nth.call(null,vec__15774,(0),null);
...
var G__15780 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__15781 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__15780;
remaining_tokens = G__15781;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15771){
var G__15772 = cljs.core.first.call(null,seq15771);
var seq15771__$1 = cljs.core.next.call(null,seq15771);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15772,seq15771__$1);
});
...
var vec__15785 = cljs.core.split_with.call(null,(function (p1__15784_SHARP_){
return cljs.core.not_EQ_.call(null,p1__15784_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__15785,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__15785,(1),null);
...
var vec__15788 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__15788,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__15788,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__15791 = cljs.core.rest.call(null,remaining_tokens);
var G__15792 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__15791;
name_tokens = G__15792;
continue;
} else {
...
var vec__15795 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__15795,(0),null);
var arity = cljs.core.nth.call(null,vec__15795,(1),null);
var vec__15798 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__15798,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__15798,(1),null);
var vec__15801 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__15801,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__15801,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__15801,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__15801,(3),null);
...
var vec__15807 = result;
var munged_ns = cljs.core.nth.call(null,vec__15807,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__15807,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__15807,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__15807,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__15807,(4),null);
var arity = cljs.core.nth.call(null,vec__15807,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__15811 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__15811,(0),null);
var args = cljs.core.nth.call(null,vec__15811,(1),null);
var vec__15814 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__15814,(0),null);
var name = cljs.core.nth.call(null,vec__15814,(1),null);
...
var G__15817 = (arity + (1));
var G__15818 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__15819){
var vec__15820 = p__15819;
var arity = cljs.core.nth.call(null,vec__15820,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__15820,(1),null);
...
return cljs.core.get.call(null,arities,p1__15823_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__15824_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___15831 = arguments.length;
var i__4532__auto___15832 = (0);
while(true){
if((i__4532__auto___15832 < len__4531__auto___15831)){
args__4534__auto__.push((arguments[i__4532__auto___15832]));

var G__15833 = (i__4532__auto___15832 + (1));
i__4532__auto___15832 = G__15833;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__15827){
var vec__15828 = p__15827;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__15828,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq15825){
var G__15826 = cljs.core.first.call(null,seq15825);
var seq15825__$1 = cljs.core.next.call(null,seq15825);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15826,seq15825__$1);
});
...
var G__15834 = arg;
var G__15834__$1 = (((G__15834 instanceof cljs.core.Keyword))?G__15834.fqn:null);
switch (G__15834__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__15836__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__15836__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__15836__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__15836__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__15837 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__15837,(0),null);
var fn_name = cljs.core.nth.call(null,vec__15837,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__15837,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__15837,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__15837,(4),null);
var arity = cljs.core.nth.call(null,vec__15837,(5),null);
...
var o__15577__auto__ = f;
return (o__15577__auto__["getBasis"]).call(o__15577__auto__);
});
/**
...
}catch (e15841){var _e__15584__auto__ = e15841;
...
var G__15842 = (obj[cljs.core.first.call(null,path)]);
var G__15843 = cljs.core.rest.call(null,path);
obj = G__15842;
path = G__15843;
continue;
} else {
...
return (function (accum,p__15844){
var vec__15845 = p__15844;
var bit = cljs.core.nth.call(null,vec__15845,(0),null);
var protocol = cljs.core.nth.call(null,vec__15845,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__15848){
var vec__15849 = p__15848;
var ns = cljs.core.nth.call(null,vec__15849,(0),null);
var name = cljs.core.nth.call(null,vec__15849,(1),null);
var selector = cljs.core.nth.call(null,vec__15849,(2),null);
...
return (function (p__15853){
var vec__15854 = p__15853;
var munged_name = cljs.core.nth.call(null,vec__15854,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__15854,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__15854,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__15852_SHARP_){
return (obj[cljs.core.first.call(null,p1__15852_SHARP_)]);
});})(name,sorted_matches,vec__15854,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
