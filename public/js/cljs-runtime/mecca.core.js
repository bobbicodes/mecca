...
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-result","set-result",766028711),cljs.core.str.cljs$core$IFn$_invoke$arity$1(mecca.core.eval_all(cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__73055 = cljs.core.deref(mecca.sci_editor._BANG_points);
var G__73055__$1 = (((G__73055 == null))?null:G__73055.state);
var G__73055__$2 = (((G__73055__$1 == null))?null:G__73055__$1.doc);
if((G__73055__$2 == null)){
return null;
} else {
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__73055__$2);
}
})())))], null));
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("re-pressed.core","set-keydown-rules","re-pressed.core/set-keydown-rules",1002257871),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"event-keys","event-keys",-835966631),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-result","set-result",766028711),cljs.core.str.cljs$core$IFn$_invoke$arity$1(mecca.core.eval_all(cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__73060 = cljs.core.deref(mecca.sci_editor._BANG_points);
var G__73060__$1 = (((G__73060 == null))?null:G__73060.state);
var G__73060__$2 = (((G__73060__$1 == null))?null:G__73060__$1.doc);
if((G__73060__$2 == null)){
return null;
} else {
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__73060__$2);
}
