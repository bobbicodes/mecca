...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([attrs,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$transform,["scale(",cljs.core.str.cljs$core$IFn$_invoke$arity$1(scale),") translate(",cljs.core.str.cljs$core$IFn$_invoke$arity$1(x),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1(y),")"].join('')], null)], 0))], null),(function (){var iter__4324__auto__ = (function mecca$transport$iter__18756(s__18757){
return (new cljs.core.LazySeq(null,(function (){
var s__18757__$1 = s__18757;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__18757__$1);
if(temp__5457__auto__){
var s__18757__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__18757__$2)){
var c__4322__auto__ = cljs.core.chunk_first(s__18757__$2);
var size__4323__auto__ = cljs.core.count(c__4322__auto__);
var b__18759 = cljs.core.chunk_buffer(size__4323__auto__);
if((function (){var i__18758 = (0);
while(true){
if((i__18758 < size__4323__auto__)){
var vec__18760 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4322__auto__,i__18758);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18760,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18760,(1),null);
cljs.core.chunk_append(b__18759,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$path,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$stroke,color,cljs.core.cst$kw$d,path], null)], null));

var G__18767 = (i__18758 + (1));
i__18758 = G__18767;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__18759),mecca$transport$iter__18756(cljs.core.chunk_rest(s__18757__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__18759),null);
}
} else {
var vec__18763 = cljs.core.first(s__18757__$2);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18763,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18763,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$path,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$stroke,color,cljs.core.cst$kw$d,path], null)], null),mecca$transport$iter__18756(cljs.core.rest(s__18757__$2)));
}
} else {
return null;
}
...
var G__18768 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$inc_DASH_tempo], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__18768) : re_frame.core.dispatch.call(null,G__18768));
}),(1),x,"all","hidden",(scale * (12))])], null);
});
mecca.transport.tempo_down = (function mecca$transport$tempo_down(x,y,scale){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$rect,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$y,cljs.core.cst$kw$stroke,cljs.core.cst$kw$width,cljs.core.cst$kw$on_DASH_click,cljs.core.cst$kw$stroke_DASH_width,cljs.core.cst$kw$x,cljs.core.cst$kw$pointer_DASH_events,cljs.core.cst$kw$visibility,cljs.core.cst$kw$height],[y,"black",(scale * (12)),(function (){
var G__18769 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$dec_DASH_tempo], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__18769) : re_frame.core.dispatch.call(null,G__18769));
}),(1),x,"all","hidden",(scale * (12))])], null);
});
...
var G__18770_18772 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$stop], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__18770_18772) : re_frame.core.dispatch.call(null,G__18770_18772));

return mecca.music.play_sample((17),(63));
})], null),(cljs.core.truth_(cljs.core.deref((function (){var G__18771 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$playing_QMARK_], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__18771) : re_frame.core.subscribe.call(null,G__18771));
...
if(cljs.core.truth_(cljs.core.deref((function (){var G__18773 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$playing_QMARK_], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__18773) : re_frame.core.subscribe.call(null,G__18773));
})()))){
return mecca.transport.svg_paths.cljs$core$IFn$_invoke$arity$5(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$on_DASH_click,(function (){
var G__18774_18776 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pause], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__18774_18776) : re_frame.core.dispatch.call(null,G__18774_18776));
...
return mecca.transport.svg_paths.cljs$core$IFn$_invoke$arity$5(new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$on_DASH_click,(function (){
var G__18775_18777 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$play_DASH_on], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__18775_18777) : re_frame.core.dispatch.call(null,G__18775_18777));
