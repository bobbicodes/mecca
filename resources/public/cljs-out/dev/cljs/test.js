...
var G__13904 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__13904,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__13904;
}
});
...
var len__4531__auto___13909 = arguments.length;
var i__4532__auto___13910 = (0);
while(true){
if((i__4532__auto___13910 < len__4531__auto___13909)){
args__4534__auto__.push((arguments[i__4532__auto___13910]));

var G__13911 = (i__4532__auto___13910 + (1));
i__4532__auto___13910 = G__13911;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq13906){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13907,G__13908,seq13906__$2);
});
...
var file = cljs.core.get.call(null,map__13913__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__13913__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__13913__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__13913,map__13913__$1,file,line,column){
return (function (p1__13912_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__13912_SHARP_));
});})(map__13913,map__13913__$1,file,line,column))
...
var temp__5457__auto___13915 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13915)){
var message_13916 = temp__5457__auto___13915;
cljs.core.println.call(null,message_13916);
} else {
}
...
var temp__5457__auto___13917 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13917)){
var message_13918 = temp__5457__auto___13917;
cljs.core.println.call(null,message_13918);
} else {
}
...
var output_dir__$1 = (function (){var G__13919 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13919),"/"].join('');
} else {
return G__13919;
}
})();
...
var G__13921 = exception.stack;
var G__13921__$1 = (((G__13921 == null))?null:clojure.string.split_lines.call(null,G__13921));
var G__13921__$2 = (((G__13921__$1 == null))?null:cljs.core.get.call(null,G__13921__$1,depth));
if((G__13921__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__13921__$2);
}
} else {
...
var vec__13922 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__13922,(0),null);
var column = cljs.core.nth.call(null,vec__13922,(1),null);
var vec__13925 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__13925,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__13925,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__13925,(2),null);
...
var m__$1 = (function (){var G__13928 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__13928__$1 = (((G__13928 instanceof cljs.core.Keyword))?G__13928.fqn:null);
switch (G__13928__$1) {
case "fail":
...
var G__13932 = (function (){var G__13931 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__13931);
} else {
return G__13931;
}
})();
...
return cljs.core.vary_meta.call(null,G__13933,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__13937 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__13937,(0),null);
var types = vec__13937;
...
return cljs.core.map.call(null,(function (p__13940){
var vec__13941 = p__13940;
var ns = cljs.core.nth.call(null,vec__13941,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__13941,(1),null);
return ((function (vec__13941,ns,vars__$1){
return (function (){
...
var G__13944 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__13944__$1 = (((G__13944 instanceof cljs.core.Keyword))?G__13944.fqn:null);
switch (G__13944__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__13944,G__13944__$1,env,once_fixtures,each_fixtures,vec__13941,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__13944,G__13944__$1,env,once_fixtures,each_fixtures,vec__13941,ns,vars__$1){
return (function (){
var seq__13945 = cljs.core.seq.call(null,vars__$1);
var chunk__13946 = null;
var count__13947 = (0);
var i__13948 = (0);
while(true){
if((i__13948 < count__13947)){
var v = cljs.core._nth.call(null,chunk__13946,i__13948);
var temp__5457__auto___13950 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13950)){
var t_13951 = temp__5457__auto___13950;
each_fixture_fn.call(null,((function (seq__13945,chunk__13946,count__13947,i__13948,t_13951,temp__5457__auto___13950,v,each_fixture_fn,G__13944,G__13944__$1,env,once_fixtures,each_fixtures,vec__13941,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13951)));
});})(seq__13945,chunk__13946,count__13947,i__13948,t_13951,temp__5457__auto___13950,v,each_fixture_fn,G__13944,G__13944__$1,env,once_fixtures,each_fixtures,vec__13941,ns,vars__$1))
);
} else {
}


var G__13952 = seq__13945;
var G__13953 = chunk__13946;
var G__13954 = count__13947;
var G__13955 = (i__13948 + (1));
seq__13945 = G__13952;
chunk__13946 = G__13953;
count__13947 = G__13954;
i__13948 = G__13955;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__13945);
if(temp__5457__auto__){
var seq__13945__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__13945__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__13945__$1);
var G__13956 = cljs.core.chunk_rest.call(null,seq__13945__$1);
var G__13957 = c__4351__auto__;
var G__13958 = cljs.core.count.call(null,c__4351__auto__);
var G__13959 = (0);
seq__13945 = G__13956;
chunk__13946 = G__13957;
count__13947 = G__13958;
i__13948 = G__13959;
continue;
} else {
var v = cljs.core.first.call(null,seq__13945__$1);
var temp__5457__auto___13960__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13960__$1)){
var t_13961 = temp__5457__auto___13960__$1;
each_fixture_fn.call(null,((function (seq__13945,chunk__13946,count__13947,i__13948,t_13961,temp__5457__auto___13960__$1,v,seq__13945__$1,temp__5457__auto__,each_fixture_fn,G__13944,G__13944__$1,env,once_fixtures,each_fixtures,vec__13941,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13961)));
});})(seq__13945,chunk__13946,count__13947,i__13948,t_13961,temp__5457__auto___13960__$1,v,seq__13945__$1,temp__5457__auto__,each_fixture_fn,G__13944,G__13944__$1,env,once_fixtures,each_fixtures,vec__13941,ns,vars__$1))
);
} else {
}


var G__13962 = cljs.core.next.call(null,seq__13945__$1);
var G__13963 = null;
var G__13964 = (0);
var G__13965 = (0);
seq__13945 = G__13962;
chunk__13946 = G__13963;
count__13947 = G__13964;
i__13948 = G__13965;
continue;
}
} else {
...
});})(each_fixture_fn,G__13944,G__13944__$1,env,once_fixtures,each_fixtures,vec__13941,ns,vars__$1))
);
});})(each_fixture_fn,G__13944,G__13944__$1,env,once_fixtures,each_fixtures,vec__13941,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13944__$1)].join('')));

}
})());
});
;})(vec__13941,ns,vars__$1))
