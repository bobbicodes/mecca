...
var G__10602 = o;
(G__10602[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__10606 = o;
(G__10606[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__10608__i < G__10608__a.length) {G__10608__a[G__10608__i] = arguments[G__10608__i + 0]; ++G__10608__i;}
  args = new cljs.core.IndexedSeq(G__10608__a,0,null);
} 
...
var G__10611 = props;
var G__10611__$1 = ((((!((id == null))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10611,cljs.core.cst$kw$id,id):G__10611);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10611__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__10612){
...
var props = map__10613__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10613__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__10613,map__10613__$1,props,class$){
return (function (c){
...
});})(map__10613,map__10613__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10615){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10616__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__10616,map__10616__$1,on_write){
return (function (){
...
});})(node_value,map__10616,map__10616__$1,on_write))
);
} else {
...
var G__10619 = jsprops;
(G__10619["defaultValue"] = value);

(G__10619["onChange"] = ((function (G__10619,v,value,on_change){
return (function (p1__10618_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__10618_SHARP_);
});})(G__10619,v,value,on_change))
);
...
var vec__10622 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10622,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10622,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10622,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___10626 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___10626 == null)){
} else {
var key_10627 = temp__5461__auto___10626;
(jsprops["key"] = key_10627);
}
...
var temp__5461__auto___10628 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___10628 == null)){
} else {
var key_10629 = temp__5461__auto___10628;
reagent.impl.template.oset(jsprops,"key",key_10629);
}
...
var G__10630 = reagent.impl.template.__GT_NativeWrapper();
(G__10630["name"] = c);
...
var G__10631 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__10631) : reagent.impl.template.as_element.call(null,G__10631));
} else {
...
var len__4531__auto___10636 = arguments.length;
var i__4532__auto___10637 = (0);
while(true){
if((i__4532__auto___10637 < len__4531__auto___10636)){
args__4534__auto__.push((arguments[i__4532__auto___10637]));

var G__10638 = (i__4532__auto___10637 + (1));
i__4532__auto___10637 = G__10638;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10634){
var G__10635 = cljs.core.first(seq10634);
var seq10634__$1 = cljs.core.next(seq10634);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10635,seq10634__$1);
});
...
break;
default:
var G__10641 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__10641;
continue;
...
var n__4408__auto___10643 = a.length;
var i_10644 = (0);
while(true){
if((i_10644 < n__4408__auto___10643)){
(a[i_10644] = reagent.impl.template.as_element((a[i_10644])));

var G__10645 = (i_10644 + (1));
i_10644 = G__10645;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4408__auto___10646 = a.length;
var i_10647 = (0);
while(true){
if((i_10647 < n__4408__auto___10646)){
var val_10648 = (a[i_10647]);
if(((cljs.core.vector_QMARK_(val_10648)) && ((reagent.impl.template.key_from_vec(val_10648) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_10647] = reagent.impl.template.as_element(val_10648));

var G__10649 = (i_10647 + (1));
i_10647 = G__10649;
continue;
} else {
}
...
var ctx = ({});
var vec__10650 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10650,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10650,(1),null);
...
var G__10653 = (cljs.core.count(argv) - first_child);
switch (G__10653) {
case (0):
...
case (1):
var G__10654 = comp;
var G__10655 = jsprops;
var G__10656 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__10654,G__10655,G__10656) : reagent.impl.template.global$module$react.createElement.call(null,G__10654,G__10655,G__10656));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__10653){
