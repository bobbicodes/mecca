...
if((i < len)){
var k = (ks[i]);
var G__10530 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__10531 = (i + (1));
m = G__10530;
i = G__10531;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__10532 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__10532) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__10532));
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__10534 = c;
var G__10534__$1 = (((G__10534 == null))?null:G__10534.prototype);
if((G__10534__$1 == null)){
return null;
} else {
return (G__10534__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__10536 = c;
var G__10536__$1 = (((G__10536 == null))?null:G__10536.prototype);
if((G__10536__$1 == null)){
return null;
} else {
return (G__10536__$1["render"]);
}
})() == null))));
});
...
var G__10538 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__10538) : reagent.impl.component.as_element.call(null,G__10538));
};
var G__10540 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__10541__i = 0, G__10541__a = new Array(arguments.length -  0);
while (G__10541__i < G__10541__a.length) {G__10541__a[G__10541__i] = arguments[G__10541__i + 0]; ++G__10541__i;}
  args = new cljs.core.IndexedSeq(G__10541__a,0,null);
} 
...
var args = cljs.core.seq(arglist__10542);
return G__10540__delegate(args);
});
...
var _STAR_current_component_STAR_10544 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_10544;
}});
...
var G__10545 = key;
var G__10545__$1 = (((G__10545 instanceof cljs.core.Keyword))?G__10545.fqn:null);
switch (G__10545__$1) {
...
return ((function (G__10545,G__10545__$1){
...
var c = this;
var G__10550_10552 = (c["cljsRatom"]);
if((G__10550_10552 == null)){
} else {
reagent.ratom.dispose_BANG_(G__10550_10552);
}
...
var renders_10554 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_10555 = cljs.core.first(cljs.core.vals(renders_10554));
if((cljs.core.count(renders_10554) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_10554))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_10555)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_10555], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__10553 = name;
switch (G__10553) {
case "":
...
var G__10558 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__10558) : reagent.impl.component.global$module$create_react_class.call(null,G__10558));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__10559 = fiber;
var G__10559__$1 = (((G__10559 == null))?null:(G__10559["type"]));
if((G__10559__$1 == null)){
return null;
} else {
return (G__10559__$1["displayName"]);
}
})();
var parent = (function (){var G__10560 = fiber;
if((G__10560 == null)){
return null;
} else {
return (G__10560["return"]);
}
})();
var path = (function (){var G__10561 = parent;
var G__10561__$1 = (((G__10561 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__10561) : reagent.impl.component.fiber_component_path.call(null,G__10561)));
if((G__10561__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10561__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3949__auto__ = (function (){var G__10563 = c;
if((G__10563 == null)){
return null;
} else {
return (G__10563["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__10564._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__10566 = c;
if((G__10566 == null)){
return null;
} else {
return (G__10566["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__10568 = c;
if((G__10568 == null)){
return null;
} else {
return G__10568._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__10570 = instance;
if((G__10570 == null)){
return null;
} else {
return (G__10570["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__10571 = instance;
if((G__10571 == null)){
return null;
} else {
return G__10571._currentElement;
}
}
})();
var name = (function (){var G__10572 = elem;
var G__10572__$1 = (((G__10572 == null))?null:(G__10572["type"]));
if((G__10572__$1 == null)){
return null;
} else {
return (G__10572__$1["displayName"]);
}
})();
var owner = (function (){var or__3949__auto__ = (function (){var G__10574 = elem;
if((G__10574 == null)){
return null;
} else {
return (G__10574["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__10575._owner;
}
}
})();
var path = (function (){var G__10576 = owner;
var G__10576__$1 = (((G__10576 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__10576) : reagent.impl.component.component_path.call(null,G__10576)));
if((G__10576__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__10576__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__10577 = c;
var G__10577__$1 = (((G__10577 == null))?null:G__10577.constructor);
if((G__10577__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__10577__$1);
}
}
})();
