...
var G__13860 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__13860,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__13860;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq13862){
...
var file = cljs.core.get.call(null,map__13869__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__13869__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__13869__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__13869,map__13869__$1,file,line,column){
return (function (p1__13868_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__13868_SHARP_));
});})(map__13869,map__13869__$1,file,line,column))
...
var temp__5457__auto___13871 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13871)){
var message_13872 = temp__5457__auto___13871;
cljs.core.println.call(null,message_13872);
} else {
}
...
var temp__5457__auto___13873 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13873)){
var message_13874 = temp__5457__auto___13873;
cljs.core.println.call(null,message_13874);
} else {
}
...
var output_dir__$1 = (function (){var G__13875 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13875),"/"].join('');
} else {
return G__13875;
}
})();
...
var G__13877 = exception.stack;
var G__13877__$1 = (((G__13877 == null))?null:clojure.string.split_lines.call(null,G__13877));
var G__13877__$2 = (((G__13877__$1 == null))?null:cljs.core.get.call(null,G__13877__$1,depth));
if((G__13877__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__13877__$2);
}
} else {
...
var vec__13878 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__13878,(0),null);
var column = cljs.core.nth.call(null,vec__13878,(1),null);
var vec__13881 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__13881,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__13881,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__13881,(2),null);
...
var m__$1 = (function (){var G__13884 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__13884__$1 = (((G__13884 instanceof cljs.core.Keyword))?G__13884.fqn:null);
switch (G__13884__$1) {
case "fail":
...
var G__13888 = (function (){var G__13887 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__13887);
} else {
return G__13887;
}
})();
...
return cljs.core.vary_meta.call(null,G__13889,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e13890){var e = e13890;
var G__13891 = e;
var G__13891__$1 = (((G__13891 instanceof cljs.core.Keyword))?G__13891.fqn:null);
switch (G__13891__$1) {
...
var vec__13893 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__13893,(0),null);
var types = vec__13893;
...
return cljs.core.map.call(null,(function (p__13896){
var vec__13897 = p__13896;
var ns = cljs.core.nth.call(null,vec__13897,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__13897,(1),null);
return ((function (vec__13897,ns,vars__$1){
return (function (){
...
var G__13900 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__13900,G__13900__$1,env,once_fixtures,each_fixtures,vec__13897,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__13900,G__13900__$1,env,once_fixtures,each_fixtures,vec__13897,ns,vars__$1){
return (function (){
var seq__13901 = cljs.core.seq.call(null,vars__$1);
var chunk__13902 = null;
var count__13903 = (0);
var i__13904 = (0);
while(true){
if((i__13904 < count__13903)){
var v = cljs.core._nth.call(null,chunk__13902,i__13904);
var temp__5457__auto___13906 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13906)){
var t_13907 = temp__5457__auto___13906;
each_fixture_fn.call(null,((function (seq__13901,chunk__13902,count__13903,i__13904,t_13907,temp__5457__auto___13906,v,each_fixture_fn,G__13900,G__13900__$1,env,once_fixtures,each_fixtures,vec__13897,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13907)));
});})(seq__13901,chunk__13902,count__13903,i__13904,t_13907,temp__5457__auto___13906,v,each_fixture_fn,G__13900,G__13900__$1,env,once_fixtures,each_fixtures,vec__13897,ns,vars__$1))
);
} else {
}


var G__13908 = seq__13901;
var G__13909 = chunk__13902;
var G__13910 = count__13903;
var G__13911 = (i__13904 + (1));
seq__13901 = G__13908;
chunk__13902 = G__13909;
count__13903 = G__13910;
i__13904 = G__13911;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__13901);
if(temp__5457__auto__){
var seq__13901__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__13901__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__13901__$1);
var G__13912 = cljs.core.chunk_rest.call(null,seq__13901__$1);
var G__13913 = c__4351__auto__;
var G__13914 = cljs.core.count.call(null,c__4351__auto__);
var G__13915 = (0);
seq__13901 = G__13912;
chunk__13902 = G__13913;
count__13903 = G__13914;
i__13904 = G__13915;
continue;
} else {
var v = cljs.core.first.call(null,seq__13901__$1);
var temp__5457__auto___13916__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13916__$1)){
var t_13917 = temp__5457__auto___13916__$1;
each_fixture_fn.call(null,((function (seq__13901,chunk__13902,count__13903,i__13904,t_13917,temp__5457__auto___13916__$1,v,seq__13901__$1,temp__5457__auto__,each_fixture_fn,G__13900,G__13900__$1,env,once_fixtures,each_fixtures,vec__13897,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13917)));
});})(seq__13901,chunk__13902,count__13903,i__13904,t_13917,temp__5457__auto___13916__$1,v,seq__13901__$1,temp__5457__auto__,each_fixture_fn,G__13900,G__13900__$1,env,once_fixtures,each_fixtures,vec__13897,ns,vars__$1))
);
} else {
}


var G__13918 = cljs.core.next.call(null,seq__13901__$1);
var G__13919 = null;
var G__13920 = (0);
var G__13921 = (0);
seq__13901 = G__13918;
...
});})(each_fixture_fn,G__13900,G__13900__$1,env,once_fixtures,each_fixtures,vec__13897,ns,vars__$1))
);
});})(each_fixture_fn,G__13900,G__13900__$1,env,once_fixtures,each_fixtures,vec__13897,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13900__$1)].join('')));

}
})());
});
;})(vec__13897,ns,vars__$1))
