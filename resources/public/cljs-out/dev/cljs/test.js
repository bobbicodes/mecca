...
var G__20919 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__20919,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__20919;
}
});
...
var len__4531__auto___20924 = arguments.length;
var i__4532__auto___20925 = (0);
while(true){
if((i__4532__auto___20925 < len__4531__auto___20924)){
args__4534__auto__.push((arguments[i__4532__auto___20925]));

var G__20926 = (i__4532__auto___20925 + (1));
i__4532__auto___20925 = G__20926;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq20921){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20922,G__20923,seq20921__$2);
});
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__20928,map__20928__$1,file,line,column){
return (function (p1__20927_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__20927_SHARP_));
});})(map__20928,map__20928__$1,file,line,column))
...
var temp__5457__auto___20930 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20930)){
var message_20931 = temp__5457__auto___20930;
cljs.core.println.call(null,message_20931);
} else {
}
...
var temp__5457__auto___20932 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20932)){
var message_20933 = temp__5457__auto___20932;
cljs.core.println.call(null,message_20933);
} else {
}
...
var output_dir__$1 = (function (){var G__20934 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20934),"/"].join('');
} else {
return G__20934;
}
})();
...
var G__20936 = exception.stack;
var G__20936__$1 = (((G__20936 == null))?null:clojure.string.split_lines.call(null,G__20936));
var G__20936__$2 = (((G__20936__$1 == null))?null:cljs.core.get.call(null,G__20936__$1,depth));
if((G__20936__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__20936__$2);
}
} else {
...
var vec__20937 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__20937,(0),null);
var column = cljs.core.nth.call(null,vec__20937,(1),null);
...
var m__$1 = (function (){var G__20943 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__20947 = (function (){var G__20946 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__20946);
} else {
return G__20946;
}
})();
...
return cljs.core.vary_meta.call(null,G__20948,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__20952 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__20952,(0),null);
var types = vec__20952;
...
return cljs.core.map.call(null,(function (p__20955){
var vec__20956 = p__20955;
var ns = cljs.core.nth.call(null,vec__20956,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__20956,(1),null);
return ((function (vec__20956,ns,vars__$1){
return (function (){
...
var G__20959 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__20959,G__20959__$1,env,once_fixtures,each_fixtures,vec__20956,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__20959,G__20959__$1,env,once_fixtures,each_fixtures,vec__20956,ns,vars__$1){
return (function (){
var seq__20960 = cljs.core.seq.call(null,vars__$1);
var chunk__20961 = null;
var count__20962 = (0);
var i__20963 = (0);
while(true){
if((i__20963 < count__20962)){
var v = cljs.core._nth.call(null,chunk__20961,i__20963);
var temp__5457__auto___20965 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20965)){
var t_20966 = temp__5457__auto___20965;
each_fixture_fn.call(null,((function (seq__20960,chunk__20961,count__20962,i__20963,t_20966,temp__5457__auto___20965,v,each_fixture_fn,G__20959,G__20959__$1,env,once_fixtures,each_fixtures,vec__20956,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20966)));
});})(seq__20960,chunk__20961,count__20962,i__20963,t_20966,temp__5457__auto___20965,v,each_fixture_fn,G__20959,G__20959__$1,env,once_fixtures,each_fixtures,vec__20956,ns,vars__$1))
);
} else {
}


var G__20967 = seq__20960;
var G__20968 = chunk__20961;
var G__20969 = count__20962;
var G__20970 = (i__20963 + (1));
seq__20960 = G__20967;
chunk__20961 = G__20968;
count__20962 = G__20969;
i__20963 = G__20970;
continue;
} else {
...
var G__20971 = cljs.core.chunk_rest.call(null,seq__20960__$1);
var G__20972 = c__4351__auto__;
var G__20973 = cljs.core.count.call(null,c__4351__auto__);
var G__20974 = (0);
seq__20960 = G__20971;
chunk__20961 = G__20972;
count__20962 = G__20973;
i__20963 = G__20974;
continue;
} else {
var v = cljs.core.first.call(null,seq__20960__$1);
var temp__5457__auto___20975__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20975__$1)){
var t_20976 = temp__5457__auto___20975__$1;
each_fixture_fn.call(null,((function (seq__20960,chunk__20961,count__20962,i__20963,t_20976,temp__5457__auto___20975__$1,v,seq__20960__$1,temp__5457__auto__,each_fixture_fn,G__20959,G__20959__$1,env,once_fixtures,each_fixtures,vec__20956,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20976)));
});})(seq__20960,chunk__20961,count__20962,i__20963,t_20976,temp__5457__auto___20975__$1,v,seq__20960__$1,temp__5457__auto__,each_fixture_fn,G__20959,G__20959__$1,env,once_fixtures,each_fixtures,vec__20956,ns,vars__$1))
);
} else {
}


var G__20977 = cljs.core.next.call(null,seq__20960__$1);
var G__20978 = null;
var G__20979 = (0);
var G__20980 = (0);
seq__20960 = G__20977;
chunk__20961 = G__20978;
count__20962 = G__20979;
i__20963 = G__20980;
continue;
}
} else {
...
});})(each_fixture_fn,G__20959,G__20959__$1,env,once_fixtures,each_fixtures,vec__20956,ns,vars__$1))
);
});})(each_fixture_fn,G__20959,G__20959__$1,env,once_fixtures,each_fixtures,vec__20956,ns,vars__$1))
], null);
