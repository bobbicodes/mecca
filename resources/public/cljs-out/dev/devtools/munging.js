...
var o12454 = temp__5455__auto__;
var temp__5455__auto____$1 = (o12454["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o12455 = temp__5455__auto____$1;
return (o12455["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11384__auto__ = f;
return (o__11384__auto__["toString"]).call(o__11384__auto__);
} else {
return "";
}
}catch (e12456){var _ = e12456;
return "";
}});
...
try{var o__11384__auto___12458 = t;
(o__11384__auto___12458["cljs$lang$ctorPrWriter"]).call(o__11384__auto___12458,t,writer);
}catch (e12457){var __12459 = e12457;
}
...
var char_code = (function (){var o__11384__auto__ = (new String(char$));
return (o__11384__auto__["charCodeAt"]).call(o__11384__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11384__auto__ = String;
return (o__11384__auto__["fromCharCode"]).call(o__11384__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__12460 = num_code;
switch (G__12460) {
case (1):
return (185);
...
var o__11384__auto__ = String;
return (o__11384__auto__["fromCharCode"]).call(o__11384__auto__,superscript_code);
});
/**
...
}catch (e12462){var _e__11391__auto__ = e12462;
return false;
}})())){
...
var vec__12463 = devtools.munging.parse_fn_source.call(null,fn_source);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o12466 = temp__5455__auto__;
var temp__5455__auto____$1 = (o12466["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o12467 = temp__5455__auto____$1;
return (o12467["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___12474 = arguments.length;
var i__4532__auto___12475 = (0);
while(true){
if((i__4532__auto___12475 < len__4531__auto___12474)){
args__4534__auto__.push((arguments[i__4532__auto___12475]));

var G__12476 = (i__4532__auto___12475 + (1));
i__4532__auto___12475 = G__12476;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__12470){
var vec__12471 = p__12470;
var ns_detector = cljs.core.nth.call(null,vec__12471,(0),null);
...
var G__12477 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__12478 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__12477;
remaining_tokens = G__12478;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq12468){
var G__12469 = cljs.core.first.call(null,seq12468);
var seq12468__$1 = cljs.core.next.call(null,seq12468);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12469,seq12468__$1);
});
...
var vec__12482 = cljs.core.split_with.call(null,(function (p1__12481_SHARP_){
return cljs.core.not_EQ_.call(null,p1__12481_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__12482,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__12482,(1),null);
...
var vec__12485 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__12485,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__12485,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__12488 = cljs.core.rest.call(null,remaining_tokens);
var G__12489 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__12488;
name_tokens = G__12489;
continue;
} else {
...
var vec__12492 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__12492,(0),null);
var arity = cljs.core.nth.call(null,vec__12492,(1),null);
var vec__12495 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__12495,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__12495,(1),null);
var vec__12498 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__12498,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__12498,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__12498,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__12498,(3),null);
...
var vec__12504 = result;
var munged_ns = cljs.core.nth.call(null,vec__12504,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__12504,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__12504,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__12504,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__12504,(4),null);
var arity = cljs.core.nth.call(null,vec__12504,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__12508 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__12508,(0),null);
var args = cljs.core.nth.call(null,vec__12508,(1),null);
var vec__12511 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__12511,(0),null);
var name = cljs.core.nth.call(null,vec__12511,(1),null);
...
var G__12514 = (arity + (1));
var G__12515 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12516){
var vec__12517 = p__12516;
var arity = cljs.core.nth.call(null,vec__12517,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__12517,(1),null);
...
return (function (p1__12520_SHARP_){
return cljs.core.get.call(null,arities,p1__12520_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__12521_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___12528 = arguments.length;
var i__4532__auto___12529 = (0);
while(true){
if((i__4532__auto___12529 < len__4531__auto___12528)){
args__4534__auto__.push((arguments[i__4532__auto___12529]));

var G__12530 = (i__4532__auto___12529 + (1));
i__4532__auto___12529 = G__12530;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12524){
var vec__12525 = p__12524;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__12525,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12522){
var G__12523 = cljs.core.first.call(null,seq12522);
var seq12522__$1 = cljs.core.next.call(null,seq12522);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12523,seq12522__$1);
});
...
var map__12533 = options;
var map__12533__$1 = ((((!((map__12533 == null)))?(((((map__12533.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12533.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12533):map__12533);
var include_ns_QMARK_ = cljs.core.get.call(null,map__12533__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__12533__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__12533__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__12533__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12534 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__12534,(0),null);
var fn_name = cljs.core.nth.call(null,vec__12534,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__12534,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__12534,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__12534,(4),null);
var arity = cljs.core.nth.call(null,vec__12534,(5),null);
...
var o__11384__auto__ = f;
return (o__11384__auto__["getBasis"]).call(o__11384__auto__);
});
/**
...
}catch (e12538){var _e__11391__auto__ = e12538;
...
var G__12539 = (obj[cljs.core.first.call(null,path)]);
var G__12540 = cljs.core.rest.call(null,path);
obj = G__12539;
path = G__12540;
continue;
} else {
...
return (function (accum,p__12541){
var vec__12542 = p__12541;
var bit = cljs.core.nth.call(null,vec__12542,(0),null);
var protocol = cljs.core.nth.call(null,vec__12542,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12545){
var vec__12546 = p__12545;
var ns = cljs.core.nth.call(null,vec__12546,(0),null);
var name = cljs.core.nth.call(null,vec__12546,(1),null);
var selector = cljs.core.nth.call(null,vec__12546,(2),null);
...
return (function (p__12550){
var vec__12551 = p__12550;
var munged_name = cljs.core.nth.call(null,vec__12551,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__12551,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__12551,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__12549_SHARP_){
return (obj[cljs.core.first.call(null,p1__12549_SHARP_)]);
});})(name,sorted_matches,vec__12551,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
