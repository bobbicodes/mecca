...
var G__21077 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__21077,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__21077;
}
});
...
var len__4531__auto___21082 = arguments.length;
var i__4532__auto___21083 = (0);
while(true){
if((i__4532__auto___21083 < len__4531__auto___21082)){
args__4534__auto__.push((arguments[i__4532__auto___21083]));

var G__21084 = (i__4532__auto___21083 + (1));
i__4532__auto___21083 = G__21084;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq21079){
var G__21080 = cljs.core.first.call(null,seq21079);
var seq21079__$1 = cljs.core.next.call(null,seq21079);
var G__21081 = cljs.core.first.call(null,seq21079__$1);
var seq21079__$2 = cljs.core.next.call(null,seq21079__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21080,G__21081,seq21079__$2);
});
...
var file = cljs.core.get.call(null,map__21086__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__21086__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__21086__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__21086,map__21086__$1,file,line,column){
return (function (p1__21085_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__21085_SHARP_));
});})(map__21086,map__21086__$1,file,line,column))
...
var temp__5457__auto___21088 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21088)){
var message_21089 = temp__5457__auto___21088;
cljs.core.println.call(null,message_21089);
} else {
}
...
var temp__5457__auto___21090 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21090)){
var message_21091 = temp__5457__auto___21090;
cljs.core.println.call(null,message_21091);
} else {
}
...
var output_dir__$1 = (function (){var G__21092 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21092),"/"].join('');
} else {
return G__21092;
}
})();
...
var G__21094 = exception.stack;
var G__21094__$1 = (((G__21094 == null))?null:clojure.string.split_lines.call(null,G__21094));
var G__21094__$2 = (((G__21094__$1 == null))?null:cljs.core.get.call(null,G__21094__$1,depth));
if((G__21094__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__21094__$2);
}
} else {
...
var vec__21095 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__21095,(0),null);
var column = cljs.core.nth.call(null,vec__21095,(1),null);
var vec__21098 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__21098,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__21098,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__21098,(2),null);
...
var m__$1 = (function (){var G__21101 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__21105 = (function (){var G__21104 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__21104);
} else {
return G__21104;
}
})();
...
return cljs.core.vary_meta.call(null,G__21106,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__21110 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__21110,(0),null);
var types = vec__21110;
...
return cljs.core.map.call(null,(function (p__21113){
var vec__21114 = p__21113;
var ns = cljs.core.nth.call(null,vec__21114,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__21114,(1),null);
return ((function (vec__21114,ns,vars__$1){
return (function (){
...
var G__21117 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__21117__$1 = (((G__21117 instanceof cljs.core.Keyword))?G__21117.fqn:null);
switch (G__21117__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__21117,G__21117__$1,env,once_fixtures,each_fixtures,vec__21114,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__21117,G__21117__$1,env,once_fixtures,each_fixtures,vec__21114,ns,vars__$1){
return (function (){
var seq__21118 = cljs.core.seq.call(null,vars__$1);
var chunk__21119 = null;
var count__21120 = (0);
var i__21121 = (0);
while(true){
if((i__21121 < count__21120)){
var v = cljs.core._nth.call(null,chunk__21119,i__21121);
var temp__5457__auto___21123 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___21123)){
var t_21124 = temp__5457__auto___21123;
each_fixture_fn.call(null,((function (seq__21118,chunk__21119,count__21120,i__21121,t_21124,temp__5457__auto___21123,v,each_fixture_fn,G__21117,G__21117__$1,env,once_fixtures,each_fixtures,vec__21114,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21124)));
});})(seq__21118,chunk__21119,count__21120,i__21121,t_21124,temp__5457__auto___21123,v,each_fixture_fn,G__21117,G__21117__$1,env,once_fixtures,each_fixtures,vec__21114,ns,vars__$1))
);
} else {
}


var G__21125 = seq__21118;
var G__21126 = chunk__21119;
var G__21127 = count__21120;
var G__21128 = (i__21121 + (1));
seq__21118 = G__21125;
chunk__21119 = G__21126;
count__21120 = G__21127;
i__21121 = G__21128;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__21118);
if(temp__5457__auto__){
var seq__21118__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__21118__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__21118__$1);
var G__21129 = cljs.core.chunk_rest.call(null,seq__21118__$1);
var G__21130 = c__4351__auto__;
var G__21131 = cljs.core.count.call(null,c__4351__auto__);
var G__21132 = (0);
seq__21118 = G__21129;
chunk__21119 = G__21130;
count__21120 = G__21131;
i__21121 = G__21132;
continue;
} else {
var v = cljs.core.first.call(null,seq__21118__$1);
var temp__5457__auto___21133__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___21133__$1)){
var t_21134 = temp__5457__auto___21133__$1;
each_fixture_fn.call(null,((function (seq__21118,chunk__21119,count__21120,i__21121,t_21134,temp__5457__auto___21133__$1,v,seq__21118__$1,temp__5457__auto__,each_fixture_fn,G__21117,G__21117__$1,env,once_fixtures,each_fixtures,vec__21114,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21134)));
});})(seq__21118,chunk__21119,count__21120,i__21121,t_21134,temp__5457__auto___21133__$1,v,seq__21118__$1,temp__5457__auto__,each_fixture_fn,G__21117,G__21117__$1,env,once_fixtures,each_fixtures,vec__21114,ns,vars__$1))
);
} else {
}


var G__21135 = cljs.core.next.call(null,seq__21118__$1);
var G__21136 = null;
var G__21137 = (0);
var G__21138 = (0);
seq__21118 = G__21135;
chunk__21119 = G__21136;
count__21120 = G__21137;
i__21121 = G__21138;
continue;
}
} else {
...
});})(each_fixture_fn,G__21117,G__21117__$1,env,once_fixtures,each_fixtures,vec__21114,ns,vars__$1))
);
});})(each_fixture_fn,G__21117,G__21117__$1,env,once_fixtures,each_fixtures,vec__21114,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21117__$1)].join('')));

}
})());
});
;})(vec__21114,ns,vars__$1))
