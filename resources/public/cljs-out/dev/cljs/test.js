...
var G__20277 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__20277,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__20277;
}
});
...
args__4534__auto__.push((arguments[i__4532__auto___20283]));
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq20279){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20280,G__20281,seq20279__$2);
});
...
var file = cljs.core.get.call(null,map__20286__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__20286__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__20286__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__20286,map__20286__$1,file,line,column){
return (function (p1__20285_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__20285_SHARP_));
});})(map__20286,map__20286__$1,file,line,column))
...
var temp__5457__auto___20288 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20288)){
var message_20289 = temp__5457__auto___20288;
cljs.core.println.call(null,message_20289);
} else {
}
...
var temp__5457__auto___20290 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20290)){
var message_20291 = temp__5457__auto___20290;
cljs.core.println.call(null,message_20291);
} else {
}
...
var output_dir__$1 = (function (){var G__20292 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20292),"/"].join('');
} else {
return G__20292;
}
})();
...
var G__20294 = exception.stack;
var G__20294__$1 = (((G__20294 == null))?null:clojure.string.split_lines.call(null,G__20294));
var G__20294__$2 = (((G__20294__$1 == null))?null:cljs.core.get.call(null,G__20294__$1,depth));
if((G__20294__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__20294__$2);
}
} else {
...
var vec__20295 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__20295,(0),null);
var column = cljs.core.nth.call(null,vec__20295,(1),null);
var vec__20298 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__20298,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__20298,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__20298,(2),null);
...
var m__$1 = (function (){var G__20301 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__20301__$1 = (((G__20301 instanceof cljs.core.Keyword))?G__20301.fqn:null);
switch (G__20301__$1) {
case "fail":
...
var G__20305 = (function (){var G__20304 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__20304);
} else {
return G__20304;
}
})();
...
return cljs.core.vary_meta.call(null,G__20306,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__20310 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__20310,(0),null);
var types = vec__20310;
...
return cljs.core.map.call(null,(function (p__20313){
var vec__20314 = p__20313;
var ns = cljs.core.nth.call(null,vec__20314,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__20314,(1),null);
return ((function (vec__20314,ns,vars__$1){
return (function (){
...
var G__20317 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__20317,G__20317__$1,env,once_fixtures,each_fixtures,vec__20314,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__20317,G__20317__$1,env,once_fixtures,each_fixtures,vec__20314,ns,vars__$1){
return (function (){
var seq__20318 = cljs.core.seq.call(null,vars__$1);
var chunk__20319 = null;
var count__20320 = (0);
var i__20321 = (0);
while(true){
if((i__20321 < count__20320)){
var v = cljs.core._nth.call(null,chunk__20319,i__20321);
var temp__5457__auto___20323 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20323)){
var t_20324 = temp__5457__auto___20323;
each_fixture_fn.call(null,((function (seq__20318,chunk__20319,count__20320,i__20321,t_20324,temp__5457__auto___20323,v,each_fixture_fn,G__20317,G__20317__$1,env,once_fixtures,each_fixtures,vec__20314,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20324)));
});})(seq__20318,chunk__20319,count__20320,i__20321,t_20324,temp__5457__auto___20323,v,each_fixture_fn,G__20317,G__20317__$1,env,once_fixtures,each_fixtures,vec__20314,ns,vars__$1))
);
} else {
}


var G__20325 = seq__20318;
var G__20326 = chunk__20319;
var G__20327 = count__20320;
var G__20328 = (i__20321 + (1));
seq__20318 = G__20325;
chunk__20319 = G__20326;
count__20320 = G__20327;
i__20321 = G__20328;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__20318);
if(temp__5457__auto__){
var seq__20318__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__20318__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__20318__$1);
var G__20329 = cljs.core.chunk_rest.call(null,seq__20318__$1);
var G__20330 = c__4351__auto__;
var G__20331 = cljs.core.count.call(null,c__4351__auto__);
var G__20332 = (0);
seq__20318 = G__20329;
chunk__20319 = G__20330;
count__20320 = G__20331;
i__20321 = G__20332;
continue;
} else {
var v = cljs.core.first.call(null,seq__20318__$1);
var temp__5457__auto___20333__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20333__$1)){
var t_20334 = temp__5457__auto___20333__$1;
each_fixture_fn.call(null,((function (seq__20318,chunk__20319,count__20320,i__20321,t_20334,temp__5457__auto___20333__$1,v,seq__20318__$1,temp__5457__auto__,each_fixture_fn,G__20317,G__20317__$1,env,once_fixtures,each_fixtures,vec__20314,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20334)));
});})(seq__20318,chunk__20319,count__20320,i__20321,t_20334,temp__5457__auto___20333__$1,v,seq__20318__$1,temp__5457__auto__,each_fixture_fn,G__20317,G__20317__$1,env,once_fixtures,each_fixtures,vec__20314,ns,vars__$1))
);
} else {
}


var G__20335 = cljs.core.next.call(null,seq__20318__$1);
var G__20336 = null;
var G__20337 = (0);
var G__20338 = (0);
seq__20318 = G__20335;
chunk__20319 = G__20336;
count__20320 = G__20337;
i__20321 = G__20338;
continue;
}
} else {
...
});})(each_fixture_fn,G__20317,G__20317__$1,env,once_fixtures,each_fixtures,vec__20314,ns,vars__$1))
);
});})(each_fixture_fn,G__20317,G__20317__$1,env,once_fixtures,each_fixtures,vec__20314,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20317__$1)].join('')));

}
})());
});
;})(vec__20314,ns,vars__$1))
