...
cljs_test_display.notify.failure = (function cljs_test_display$notify$failure(p__20958){
...
var fail = cljs.core.get.call(null,map__20959__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
return cljs_test_display.notify.with_permission.call(null,"granted",((function (map__20959,map__20959__$1,error,fail){
return (function (){
...
});})(map__20959,map__20959__$1,error,fail))
);
});
