...
if((i < len)){
var k = (ks[i]);
var G__36022 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__36023 = (i + (1));
m = G__36022;
i = G__36023;
continue;
...
var temp__5737__auto__ = (p["argv"]);
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__35846 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__35846);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35848 = c;
var G__35848__$1 = (((G__35848 == null))?null:G__35848.prototype);
if((G__35848__$1 == null)){
return null;
} else {
return (G__35848__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35854 = c;
var G__35854__$1 = (((G__35854 == null))?null:G__35854.prototype);
if((G__35854__$1 == null)){
return null;
} else {
return (G__35854__$1["render"]);
}
})() == null)))));
});
...
var G__35872 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__35872) : reagent.impl.component.as_element.call(null,G__35872));
};
...
var _STAR_current_component_STAR__orig_val__35873 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__35874 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__35874);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__35873);
}});
...
var c = this;
var G__35909_36041 = (c["cljsRatom"]);
if((G__35909_36041 == null)){
} else {
reagent.ratom.dispose_BANG_(G__35909_36041);
}
...
var renders_36046 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_36047 = cljs.core.first(cljs.core.vals(renders_36046));
if((cljs.core.count(renders_36046) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36046))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36047)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36047], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__35957 = name;
switch (G__35957) {
case "":
...
var G__35967 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__35967);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__35972 = fiber;
var G__35972__$1 = (((G__35972 == null))?null:(G__35972["type"]));
if((G__35972__$1 == null)){
return null;
} else {
return (G__35972__$1["displayName"]);
}
})();
var parent = (function (){var G__35973 = fiber;
if((G__35973 == null)){
return null;
} else {
return (G__35973["return"]);
}
})();
var path = (function (){var G__35975 = parent;
var G__35975__$1 = (((G__35975 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__35975) : reagent.impl.component.fiber_component_path.call(null,G__35975)));
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__36003 = c;
if((G__36003 == null)){
return null;
} else {
return (G__36003["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__36004._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__36006 = c;
if((G__36006 == null)){
return null;
} else {
return (G__36006["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__36008 = c;
if((G__36008 == null)){
return null;
} else {
return G__36008._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4185__auto__ = (function (){var G__36010 = instance;
if((G__36010 == null)){
return null;
} else {
return (G__36010["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__36011 = instance;
if((G__36011 == null)){
return null;
} else {
return G__36011._currentElement;
}
}
})();
var name = (function (){var G__36012 = elem;
var G__36012__$1 = (((G__36012 == null))?null:(G__36012["type"]));
if((G__36012__$1 == null)){
return null;
} else {
return (G__36012__$1["displayName"]);
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__36014 = elem;
if((G__36014 == null)){
return null;
} else {
return (G__36014["_owner"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__36015._owner;
}
}
})();
var path = (function (){var G__36016 = owner;
var G__36016__$1 = (((G__36016 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__36016) : reagent.impl.component.component_path.call(null,G__36016)));
if((G__36016__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36016__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__36017 = c;
var G__36017__$1 = (((G__36017 == null))?null:G__36017.constructor);
if((G__36017__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__36017__$1);
}
}
})();
