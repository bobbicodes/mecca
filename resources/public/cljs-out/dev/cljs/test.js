...
var G__13948 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__13948,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__13948;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq13950){
var G__13951 = cljs.core.first.call(null,seq13950);
var seq13950__$1 = cljs.core.next.call(null,seq13950);
var G__13952 = cljs.core.first.call(null,seq13950__$1);
var seq13950__$2 = cljs.core.next.call(null,seq13950__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13951,G__13952,seq13950__$2);
});
...
var map__13957 = m;
var map__13957__$1 = ((((!((map__13957 == null)))?(((((map__13957.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__13957.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__13957):map__13957);
var file = cljs.core.get.call(null,map__13957__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__13957__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__13957__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__13957,map__13957__$1,file,line,column){
return (function (p1__13956_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__13956_SHARP_));
});})(map__13957,map__13957__$1,file,line,column))
...
var temp__5457__auto___13959 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13959)){
var message_13960 = temp__5457__auto___13959;
cljs.core.println.call(null,message_13960);
} else {
}
...
var temp__5457__auto___13961 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13961)){
var message_13962 = temp__5457__auto___13961;
cljs.core.println.call(null,message_13962);
} else {
}
...
var output_dir__$1 = (function (){var G__13963 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13963),"/"].join('');
} else {
return G__13963;
}
})();
...
var G__13965 = exception.stack;
var G__13965__$1 = (((G__13965 == null))?null:clojure.string.split_lines.call(null,G__13965));
var G__13965__$2 = (((G__13965__$1 == null))?null:cljs.core.get.call(null,G__13965__$1,depth));
if((G__13965__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__13965__$2);
}
} else {
...
var vec__13966 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__13966,(0),null);
var column = cljs.core.nth.call(null,vec__13966,(1),null);
var vec__13969 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__13969,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__13969,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__13969,(2),null);
...
var m__$1 = (function (){var G__13972 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__13976 = (function (){var G__13975 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__13975);
} else {
return G__13975;
}
})();
...
return cljs.core.vary_meta.call(null,G__13977,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__13981 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__13981,(0),null);
var types = vec__13981;
...
return cljs.core.map.call(null,(function (p__13984){
var vec__13985 = p__13984;
var ns = cljs.core.nth.call(null,vec__13985,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__13985,(1),null);
return ((function (vec__13985,ns,vars__$1){
return (function (){
...
var G__13988 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__13988,G__13988__$1,env,once_fixtures,each_fixtures,vec__13985,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__13988,G__13988__$1,env,once_fixtures,each_fixtures,vec__13985,ns,vars__$1){
return (function (){
var seq__13989 = cljs.core.seq.call(null,vars__$1);
var chunk__13990 = null;
var count__13991 = (0);
var i__13992 = (0);
while(true){
if((i__13992 < count__13991)){
var v = cljs.core._nth.call(null,chunk__13990,i__13992);
var temp__5457__auto___13994 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13994)){
var t_13995 = temp__5457__auto___13994;
each_fixture_fn.call(null,((function (seq__13989,chunk__13990,count__13991,i__13992,t_13995,temp__5457__auto___13994,v,each_fixture_fn,G__13988,G__13988__$1,env,once_fixtures,each_fixtures,vec__13985,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13995)));
});})(seq__13989,chunk__13990,count__13991,i__13992,t_13995,temp__5457__auto___13994,v,each_fixture_fn,G__13988,G__13988__$1,env,once_fixtures,each_fixtures,vec__13985,ns,vars__$1))
);
} else {
}


var G__13996 = seq__13989;
var G__13997 = chunk__13990;
var G__13998 = count__13991;
var G__13999 = (i__13992 + (1));
seq__13989 = G__13996;
chunk__13990 = G__13997;
count__13991 = G__13998;
i__13992 = G__13999;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__13989);
if(temp__5457__auto__){
var seq__13989__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__13989__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__13989__$1);
var G__14000 = cljs.core.chunk_rest.call(null,seq__13989__$1);
var G__14001 = c__4351__auto__;
var G__14002 = cljs.core.count.call(null,c__4351__auto__);
var G__14003 = (0);
seq__13989 = G__14000;
chunk__13990 = G__14001;
count__13991 = G__14002;
i__13992 = G__14003;
continue;
} else {
var v = cljs.core.first.call(null,seq__13989__$1);
var temp__5457__auto___14004__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___14004__$1)){
var t_14005 = temp__5457__auto___14004__$1;
each_fixture_fn.call(null,((function (seq__13989,chunk__13990,count__13991,i__13992,t_14005,temp__5457__auto___14004__$1,v,seq__13989__$1,temp__5457__auto__,each_fixture_fn,G__13988,G__13988__$1,env,once_fixtures,each_fixtures,vec__13985,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14005)));
});})(seq__13989,chunk__13990,count__13991,i__13992,t_14005,temp__5457__auto___14004__$1,v,seq__13989__$1,temp__5457__auto__,each_fixture_fn,G__13988,G__13988__$1,env,once_fixtures,each_fixtures,vec__13985,ns,vars__$1))
);
} else {
}


var G__14006 = cljs.core.next.call(null,seq__13989__$1);
var G__14007 = null;
var G__14008 = (0);
var G__14009 = (0);
seq__13989 = G__14006;
chunk__13990 = G__14007;
count__13991 = G__14008;
i__13992 = G__14009;
continue;
}
} else {
...
});})(each_fixture_fn,G__13988,G__13988__$1,env,once_fixtures,each_fixtures,vec__13985,ns,vars__$1))
);
});})(each_fixture_fn,G__13988,G__13988__$1,env,once_fixtures,each_fixtures,vec__13985,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13988__$1)].join('')));

}
})());
});
;})(vec__13985,ns,vars__$1))
