...
cljs_test_display.notify.failure = (function cljs_test_display$notify$failure(p__21964){
var map__21965 = p__21964;
var map__21965__$1 = ((((!((map__21965 == null)))?(((((map__21965.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21965.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21965):map__21965);
var error = cljs.core.get.call(null,map__21965__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var fail = cljs.core.get.call(null,map__21965__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
return cljs_test_display.notify.with_permission.call(null,"granted",((function (map__21965,map__21965__$1,error,fail){
return (function (){
...
});})(map__21965,map__21965__$1,error,fail))
);
});
