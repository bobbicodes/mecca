...
var G__20553 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__20553,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__20553;
}
});
...
var len__4531__auto___20558 = arguments.length;
var i__4532__auto___20559 = (0);
while(true){
if((i__4532__auto___20559 < len__4531__auto___20558)){
args__4534__auto__.push((arguments[i__4532__auto___20559]));

var G__20560 = (i__4532__auto___20559 + (1));
i__4532__auto___20559 = G__20560;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq20555){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20556,G__20557,seq20555__$2);
});
...
var file = cljs.core.get.call(null,map__20562__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__20562__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__20562__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__20562,map__20562__$1,file,line,column){
return (function (p1__20561_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__20561_SHARP_));
});})(map__20562,map__20562__$1,file,line,column))
...
var temp__5457__auto___20564 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20564)){
var message_20565 = temp__5457__auto___20564;
cljs.core.println.call(null,message_20565);
} else {
}
...
var temp__5457__auto___20566 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20566)){
var message_20567 = temp__5457__auto___20566;
cljs.core.println.call(null,message_20567);
} else {
}
...
var output_dir__$1 = (function (){var G__20568 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20568),"/"].join('');
} else {
return G__20568;
}
})();
...
var G__20570 = exception.stack;
var G__20570__$1 = (((G__20570 == null))?null:clojure.string.split_lines.call(null,G__20570));
var G__20570__$2 = (((G__20570__$1 == null))?null:cljs.core.get.call(null,G__20570__$1,depth));
if((G__20570__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__20570__$2);
}
} else {
...
var vec__20571 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__20571,(0),null);
var column = cljs.core.nth.call(null,vec__20571,(1),null);
var vec__20574 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__20574,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__20574,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__20574,(2),null);
...
var m__$1 = (function (){var G__20577 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__20581 = (function (){var G__20580 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__20580);
} else {
return G__20580;
}
})();
...
return cljs.core.vary_meta.call(null,G__20582,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__20586 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__20586,(0),null);
var types = vec__20586;
...
return cljs.core.map.call(null,(function (p__20589){
var vec__20590 = p__20589;
var ns = cljs.core.nth.call(null,vec__20590,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__20590,(1),null);
return ((function (vec__20590,ns,vars__$1){
return (function (){
...
var G__20593 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__20593,G__20593__$1,env,once_fixtures,each_fixtures,vec__20590,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__20593,G__20593__$1,env,once_fixtures,each_fixtures,vec__20590,ns,vars__$1){
return (function (){
var seq__20594 = cljs.core.seq.call(null,vars__$1);
var chunk__20595 = null;
var count__20596 = (0);
var i__20597 = (0);
while(true){
if((i__20597 < count__20596)){
var v = cljs.core._nth.call(null,chunk__20595,i__20597);
var temp__5457__auto___20599 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20599)){
var t_20600 = temp__5457__auto___20599;
each_fixture_fn.call(null,((function (seq__20594,chunk__20595,count__20596,i__20597,t_20600,temp__5457__auto___20599,v,each_fixture_fn,G__20593,G__20593__$1,env,once_fixtures,each_fixtures,vec__20590,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20600)));
});})(seq__20594,chunk__20595,count__20596,i__20597,t_20600,temp__5457__auto___20599,v,each_fixture_fn,G__20593,G__20593__$1,env,once_fixtures,each_fixtures,vec__20590,ns,vars__$1))
);
} else {
}


var G__20601 = seq__20594;
var G__20602 = chunk__20595;
var G__20603 = count__20596;
var G__20604 = (i__20597 + (1));
seq__20594 = G__20601;
chunk__20595 = G__20602;
count__20596 = G__20603;
i__20597 = G__20604;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__20594);
if(temp__5457__auto__){
var seq__20594__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__20594__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__20594__$1);
var G__20605 = cljs.core.chunk_rest.call(null,seq__20594__$1);
var G__20606 = c__4351__auto__;
var G__20607 = cljs.core.count.call(null,c__4351__auto__);
var G__20608 = (0);
seq__20594 = G__20605;
chunk__20595 = G__20606;
count__20596 = G__20607;
i__20597 = G__20608;
continue;
} else {
var v = cljs.core.first.call(null,seq__20594__$1);
var temp__5457__auto___20609__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20609__$1)){
var t_20610 = temp__5457__auto___20609__$1;
each_fixture_fn.call(null,((function (seq__20594,chunk__20595,count__20596,i__20597,t_20610,temp__5457__auto___20609__$1,v,seq__20594__$1,temp__5457__auto__,each_fixture_fn,G__20593,G__20593__$1,env,once_fixtures,each_fixtures,vec__20590,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20610)));
});})(seq__20594,chunk__20595,count__20596,i__20597,t_20610,temp__5457__auto___20609__$1,v,seq__20594__$1,temp__5457__auto__,each_fixture_fn,G__20593,G__20593__$1,env,once_fixtures,each_fixtures,vec__20590,ns,vars__$1))
);
} else {
}


var G__20611 = cljs.core.next.call(null,seq__20594__$1);
var G__20612 = null;
var G__20613 = (0);
var G__20614 = (0);
seq__20594 = G__20611;
chunk__20595 = G__20612;
count__20596 = G__20613;
i__20597 = G__20614;
continue;
}
} else {
...
});})(each_fixture_fn,G__20593,G__20593__$1,env,once_fixtures,each_fixtures,vec__20590,ns,vars__$1))
);
});})(each_fixture_fn,G__20593,G__20593__$1,env,once_fixtures,each_fixtures,vec__20590,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20593__$1)].join('')));

}
})());
});
;})(vec__20590,ns,vars__$1))
