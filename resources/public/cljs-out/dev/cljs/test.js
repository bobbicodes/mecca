...
var G__13836 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__13836,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__13836;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq13838){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13839,G__13840,seq13838__$2);
});
...
var file = cljs.core.get.call(null,map__13845__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__13845__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__13845__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__13845,map__13845__$1,file,line,column){
return (function (p1__13844_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__13844_SHARP_));
});})(map__13845,map__13845__$1,file,line,column))
...
var temp__5457__auto___13847 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13847)){
var message_13848 = temp__5457__auto___13847;
cljs.core.println.call(null,message_13848);
} else {
}
...
var temp__5457__auto___13849 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13849)){
var message_13850 = temp__5457__auto___13849;
cljs.core.println.call(null,message_13850);
} else {
}
...
var output_dir__$1 = (function (){var G__13851 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13851),"/"].join('');
} else {
return G__13851;
}
})();
...
var G__13853 = exception.stack;
var G__13853__$1 = (((G__13853 == null))?null:clojure.string.split_lines.call(null,G__13853));
var G__13853__$2 = (((G__13853__$1 == null))?null:cljs.core.get.call(null,G__13853__$1,depth));
if((G__13853__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__13853__$2);
}
} else {
...
var vec__13854 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__13854,(0),null);
var column = cljs.core.nth.call(null,vec__13854,(1),null);
var vec__13857 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__13857,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__13857,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__13857,(2),null);
...
var m__$1 = (function (){var G__13860 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__13860__$1 = (((G__13860 instanceof cljs.core.Keyword))?G__13860.fqn:null);
switch (G__13860__$1) {
case "fail":
...
var G__13864 = (function (){var G__13863 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__13863);
} else {
return G__13863;
}
})();
...
return cljs.core.vary_meta.call(null,G__13865,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__13869 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__13869,(0),null);
var types = vec__13869;
...
return cljs.core.map.call(null,(function (p__13872){
var vec__13873 = p__13872;
var ns = cljs.core.nth.call(null,vec__13873,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__13873,(1),null);
return ((function (vec__13873,ns,vars__$1){
return (function (){
...
var G__13876 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__13876,G__13876__$1,env,once_fixtures,each_fixtures,vec__13873,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__13876,G__13876__$1,env,once_fixtures,each_fixtures,vec__13873,ns,vars__$1){
return (function (){
var seq__13877 = cljs.core.seq.call(null,vars__$1);
var chunk__13878 = null;
var count__13879 = (0);
var i__13880 = (0);
while(true){
if((i__13880 < count__13879)){
var v = cljs.core._nth.call(null,chunk__13878,i__13880);
var temp__5457__auto___13882 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13882)){
var t_13883 = temp__5457__auto___13882;
each_fixture_fn.call(null,((function (seq__13877,chunk__13878,count__13879,i__13880,t_13883,temp__5457__auto___13882,v,each_fixture_fn,G__13876,G__13876__$1,env,once_fixtures,each_fixtures,vec__13873,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13883)));
});})(seq__13877,chunk__13878,count__13879,i__13880,t_13883,temp__5457__auto___13882,v,each_fixture_fn,G__13876,G__13876__$1,env,once_fixtures,each_fixtures,vec__13873,ns,vars__$1))
);
} else {
}


var G__13884 = seq__13877;
var G__13885 = chunk__13878;
var G__13886 = count__13879;
var G__13887 = (i__13880 + (1));
seq__13877 = G__13884;
chunk__13878 = G__13885;
count__13879 = G__13886;
i__13880 = G__13887;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__13877);
if(temp__5457__auto__){
var seq__13877__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__13877__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__13877__$1);
var G__13888 = cljs.core.chunk_rest.call(null,seq__13877__$1);
var G__13889 = c__4351__auto__;
var G__13890 = cljs.core.count.call(null,c__4351__auto__);
var G__13891 = (0);
seq__13877 = G__13888;
chunk__13878 = G__13889;
count__13879 = G__13890;
i__13880 = G__13891;
continue;
} else {
var v = cljs.core.first.call(null,seq__13877__$1);
var temp__5457__auto___13892__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13892__$1)){
var t_13893 = temp__5457__auto___13892__$1;
each_fixture_fn.call(null,((function (seq__13877,chunk__13878,count__13879,i__13880,t_13893,temp__5457__auto___13892__$1,v,seq__13877__$1,temp__5457__auto__,each_fixture_fn,G__13876,G__13876__$1,env,once_fixtures,each_fixtures,vec__13873,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13893)));
});})(seq__13877,chunk__13878,count__13879,i__13880,t_13893,temp__5457__auto___13892__$1,v,seq__13877__$1,temp__5457__auto__,each_fixture_fn,G__13876,G__13876__$1,env,once_fixtures,each_fixtures,vec__13873,ns,vars__$1))
);
} else {
}


var G__13894 = cljs.core.next.call(null,seq__13877__$1);
var G__13895 = null;
var G__13896 = (0);
var G__13897 = (0);
seq__13877 = G__13894;
chunk__13878 = G__13895;
count__13879 = G__13896;
i__13880 = G__13897;
continue;
}
} else {
...
});})(each_fixture_fn,G__13876,G__13876__$1,env,once_fixtures,each_fixtures,vec__13873,ns,vars__$1))
);
});})(each_fixture_fn,G__13876,G__13876__$1,env,once_fixtures,each_fixtures,vec__13873,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13876__$1)].join('')));

}
})());
});
;})(vec__13873,ns,vars__$1))
