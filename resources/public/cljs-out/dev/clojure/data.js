...
return cljs.core.reduce.call(null,(function (result,p__16740){
...
var vec__16744 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__16744,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__16744,(1),null);
var ab = cljs.core.nth.call(null,vec__16744,(2),null);
...
return (function (){var G__16753 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__16753__$1)].join('')));
