...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.drop.cljs$core$IFn$_invoke$arity$2(c,mecca.music.scale.major),cljs.core.take.cljs$core$IFn$_invoke$arity$2(c,mecca.music.scale.major));
});
mecca.music.scale.ionian = mecca.music.scale.mode((0));
mecca.music.scale.dorian = mecca.music.scale.mode((1));
mecca.music.scale.phrygian = mecca.music.scale.mode((2));
mecca.music.scale.lydian = mecca.music.scale.mode((3));
mecca.music.scale.mixolydian = mecca.music.scale.mode((4));
mecca.music.scale.aeolian = mecca.music.scale.mode((5));
mecca.music.scale.locrian = mecca.music.scale.mode((6));
/**
