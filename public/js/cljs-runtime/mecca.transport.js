...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"g","g",1738089905),cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([attrs,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"transform","transform",1381301764),["scale(",cljs.core.str.cljs$core$IFn$_invoke$arity$1(scale),") translate(",cljs.core.str.cljs$core$IFn$_invoke$arity$1(x),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1(y),")"].join('')], null)], 0))], null),(function (){var iter__4582__auto__ = (function mecca$transport$iter__42535(s__42536){
return (new cljs.core.LazySeq(null,(function (){
var s__42536__$1 = s__42536;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__42536__$1);
if(temp__5735__auto__){
var s__42536__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__42536__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__42536__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__42538 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__42537 = (0);
while(true){
if((i__42537 < size__4581__auto__)){
var vec__42539 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__42537);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42539,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42539,(1),null);
cljs.core.chunk_append(b__42538,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"path","path",-188191168),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"stroke","stroke",1741823555),color,new cljs.core.Keyword(null,"d","d",1972142424),path], null)], null));

var G__42554 = (i__42537 + (1));
i__42537 = G__42554;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__42538),mecca$transport$iter__42535(cljs.core.chunk_rest(s__42536__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__42538),null);
}
} else {
var vec__42542 = cljs.core.first(s__42536__$2);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42542,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42542,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"path","path",-188191168),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"stroke","stroke",1741823555),color,new cljs.core.Keyword(null,"d","d",1972142424),path], null)], null),mecca$transport$iter__42535(cljs.core.rest(s__42536__$2)));
}
} else {
return null;
}
...
var G__42545 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"inc-tempo","inc-tempo",-1684511808)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__42545) : re_frame.core.dispatch.call(null,G__42545));
}),(1),x,"all","hidden",(scale * (12))])], null);
});
mecca.transport.tempo_down = (function mecca$transport$tempo_down(x,y,scale){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"rect","rect",-108902628),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"y","y",-1757859776),new cljs.core.Keyword(null,"stroke","stroke",1741823555),new cljs.core.Keyword(null,"width","width",-384071477),new cljs.core.Keyword(null,"on-click","on-click",1632826543),new cljs.core.Keyword(null,"stroke-width","stroke-width",716836435),new cljs.core.Keyword(null,"x","x",2099068185),new cljs.core.Keyword(null,"pointer-events","pointer-events",-1053858853),new cljs.core.Keyword(null,"visibility","visibility",1338380893),new cljs.core.Keyword(null,"height","height",1025178622)],[y,"black",(scale * (12)),(function (){
var G__42546 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"dec-tempo","dec-tempo",375495204)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__42546) : re_frame.core.dispatch.call(null,G__42546));
}),(1),x,"all","hidden",(scale * (12))])], null);
});
...
var G__42547_42555 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"stop","stop",-2140911342)], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__42547_42555) : re_frame.core.dispatch.call(null,G__42547_42555));

return mecca.music.play_sample((17),(63));
})], null),(cljs.core.truth_(cljs.core.deref((function (){var G__42548 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"playing?","playing?",-1884542863)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__42548) : re_frame.core.subscribe.call(null,G__42548));
...
if(cljs.core.truth_(cljs.core.deref((function (){var G__42549 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"playing?","playing?",-1884542863)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__42549) : re_frame.core.subscribe.call(null,G__42549));
})()))){
return mecca.transport.svg_paths.cljs$core$IFn$_invoke$arity$5(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
var G__42550_42556 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pause","pause",-2095325672)], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__42550_42556) : re_frame.core.dispatch.call(null,G__42550_42556));
...
return mecca.transport.svg_paths.cljs$core$IFn$_invoke$arity$5(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
var G__42551_42557 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"play-on","play-on",-1655917734)], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__42551_42557) : re_frame.core.dispatch.call(null,G__42551_42557));
