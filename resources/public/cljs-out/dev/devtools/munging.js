...
var temp__5455__auto____$1 = (o22288["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22289 = temp__5455__auto____$1;
return (o22289["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__22108__auto___22292 = t;
(o__22108__auto___22292["cljs$lang$ctorPrWriter"]).call(o__22108__auto___22292,t,writer);
}catch (e22291){var __22293 = e22291;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22294 = num_code;
switch (G__22294) {
case (1):
return (185);
...
}catch (e22296){var _e__22115__auto__ = e22296;
return false;
}})())){
...
var vec__22297 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22297,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o22300 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22300["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22301 = temp__5455__auto____$1;
return (o22301["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___22308 = arguments.length;
var i__4532__auto___22309 = (0);
while(true){
if((i__4532__auto___22309 < len__4531__auto___22308)){
args__4534__auto__.push((arguments[i__4532__auto___22309]));

var G__22310 = (i__4532__auto___22309 + (1));
i__4532__auto___22309 = G__22310;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22304){
var vec__22305 = p__22304;
var ns_detector = cljs.core.nth.call(null,vec__22305,(0),null);
...
var G__22311 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22312 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22311;
remaining_tokens = G__22312;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22302){
var G__22303 = cljs.core.first.call(null,seq22302);
var seq22302__$1 = cljs.core.next.call(null,seq22302);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22303,seq22302__$1);
});
...
var vec__22316 = cljs.core.split_with.call(null,(function (p1__22315_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22315_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22316,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22316,(1),null);
...
var vec__22319 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22319,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22319,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22322 = cljs.core.rest.call(null,remaining_tokens);
var G__22323 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22322;
name_tokens = G__22323;
continue;
} else {
...
var vec__22326 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22326,(0),null);
var arity = cljs.core.nth.call(null,vec__22326,(1),null);
var vec__22329 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22329,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22329,(1),null);
var vec__22332 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22332,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22332,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22332,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22332,(3),null);
...
var vec__22338 = result;
var munged_ns = cljs.core.nth.call(null,vec__22338,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22338,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22338,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22338,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22338,(4),null);
var arity = cljs.core.nth.call(null,vec__22338,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__22342 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__22342,(0),null);
var args = cljs.core.nth.call(null,vec__22342,(1),null);
var vec__22345 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22345,(0),null);
var name = cljs.core.nth.call(null,vec__22345,(1),null);
...
var G__22348 = (arity + (1));
var G__22349 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22350){
var vec__22351 = p__22350;
var arity = cljs.core.nth.call(null,vec__22351,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22351,(1),null);
...
return cljs.core.get.call(null,arities,p1__22354_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22355_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22358){
var vec__22359 = p__22358;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22359,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22356){
var G__22357 = cljs.core.first.call(null,seq22356);
var seq22356__$1 = cljs.core.next.call(null,seq22356);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22357,seq22356__$1);
});
...
var map__22367 = options;
var map__22367__$1 = ((((!((map__22367 == null)))?(((((map__22367.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22367.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22367):map__22367);
var include_ns_QMARK_ = cljs.core.get.call(null,map__22367__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22367__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22367__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22367__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22368 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22368,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22368,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22368,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22368,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22368,(4),null);
var arity = cljs.core.nth.call(null,vec__22368,(5),null);
...
}catch (e22372){var _e__22115__auto__ = e22372;
...
var G__22373 = (obj[cljs.core.first.call(null,path)]);
var G__22374 = cljs.core.rest.call(null,path);
obj = G__22373;
path = G__22374;
continue;
} else {
...
return (function (accum,p__22375){
var vec__22376 = p__22375;
var bit = cljs.core.nth.call(null,vec__22376,(0),null);
var protocol = cljs.core.nth.call(null,vec__22376,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22379){
var vec__22380 = p__22379;
var ns = cljs.core.nth.call(null,vec__22380,(0),null);
var name = cljs.core.nth.call(null,vec__22380,(1),null);
var selector = cljs.core.nth.call(null,vec__22380,(2),null);
...
return (function (p__22384){
var vec__22385 = p__22384;
var munged_name = cljs.core.nth.call(null,vec__22385,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22385,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22385,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22383_SHARP_){
return (obj[cljs.core.first.call(null,p1__22383_SHARP_)]);
});})(name,sorted_matches,vec__22385,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
