...
var G__15228 = devtools.prefs.pref.call(null,v);
v = G__15228;
continue;
} else {
return v;
...
}catch (e15231){var _e__14482__auto__ = e15231;
return false;
}})();
...
}catch (e15235){var _e__14482__auto__ = e15235;
return false;
}})();
...
}catch (e15237){var _e__14482__auto__ = e15237;
return false;
}}
}
});
...
var vec__15239 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__15239,(0),null);
var name = cljs.core.nth.call(null,vec__15239,(1),null);
...
return cljs.core.some.call(null,(function (p1__15242_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15242_SHARP_);
}),template);
});
