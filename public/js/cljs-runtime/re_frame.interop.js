...
return [(function (){var pred__36525 = cljs.core.instance_QMARK_;
var expr__36526 = reactive_val;
if(cljs.core.truth_((pred__36525.cljs$core$IFn$_invoke$arity$2 ? pred__36525.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__36526) : pred__36525.call(null,reagent.ratom.RAtom,expr__36526)))){
return "ra";
} else {
if(cljs.core.truth_((pred__36525.cljs$core$IFn$_invoke$arity$2 ? pred__36525.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__36526) : pred__36525.call(null,reagent.ratom.RCursor,expr__36526)))){
return "rc";
} else {
if(cljs.core.truth_((pred__36525.cljs$core$IFn$_invoke$arity$2 ? pred__36525.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__36526) : pred__36525.call(null,reagent.ratom.Reaction,expr__36526)))){
return "rx";
} else {
if(cljs.core.truth_((pred__36525.cljs$core$IFn$_invoke$arity$2 ? pred__36525.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__36526) : pred__36525.call(null,reagent.ratom.Track,expr__36526)))){
return "tr";
} else {
return "other";
}
