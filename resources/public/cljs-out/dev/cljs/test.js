...
var G__20557 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__20557,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__20557;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq20559){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20560,G__20561,seq20559__$2);
});
...
var file = cljs.core.get.call(null,map__20566__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__20566__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__20566__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__20566,map__20566__$1,file,line,column){
return (function (p1__20565_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__20565_SHARP_));
});})(map__20566,map__20566__$1,file,line,column))
...
var temp__5457__auto___20568 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20568)){
var message_20569 = temp__5457__auto___20568;
cljs.core.println.call(null,message_20569);
} else {
}
...
var temp__5457__auto___20570 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20570)){
var message_20571 = temp__5457__auto___20570;
cljs.core.println.call(null,message_20571);
} else {
}
...
var output_dir__$1 = (function (){var G__20572 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20572),"/"].join('');
} else {
return G__20572;
}
})();
...
var G__20574 = exception.stack;
var G__20574__$1 = (((G__20574 == null))?null:clojure.string.split_lines.call(null,G__20574));
var G__20574__$2 = (((G__20574__$1 == null))?null:cljs.core.get.call(null,G__20574__$1,depth));
if((G__20574__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__20574__$2);
}
} else {
...
var vec__20575 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__20575,(0),null);
var column = cljs.core.nth.call(null,vec__20575,(1),null);
var vec__20578 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__20578,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__20578,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__20578,(2),null);
...
var m__$1 = (function (){var G__20581 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__20585 = (function (){var G__20584 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__20584);
} else {
return G__20584;
}
})();
...
return cljs.core.vary_meta.call(null,G__20586,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e20587){var e = e20587;
var G__20588 = e;
var G__20588__$1 = (((G__20588 instanceof cljs.core.Keyword))?G__20588.fqn:null);
switch (G__20588__$1) {
...
var vec__20590 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__20590,(0),null);
var types = vec__20590;
...
return cljs.core.map.call(null,(function (p__20593){
var vec__20594 = p__20593;
var ns = cljs.core.nth.call(null,vec__20594,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__20594,(1),null);
...
var G__20597 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__20597,G__20597__$1,env,once_fixtures,each_fixtures,vec__20594,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__20597,G__20597__$1,env,once_fixtures,each_fixtures,vec__20594,ns,vars__$1){
return (function (){
var seq__20598 = cljs.core.seq.call(null,vars__$1);
var chunk__20599 = null;
var count__20600 = (0);
var i__20601 = (0);
while(true){
if((i__20601 < count__20600)){
var v = cljs.core._nth.call(null,chunk__20599,i__20601);
var temp__5457__auto___20603 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20603)){
var t_20604 = temp__5457__auto___20603;
each_fixture_fn.call(null,((function (seq__20598,chunk__20599,count__20600,i__20601,t_20604,temp__5457__auto___20603,v,each_fixture_fn,G__20597,G__20597__$1,env,once_fixtures,each_fixtures,vec__20594,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20604)));
});})(seq__20598,chunk__20599,count__20600,i__20601,t_20604,temp__5457__auto___20603,v,each_fixture_fn,G__20597,G__20597__$1,env,once_fixtures,each_fixtures,vec__20594,ns,vars__$1))
);
} else {
}


var G__20605 = seq__20598;
var G__20606 = chunk__20599;
var G__20607 = count__20600;
var G__20608 = (i__20601 + (1));
seq__20598 = G__20605;
chunk__20599 = G__20606;
count__20600 = G__20607;
i__20601 = G__20608;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__20598);
if(temp__5457__auto__){
var seq__20598__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__20598__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__20598__$1);
var G__20609 = cljs.core.chunk_rest.call(null,seq__20598__$1);
var G__20610 = c__4351__auto__;
var G__20611 = cljs.core.count.call(null,c__4351__auto__);
var G__20612 = (0);
seq__20598 = G__20609;
chunk__20599 = G__20610;
count__20600 = G__20611;
i__20601 = G__20612;
continue;
} else {
var v = cljs.core.first.call(null,seq__20598__$1);
var temp__5457__auto___20613__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20613__$1)){
var t_20614 = temp__5457__auto___20613__$1;
each_fixture_fn.call(null,((function (seq__20598,chunk__20599,count__20600,i__20601,t_20614,temp__5457__auto___20613__$1,v,seq__20598__$1,temp__5457__auto__,each_fixture_fn,G__20597,G__20597__$1,env,once_fixtures,each_fixtures,vec__20594,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20614)));
});})(seq__20598,chunk__20599,count__20600,i__20601,t_20614,temp__5457__auto___20613__$1,v,seq__20598__$1,temp__5457__auto__,each_fixture_fn,G__20597,G__20597__$1,env,once_fixtures,each_fixtures,vec__20594,ns,vars__$1))
);
} else {
}


var G__20615 = cljs.core.next.call(null,seq__20598__$1);
var G__20616 = null;
var G__20617 = (0);
var G__20618 = (0);
seq__20598 = G__20615;
chunk__20599 = G__20616;
count__20600 = G__20617;
i__20601 = G__20618;
continue;
}
} else {
...
});})(each_fixture_fn,G__20597,G__20597__$1,env,once_fixtures,each_fixtures,vec__20594,ns,vars__$1))
);
});})(each_fixture_fn,G__20597,G__20597__$1,env,once_fixtures,each_fixtures,vec__20594,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20597__$1)].join('')));
