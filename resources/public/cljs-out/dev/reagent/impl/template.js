...
var G__10653 = o;
(G__10653[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__10655__i < G__10655__a.length) {G__10655__a[G__10655__i] = arguments[G__10655__i + 0]; ++G__10655__i;}
  args = new cljs.core.IndexedSeq(G__10655__a,0,null);
} 
...
var G__10657 = o;
(G__10657[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__10659__i < G__10659__a.length) {G__10659__a[G__10659__i] = arguments[G__10659__i + 0]; ++G__10659__i;}
  args = new cljs.core.IndexedSeq(G__10659__a,0,null);
} 
...
return G__10658__delegate(args);
});
...
var G__10662 = props;
var G__10662__$1 = ((((!((id == null))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10662,cljs.core.cst$kw$id,id):G__10662);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10662__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__10663){
var map__10664 = p__10663;
var map__10664__$1 = ((((!((map__10664 == null)))?(((((map__10664.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10664.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10664):map__10664);
var props = map__10664__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10664__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__10664,map__10664__$1,props,class$){
return (function (c){
...
});})(map__10664,map__10664__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10666){
var map__10667 = p__10666;
var map__10667__$1 = ((((!((map__10667 == null)))?(((((map__10667.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10667.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10667):map__10667);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10667__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__10667,map__10667__$1,on_write){
return (function (){
...
});})(node_value,map__10667,map__10667__$1,on_write))
);
} else {
...
var G__10670 = jsprops;
(G__10670["defaultValue"] = value);

(G__10670["onChange"] = ((function (G__10670,v,value,on_change){
return (function (p1__10669_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__10669_SHARP_);
});})(G__10670,v,value,on_change))
);
...
var vec__10673 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10673,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10673,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10673,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___10677 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___10677 == null)){
} else {
var key_10678 = temp__5461__auto___10677;
(jsprops["key"] = key_10678);
}
...
var temp__5461__auto___10679 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___10679 == null)){
} else {
var key_10680 = temp__5461__auto___10679;
reagent.impl.template.oset(jsprops,"key",key_10680);
}
...
var G__10681 = reagent.impl.template.__GT_NativeWrapper();
(G__10681["name"] = c);
...
var G__10682 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__10682) : reagent.impl.template.as_element.call(null,G__10682));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10685){
var G__10686 = cljs.core.first(seq10685);
var seq10685__$1 = cljs.core.next(seq10685);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10686,seq10685__$1);
});
...
var n__4408__auto___10694 = a.length;
var i_10695 = (0);
while(true){
if((i_10695 < n__4408__auto___10694)){
(a[i_10695] = reagent.impl.template.as_element((a[i_10695])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4408__auto___10697 = a.length;
var i_10698 = (0);
while(true){
if((i_10698 < n__4408__auto___10697)){
var val_10699 = (a[i_10698]);
if(((cljs.core.vector_QMARK_(val_10699)) && ((reagent.impl.template.key_from_vec(val_10699) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_10698] = reagent.impl.template.as_element(val_10699));
...
var ctx = ({});
var vec__10701 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10701,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10701,(1),null);
...
var G__10704 = (cljs.core.count(argv) - first_child);
switch (G__10704) {
case (0):
...
case (1):
var G__10705 = comp;
var G__10706 = jsprops;
var G__10707 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__10705,G__10706,G__10707) : reagent.impl.template.global$module$react.createElement.call(null,G__10705,G__10706,G__10707));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__10704){
