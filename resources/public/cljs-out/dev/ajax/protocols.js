...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4205__auto__,k18757,else__4206__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k18757,else__4206__auto__);
...
ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__18756){
var self__ = this;
var G__18756__$1 = this;
return (new cljs.core.RecordIter((0),G__18756__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$status,cljs.core.cst$kw$body,cljs.core.cst$kw$status_DASH_text,cljs.core.cst$kw$headers,cljs.core.cst$kw$was_DASH_aborted], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
var h__4061__auto____$1 = (function (){var fexpr__18762 = ((function (h__4061__auto__,this__4199__auto____$1){
return (function (coll__4200__auto__){
return (-473222333 ^ cljs.core.hash_unordered_coll(coll__4200__auto__));
});})(h__4061__auto__,this__4199__auto____$1))
;
return fexpr__18762(this__4199__auto____$1);
})();
...
ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this18758,other18759){
var self__ = this;
var this18758__$1 = this;
return ((!((other18759 == null))) && ((this18758__$1.constructor === other18759.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18758__$1.status,other18759.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18758__$1.body,other18759.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18758__$1.status_text,other18759.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18758__$1.headers,other18759.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18758__$1.was_aborted,other18759.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18758__$1.__extmap,other18759.__extmap)));
});
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4210__auto__,k__4211__auto__,G__18756){
var self__ = this;
var this__4210__auto____$1 = this;
var pred__18763 = cljs.core.keyword_identical_QMARK_;
var expr__18764 = k__4211__auto__;
if(cljs.core.truth_((function (){var G__18766 = cljs.core.cst$kw$status;
var G__18767 = expr__18764;
return (pred__18763.cljs$core$IFn$_invoke$arity$2 ? pred__18763.cljs$core$IFn$_invoke$arity$2(G__18766,G__18767) : pred__18763.call(null,G__18766,G__18767));
})())){
return (new ajax.protocols.Response(G__18756,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__18768 = cljs.core.cst$kw$body;
var G__18769 = expr__18764;
return (pred__18763.cljs$core$IFn$_invoke$arity$2 ? pred__18763.cljs$core$IFn$_invoke$arity$2(G__18768,G__18769) : pred__18763.call(null,G__18768,G__18769));
})())){
return (new ajax.protocols.Response(self__.status,G__18756,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__18770 = cljs.core.cst$kw$status_DASH_text;
var G__18771 = expr__18764;
return (pred__18763.cljs$core$IFn$_invoke$arity$2 ? pred__18763.cljs$core$IFn$_invoke$arity$2(G__18770,G__18771) : pred__18763.call(null,G__18770,G__18771));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,G__18756,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__18772 = cljs.core.cst$kw$headers;
var G__18773 = expr__18764;
return (pred__18763.cljs$core$IFn$_invoke$arity$2 ? pred__18763.cljs$core$IFn$_invoke$arity$2(G__18772,G__18773) : pred__18763.call(null,G__18772,G__18773));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__18756,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__18774 = cljs.core.cst$kw$was_DASH_aborted;
var G__18775 = expr__18764;
return (pred__18763.cljs$core$IFn$_invoke$arity$2 ? pred__18763.cljs$core$IFn$_invoke$arity$2(G__18774,G__18775) : pred__18763.call(null,G__18774,G__18775));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__18756,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4211__auto__,G__18756),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4202__auto__,G__18756){
var self__ = this;
var this__4202__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__18756,self__.__extmap,self__.__hash));
});
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__18760){
var extmap__4236__auto__ = (function (){var G__18776 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__18760,cljs.core.cst$kw$status,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$body,cljs.core.cst$kw$status_DASH_text,cljs.core.cst$kw$headers,cljs.core.cst$kw$was_DASH_aborted], 0));
if(cljs.core.record_QMARK_(G__18760)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__18776);
} else {
return G__18776;
}
})();
return (new ajax.protocols.Response(cljs.core.cst$kw$status.cljs$core$IFn$_invoke$arity$1(G__18760),cljs.core.cst$kw$body.cljs$core$IFn$_invoke$arity$1(G__18760),cljs.core.cst$kw$status_DASH_text.cljs$core$IFn$_invoke$arity$1(G__18760),cljs.core.cst$kw$headers.cljs$core$IFn$_invoke$arity$1(G__18760),cljs.core.cst$kw$was_DASH_aborted.cljs$core$IFn$_invoke$arity$1(G__18760),null,cljs.core.not_empty(extmap__4236__auto__),null));
});
