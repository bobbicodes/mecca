...
return html_coll.item(p1__14439_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__14440_SHARP_);
...
var ctx_14441 = cvs.getContext("2d");
ctx_14441.fillStyle = color;

ctx_14441.fillRect((0),(0),size,size);
