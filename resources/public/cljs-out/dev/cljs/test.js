...
return cljs.core.assoc.call(null,G__14786,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__14786;
}
});
...
var len__4531__auto___14791 = arguments.length;
var i__4532__auto___14792 = (0);
while(true){
if((i__4532__auto___14792 < len__4531__auto___14791)){
args__4534__auto__.push((arguments[i__4532__auto___14792]));

var G__14793 = (i__4532__auto___14792 + (1));
i__4532__auto___14792 = G__14793;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq14788){
var G__14789 = cljs.core.first.call(null,seq14788);
var seq14788__$1 = cljs.core.next.call(null,seq14788);
var G__14790 = cljs.core.first.call(null,seq14788__$1);
var seq14788__$2 = cljs.core.next.call(null,seq14788__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14789,G__14790,seq14788__$2);
});
...
var map__14795 = m;
var map__14795__$1 = ((((!((map__14795 == null)))?(((((map__14795.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14795.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14795):map__14795);
var file = cljs.core.get.call(null,map__14795__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__14795__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__14795__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__14795,map__14795__$1,file,line,column){
return (function (p1__14794_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__14794_SHARP_));
});})(map__14795,map__14795__$1,file,line,column))
...
var temp__5457__auto___14797 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___14797)){
var message_14798 = temp__5457__auto___14797;
cljs.core.println.call(null,message_14798);
} else {
}
...
var output_dir__$1 = (function (){var G__14801 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14801),"/"].join('');
} else {
return G__14801;
}
})();
...
var G__14803 = exception.stack;
var G__14803__$1 = (((G__14803 == null))?null:clojure.string.split_lines.call(null,G__14803));
var G__14803__$2 = (((G__14803__$1 == null))?null:cljs.core.get.call(null,G__14803__$1,depth));
if((G__14803__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__14803__$2);
}
} else {
...
var vec__14804 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__14804,(0),null);
var column = cljs.core.nth.call(null,vec__14804,(1),null);
var vec__14807 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__14807,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__14807,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__14807,(2),null);
...
var m__$1 = (function (){var G__14810 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__14814 = (function (){var G__14813 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__14813);
} else {
return G__14813;
}
})();
...
return cljs.core.vary_meta.call(null,G__14815,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__14819 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__14819,(0),null);
var types = vec__14819;
...
return cljs.core.map.call(null,(function (p__14822){
var vec__14823 = p__14822;
var ns = cljs.core.nth.call(null,vec__14823,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__14823,(1),null);
return ((function (vec__14823,ns,vars__$1){
return (function (){
...
var G__14826 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__14826,G__14826__$1,env,once_fixtures,each_fixtures,vec__14823,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__14826,G__14826__$1,env,once_fixtures,each_fixtures,vec__14823,ns,vars__$1){
return (function (){
var seq__14827 = cljs.core.seq.call(null,vars__$1);
var chunk__14828 = null;
var count__14829 = (0);
var i__14830 = (0);
while(true){
if((i__14830 < count__14829)){
var v = cljs.core._nth.call(null,chunk__14828,i__14830);
var temp__5457__auto___14832 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___14832)){
var t_14833 = temp__5457__auto___14832;
each_fixture_fn.call(null,((function (seq__14827,chunk__14828,count__14829,i__14830,t_14833,temp__5457__auto___14832,v,each_fixture_fn,G__14826,G__14826__$1,env,once_fixtures,each_fixtures,vec__14823,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14833)));
});})(seq__14827,chunk__14828,count__14829,i__14830,t_14833,temp__5457__auto___14832,v,each_fixture_fn,G__14826,G__14826__$1,env,once_fixtures,each_fixtures,vec__14823,ns,vars__$1))
);
} else {
}


var G__14834 = seq__14827;
var G__14835 = chunk__14828;
var G__14836 = count__14829;
var G__14837 = (i__14830 + (1));
seq__14827 = G__14834;
chunk__14828 = G__14835;
count__14829 = G__14836;
i__14830 = G__14837;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__14827);
if(temp__5457__auto__){
var seq__14827__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__14827__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__14827__$1);
var G__14838 = cljs.core.chunk_rest.call(null,seq__14827__$1);
var G__14839 = c__4351__auto__;
var G__14840 = cljs.core.count.call(null,c__4351__auto__);
var G__14841 = (0);
seq__14827 = G__14838;
chunk__14828 = G__14839;
count__14829 = G__14840;
i__14830 = G__14841;
continue;
} else {
var v = cljs.core.first.call(null,seq__14827__$1);
var temp__5457__auto___14842__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___14842__$1)){
var t_14843 = temp__5457__auto___14842__$1;
each_fixture_fn.call(null,((function (seq__14827,chunk__14828,count__14829,i__14830,t_14843,temp__5457__auto___14842__$1,v,seq__14827__$1,temp__5457__auto__,each_fixture_fn,G__14826,G__14826__$1,env,once_fixtures,each_fixtures,vec__14823,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14843)));
});})(seq__14827,chunk__14828,count__14829,i__14830,t_14843,temp__5457__auto___14842__$1,v,seq__14827__$1,temp__5457__auto__,each_fixture_fn,G__14826,G__14826__$1,env,once_fixtures,each_fixtures,vec__14823,ns,vars__$1))
);
} else {
}


var G__14844 = cljs.core.next.call(null,seq__14827__$1);
var G__14845 = null;
var G__14846 = (0);
var G__14847 = (0);
seq__14827 = G__14844;
chunk__14828 = G__14845;
count__14829 = G__14846;
i__14830 = G__14847;
continue;
}
} else {
...
});})(each_fixture_fn,G__14826,G__14826__$1,env,once_fixtures,each_fixtures,vec__14823,ns,vars__$1))
);
});})(each_fixture_fn,G__14826,G__14826__$1,env,once_fixtures,each_fixtures,vec__14823,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14826__$1)].join('')));

}
})());
});
;})(vec__14823,ns,vars__$1))
