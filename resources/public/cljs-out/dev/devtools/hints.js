...
var line = cljs.core.get.call(null,map__26212__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__26212__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e26211){var _e = e26211;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___26214 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___26214)){
var seen_errors_26215 = temp__5455__auto___26214;
if(cljs.core.truth_(seen_errors_26215.has(self))){
} else {
seen_errors_26215.add(self);

var temp__5457__auto___26216 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___26216)){
var sense_26217 = temp__5457__auto___26216;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_26217)].join('');
} else {
}
}
} else {
