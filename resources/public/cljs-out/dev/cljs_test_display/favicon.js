...
return cljs.core.map.call(null,(function (p1__21804_SHARP_){
return html_coll.item(p1__21804_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__21805_SHARP_);
...
var ctx_21806 = cvs.getContext("2d");
ctx_21806.fillStyle = color;

ctx_21806.fillRect((0),(0),size,size);
