...
if((i < len)){
var k = (ks[i]);
var G__40572 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__40573 = (i + (1));
m = G__40572;
i = G__40573;
continue;
...
var temp__5737__auto__ = (p["argv"]);
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__40460 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__40460);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__40531 = c;
var G__40531__$1 = (((G__40531 == null))?null:G__40531.prototype);
if((G__40531__$1 == null)){
return null;
} else {
return (G__40531__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__40536 = c;
var G__40536__$1 = (((G__40536 == null))?null:G__40536.prototype);
if((G__40536__$1 == null)){
return null;
} else {
return (G__40536__$1["render"]);
}
})() == null)))));
});
...
var G__40541 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__40541) : reagent.impl.component.as_element.call(null,G__40541));
};
...
var _STAR_current_component_STAR__orig_val__40542 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__40543 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__40543);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__40542);
}});
...
var c = this;
var G__40547_40585 = (c["cljsRatom"]);
if((G__40547_40585 == null)){
} else {
reagent.ratom.dispose_BANG_(G__40547_40585);
}
...
var renders_40597 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_40598 = cljs.core.first(cljs.core.vals(renders_40597));
if((cljs.core.count(renders_40597) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_40597))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_40598)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_40598], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__40548 = name;
switch (G__40548) {
case "":
...
var G__40550 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__40550);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__40551 = fiber;
var G__40551__$1 = (((G__40551 == null))?null:(G__40551["type"]));
if((G__40551__$1 == null)){
return null;
} else {
return (G__40551__$1["displayName"]);
}
})();
var parent = (function (){var G__40552 = fiber;
if((G__40552 == null)){
return null;
} else {
return (G__40552["return"]);
}
})();
var path = (function (){var G__40553 = parent;
var G__40553__$1 = (((G__40553 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__40553) : reagent.impl.component.fiber_component_path.call(null,G__40553)));
if((G__40553__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__40553__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__40555 = c;
if((G__40555 == null)){
return null;
} else {
return (G__40555["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__40556._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__40558 = c;
if((G__40558 == null)){
return null;
} else {
return (G__40558["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__40560 = c;
if((G__40560 == null)){
return null;
} else {
return G__40560._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4185__auto__ = (function (){var G__40562 = instance;
if((G__40562 == null)){
return null;
} else {
return (G__40562["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__40563 = instance;
if((G__40563 == null)){
return null;
} else {
return G__40563._currentElement;
}
}
})();
var name = (function (){var G__40564 = elem;
var G__40564__$1 = (((G__40564 == null))?null:(G__40564["type"]));
if((G__40564__$1 == null)){
return null;
} else {
return (G__40564__$1["displayName"]);
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__40566 = elem;
if((G__40566 == null)){
return null;
} else {
return (G__40566["_owner"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__40567._owner;
}
}
})();
var path = (function (){var G__40568 = owner;
var G__40568__$1 = (((G__40568 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__40568) : reagent.impl.component.component_path.call(null,G__40568)));
if((G__40568__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__40568__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__40569 = c;
var G__40569__$1 = (((G__40569 == null))?null:G__40569.constructor);
if((G__40569__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__40569__$1);
}
}
})();
