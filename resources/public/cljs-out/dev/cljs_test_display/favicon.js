...
return cljs.core.map.call(null,(function (p1__21968_SHARP_){
return html_coll.item(p1__21968_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__21969_SHARP_);
...
var ctx_21970 = cvs.getContext("2d");
ctx_21970.fillStyle = color;

ctx_21970.fillRect((0),(0),size,size);
