...
var G__21895 = devtools.prefs.pref.call(null,v);
v = G__21895;
continue;
} else {
return v;
...
}catch (e21898){var _e__21149__auto__ = e21898;
return false;
}})();
...
}catch (e21902){var _e__21149__auto__ = e21902;
return false;
}})();
...
}catch (e21904){var _e__21149__auto__ = e21904;
return false;
}}
}
});
...
var vec__21906 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21906,(0),null);
var name = cljs.core.nth.call(null,vec__21906,(1),null);
...
return cljs.core.some.call(null,(function (p1__21909_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21909_SHARP_);
}),template);
});
