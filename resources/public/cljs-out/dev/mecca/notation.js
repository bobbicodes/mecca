...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$path,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$transform,["translate(",cljs.core.str.cljs$core$IFn$_invoke$arity$1((0.3 + ((24) * (n - (1))))),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1(6.3),")"].join(''),cljs.core.cst$kw$d,(function (){var G__20644 = n;
switch (G__20644) {
case (0):
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20644)].join('')));
...
mecca.notation.drum_hit = (function mecca$notation$drum_hit(duration,p__20646){
var vec__20647 = p__20646;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20647,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20647,(1),null);
var mouseover_QMARK_ = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false);
return ((function (mouseover_QMARK_,vec__20647,x,y){
return (function (color,p__20650){
var vec__20651 = p__20650;
var x__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20651,(0),null);
var y__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20651,(1),null);
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$on_DASH_mouse_DASH_over,((function (vec__20651,x__$1,y__$1,mouseover_QMARK_,vec__20647,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,true);
});})(vec__20651,x__$1,y__$1,mouseover_QMARK_,vec__20647,x,y))
,cljs.core.cst$kw$on_DASH_mouse_DASH_out,((function (vec__20651,x__$1,y__$1,mouseover_QMARK_,vec__20647,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,false);
});})(vec__20651,x__$1,y__$1,mouseover_QMARK_,vec__20647,x,y))
,cljs.core.cst$kw$on_DASH_click,((function (vec__20651,x__$1,y__$1,mouseover_QMARK_,vec__20647,x,y){
return (function (){
var G__20654 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$remove_DASH_note,x__$1,y__$1], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__20654) : re_frame.core.dispatch.call(null,G__20654));
});})(vec__20651,x__$1,y__$1,mouseover_QMARK_,vec__20647,x,y))
...
;})(mouseover_QMARK_,vec__20647,x,y))
});
mecca.notation.ledger_line = (function mecca$notation$ledger_line(p__20655){
var vec__20656 = p__20655;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20656,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20656,(1),null);
...
mecca.notation.note = (function mecca$notation$note(value,p__20659){
var vec__20660 = p__20659;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20660,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20660,(1),null);
var mouseover_QMARK_ = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false);
return ((function (mouseover_QMARK_,vec__20660,x,y){
return (function (value__$1,p__20663){
var vec__20664 = p__20663;
var x__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20664,(0),null);
var y__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20664,(1),null);
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$on_DASH_mouse_DASH_over,((function (vec__20664,x__$1,y__$1,mouseover_QMARK_,vec__20660,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,true);
});})(vec__20664,x__$1,y__$1,mouseover_QMARK_,vec__20660,x,y))
,cljs.core.cst$kw$on_DASH_mouse_DASH_out,((function (vec__20664,x__$1,y__$1,mouseover_QMARK_,vec__20660,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,false);
});})(vec__20664,x__$1,y__$1,mouseover_QMARK_,vec__20660,x,y))
,cljs.core.cst$kw$on_DASH_click,((function (vec__20664,x__$1,y__$1,mouseover_QMARK_,vec__20660,x,y){
return (function (){
var G__20667 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$remove_DASH_note,x__$1,y__$1], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__20667) : re_frame.core.dispatch.call(null,G__20667));
});})(vec__20664,x__$1,y__$1,mouseover_QMARK_,vec__20660,x,y))
...
;})(mouseover_QMARK_,vec__20660,x,y))
});
...
return cljs.core.chunk_cons(cljs.core.chunk(b__20671),mecca$notation$staff_lines_$_iter__20668(cljs.core.chunk_rest(s__20669__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__20671),null);
}
} else {
var y = cljs.core.first(s__20669__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$line,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$stroke_DASH_dasharray,cljs.core.cst$kw$stroke,cljs.core.cst$kw$stroke_DASH_linejoin,cljs.core.cst$kw$y1,cljs.core.cst$kw$stroke_DASH_linecap,cljs.core.cst$kw$stroke_DASH_width,cljs.core.cst$kw$x1,cljs.core.cst$kw$y2,cljs.core.cst$kw$x2,cljs.core.cst$kw$visibility],[((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.25:null),"black","bevel",y,"butt",((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.06:0.15),(1),y,(63),(((((y > (7))) && (cljs.core.even_QMARK_(y)) && ((y < (42)))))?"visible":"hidden")])], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,y], null)),mecca$notation$staff_lines_$_iter__20668(cljs.core.rest(s__20669__$2)));
}
} else {
return null;
}
