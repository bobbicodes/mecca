...
var G__10595 = o;
(G__10595[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__10599 = o;
(G__10599[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__10604 = props;
var G__10604__$1 = ((((!((id == null))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10604,cljs.core.cst$kw$id,id):G__10604);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10604__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__10605){
var map__10606 = p__10605;
var map__10606__$1 = ((((!((map__10606 == null)))?(((((map__10606.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10606.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10606):map__10606);
var props = map__10606__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10606__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__10606,map__10606__$1,props,class$){
return (function (c){
...
});})(map__10606,map__10606__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10608){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10609__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__10609,map__10609__$1,on_write){
return (function (){
...
});})(node_value,map__10609,map__10609__$1,on_write))
);
} else {
...
var G__10612 = jsprops;
(G__10612["defaultValue"] = value);

(G__10612["onChange"] = ((function (G__10612,v,value,on_change){
return (function (p1__10611_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__10611_SHARP_);
});})(G__10612,v,value,on_change))
);
...
var vec__10615 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10615,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10615,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10615,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___10619 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___10619 == null)){
} else {
var key_10620 = temp__5461__auto___10619;
(jsprops["key"] = key_10620);
}
...
var temp__5461__auto___10621 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___10621 == null)){
} else {
var key_10622 = temp__5461__auto___10621;
reagent.impl.template.oset(jsprops,"key",key_10622);
}
...
var G__10623 = reagent.impl.template.__GT_NativeWrapper();
(G__10623["name"] = c);
...
var G__10624 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__10624) : reagent.impl.template.as_element.call(null,G__10624));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10627){
var G__10628 = cljs.core.first(seq10627);
var seq10627__$1 = cljs.core.next(seq10627);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10628,seq10627__$1);
});
...
var n__4408__auto___10636 = a.length;
var i_10637 = (0);
while(true){
if((i_10637 < n__4408__auto___10636)){
(a[i_10637] = reagent.impl.template.as_element((a[i_10637])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4408__auto___10639 = a.length;
var i_10640 = (0);
while(true){
if((i_10640 < n__4408__auto___10639)){
var val_10641 = (a[i_10640]);
if(((cljs.core.vector_QMARK_(val_10641)) && ((reagent.impl.template.key_from_vec(val_10641) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_10640] = reagent.impl.template.as_element(val_10641));
...
var ctx = ({});
var vec__10643 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10643,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10643,(1),null);
...
var G__10646 = (cljs.core.count(argv) - first_child);
switch (G__10646) {
case (0):
...
case (1):
var G__10647 = comp;
var G__10648 = jsprops;
var G__10649 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__10647,G__10648,G__10649) : reagent.impl.template.global$module$react.createElement.call(null,G__10647,G__10648,G__10649));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__10646){
