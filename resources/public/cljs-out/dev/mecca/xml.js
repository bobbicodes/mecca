...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__21321_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(tag,cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__21321_SHARP_,cljs.core.cst$kw$tag));
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__21322_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(voice,mecca.xml.get_voice(p1__21322_SHARP_));
...
return new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$time,time,cljs.core.cst$kw$pitch,((mecca.xml.pitch__GT_midi(mecca.xml.get_pitch(note)) + (function (){var G__21323 = mecca.xml.get_voice(note);
switch (G__21323) {
case (5):
return (12);
...
})()) + (6)),cljs.core.cst$kw$instrument,(function (){var G__21324 = mecca.xml.get_voice(note);
switch (G__21324) {
case (5):
return (15);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21324)].join('')));
...
var G__21327 = (time + (mecca.xml.get_duration(cljs.core.first(notes)) / (6)));
var G__21328 = cljs.core.rest(notes);
var G__21329 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,mecca.xml.parse_note(cljs.core.first(notes),time));
time = G__21327;
notes = G__21328;
result = G__21329;
continue;
...
return mecca.xml.extract_voice(p1__21330_SHARP_,voice);
});})(time))
...
var G__21331 = (time + (mecca.xml.get_duration(cljs.core.first(notes)) / (6)));
var G__21332 = cljs.core.rest(notes);
var G__21333 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,mecca.xml.parse_note(cljs.core.first(notes),time));
time = G__21331;
notes = G__21332;
result = G__21333;
continue;
