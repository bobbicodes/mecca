...
if((i < len)){
var k = (ks[i]);
var G__35990 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__35991 = (i + (1));
m = G__35990;
i = G__35991;
continue;
...
var temp__5737__auto__ = (p["argv"]);
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__35873 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__35873);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35875 = c;
var G__35875__$1 = (((G__35875 == null))?null:G__35875.prototype);
if((G__35875__$1 == null)){
return null;
} else {
return (G__35875__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35882 = c;
var G__35882__$1 = (((G__35882 == null))?null:G__35882.prototype);
if((G__35882__$1 == null)){
return null;
} else {
return (G__35882__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__36249__delegate = function (args){
var G__35886 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__35886) : reagent.impl.component.as_element.call(null,G__35886));
};
...
while (G__36250__i < G__36250__a.length) {G__36250__a[G__36250__i] = arguments[G__36250__i + 0]; ++G__36250__i;}
  args = new cljs.core.IndexedSeq(G__36250__a,0,null);
} 
return G__36249__delegate.call(this,args);};
G__36249.cljs$lang$maxFixedArity = 0;
G__36249.cljs$lang$applyTo = (function (arglist__36251){
var args = cljs.core.seq(arglist__36251);
return G__36249__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__35890 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__35891 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__35891);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__35890);
}});
...
var c = this;
var G__35914_36332 = (c["cljsRatom"]);
if((G__35914_36332 == null)){
} else {
reagent.ratom.dispose_BANG_(G__35914_36332);
}
...
var renders_36333 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_36334 = cljs.core.first(cljs.core.vals(renders_36333));
if((cljs.core.count(renders_36333) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36333))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36334)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36334], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__35936 = name;
switch (G__35936) {
case "":
...
var G__35941 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__35941);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__35942 = fiber;
var G__35942__$1 = (((G__35942 == null))?null:(G__35942["type"]));
if((G__35942__$1 == null)){
return null;
} else {
return (G__35942__$1["displayName"]);
}
})();
var parent = (function (){var G__35943 = fiber;
if((G__35943 == null)){
return null;
} else {
return (G__35943["return"]);
}
})();
var path = (function (){var G__35944 = parent;
var G__35944__$1 = (((G__35944 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__35944) : reagent.impl.component.fiber_component_path.call(null,G__35944)));
if((G__35944__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35944__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__35946 = c;
if((G__35946 == null)){
return null;
} else {
return (G__35946["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__35947._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__35949 = c;
if((G__35949 == null)){
return null;
} else {
return (G__35949["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__35951 = c;
if((G__35951 == null)){
return null;
} else {
return G__35951._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4185__auto__ = (function (){var G__35953 = instance;
if((G__35953 == null)){
return null;
} else {
return (G__35953["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__35958 = instance;
if((G__35958 == null)){
return null;
} else {
return G__35958._currentElement;
}
}
})();
var name = (function (){var G__35959 = elem;
...
var owner = (function (){var or__4185__auto__ = (function (){var G__35967 = elem;
if((G__35967 == null)){
return null;
} else {
return (G__35967["_owner"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__35974._owner;
}
}
})();
var path = (function (){var G__35975 = owner;
var G__35975__$1 = (((G__35975 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__35975) : reagent.impl.component.component_path.call(null,G__35975)));
if((G__35975__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35975__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__35984 = c;
var G__35984__$1 = (((G__35984 == null))?null:G__35984.constructor);
if((G__35984__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__35984__$1);
}
}
})();
