...
tubax.core.xml__GT_clj.cljs$core$IFn$_invoke$arity$2 = (function (source,p__24041){
var map__24042 = p__24041;
var map__24042__$1 = ((((!((map__24042 == null)))?(((((map__24042.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__24042.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__24042):map__24042);
var strict = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24042__$1,cljs.core.cst$kw$strict,true);
var trim = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24042__$1,cljs.core.cst$kw$trim,true);
var normalize = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24042__$1,cljs.core.cst$kw$normalize,false);
var lowercase = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24042__$1,cljs.core.cst$kw$lowercase,true);
var xmlns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__24042__$1,cljs.core.cst$kw$xmlns);
var position = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24042__$1,cljs.core.cst$kw$position,true);
var strict_entities = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__24042__$1,cljs.core.cst$kw$strict_DASH_entities,false);
...
parser.onopentag = ((function (parser,document,result,map__24042,map__24042__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__24034_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.add_node_document,p1__24034_SHARP_));
});})(parser,document,result,map__24042,map__24042__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.onclosetag = ((function (parser,document,result,map__24042,map__24042__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__24035_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.close_node_document,p1__24035_SHARP_));
});})(parser,document,result,map__24042,map__24042__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.ontext = ((function (parser,document,result,map__24042,map__24042__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__24036_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.add_text,p1__24036_SHARP_));
});})(parser,document,result,map__24042,map__24042__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.oncdata = ((function (parser,document,result,map__24042,map__24042__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__24037_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.add_text,p1__24037_SHARP_));
});})(parser,document,result,map__24042,map__24042__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.onend = ((function (parser,document,result,map__24042,map__24042__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (){
...
parser.onerror = ((function (parser,document,result,map__24042,map__24042__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__24038_SHARP_){
return cljs.core.reset_BANG_(result,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$error,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__24038_SHARP_)].join('')], null));
});})(parser,document,result,map__24042,map__24042__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;
