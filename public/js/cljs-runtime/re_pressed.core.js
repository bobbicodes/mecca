...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("re-pressed.core","add-keyboard-event-listener","re-pressed.core/add-keyboard-event-listener",719500381),(function (_,p__37583){
var vec__37584 = p__37583;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37584,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37584,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("re-pressed.core","set-keydown-rules","re-pressed.core/set-keydown-rules",1002257871),(function (p__37587,p__37588){
...
var map__37593 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37590,(1),null);
...
var event_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37593__$1,new cljs.core.Keyword(null,"event-keys","event-keys",-835966631));
var clear_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37593__$1,new cljs.core.Keyword(null,"clear-keys","clear-keys",-1035470539));
var always_listen_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37593__$1,new cljs.core.Keyword(null,"always-listen-keys","always-listen-keys",497991050));
var prevent_default_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37593__$1,new cljs.core.Keyword(null,"prevent-default-keys","prevent-default-keys",1744205310));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("re-pressed.core","set-keypress-rules","re-pressed.core/set-keypress-rules",1541561860),(function (p__37596,p__37597){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37598__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__37599 = p__37597;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37599,(0),null);
var map__37602 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37599,(1),null);
...
var opts = map__37602__$1;
var event_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37602__$1,new cljs.core.Keyword(null,"event-keys","event-keys",-835966631));
var clear_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37602__$1,new cljs.core.Keyword(null,"clear-keys","clear-keys",-1035470539));
var always_listen_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37602__$1,new cljs.core.Keyword(null,"always-listen-keys","always-listen-keys",497991050));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("re-pressed.core","set-keyup-rules","re-pressed.core/set-keyup-rules",519284589),(function (p__37605,p__37606){
var map__37607 = p__37605;
var map__37607__$1 = (((((!((map__37607 == null))))?(((((map__37607.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__37607.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__37607):map__37607);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37607__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__37608 = p__37606;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37608,(0),null);
var map__37611 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37608,(1),null);
...
var opts = map__37611__$1;
var event_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37611__$1,new cljs.core.Keyword(null,"event-keys","event-keys",-835966631));
var clear_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37611__$1,new cljs.core.Keyword(null,"clear-keys","clear-keys",-1035470539));
var always_listen_keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37611__$1,new cljs.core.Keyword(null,"always-listen-keys","always-listen-keys",497991050));
