...
var len__4531__auto___20964 = arguments.length;
var i__4532__auto___20965 = (0);
while(true){
if((i__4532__auto___20965 < len__4531__auto___20964)){
args__4534__auto__.push((arguments[i__4532__auto___20965]));

var G__20966 = (i__4532__auto___20965 + (1));
i__4532__auto___20965 = G__20966;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq20961){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20962,G__20963,seq20961__$2);
});
...
var id = cljs.core.nth.call(null,vec__20967,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__20967,(1),null);
var G__20970 = cljs.core.PersistentArrayMap.EMPTY;
var G__20970__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__20970,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__20970);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__20970__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__20970__$1;
}
} else {
...
return (function() { 
var G__20974__delegate = function (klass,contents){
var vec__20971 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__20971,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__20971,(1),null);
...
var G__20974 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__20975__i = 0, G__20975__a = new Array(arguments.length -  1);
while (G__20975__i < G__20975__a.length) {G__20975__a[G__20975__i] = arguments[G__20975__i + 1]; ++G__20975__i;}
  contents = new cljs.core.IndexedSeq(G__20975__a,0,null);
} 
return G__20974__delegate.call(this,klass,contents);};
G__20974.cljs$lang$maxFixedArity = 1;
G__20974.cljs$lang$applyTo = (function (arglist__20976){
var klass = cljs.core.first(arglist__20976);
var contents = cljs.core.rest(arglist__20976);
return G__20974__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__20980){
...
var ns = cljs.core.get.call(null,map__20981__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__20981__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
var actual = cljs.core.get.call(null,map__20984__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__20984__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__20986){
var map__20987 = p__20986;
var map__20987__$1 = ((((!((map__20987 == null)))?(((((map__20987.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20987.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20987):map__20987);
var expected = cljs.core.get.call(null,map__20987__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__20987__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__20989_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__20991 = cljs_test_display.core.current_var_info.call(null);
var map__20991__$1 = ((((!((map__20991 == null)))?(((((map__20991.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20991.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20991):map__20991);
var info = map__20991__$1;
var name = cljs.core.get.call(null,map__20991__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__20991__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__20991__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__20991,map__20991__$1,info,name,line,file,node){
return (function (p1__20990_SHARP_){
return cljs.core.cons.call(null,node,p1__20990_SHARP_);
});})(curr_node,map__20991,map__20991__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__20993){
...
var m = map__20994__$1;
var fail = cljs.core.get.call(null,map__20994__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__20994__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__20994__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__20994__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5457__auto___20996 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20996)){
var message_20997 = temp__5457__auto___20996;
cljs.core.println.call(null,message_20997);
} else {
}
...
var temp__5457__auto___20998 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20998)){
var message_20999 = temp__5457__auto___20998;
cljs.core.println.call(null,message_20999);
} else {
}
