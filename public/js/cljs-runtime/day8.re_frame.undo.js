...
var temp__5751__auto__ = cljs.core.seq(clojure.set.difference.cljs$core$IFn$_invoke$arity$2(cljs.core.set(cljs.core.keys(new_config)),cljs.core.set(cljs.core.keys(cljs.core.deref(day8.re_frame.undo.config)))));
if(temp__5751__auto__){
var unknown_keys = temp__5751__auto__;
return re_frame.core.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["re-frame-undo: undo-config! called within unknown keys: ",unknown_keys], 0));
} else {
...
cljs.core.reset_BANG_(day8.re_frame.undo.undo_list,cljs.core.vec(cljs.core.take_last(day8.re_frame.undo.max_undos(),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(day8.re_frame.undo.undo_list),(function (){var fexpr__71201 = new cljs.core.Keyword(null,"harvest-fn","harvest-fn",9140059).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(day8.re_frame.undo.config));
return (fexpr__71201.cljs$core$IFn$_invoke$arity$1 ? fexpr__71201.cljs$core$IFn$_invoke$arity$1(re_frame.db.app_db) : fexpr__71201.call(null,re_frame.db.app_db));
})()))));
...
var G__71221_71240 = cur;
var G__71222_71241 = cljs.core.last(u);
(reinstater.cljs$core$IFn$_invoke$arity$2 ? reinstater.cljs$core$IFn$_invoke$arity$2(G__71221_71240,G__71222_71241) : reinstater.call(null,G__71221_71240,G__71222_71241));
...
day8.re_frame.undo.undo_handler = (function day8$re_frame$undo$undo_handler(_,p__71226){
var vec__71227 = p__71226;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71227,(0),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71227,(1),null);
...
day8.re_frame.undo.undo_n((function (){var or__4223__auto__ = n;
...
var G__71230_71271 = cur;
var G__71231_71272 = cljs.core.first(r);
(reinstater.cljs$core$IFn$_invoke$arity$2 ? reinstater.cljs$core$IFn$_invoke$arity$2(G__71230_71271,G__71231_71272) : reinstater.call(null,G__71230_71271,G__71231_71272));
...
day8.re_frame.undo.redo_handler = (function day8$re_frame$undo$redo_handler(_,p__71232){
var vec__71233 = p__71232;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71233,(0),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__71233,(1),null);
...
day8.re_frame.undo.redo_n((function (){var or__4223__auto__ = n;
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
return (1);
...
if(cljs.core.not(day8.re_frame.undo.redos_QMARK_())){
re_frame.core.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"warn","warn",-436710552),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["re-frame: you did a (dispatch [:purge-redos]), but there is nothing to redo."], 0));
} else {
day8.re_frame.undo.clear_redos_BANG_();
}
...
var explanation__$1 = (((!((undo_effect == null))))?undo_effect:((cljs.core.fn_QMARK_(explanation))?(function (){var G__71238 = re_frame.core.get_coeffect.cljs$core$IFn$_invoke$arity$2(context,new cljs.core.Keyword(null,"db","db",993250759));
var G__71239 = event;
return (explanation.cljs$core$IFn$_invoke$arity$2 ? explanation.cljs$core$IFn$_invoke$arity$2(G__71238,G__71239) : explanation.call(null,G__71238,G__71239));
