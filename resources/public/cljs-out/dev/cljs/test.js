...
var G__14855 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__14855,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__14855;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq14857){
var G__14858 = cljs.core.first.call(null,seq14857);
var seq14857__$1 = cljs.core.next.call(null,seq14857);
var G__14859 = cljs.core.first.call(null,seq14857__$1);
var seq14857__$2 = cljs.core.next.call(null,seq14857__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14858,G__14859,seq14857__$2);
});
...
var file = cljs.core.get.call(null,map__14864__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__14864__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__14864__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__14864,map__14864__$1,file,line,column){
return (function (p1__14863_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__14863_SHARP_));
});})(map__14864,map__14864__$1,file,line,column))
...
var temp__5457__auto___14866 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___14866)){
var message_14867 = temp__5457__auto___14866;
cljs.core.println.call(null,message_14867);
} else {
}
...
var temp__5457__auto___14868 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___14868)){
var message_14869 = temp__5457__auto___14868;
cljs.core.println.call(null,message_14869);
} else {
}
...
var output_dir__$1 = (function (){var G__14870 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14870),"/"].join('');
} else {
return G__14870;
}
})();
...
var G__14872 = exception.stack;
var G__14872__$1 = (((G__14872 == null))?null:clojure.string.split_lines.call(null,G__14872));
var G__14872__$2 = (((G__14872__$1 == null))?null:cljs.core.get.call(null,G__14872__$1,depth));
if((G__14872__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__14872__$2);
}
} else {
...
var vec__14873 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__14873,(0),null);
var column = cljs.core.nth.call(null,vec__14873,(1),null);
var vec__14876 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__14876,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__14876,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__14876,(2),null);
...
var m__$1 = (function (){var G__14879 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__14883 = (function (){var G__14882 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__14882);
} else {
return G__14882;
}
})();
...
return cljs.core.vary_meta.call(null,G__14884,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__14888 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__14888,(0),null);
var types = vec__14888;
...
return cljs.core.map.call(null,(function (p__14891){
var vec__14892 = p__14891;
var ns = cljs.core.nth.call(null,vec__14892,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__14892,(1),null);
return ((function (vec__14892,ns,vars__$1){
return (function (){
...
var G__14895 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__14895__$1 = (((G__14895 instanceof cljs.core.Keyword))?G__14895.fqn:null);
switch (G__14895__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__14895,G__14895__$1,env,once_fixtures,each_fixtures,vec__14892,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__14895,G__14895__$1,env,once_fixtures,each_fixtures,vec__14892,ns,vars__$1){
return (function (){
var seq__14896 = cljs.core.seq.call(null,vars__$1);
var chunk__14897 = null;
var count__14898 = (0);
var i__14899 = (0);
while(true){
if((i__14899 < count__14898)){
var v = cljs.core._nth.call(null,chunk__14897,i__14899);
var temp__5457__auto___14901 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___14901)){
var t_14902 = temp__5457__auto___14901;
each_fixture_fn.call(null,((function (seq__14896,chunk__14897,count__14898,i__14899,t_14902,temp__5457__auto___14901,v,each_fixture_fn,G__14895,G__14895__$1,env,once_fixtures,each_fixtures,vec__14892,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14902)));
});})(seq__14896,chunk__14897,count__14898,i__14899,t_14902,temp__5457__auto___14901,v,each_fixture_fn,G__14895,G__14895__$1,env,once_fixtures,each_fixtures,vec__14892,ns,vars__$1))
);
} else {
}


var G__14903 = seq__14896;
var G__14904 = chunk__14897;
var G__14905 = count__14898;
var G__14906 = (i__14899 + (1));
seq__14896 = G__14903;
chunk__14897 = G__14904;
count__14898 = G__14905;
i__14899 = G__14906;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__14896);
if(temp__5457__auto__){
var seq__14896__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__14896__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__14896__$1);
var G__14907 = cljs.core.chunk_rest.call(null,seq__14896__$1);
var G__14908 = c__4351__auto__;
var G__14909 = cljs.core.count.call(null,c__4351__auto__);
var G__14910 = (0);
seq__14896 = G__14907;
chunk__14897 = G__14908;
count__14898 = G__14909;
i__14899 = G__14910;
continue;
} else {
var v = cljs.core.first.call(null,seq__14896__$1);
var temp__5457__auto___14911__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___14911__$1)){
var t_14912 = temp__5457__auto___14911__$1;
each_fixture_fn.call(null,((function (seq__14896,chunk__14897,count__14898,i__14899,t_14912,temp__5457__auto___14911__$1,v,seq__14896__$1,temp__5457__auto__,each_fixture_fn,G__14895,G__14895__$1,env,once_fixtures,each_fixtures,vec__14892,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14912)));
});})(seq__14896,chunk__14897,count__14898,i__14899,t_14912,temp__5457__auto___14911__$1,v,seq__14896__$1,temp__5457__auto__,each_fixture_fn,G__14895,G__14895__$1,env,once_fixtures,each_fixtures,vec__14892,ns,vars__$1))
);
} else {
}


var G__14913 = cljs.core.next.call(null,seq__14896__$1);
var G__14914 = null;
var G__14915 = (0);
var G__14916 = (0);
seq__14896 = G__14913;
chunk__14897 = G__14914;
count__14898 = G__14915;
i__14899 = G__14916;
continue;
}
} else {
...
});})(each_fixture_fn,G__14895,G__14895__$1,env,once_fixtures,each_fixtures,vec__14892,ns,vars__$1))
);
});})(each_fixture_fn,G__14895,G__14895__$1,env,once_fixtures,each_fixtures,vec__14892,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14895__$1)].join('')));

}
})());
});
;})(vec__14892,ns,vars__$1))
