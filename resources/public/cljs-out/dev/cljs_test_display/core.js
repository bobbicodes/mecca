...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq22022){
var G__22023 = cljs.core.first.call(null,seq22022);
var seq22022__$1 = cljs.core.next.call(null,seq22022);
var G__22024 = cljs.core.first.call(null,seq22022__$1);
var seq22022__$2 = cljs.core.next.call(null,seq22022__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22023,G__22024,seq22022__$2);
});
...
var vec__22028 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__22028,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__22028,(1),null);
var G__22031 = cljs.core.PersistentArrayMap.EMPTY;
var G__22031__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__22031,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22031);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__22031__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__22031__$1;
}
} else {
...
return (function() { 
var G__22035__delegate = function (klass,contents){
var vec__22032 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__22032,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__22032,(1),null);
...
var G__22035 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__22036__i = 0, G__22036__a = new Array(arguments.length -  1);
while (G__22036__i < G__22036__a.length) {G__22036__a[G__22036__i] = arguments[G__22036__i + 1]; ++G__22036__i;}
  contents = new cljs.core.IndexedSeq(G__22036__a,0,null);
} 
return G__22035__delegate.call(this,klass,contents);};
G__22035.cljs$lang$maxFixedArity = 1;
G__22035.cljs$lang$applyTo = (function (arglist__22037){
var klass = cljs.core.first(arglist__22037);
var contents = cljs.core.rest(arglist__22037);
return G__22035__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__22041){
...
var ns = cljs.core.get.call(null,map__22042__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__22042__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__22044){
...
var actual = cljs.core.get.call(null,map__22045__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__22045__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__22047){
...
var expected = cljs.core.get.call(null,map__22048__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__22048__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__22050_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__22052 = cljs_test_display.core.current_var_info.call(null);
...
var info = map__22052__$1;
var name = cljs.core.get.call(null,map__22052__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__22052__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__22052__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__22052,map__22052__$1,info,name,line,file,node){
return (function (p1__22051_SHARP_){
return cljs.core.cons.call(null,node,p1__22051_SHARP_);
});})(curr_node,map__22052,map__22052__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__22054){
...
var m = map__22055__$1;
var fail = cljs.core.get.call(null,map__22055__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__22055__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__22055__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__22055__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5457__auto___22057 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___22057)){
var message_22058 = temp__5457__auto___22057;
cljs.core.println.call(null,message_22058);
} else {
}
...
var temp__5457__auto___22059 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___22059)){
var message_22060 = temp__5457__auto___22059;
cljs.core.println.call(null,message_22060);
} else {
}
