...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__19449 = cljs.core.second(format);
var G__19450 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__19449,G__19450) : ajax.easy.keyword_response_format_element.call(null,G__19449,G__19450));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__19451 = format;
var G__19451__$1 = (((G__19451 instanceof cljs.core.Keyword))?G__19451.fqn:null);
switch (G__19451__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__19453_SHARP_){
return ajax.easy.keyword_response_format_element(p1__19453_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__19454){
var map__19455 = p__19454;
var map__19455__$1 = ((((!((map__19455 == null)))?(((((map__19455.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19455.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__19455):map__19455);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19455__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19455__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19455__$1,cljs.core.cst$kw$finally);
...
return ((function (h,e,map__19455,map__19455__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__19457){
var vec__19458 = p__19457;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19458,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19458,(1),null);
var fexpr__19461_19462 = (cljs.core.truth_(ok)?h:e);
(fexpr__19461_19462.cljs$core$IFn$_invoke$arity$1 ? fexpr__19461_19462.cljs$core$IFn$_invoke$arity$1(result) : fexpr__19461_19462.call(null,result));
...
;})(h,e,map__19455,map__19455__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__19463){
var map__19464 = p__19463;
var map__19464__$1 = ((((!((map__19464 == null)))?(((((map__19464.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19464.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__19464):map__19464);
var opts = map__19464__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19464__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19464__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19464__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19464__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19464__$1,cljs.core.cst$kw$body);
