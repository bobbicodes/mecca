...
var G__14777 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__14777,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__14777;
}
});
...
var len__4531__auto___14782 = arguments.length;
var i__4532__auto___14783 = (0);
while(true){
if((i__4532__auto___14783 < len__4531__auto___14782)){
args__4534__auto__.push((arguments[i__4532__auto___14783]));

var G__14784 = (i__4532__auto___14783 + (1));
i__4532__auto___14783 = G__14784;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq14779){
var G__14780 = cljs.core.first.call(null,seq14779);
var seq14779__$1 = cljs.core.next.call(null,seq14779);
var G__14781 = cljs.core.first.call(null,seq14779__$1);
var seq14779__$2 = cljs.core.next.call(null,seq14779__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14780,G__14781,seq14779__$2);
});
...
var file = cljs.core.get.call(null,map__14786__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__14786__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__14786__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__14786,map__14786__$1,file,line,column){
return (function (p1__14785_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__14785_SHARP_));
});})(map__14786,map__14786__$1,file,line,column))
...
var temp__5457__auto___14788 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___14788)){
var message_14789 = temp__5457__auto___14788;
cljs.core.println.call(null,message_14789);
} else {
}
...
var temp__5457__auto___14790 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___14790)){
var message_14791 = temp__5457__auto___14790;
cljs.core.println.call(null,message_14791);
} else {
}
...
var output_dir__$1 = (function (){var G__14792 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14792),"/"].join('');
} else {
return G__14792;
}
})();
...
var G__14794 = exception.stack;
var G__14794__$1 = (((G__14794 == null))?null:clojure.string.split_lines.call(null,G__14794));
var G__14794__$2 = (((G__14794__$1 == null))?null:cljs.core.get.call(null,G__14794__$1,depth));
if((G__14794__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__14794__$2);
}
} else {
...
var vec__14795 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__14795,(0),null);
var column = cljs.core.nth.call(null,vec__14795,(1),null);
var vec__14798 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__14798,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__14798,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__14798,(2),null);
...
var m__$1 = (function (){var G__14801 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__14805 = (function (){var G__14804 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__14804);
} else {
return G__14804;
}
})();
...
return cljs.core.vary_meta.call(null,G__14806,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__14808 = e;
var G__14808__$1 = (((G__14808 instanceof cljs.core.Keyword))?G__14808.fqn:null);
switch (G__14808__$1) {
...
var vec__14810 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__14810,(0),null);
var types = vec__14810;
...
return cljs.core.map.call(null,(function (p__14813){
var vec__14814 = p__14813;
var ns = cljs.core.nth.call(null,vec__14814,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__14814,(1),null);
return ((function (vec__14814,ns,vars__$1){
return (function (){
...
var G__14817 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__14817,G__14817__$1,env,once_fixtures,each_fixtures,vec__14814,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__14817,G__14817__$1,env,once_fixtures,each_fixtures,vec__14814,ns,vars__$1){
return (function (){
var seq__14818 = cljs.core.seq.call(null,vars__$1);
var chunk__14819 = null;
var count__14820 = (0);
var i__14821 = (0);
while(true){
if((i__14821 < count__14820)){
var v = cljs.core._nth.call(null,chunk__14819,i__14821);
var temp__5457__auto___14823 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___14823)){
var t_14824 = temp__5457__auto___14823;
each_fixture_fn.call(null,((function (seq__14818,chunk__14819,count__14820,i__14821,t_14824,temp__5457__auto___14823,v,each_fixture_fn,G__14817,G__14817__$1,env,once_fixtures,each_fixtures,vec__14814,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14824)));
});})(seq__14818,chunk__14819,count__14820,i__14821,t_14824,temp__5457__auto___14823,v,each_fixture_fn,G__14817,G__14817__$1,env,once_fixtures,each_fixtures,vec__14814,ns,vars__$1))
);
} else {
}
...
var temp__5457__auto__ = cljs.core.seq.call(null,seq__14818);
if(temp__5457__auto__){
var seq__14818__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__14818__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__14818__$1);
var G__14829 = cljs.core.chunk_rest.call(null,seq__14818__$1);
var G__14830 = c__4351__auto__;
var G__14831 = cljs.core.count.call(null,c__4351__auto__);
var G__14832 = (0);
seq__14818 = G__14829;
...
var v = cljs.core.first.call(null,seq__14818__$1);
var temp__5457__auto___14833__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___14833__$1)){
var t_14834 = temp__5457__auto___14833__$1;
each_fixture_fn.call(null,((function (seq__14818,chunk__14819,count__14820,i__14821,t_14834,temp__5457__auto___14833__$1,v,seq__14818__$1,temp__5457__auto__,each_fixture_fn,G__14817,G__14817__$1,env,once_fixtures,each_fixtures,vec__14814,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14834)));
});})(seq__14818,chunk__14819,count__14820,i__14821,t_14834,temp__5457__auto___14833__$1,v,seq__14818__$1,temp__5457__auto__,each_fixture_fn,G__14817,G__14817__$1,env,once_fixtures,each_fixtures,vec__14814,ns,vars__$1))
);
} else {
}


var G__14835 = cljs.core.next.call(null,seq__14818__$1);
var G__14836 = null;
var G__14837 = (0);
var G__14838 = (0);
seq__14818 = G__14835;
chunk__14819 = G__14836;
count__14820 = G__14837;
i__14821 = G__14838;
continue;
}
} else {
...
});})(each_fixture_fn,G__14817,G__14817__$1,env,once_fixtures,each_fixtures,vec__14814,ns,vars__$1))
);
});})(each_fixture_fn,G__14817,G__14817__$1,env,once_fixtures,each_fixtures,vec__14814,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14817__$1)].join('')));

}
})());
});
;})(vec__14814,ns,vars__$1))
