...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__13673 = cljs.core.second(format);
var G__13674 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__13673,G__13674) : ajax.easy.keyword_response_format_element.call(null,G__13673,G__13674));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__13675 = format;
var G__13675__$1 = (((G__13675 instanceof cljs.core.Keyword))?G__13675.fqn:null);
switch (G__13675__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__13677_SHARP_){
return ajax.easy.keyword_response_format_element(p1__13677_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__13678){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13679__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13679__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13679__$1,cljs.core.cst$kw$finally);
...
return ((function (h,e,map__13679,map__13679__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__13681){
var vec__13682 = p__13681;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13682,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13682,(1),null);
var fexpr__13685_13686 = (cljs.core.truth_(ok)?h:e);
(fexpr__13685_13686.cljs$core$IFn$_invoke$arity$1 ? fexpr__13685_13686.cljs$core$IFn$_invoke$arity$1(result) : fexpr__13685_13686.call(null,result));
...
;})(h,e,map__13679,map__13679__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__13687){
...
var opts = map__13688__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13688__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13688__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13688__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13688__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13688__$1,cljs.core.cst$kw$body);
