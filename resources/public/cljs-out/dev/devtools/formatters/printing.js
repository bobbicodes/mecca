...
var len__4531__auto___23369 = arguments.length;
var i__4532__auto___23370 = (0);
while(true){
if((i__4532__auto___23370 < len__4531__auto___23369)){
args__4534__auto__.push((arguments[i__4532__auto___23370]));

var G__23371 = (i__4532__auto___23370 + (1));
i__4532__auto___23370 = G__23371;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23366){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23367,G__23368,seq23366__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23372_SHARP_){
return !((cljs.core.meta.call(null,p1__23372_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__23373__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23377){var _e__22132__auto__ = e23377;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e23379){var _e__22132__auto__ = e23379;
return false;
}}
})())){
...
var _STAR_current_state_STAR_23381 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__23382 = opts;
var map__23382__$1 = ((((!((map__23382 == null)))?(((((map__23382.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23382.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23382):map__23382);
var markup_db = cljs.core.get.call(null,map__23382__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_23381;
}});
...
;
var temp__5455__auto___23386 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___23386)){
var managed_print_level_23387 = temp__5455__auto___23386;
var _STAR_print_level_STAR_23385_23388 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_23387;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_23385_23388,managed_print_level_23387,temp__5455__auto___23386,writer,opts,job_fn){
return (function (p1__23384_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__23384_SHARP_,null);
});})(_STAR_print_level_STAR_23385_23388,managed_print_level_23387,temp__5455__auto___23386,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_23385_23388;
}} else {
job_fn.call(null);
}
