...
var len__4531__auto___15304 = arguments.length;
var i__4532__auto___15305 = (0);
while(true){
if((i__4532__auto___15305 < len__4531__auto___15304)){
args__4534__auto__.push((arguments[i__4532__auto___15305]));

var G__15306 = (i__4532__auto___15305 + (1));
i__4532__auto___15305 = G__15306;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq15301){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15302,G__15303,seq15301__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__15307_SHARP_){
return !((cljs.core.meta.call(null,p1__15307_SHARP_) == null));
})))){
...
var map__15308 = opts;
var map__15308__$1 = ((((!((map__15308 == null)))?(((((map__15308.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15308.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15308):map__15308);
var markup_db = cljs.core.get.call(null,map__15308__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e15312){var _e__14512__auto__ = e15312;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e15314){var _e__14512__auto__ = e15314;
return false;
}}
})())){
...
var _STAR_current_state_STAR_15316 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__15317 = opts;
...
var markup_db = cljs.core.get.call(null,map__15317__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_15316;
}});
...
;
var temp__5455__auto___15321 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___15321)){
var managed_print_level_15322 = temp__5455__auto___15321;
var _STAR_print_level_STAR_15320_15323 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_15322;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_15320_15323,managed_print_level_15322,temp__5455__auto___15321,writer,opts,job_fn){
return (function (p1__15319_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__15319_SHARP_,null);
});})(_STAR_print_level_STAR_15320_15323,managed_print_level_15322,temp__5455__auto___15321,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_15320_15323;
}} else {
job_fn.call(null);
}
