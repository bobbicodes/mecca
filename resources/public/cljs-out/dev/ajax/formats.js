...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__13632){
var map__13633 = p__13632;
var map__13633__$1 = ((((!((map__13633 == null)))?(((((map__13633.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__13633.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__13633):map__13633);
var request = map__13633__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13633__$1,cljs.core.cst$kw$response_DASH_format);
...
var format = ajax.formats.get_default_format(response,request);
var fexpr__13638 = cljs.core.cst$kw$read.cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__13638.cljs$core$IFn$_invoke$arity$1 ? fexpr__13638.cljs$core$IFn$_invoke$arity$1(response) : fexpr__13638.call(null,response));
});
});

ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2;

ajax.formats.accept_header = (function ajax$formats$accept_header(p__13640){
