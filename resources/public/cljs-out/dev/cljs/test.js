...
return cljs.core.assoc.call(null,G__21102,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__21102;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq21104){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21105,G__21106,seq21104__$2);
});
...
var map__21111 = m;
var map__21111__$1 = ((((!((map__21111 == null)))?(((((map__21111.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21111.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21111):map__21111);
var file = cljs.core.get.call(null,map__21111__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__21111__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__21111__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__21111,map__21111__$1,file,line,column){
return (function (p1__21110_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__21110_SHARP_));
});})(map__21111,map__21111__$1,file,line,column))
...
var temp__5457__auto___21113 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21113)){
var message_21114 = temp__5457__auto___21113;
cljs.core.println.call(null,message_21114);
} else {
}
...
var temp__5457__auto___21115 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21115)){
var message_21116 = temp__5457__auto___21115;
cljs.core.println.call(null,message_21116);
} else {
}
...
var output_dir__$1 = (function (){var G__21117 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21117),"/"].join('');
} else {
return G__21117;
}
})();
...
var G__21119 = exception.stack;
var G__21119__$1 = (((G__21119 == null))?null:clojure.string.split_lines.call(null,G__21119));
var G__21119__$2 = (((G__21119__$1 == null))?null:cljs.core.get.call(null,G__21119__$1,depth));
if((G__21119__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__21119__$2);
}
} else {
...
var vec__21120 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__21120,(0),null);
var column = cljs.core.nth.call(null,vec__21120,(1),null);
var vec__21123 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__21123,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__21123,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__21123,(2),null);
...
var m__$1 = (function (){var G__21126 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__21130 = (function (){var G__21129 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__21129);
} else {
return G__21129;
}
})();
...
return cljs.core.vary_meta.call(null,G__21131,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__21135 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__21135,(0),null);
var types = vec__21135;
...
return cljs.core.map.call(null,(function (p__21138){
var vec__21139 = p__21138;
var ns = cljs.core.nth.call(null,vec__21139,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__21139,(1),null);
return ((function (vec__21139,ns,vars__$1){
return (function (){
...
var G__21142 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__21142,G__21142__$1,env,once_fixtures,each_fixtures,vec__21139,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__21142,G__21142__$1,env,once_fixtures,each_fixtures,vec__21139,ns,vars__$1){
return (function (){
var seq__21143 = cljs.core.seq.call(null,vars__$1);
var chunk__21144 = null;
var count__21145 = (0);
var i__21146 = (0);
while(true){
if((i__21146 < count__21145)){
var v = cljs.core._nth.call(null,chunk__21144,i__21146);
var temp__5457__auto___21148 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___21148)){
var t_21149 = temp__5457__auto___21148;
each_fixture_fn.call(null,((function (seq__21143,chunk__21144,count__21145,i__21146,t_21149,temp__5457__auto___21148,v,each_fixture_fn,G__21142,G__21142__$1,env,once_fixtures,each_fixtures,vec__21139,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21149)));
});})(seq__21143,chunk__21144,count__21145,i__21146,t_21149,temp__5457__auto___21148,v,each_fixture_fn,G__21142,G__21142__$1,env,once_fixtures,each_fixtures,vec__21139,ns,vars__$1))
);
} else {
}


var G__21150 = seq__21143;
var G__21151 = chunk__21144;
var G__21152 = count__21145;
var G__21153 = (i__21146 + (1));
seq__21143 = G__21150;
chunk__21144 = G__21151;
count__21145 = G__21152;
i__21146 = G__21153;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__21143);
if(temp__5457__auto__){
var seq__21143__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__21143__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__21143__$1);
var G__21154 = cljs.core.chunk_rest.call(null,seq__21143__$1);
var G__21155 = c__4351__auto__;
var G__21156 = cljs.core.count.call(null,c__4351__auto__);
var G__21157 = (0);
seq__21143 = G__21154;
chunk__21144 = G__21155;
count__21145 = G__21156;
i__21146 = G__21157;
continue;
} else {
var v = cljs.core.first.call(null,seq__21143__$1);
var temp__5457__auto___21158__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___21158__$1)){
var t_21159 = temp__5457__auto___21158__$1;
each_fixture_fn.call(null,((function (seq__21143,chunk__21144,count__21145,i__21146,t_21159,temp__5457__auto___21158__$1,v,seq__21143__$1,temp__5457__auto__,each_fixture_fn,G__21142,G__21142__$1,env,once_fixtures,each_fixtures,vec__21139,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21159)));
});})(seq__21143,chunk__21144,count__21145,i__21146,t_21159,temp__5457__auto___21158__$1,v,seq__21143__$1,temp__5457__auto__,each_fixture_fn,G__21142,G__21142__$1,env,once_fixtures,each_fixtures,vec__21139,ns,vars__$1))
);
} else {
}


var G__21160 = cljs.core.next.call(null,seq__21143__$1);
var G__21161 = null;
var G__21162 = (0);
var G__21163 = (0);
seq__21143 = G__21160;
chunk__21144 = G__21161;
count__21145 = G__21162;
i__21146 = G__21163;
continue;
}
} else {
...
});})(each_fixture_fn,G__21142,G__21142__$1,env,once_fixtures,each_fixtures,vec__21139,ns,vars__$1))
);
});})(each_fixture_fn,G__21142,G__21142__$1,env,once_fixtures,each_fixtures,vec__21139,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21142__$1)].join('')));

}
})());
});
;})(vec__21139,ns,vars__$1))
