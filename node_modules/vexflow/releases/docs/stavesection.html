...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">StaveSection</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">StaveModifier</span> </span>{
  ...
  <span class="hljs-keyword">constructor</span>(section, x, shift_y) {
    ...
    <span class="hljs-keyword">this</span>.setAttribute(<span class="hljs-string">'type'</span>, <span class="hljs-string">'StaveSection'</span>);
  ...
  draw(stave, shift_x) {
    <span class="hljs-keyword">const</span> ctx = stave.checkContext();
    ...
    <span class="hljs-keyword">const</span> text_width = ctx.measureText(<span class="hljs-string">''</span> + <span class="hljs-keyword">this</span>.section).width;
    <span class="hljs-keyword">let</span> width = text_width + <span class="hljs-number">6</span>;  <span class="hljs-comment">// add left &amp; right padding</span>
    <span class="hljs-keyword">if</span> (width &lt; <span class="hljs-number">18</span>) width = <span class="hljs-number">18</span>;
    <span class="hljs-keyword">const</span> height = <span class="hljs-number">20</span>;</pre></div>
        ...
        <p> Seems to be a good default y</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">const</span> y = stave.getYForTopText(<span class="hljs-number">3</span>) + <span class="hljs-keyword">this</span>.shift_y;
    <span class="hljs-keyword">let</span> x = <span class="hljs-keyword">this</span>.x + shift_x;
    ctx.beginPath();
    ctx.lineWidth = <span class="hljs-number">2</span>;
