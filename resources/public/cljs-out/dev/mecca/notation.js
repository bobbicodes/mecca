...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$path,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$transform,["translate(",cljs.core.str.cljs$core$IFn$_invoke$arity$1((0.3 + ((24) * (n - (1))))),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1(6.3),")"].join(''),cljs.core.cst$kw$d,(function (){var G__20951 = n;
switch (G__20951) {
case (0):
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20951)].join('')));
...
mecca.notation.drum_hit = (function mecca$notation$drum_hit(duration,p__20953){
var vec__20954 = p__20953;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20954,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20954,(1),null);
var mouseover_QMARK_ = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false);
return ((function (mouseover_QMARK_,vec__20954,x,y){
return (function (color,p__20957){
var vec__20958 = p__20957;
var x__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20958,(0),null);
var y__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20958,(1),null);
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$on_DASH_mouse_DASH_over,((function (vec__20958,x__$1,y__$1,mouseover_QMARK_,vec__20954,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,true);
});})(vec__20958,x__$1,y__$1,mouseover_QMARK_,vec__20954,x,y))
,cljs.core.cst$kw$on_DASH_mouse_DASH_out,((function (vec__20958,x__$1,y__$1,mouseover_QMARK_,vec__20954,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,false);
});})(vec__20958,x__$1,y__$1,mouseover_QMARK_,vec__20954,x,y))
,cljs.core.cst$kw$on_DASH_click,((function (vec__20958,x__$1,y__$1,mouseover_QMARK_,vec__20954,x,y){
return (function (){
var G__20961 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$remove_DASH_note,x__$1,y__$1], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__20961) : re_frame.core.dispatch.call(null,G__20961));
});})(vec__20958,x__$1,y__$1,mouseover_QMARK_,vec__20954,x,y))
...
;})(mouseover_QMARK_,vec__20954,x,y))
});
mecca.notation.ledger_line = (function mecca$notation$ledger_line(p__20962){
var vec__20963 = p__20962;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20963,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20963,(1),null);
...
mecca.notation.note = (function mecca$notation$note(value,p__20966){
var vec__20967 = p__20966;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20967,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20967,(1),null);
var mouseover_QMARK_ = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false);
return ((function (mouseover_QMARK_,vec__20967,x,y){
return (function (value__$1,p__20970){
var vec__20971 = p__20970;
var x__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20971,(0),null);
var y__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20971,(1),null);
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$on_DASH_mouse_DASH_over,((function (vec__20971,x__$1,y__$1,mouseover_QMARK_,vec__20967,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,true);
});})(vec__20971,x__$1,y__$1,mouseover_QMARK_,vec__20967,x,y))
,cljs.core.cst$kw$on_DASH_mouse_DASH_out,((function (vec__20971,x__$1,y__$1,mouseover_QMARK_,vec__20967,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,false);
});})(vec__20971,x__$1,y__$1,mouseover_QMARK_,vec__20967,x,y))
,cljs.core.cst$kw$on_DASH_click,((function (vec__20971,x__$1,y__$1,mouseover_QMARK_,vec__20967,x,y){
return (function (){
var G__20974 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$remove_DASH_note,x__$1,y__$1], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__20974) : re_frame.core.dispatch.call(null,G__20974));
});})(vec__20971,x__$1,y__$1,mouseover_QMARK_,vec__20967,x,y))
...
;})(mouseover_QMARK_,vec__20967,x,y))
});
...
return cljs.core.chunk_cons(cljs.core.chunk(b__20978),mecca$notation$staff_lines_$_iter__20975(cljs.core.chunk_rest(s__20976__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__20978),null);
}
} else {
var y = cljs.core.first(s__20976__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$line,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$stroke_DASH_dasharray,cljs.core.cst$kw$stroke,cljs.core.cst$kw$stroke_DASH_linejoin,cljs.core.cst$kw$y1,cljs.core.cst$kw$stroke_DASH_linecap,cljs.core.cst$kw$stroke_DASH_width,cljs.core.cst$kw$x1,cljs.core.cst$kw$y2,cljs.core.cst$kw$x2,cljs.core.cst$kw$visibility],[((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.25:null),"black","bevel",y,"butt",((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.06:0.15),(1),y,(63),(((((y > (7))) && (cljs.core.even_QMARK_(y)) && ((y < (42)))))?"visible":"hidden")])], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,y], null)),mecca$notation$staff_lines_$_iter__20975(cljs.core.rest(s__20976__$2)));
}
} else {
return null;
}
