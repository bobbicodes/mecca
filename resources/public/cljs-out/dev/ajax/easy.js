...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__19415 = cljs.core.second(format);
var G__19416 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__19415,G__19416) : ajax.easy.keyword_response_format_element.call(null,G__19415,G__19416));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__19419_SHARP_){
return ajax.easy.keyword_response_format_element(p1__19419_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__19420){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19421__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19421__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19421__$1,cljs.core.cst$kw$finally);
...
return ((function (h,e,map__19421,map__19421__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__19423){
var vec__19424 = p__19423;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19424,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19424,(1),null);
var fexpr__19427_19428 = (cljs.core.truth_(ok)?h:e);
(fexpr__19427_19428.cljs$core$IFn$_invoke$arity$1 ? fexpr__19427_19428.cljs$core$IFn$_invoke$arity$1(result) : fexpr__19427_19428.call(null,result));
...
;})(h,e,map__19421,map__19421__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__19429){
...
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19430__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19430__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19430__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19430__$1,cljs.core.cst$kw$body);
