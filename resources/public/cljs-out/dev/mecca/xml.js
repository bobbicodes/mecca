...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(tag,cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__20991_SHARP_,cljs.core.cst$kw$tag));
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__20992_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(voice,mecca.xml.get_voice(p1__20992_SHARP_));
...
return new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$time,time,cljs.core.cst$kw$pitch,((mecca.xml.pitch__GT_midi(mecca.xml.get_pitch(note)) + (function (){var G__20993 = mecca.xml.get_voice(note);
switch (G__20993) {
case (5):
return (12);
...
})()) + (6)),cljs.core.cst$kw$instrument,(function (){var G__20994 = mecca.xml.get_voice(note);
switch (G__20994) {
case (5):
return (15);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20994)].join('')));
...
var G__20997 = (time + (mecca.xml.get_duration(cljs.core.first(notes)) / (6)));
var G__20998 = cljs.core.rest(notes);
var G__20999 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,mecca.xml.parse_note(cljs.core.first(notes),time));
time = G__20997;
notes = G__20998;
result = G__20999;
continue;
...
return mecca.xml.extract_voice(p1__21000_SHARP_,voice);
});})(time))
...
var G__21001 = (time + (mecca.xml.get_duration(cljs.core.first(notes)) / (6)));
var G__21002 = cljs.core.rest(notes);
var G__21003 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,mecca.xml.parse_note(cljs.core.first(notes),time));
time = G__21001;
notes = G__21002;
result = G__21003;
continue;
