...
var G__21120 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__21120,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__21120;
}
});
...
var len__4531__auto___21125 = arguments.length;
var i__4532__auto___21126 = (0);
while(true){
if((i__4532__auto___21126 < len__4531__auto___21125)){
args__4534__auto__.push((arguments[i__4532__auto___21126]));

var G__21127 = (i__4532__auto___21126 + (1));
i__4532__auto___21126 = G__21127;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq21122){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21123,G__21124,seq21122__$2);
});
...
var file = cljs.core.get.call(null,map__21129__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__21129__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__21129__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__21129,map__21129__$1,file,line,column){
return (function (p1__21128_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__21128_SHARP_));
});})(map__21129,map__21129__$1,file,line,column))
...
var temp__5457__auto___21131 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21131)){
var message_21132 = temp__5457__auto___21131;
cljs.core.println.call(null,message_21132);
} else {
}
...
var temp__5457__auto___21133 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21133)){
var message_21134 = temp__5457__auto___21133;
cljs.core.println.call(null,message_21134);
} else {
}
...
var output_dir__$1 = (function (){var G__21135 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21135),"/"].join('');
} else {
return G__21135;
}
})();
...
var G__21137 = exception.stack;
var G__21137__$1 = (((G__21137 == null))?null:clojure.string.split_lines.call(null,G__21137));
var G__21137__$2 = (((G__21137__$1 == null))?null:cljs.core.get.call(null,G__21137__$1,depth));
if((G__21137__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__21137__$2);
}
} else {
...
var vec__21138 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__21138,(0),null);
var column = cljs.core.nth.call(null,vec__21138,(1),null);
var vec__21141 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__21141,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__21141,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__21141,(2),null);
...
var m__$1 = (function (){var G__21144 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__21144__$1 = (((G__21144 instanceof cljs.core.Keyword))?G__21144.fqn:null);
switch (G__21144__$1) {
case "fail":
...
var G__21148 = (function (){var G__21147 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__21147);
} else {
return G__21147;
}
})();
...
return cljs.core.vary_meta.call(null,G__21149,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__21153 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__21153,(0),null);
var types = vec__21153;
...
return cljs.core.map.call(null,(function (p__21156){
var vec__21157 = p__21156;
var ns = cljs.core.nth.call(null,vec__21157,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__21157,(1),null);
return ((function (vec__21157,ns,vars__$1){
return (function (){
...
var G__21160 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__21160,G__21160__$1,env,once_fixtures,each_fixtures,vec__21157,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__21160,G__21160__$1,env,once_fixtures,each_fixtures,vec__21157,ns,vars__$1){
return (function (){
var seq__21161 = cljs.core.seq.call(null,vars__$1);
var chunk__21162 = null;
var count__21163 = (0);
var i__21164 = (0);
while(true){
if((i__21164 < count__21163)){
var v = cljs.core._nth.call(null,chunk__21162,i__21164);
var temp__5457__auto___21166 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___21166)){
var t_21167 = temp__5457__auto___21166;
each_fixture_fn.call(null,((function (seq__21161,chunk__21162,count__21163,i__21164,t_21167,temp__5457__auto___21166,v,each_fixture_fn,G__21160,G__21160__$1,env,once_fixtures,each_fixtures,vec__21157,ns,vars__$1){
return (function (){
...
});})(seq__21161,chunk__21162,count__21163,i__21164,t_21167,temp__5457__auto___21166,v,each_fixture_fn,G__21160,G__21160__$1,env,once_fixtures,each_fixtures,vec__21157,ns,vars__$1))
);
} else {
}


var G__21168 = seq__21161;
var G__21169 = chunk__21162;
var G__21170 = count__21163;
var G__21171 = (i__21164 + (1));
seq__21161 = G__21168;
chunk__21162 = G__21169;
count__21163 = G__21170;
i__21164 = G__21171;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__21161);
if(temp__5457__auto__){
var seq__21161__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__21161__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__21161__$1);
var G__21172 = cljs.core.chunk_rest.call(null,seq__21161__$1);
var G__21173 = c__4351__auto__;
var G__21174 = cljs.core.count.call(null,c__4351__auto__);
var G__21175 = (0);
seq__21161 = G__21172;
chunk__21162 = G__21173;
count__21163 = G__21174;
i__21164 = G__21175;
continue;
} else {
var v = cljs.core.first.call(null,seq__21161__$1);
var temp__5457__auto___21176__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___21176__$1)){
var t_21177 = temp__5457__auto___21176__$1;
each_fixture_fn.call(null,((function (seq__21161,chunk__21162,count__21163,i__21164,t_21177,temp__5457__auto___21176__$1,v,seq__21161__$1,temp__5457__auto__,each_fixture_fn,G__21160,G__21160__$1,env,once_fixtures,each_fixtures,vec__21157,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21177)));
});})(seq__21161,chunk__21162,count__21163,i__21164,t_21177,temp__5457__auto___21176__$1,v,seq__21161__$1,temp__5457__auto__,each_fixture_fn,G__21160,G__21160__$1,env,once_fixtures,each_fixtures,vec__21157,ns,vars__$1))
);
} else {
}


var G__21178 = cljs.core.next.call(null,seq__21161__$1);
var G__21179 = null;
var G__21180 = (0);
var G__21181 = (0);
seq__21161 = G__21178;
chunk__21162 = G__21179;
count__21163 = G__21180;
i__21164 = G__21181;
continue;
}
} else {
...
});})(each_fixture_fn,G__21160,G__21160__$1,env,once_fixtures,each_fixtures,vec__21157,ns,vars__$1))
);
});})(each_fixture_fn,G__21160,G__21160__$1,env,once_fixtures,each_fixtures,vec__21157,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21160__$1)].join('')));

}
})());
});
;})(vec__21157,ns,vars__$1))
