...
var G__10744 = o;
(G__10744[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__10746__i < G__10746__a.length) {G__10746__a[G__10746__i] = arguments[G__10746__i + 0]; ++G__10746__i;}
  args = new cljs.core.IndexedSeq(G__10746__a,0,null);
} 
...
var G__10748 = o;
(G__10748[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var args = null;
if (arguments.length > 0) {
var G__10750__i = 0, G__10750__a = new Array(arguments.length -  0);
while (G__10750__i < G__10750__a.length) {G__10750__a[G__10750__i] = arguments[G__10750__i + 0]; ++G__10750__i;}
  args = new cljs.core.IndexedSeq(G__10750__a,0,null);
} 
...
return G__10749__delegate(args);
});
...
var G__10753 = props;
var G__10753__$1 = ((((!((id == null))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10753,cljs.core.cst$kw$id,id):G__10753);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10753__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__10754){
...
var props = map__10755__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10755__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__10755,map__10755__$1,props,class$){
return (function (c){
...
});})(map__10755,map__10755__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10757){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10758__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__10758,map__10758__$1,on_write){
return (function (){
...
});})(node_value,map__10758,map__10758__$1,on_write))
);
} else {
...
(G__10761["defaultValue"] = value);

(G__10761["onChange"] = ((function (G__10761,v,value,on_change){
return (function (p1__10760_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__10760_SHARP_);
});})(G__10761,v,value,on_change))
);
...
var jsprops = ({"argv": v});
var temp__5461__auto___10768 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___10768 == null)){
} else {
var key_10769 = temp__5461__auto___10768;
(jsprops["key"] = key_10769);
}
...
var temp__5461__auto___10770 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___10770 == null)){
} else {
var key_10771 = temp__5461__auto___10770;
reagent.impl.template.oset(jsprops,"key",key_10771);
}
...
var G__10772 = reagent.impl.template.__GT_NativeWrapper();
(G__10772["name"] = c);
...
var G__10773 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__10773) : reagent.impl.template.as_element.call(null,G__10773));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10776){
var G__10777 = cljs.core.first(seq10776);
var seq10776__$1 = cljs.core.next(seq10776);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10777,seq10776__$1);
});
...
break;
default:
var G__10783 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__10783;
continue;
...
var n__4408__auto___10785 = a.length;
var i_10786 = (0);
while(true){
if((i_10786 < n__4408__auto___10785)){
(a[i_10786] = reagent.impl.template.as_element((a[i_10786])));

var G__10787 = (i_10786 + (1));
i_10786 = G__10787;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4408__auto___10788 = a.length;
var i_10789 = (0);
while(true){
if((i_10789 < n__4408__auto___10788)){
var val_10790 = (a[i_10789]);
if(((cljs.core.vector_QMARK_(val_10790)) && ((reagent.impl.template.key_from_vec(val_10790) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_10789] = reagent.impl.template.as_element(val_10790));

var G__10791 = (i_10789 + (1));
i_10789 = G__10791;
continue;
} else {
}
...
var ctx = ({});
var vec__10792 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10792,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10792,(1),null);
...
var G__10795 = (cljs.core.count(argv) - first_child);
switch (G__10795) {
case (0):
...
case (1):
var G__10796 = comp;
var G__10797 = jsprops;
var G__10798 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__10796,G__10797,G__10798) : reagent.impl.template.global$module$react.createElement.call(null,G__10796,G__10797,G__10798));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__10795){
