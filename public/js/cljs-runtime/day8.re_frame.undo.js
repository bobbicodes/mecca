...
var G__37535 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__37536 = "re-frame-undo: undo-config! called within unknown keys: ";
var G__37537 = unknown_keys;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__37535,G__37536,G__37537) : re_frame.core.console.call(null,G__37535,G__37536,G__37537));
} else {
...
cljs.core.reset_BANG_(day8.re_frame.undo.undo_list,cljs.core.vec(cljs.core.take_last(day8.re_frame.undo.max_undos(),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(day8.re_frame.undo.undo_list),(function (){var fexpr__37544 = new cljs.core.Keyword(null,"harvest-fn","harvest-fn",9140059).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(day8.re_frame.undo.config));
return (fexpr__37544.cljs$core$IFn$_invoke$arity$1 ? fexpr__37544.cljs$core$IFn$_invoke$arity$1(re_frame.db.app_db) : fexpr__37544.call(null,re_frame.db.app_db));
})()))));
...
var G__37566_37657 = cur;
var G__37567_37658 = cljs.core.last(u);
(reinstater.cljs$core$IFn$_invoke$arity$2 ? reinstater.cljs$core$IFn$_invoke$arity$2(G__37566_37657,G__37567_37658) : reinstater.call(null,G__37566_37657,G__37567_37658));
...
day8.re_frame.undo.undo_handler = (function day8$re_frame$undo$undo_handler(_,p__37580){
var vec__37581 = p__37580;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37581,(0),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37581,(1),null);
if(cljs.core.not(day8.re_frame.undo.undos_QMARK_())){
var G__37585_37662 = new cljs.core.Keyword(null,"warn","warn",-436710552);
var G__37586_37663 = "re-frame: you did a (dispatch [:undo]), but there is nothing to undo.";
(re_frame.core.console.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$2(G__37585_37662,G__37586_37663) : re_frame.core.console.call(null,G__37585_37662,G__37586_37663));
} else {
...
var G__37597_37666 = cur;
var G__37598_37667 = cljs.core.first(r);
(reinstater.cljs$core$IFn$_invoke$arity$2 ? reinstater.cljs$core$IFn$_invoke$arity$2(G__37597_37666,G__37598_37667) : reinstater.call(null,G__37597_37666,G__37598_37667));
...
day8.re_frame.undo.redo_handler = (function day8$re_frame$undo$redo_handler(_,p__37614){
var vec__37615 = p__37614;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37615,(0),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37615,(1),null);
if(cljs.core.not(day8.re_frame.undo.redos_QMARK_())){
var G__37618_37677 = new cljs.core.Keyword(null,"warn","warn",-436710552);
var G__37619_37678 = "re-frame: you did a (dispatch [:redo]), but there is nothing to redo.";
(re_frame.core.console.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$2(G__37618_37677,G__37619_37678) : re_frame.core.console.call(null,G__37618_37677,G__37619_37678));
} else {
...
if(cljs.core.not(day8.re_frame.undo.redos_QMARK_())){
var G__37620_37679 = new cljs.core.Keyword(null,"warn","warn",-436710552);
var G__37621_37680 = "re-frame: you did a (dispatch [:purge-redos]), but there is nothing to redo.";
(re_frame.core.console.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$2(G__37620_37679,G__37621_37680) : re_frame.core.console.call(null,G__37620_37679,G__37621_37680));
} else {
day8.re_frame.undo.clear_redos_BANG_();
}
...
var G__37624 = new cljs.core.Keyword(null,"id","id",-1388402092);
var G__37625 = new cljs.core.Keyword(null,"undoable","undoable",303475882);
var G__37626 = new cljs.core.Keyword(null,"after","after",594996914);
var G__37627 = (function (context){
var event = (function (){var G__37628 = context;
var G__37629 = new cljs.core.Keyword(null,"event","event",301435442);
return (re_frame.core.get_coeffect.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.get_coeffect.cljs$core$IFn$_invoke$arity$2(G__37628,G__37629) : re_frame.core.get_coeffect.call(null,G__37628,G__37629));
})();
var undo_effect = (function (){var G__37630 = context;
var G__37631 = new cljs.core.Keyword(null,"undo","undo",-1818036302);
return (re_frame.core.get_effect.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.get_effect.cljs$core$IFn$_invoke$arity$2(G__37630,G__37631) : re_frame.core.get_effect.call(null,G__37630,G__37631));
})();
var explanation__$1 = (((!((undo_effect == null))))?undo_effect:((cljs.core.fn_QMARK_(explanation))?(function (){var G__37632 = (function (){var G__37634 = context;
var G__37635 = new cljs.core.Keyword(null,"db","db",993250759);
return (re_frame.core.get_coeffect.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.get_coeffect.cljs$core$IFn$_invoke$arity$2(G__37634,G__37635) : re_frame.core.get_coeffect.call(null,G__37634,G__37635));
})();
var G__37633 = event;
return (explanation.cljs$core$IFn$_invoke$arity$2 ? explanation.cljs$core$IFn$_invoke$arity$2(G__37632,G__37633) : explanation.call(null,G__37632,G__37633));
})():((typeof explanation === 'string')?explanation:(((explanation == null))?"":(function (){var G__37636 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__37637 = "re-frame-undo: \"undoable\" interceptor on event ";
var G__37638 = event;
var G__37639 = " given a bad parameter. Got: ";
var G__37640 = explanation;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$5 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$5(G__37636,G__37637,G__37638,G__37639,G__37640) : re_frame.core.console.call(null,G__37636,G__37637,G__37638,G__37639,G__37640));
})()
))));
...
return (re_frame.core.__GT_interceptor.cljs$core$IFn$_invoke$arity$4 ? re_frame.core.__GT_interceptor.cljs$core$IFn$_invoke$arity$4(G__37624,G__37625,G__37626,G__37627) : re_frame.core.__GT_interceptor.call(null,G__37624,G__37625,G__37626,G__37627));
}));
