...
var G__13943 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__13943,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__13943;
}
});
...
var len__4531__auto___13948 = arguments.length;
var i__4532__auto___13949 = (0);
while(true){
if((i__4532__auto___13949 < len__4531__auto___13948)){
args__4534__auto__.push((arguments[i__4532__auto___13949]));

var G__13950 = (i__4532__auto___13949 + (1));
i__4532__auto___13949 = G__13950;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq13945){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13946,G__13947,seq13945__$2);
});
...
var file = cljs.core.get.call(null,map__13952__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__13952__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__13952__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__13952,map__13952__$1,file,line,column){
return (function (p1__13951_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__13951_SHARP_));
});})(map__13952,map__13952__$1,file,line,column))
...
var temp__5457__auto___13954 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13954)){
var message_13955 = temp__5457__auto___13954;
cljs.core.println.call(null,message_13955);
} else {
}
...
var temp__5457__auto___13956 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13956)){
var message_13957 = temp__5457__auto___13956;
cljs.core.println.call(null,message_13957);
} else {
}
...
var output_dir__$1 = (function (){var G__13958 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13958),"/"].join('');
} else {
return G__13958;
}
})();
...
var G__13960 = exception.stack;
var G__13960__$1 = (((G__13960 == null))?null:clojure.string.split_lines.call(null,G__13960));
var G__13960__$2 = (((G__13960__$1 == null))?null:cljs.core.get.call(null,G__13960__$1,depth));
if((G__13960__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__13960__$2);
}
} else {
...
var vec__13961 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__13961,(0),null);
var column = cljs.core.nth.call(null,vec__13961,(1),null);
var vec__13964 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__13964,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__13964,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__13964,(2),null);
...
var m__$1 = (function (){var G__13967 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__13967__$1 = (((G__13967 instanceof cljs.core.Keyword))?G__13967.fqn:null);
switch (G__13967__$1) {
case "fail":
...
var G__13971 = (function (){var G__13970 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__13970);
} else {
return G__13970;
}
})();
...
return cljs.core.vary_meta.call(null,G__13972,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e13973){var e = e13973;
var G__13974 = e;
var G__13974__$1 = (((G__13974 instanceof cljs.core.Keyword))?G__13974.fqn:null);
switch (G__13974__$1) {
...
var vec__13976 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__13976,(0),null);
var types = vec__13976;
...
return cljs.core.map.call(null,(function (p__13979){
var vec__13980 = p__13979;
var ns = cljs.core.nth.call(null,vec__13980,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__13980,(1),null);
return ((function (vec__13980,ns,vars__$1){
return (function (){
...
var G__13983 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__13983,G__13983__$1,env,once_fixtures,each_fixtures,vec__13980,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__13983,G__13983__$1,env,once_fixtures,each_fixtures,vec__13980,ns,vars__$1){
return (function (){
var seq__13984 = cljs.core.seq.call(null,vars__$1);
var chunk__13985 = null;
var count__13986 = (0);
var i__13987 = (0);
while(true){
if((i__13987 < count__13986)){
var v = cljs.core._nth.call(null,chunk__13985,i__13987);
var temp__5457__auto___13989 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13989)){
var t_13990 = temp__5457__auto___13989;
each_fixture_fn.call(null,((function (seq__13984,chunk__13985,count__13986,i__13987,t_13990,temp__5457__auto___13989,v,each_fixture_fn,G__13983,G__13983__$1,env,once_fixtures,each_fixtures,vec__13980,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13990)));
});})(seq__13984,chunk__13985,count__13986,i__13987,t_13990,temp__5457__auto___13989,v,each_fixture_fn,G__13983,G__13983__$1,env,once_fixtures,each_fixtures,vec__13980,ns,vars__$1))
);
} else {
}


var G__13991 = seq__13984;
var G__13992 = chunk__13985;
var G__13993 = count__13986;
var G__13994 = (i__13987 + (1));
seq__13984 = G__13991;
chunk__13985 = G__13992;
count__13986 = G__13993;
i__13987 = G__13994;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__13984);
if(temp__5457__auto__){
var seq__13984__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__13984__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__13984__$1);
var G__13995 = cljs.core.chunk_rest.call(null,seq__13984__$1);
var G__13996 = c__4351__auto__;
var G__13997 = cljs.core.count.call(null,c__4351__auto__);
var G__13998 = (0);
seq__13984 = G__13995;
chunk__13985 = G__13996;
count__13986 = G__13997;
i__13987 = G__13998;
continue;
} else {
var v = cljs.core.first.call(null,seq__13984__$1);
var temp__5457__auto___13999__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13999__$1)){
var t_14000 = temp__5457__auto___13999__$1;
each_fixture_fn.call(null,((function (seq__13984,chunk__13985,count__13986,i__13987,t_14000,temp__5457__auto___13999__$1,v,seq__13984__$1,temp__5457__auto__,each_fixture_fn,G__13983,G__13983__$1,env,once_fixtures,each_fixtures,vec__13980,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14000)));
});})(seq__13984,chunk__13985,count__13986,i__13987,t_14000,temp__5457__auto___13999__$1,v,seq__13984__$1,temp__5457__auto__,each_fixture_fn,G__13983,G__13983__$1,env,once_fixtures,each_fixtures,vec__13980,ns,vars__$1))
);
} else {
}


var G__14001 = cljs.core.next.call(null,seq__13984__$1);
var G__14002 = null;
var G__14003 = (0);
var G__14004 = (0);
seq__13984 = G__14001;
chunk__13985 = G__14002;
count__13986 = G__14003;
i__13987 = G__14004;
continue;
}
} else {
...
});})(each_fixture_fn,G__13983,G__13983__$1,env,once_fixtures,each_fixtures,vec__13980,ns,vars__$1))
);
});})(each_fixture_fn,G__13983,G__13983__$1,env,once_fixtures,each_fixtures,vec__13980,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13983__$1)].join('')));

}
})());
});
;})(vec__13980,ns,vars__$1))
