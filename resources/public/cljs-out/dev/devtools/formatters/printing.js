...
var len__4531__auto___16315 = arguments.length;
var i__4532__auto___16316 = (0);
while(true){
if((i__4532__auto___16316 < len__4531__auto___16315)){
args__4534__auto__.push((arguments[i__4532__auto___16316]));

var G__16317 = (i__4532__auto___16316 + (1));
i__4532__auto___16316 = G__16317;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq16312){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16313,G__16314,seq16312__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__16318_SHARP_){
return !((cljs.core.meta.call(null,p1__16318_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__16319__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e16323){var _e__15523__auto__ = e16323;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e16325){var _e__15523__auto__ = e16325;
return false;
}}
})())){
...
var _STAR_current_state_STAR_16327 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__16328 = opts;
var map__16328__$1 = ((((!((map__16328 == null)))?(((((map__16328.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__16328.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__16328):map__16328);
var markup_db = cljs.core.get.call(null,map__16328__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_16327;
}});
...
;
var temp__5455__auto___16332 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___16332)){
var managed_print_level_16333 = temp__5455__auto___16332;
var _STAR_print_level_STAR_16331_16334 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_16333;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_16331_16334,managed_print_level_16333,temp__5455__auto___16332,writer,opts,job_fn){
return (function (p1__16330_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__16330_SHARP_,null);
});})(_STAR_print_level_STAR_16331_16334,managed_print_level_16333,temp__5455__auto___16332,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_16331_16334;
}} else {
job_fn.call(null);
}
