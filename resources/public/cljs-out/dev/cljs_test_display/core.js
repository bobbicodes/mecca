...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq21024){
var G__21025 = cljs.core.first.call(null,seq21024);
var seq21024__$1 = cljs.core.next.call(null,seq21024);
var G__21026 = cljs.core.first.call(null,seq21024__$1);
var seq21024__$2 = cljs.core.next.call(null,seq21024__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21025,G__21026,seq21024__$2);
});
...
var vec__21030 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__21030,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__21030,(1),null);
var G__21033 = cljs.core.PersistentArrayMap.EMPTY;
var G__21033__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__21033,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21033);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__21033__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__21033__$1;
}
} else {
...
return (function() { 
var G__21037__delegate = function (klass,contents){
var vec__21034 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__21034,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__21034,(1),null);
...
var G__21037 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__21038__i = 0, G__21038__a = new Array(arguments.length -  1);
while (G__21038__i < G__21038__a.length) {G__21038__a[G__21038__i] = arguments[G__21038__i + 1]; ++G__21038__i;}
  contents = new cljs.core.IndexedSeq(G__21038__a,0,null);
} 
return G__21037__delegate.call(this,klass,contents);};
G__21037.cljs$lang$maxFixedArity = 1;
G__21037.cljs$lang$applyTo = (function (arglist__21039){
var klass = cljs.core.first(arglist__21039);
var contents = cljs.core.rest(arglist__21039);
return G__21037__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__21043){
...
var ns = cljs.core.get.call(null,map__21044__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__21044__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__21046){
...
var actual = cljs.core.get.call(null,map__21047__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__21047__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__21049){
var map__21050 = p__21049;
var map__21050__$1 = ((((!((map__21050 == null)))?(((((map__21050.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21050.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21050):map__21050);
var expected = cljs.core.get.call(null,map__21050__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__21050__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__21052_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__21054 = cljs_test_display.core.current_var_info.call(null);
...
var info = map__21054__$1;
var name = cljs.core.get.call(null,map__21054__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__21054__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__21054__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__21054,map__21054__$1,info,name,line,file,node){
return (function (p1__21053_SHARP_){
return cljs.core.cons.call(null,node,p1__21053_SHARP_);
});})(curr_node,map__21054,map__21054__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__21056){
...
var m = map__21057__$1;
var fail = cljs.core.get.call(null,map__21057__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__21057__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__21057__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__21057__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5457__auto___21059 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21059)){
var message_21060 = temp__5457__auto___21059;
cljs.core.println.call(null,message_21060);
} else {
}
...
var temp__5457__auto___21061 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21061)){
var message_21062 = temp__5457__auto___21061;
cljs.core.println.call(null,message_21062);
} else {
}
