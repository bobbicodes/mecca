...
var temp__5455__auto____$1 = (o22292["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22293 = temp__5455__auto____$1;
return (o22293["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22112__auto__ = f;
return (o__22112__auto__["toString"]).call(o__22112__auto__);
} else {
return "";
}
}catch (e22294){var _ = e22294;
return "";
}});
...
try{var o__22112__auto___22296 = t;
(o__22112__auto___22296["cljs$lang$ctorPrWriter"]).call(o__22112__auto___22296,t,writer);
}catch (e22295){var __22297 = e22295;
}
...
var char_code = (function (){var o__22112__auto__ = (new String(char$));
return (o__22112__auto__["charCodeAt"]).call(o__22112__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22112__auto__ = String;
return (o__22112__auto__["fromCharCode"]).call(o__22112__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22298 = num_code;
switch (G__22298) {
case (1):
return (185);
...
var o__22112__auto__ = String;
return (o__22112__auto__["fromCharCode"]).call(o__22112__auto__,superscript_code);
});
/**
...
}catch (e22300){var _e__22119__auto__ = e22300;
return false;
}})())){
...
var vec__22301 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22301,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o22304 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22304["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22305 = temp__5455__auto____$1;
return (o22305["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___22312 = arguments.length;
var i__4532__auto___22313 = (0);
while(true){
if((i__4532__auto___22313 < len__4531__auto___22312)){
args__4534__auto__.push((arguments[i__4532__auto___22313]));

var G__22314 = (i__4532__auto___22313 + (1));
i__4532__auto___22313 = G__22314;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22308){
var vec__22309 = p__22308;
var ns_detector = cljs.core.nth.call(null,vec__22309,(0),null);
...
var G__22315 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22316 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22315;
remaining_tokens = G__22316;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22306){
var G__22307 = cljs.core.first.call(null,seq22306);
var seq22306__$1 = cljs.core.next.call(null,seq22306);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22307,seq22306__$1);
});
...
var vec__22320 = cljs.core.split_with.call(null,(function (p1__22319_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22319_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22320,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22320,(1),null);
...
var vec__22323 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22323,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22323,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22326 = cljs.core.rest.call(null,remaining_tokens);
var G__22327 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22326;
name_tokens = G__22327;
continue;
} else {
...
var vec__22330 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22330,(0),null);
var arity = cljs.core.nth.call(null,vec__22330,(1),null);
var vec__22333 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22333,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22333,(1),null);
var vec__22336 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22336,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22336,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22336,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22336,(3),null);
...
var vec__22342 = result;
var munged_ns = cljs.core.nth.call(null,vec__22342,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22342,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22342,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22342,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22342,(4),null);
var arity = cljs.core.nth.call(null,vec__22342,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__22346 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__22346,(0),null);
var args = cljs.core.nth.call(null,vec__22346,(1),null);
var vec__22349 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22349,(0),null);
var name = cljs.core.nth.call(null,vec__22349,(1),null);
...
var G__22352 = (arity + (1));
var G__22353 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22354){
var vec__22355 = p__22354;
var arity = cljs.core.nth.call(null,vec__22355,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22355,(1),null);
...
return cljs.core.get.call(null,arities,p1__22358_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22359_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___22366 = arguments.length;
var i__4532__auto___22367 = (0);
while(true){
if((i__4532__auto___22367 < len__4531__auto___22366)){
args__4534__auto__.push((arguments[i__4532__auto___22367]));

var G__22368 = (i__4532__auto___22367 + (1));
i__4532__auto___22367 = G__22368;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22362){
var vec__22363 = p__22362;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22363,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22360){
...
var map__22371 = options;
var map__22371__$1 = ((((!((map__22371 == null)))?(((((map__22371.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22371.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22371):map__22371);
var include_ns_QMARK_ = cljs.core.get.call(null,map__22371__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22371__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22371__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22371__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22372 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22372,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22372,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22372,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22372,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22372,(4),null);
var arity = cljs.core.nth.call(null,vec__22372,(5),null);
...
var o__22112__auto__ = f;
return (o__22112__auto__["getBasis"]).call(o__22112__auto__);
});
/**
...
}catch (e22376){var _e__22119__auto__ = e22376;
...
var G__22377 = (obj[cljs.core.first.call(null,path)]);
var G__22378 = cljs.core.rest.call(null,path);
obj = G__22377;
path = G__22378;
continue;
} else {
...
return (function (accum,p__22379){
var vec__22380 = p__22379;
var bit = cljs.core.nth.call(null,vec__22380,(0),null);
var protocol = cljs.core.nth.call(null,vec__22380,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22383){
var vec__22384 = p__22383;
var ns = cljs.core.nth.call(null,vec__22384,(0),null);
var name = cljs.core.nth.call(null,vec__22384,(1),null);
var selector = cljs.core.nth.call(null,vec__22384,(2),null);
...
return (function (p__22388){
var vec__22389 = p__22388;
var munged_name = cljs.core.nth.call(null,vec__22389,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22389,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22389,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22387_SHARP_){
return (obj[cljs.core.first.call(null,p1__22387_SHARP_)]);
});})(name,sorted_matches,vec__22389,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
