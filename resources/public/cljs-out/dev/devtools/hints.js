...
var file = cljs.core.get.call(null,map__26108__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__26108__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__26108__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e26107){var _e = e26107;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___26110 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___26110)){
var seen_errors_26111 = temp__5455__auto___26110;
if(cljs.core.truth_(seen_errors_26111.has(self))){
} else {
seen_errors_26111.add(self);

var temp__5457__auto___26112 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___26112)){
var sense_26113 = temp__5457__auto___26112;
