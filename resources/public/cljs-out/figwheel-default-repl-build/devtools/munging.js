...
var o9037 = temp__5718__auto__;
var temp__5718__auto____$1 = (o9037["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o9038 = temp__5718__auto____$1;
return (o9038["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__8149__auto__ = f;
return (o__8149__auto__["toString"]).call(o__8149__auto__);
} else {
return "";
}
}catch (e9039){var _ = e9039;
return "";
}});
...
try{var o__8149__auto___9041 = t;
(o__8149__auto___9041["cljs$lang$ctorPrWriter"]).call(o__8149__auto___9041,t,writer);
}catch (e9040){var __9042 = e9040;
}
...
var char_code = (function (){var o__8149__auto__ = (new String(char$));
return (o__8149__auto__["charCodeAt"]).call(o__8149__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__8149__auto__ = String;
return (o__8149__auto__["fromCharCode"]).call(o__8149__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__9043 = num_code;
switch (G__9043) {
case (1):
return (185);
...
var o__8149__auto__ = String;
return (o__8149__auto__["fromCharCode"]).call(o__8149__auto__,superscript_code);
});
/**
...
}catch (e9045){var _e__8156__auto__ = e9045;
return false;
}})())){
...
var vec__9046 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__9046,(0),null);
...
var or__3949__auto__ = (function (){var temp__5718__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5718__auto__)){
...
var temp__5718__auto____$1 = (o9049["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o9050 = temp__5718__auto____$1;
return (o9050["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__9053){
var vec__9054 = p__9053;
var ns_detector = cljs.core.nth.call(null,vec__9054,(0),null);
...
var G__9060 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__9061 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__9060;
remaining_tokens = G__9061;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq9051){
var G__9052 = cljs.core.first.call(null,seq9051);
var seq9051__$1 = cljs.core.next.call(null,seq9051);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9052,seq9051__$1);
});
...
var vec__9065 = cljs.core.split_with.call(null,(function (p1__9064_SHARP_){
return cljs.core.not_EQ_.call(null,p1__9064_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__9065,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__9065,(1),null);
...
var vec__9068 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__9068,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__9068,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__9071 = cljs.core.rest.call(null,remaining_tokens);
var G__9072 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__9071;
name_tokens = G__9072;
continue;
} else {
...
var vec__9075 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__9075,(0),null);
var arity = cljs.core.nth.call(null,vec__9075,(1),null);
var vec__9078 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__9078,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__9078,(1),null);
var vec__9081 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__9081,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__9081,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__9081,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__9081,(3),null);
...
var vec__9087 = result;
var munged_ns = cljs.core.nth.call(null,vec__9087,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__9087,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__9087,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__9087,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__9087,(4),null);
var arity = cljs.core.nth.call(null,vec__9087,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__9091 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__9091,(0),null);
var args = cljs.core.nth.call(null,vec__9091,(1),null);
var vec__9094 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__9094,(0),null);
var name = cljs.core.nth.call(null,vec__9094,(1),null);
...
var G__9097 = (arity + (1));
var G__9098 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__9099){
var vec__9100 = p__9099;
var arity = cljs.core.nth.call(null,vec__9100,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__9100,(1),null);
...
return cljs.core.get.call(null,arities,p1__9103_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__9104_SHARP_){
return cljs.core.drop.call(null,(2),p1__9104_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___9111 = arguments.length;
var i__4532__auto___9112 = (0);
while(true){
if((i__4532__auto___9112 < len__4531__auto___9111)){
args__4534__auto__.push((arguments[i__4532__auto___9112]));

var G__9113 = (i__4532__auto___9112 + (1));
i__4532__auto___9112 = G__9113;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__9107){
var vec__9108 = p__9107;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__9108,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq9105){
var G__9106 = cljs.core.first.call(null,seq9105);
var seq9105__$1 = cljs.core.next.call(null,seq9105);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9106,seq9105__$1);
});
...
var G__9114 = arg;
var G__9114__$1 = (((G__9114 instanceof cljs.core.Keyword))?G__9114.fqn:null);
switch (G__9114__$1) {
...
var map__9116 = options;
var map__9116__$1 = ((((!((map__9116 == null)))?(((((map__9116.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9116.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9116):map__9116);
var include_ns_QMARK_ = cljs.core.get.call(null,map__9116__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__9116__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__9116__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__9116__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__9117 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__9117,(0),null);
var fn_name = cljs.core.nth.call(null,vec__9117,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__9117,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__9117,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__9117,(4),null);
var arity = cljs.core.nth.call(null,vec__9117,(5),null);
...
var o__8149__auto__ = f;
return (o__8149__auto__["getBasis"]).call(o__8149__auto__);
});
/**
...
}catch (e9121){var _e__8156__auto__ = e9121;
...
var G__9122 = (obj[cljs.core.first.call(null,path)]);
var G__9123 = cljs.core.rest.call(null,path);
obj = G__9122;
path = G__9123;
continue;
} else {
...
return (function (accum,p__9124){
var vec__9125 = p__9124;
var bit = cljs.core.nth.call(null,vec__9125,(0),null);
var protocol = cljs.core.nth.call(null,vec__9125,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__9128){
var vec__9129 = p__9128;
var ns = cljs.core.nth.call(null,vec__9129,(0),null);
var name = cljs.core.nth.call(null,vec__9129,(1),null);
var selector = cljs.core.nth.call(null,vec__9129,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__9134,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__9134,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__9134,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__9132_SHARP_){
return (obj[cljs.core.first.call(null,p1__9132_SHARP_)]);
});})(name,sorted_matches,vec__9134,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
