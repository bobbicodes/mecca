...
var G__22242 = devtools.prefs.pref.call(null,v);
v = G__22242;
continue;
} else {
return v;
...
}catch (e22245){var _e__21059__auto__ = e22245;
return false;
}})();
...
}catch (e22249){var _e__21059__auto__ = e22249;
return false;
}})();
...
}catch (e22251){var _e__21059__auto__ = e22251;
return false;
}}
}
});
...
var vec__22253 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__22253,(0),null);
var name = cljs.core.nth.call(null,vec__22253,(1),null);
...
return cljs.core.some.call(null,(function (p1__22256_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__22256_SHARP_);
}),template);
});
