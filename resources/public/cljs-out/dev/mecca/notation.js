...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$path,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$transform,["translate(",cljs.core.str.cljs$core$IFn$_invoke$arity$1((0.3 + ((24) * (n - (1))))),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1(6.3),")"].join(''),cljs.core.cst$kw$d,(function (){var G__19838 = n;
switch (G__19838) {
case (0):
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19838)].join('')));
...
mecca.notation.drum_hit = (function mecca$notation$drum_hit(duration,p__19840){
var vec__19841 = p__19840;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19841,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19841,(1),null);
var mouseover_QMARK_ = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false);
return ((function (mouseover_QMARK_,vec__19841,x,y){
return (function (color,p__19844){
var vec__19845 = p__19844;
var x__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19845,(0),null);
var y__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19845,(1),null);
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$on_DASH_mouse_DASH_over,((function (vec__19845,x__$1,y__$1,mouseover_QMARK_,vec__19841,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,true);
});})(vec__19845,x__$1,y__$1,mouseover_QMARK_,vec__19841,x,y))
,cljs.core.cst$kw$on_DASH_mouse_DASH_out,((function (vec__19845,x__$1,y__$1,mouseover_QMARK_,vec__19841,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,false);
});})(vec__19845,x__$1,y__$1,mouseover_QMARK_,vec__19841,x,y))
,cljs.core.cst$kw$on_DASH_click,((function (vec__19845,x__$1,y__$1,mouseover_QMARK_,vec__19841,x,y){
return (function (){
var G__19848 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$remove_DASH_note,x__$1,y__$1], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__19848) : re_frame.core.dispatch.call(null,G__19848));
});})(vec__19845,x__$1,y__$1,mouseover_QMARK_,vec__19841,x,y))
...
;})(mouseover_QMARK_,vec__19841,x,y))
});
mecca.notation.ledger_line = (function mecca$notation$ledger_line(p__19849){
var vec__19850 = p__19849;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19850,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19850,(1),null);
...
mecca.notation.note = (function mecca$notation$note(value,p__19853){
var vec__19854 = p__19853;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19854,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19854,(1),null);
var mouseover_QMARK_ = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false);
return ((function (mouseover_QMARK_,vec__19854,x,y){
return (function (value__$1,p__19857){
var vec__19858 = p__19857;
var x__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19858,(0),null);
var y__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19858,(1),null);
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$on_DASH_mouse_DASH_over,((function (vec__19858,x__$1,y__$1,mouseover_QMARK_,vec__19854,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,true);
});})(vec__19858,x__$1,y__$1,mouseover_QMARK_,vec__19854,x,y))
,cljs.core.cst$kw$on_DASH_mouse_DASH_out,((function (vec__19858,x__$1,y__$1,mouseover_QMARK_,vec__19854,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,false);
});})(vec__19858,x__$1,y__$1,mouseover_QMARK_,vec__19854,x,y))
,cljs.core.cst$kw$on_DASH_click,((function (vec__19858,x__$1,y__$1,mouseover_QMARK_,vec__19854,x,y){
return (function (){
var G__19861 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$remove_DASH_note,x__$1,y__$1], null);
...
;})(mouseover_QMARK_,vec__19854,x,y))
});
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g_SHARP_lines,cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4324__auto__ = (function mecca$notation$staff_lines_$_iter__19862(s__19863){
return (new cljs.core.LazySeq(null,(function (){
var s__19863__$1 = s__19863;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__19863__$1);
if(temp__5457__auto__){
var s__19863__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__19863__$2)){
var c__4322__auto__ = cljs.core.chunk_first(s__19863__$2);
var size__4323__auto__ = cljs.core.count(c__4322__auto__);
var b__19865 = cljs.core.chunk_buffer(size__4323__auto__);
if((function (){var i__19864 = (0);
while(true){
if((i__19864 < size__4323__auto__)){
var y = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4322__auto__,i__19864);
cljs.core.chunk_append(b__19865,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$line,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$stroke_DASH_dasharray,cljs.core.cst$kw$stroke,cljs.core.cst$kw$stroke_DASH_linejoin,cljs.core.cst$kw$y1,cljs.core.cst$kw$stroke_DASH_linecap,cljs.core.cst$kw$stroke_DASH_width,cljs.core.cst$kw$x1,cljs.core.cst$kw$y2,cljs.core.cst$kw$x2,cljs.core.cst$kw$visibility],[((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.25:null),"black","bevel",y,"butt",((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.06:0.15),2.25,y,(63),(((((y > (7))) && (cljs.core.even_QMARK_(y)) && ((y < (42)))))?"visible":"hidden")])], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,y], null)));

var G__19866 = (i__19864 + (1));
i__19864 = G__19866;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__19865),mecca$notation$staff_lines_$_iter__19862(cljs.core.chunk_rest(s__19863__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__19865),null);
}
} else {
var y = cljs.core.first(s__19863__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$line,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$stroke_DASH_dasharray,cljs.core.cst$kw$stroke,cljs.core.cst$kw$stroke_DASH_linejoin,cljs.core.cst$kw$y1,cljs.core.cst$kw$stroke_DASH_linecap,cljs.core.cst$kw$stroke_DASH_width,cljs.core.cst$kw$x1,cljs.core.cst$kw$y2,cljs.core.cst$kw$x2,cljs.core.cst$kw$visibility],[((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.25:null),"black","bevel",y,"butt",((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.06:0.15),2.25,y,(63),(((((y > (7))) && (cljs.core.even_QMARK_(y)) && ((y < (42)))))?"visible":"hidden")])], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,y], null)),mecca$notation$staff_lines_$_iter__19862(cljs.core.rest(s__19863__$2)));
}
} else {
return null;
}
