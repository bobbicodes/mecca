...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$path,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$transform,["translate(",cljs.core.str.cljs$core$IFn$_invoke$arity$1((0.3 + ((24) * (n - (1))))),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1(6.3),")"].join(''),cljs.core.cst$kw$d,(function (){var G__23753 = n;
switch (G__23753) {
case (0):
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23753)].join('')));
...
mecca.notation.drum_hit = (function mecca$notation$drum_hit(duration,p__23755){
var vec__23756 = p__23755;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23756,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23756,(1),null);
var mouseover_QMARK_ = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false);
return ((function (mouseover_QMARK_,vec__23756,x,y){
return (function (color,p__23759){
var vec__23760 = p__23759;
var x__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23760,(0),null);
var y__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23760,(1),null);
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$on_DASH_mouse_DASH_over,((function (vec__23760,x__$1,y__$1,mouseover_QMARK_,vec__23756,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,true);
});})(vec__23760,x__$1,y__$1,mouseover_QMARK_,vec__23756,x,y))
,cljs.core.cst$kw$on_DASH_mouse_DASH_out,((function (vec__23760,x__$1,y__$1,mouseover_QMARK_,vec__23756,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,false);
});})(vec__23760,x__$1,y__$1,mouseover_QMARK_,vec__23756,x,y))
,cljs.core.cst$kw$on_DASH_click,((function (vec__23760,x__$1,y__$1,mouseover_QMARK_,vec__23756,x,y){
return (function (){
var G__23763 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$remove_DASH_note,x__$1,y__$1], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__23763) : re_frame.core.dispatch.call(null,G__23763));
});})(vec__23760,x__$1,y__$1,mouseover_QMARK_,vec__23756,x,y))
...
;})(mouseover_QMARK_,vec__23756,x,y))
});
mecca.notation.ledger_line = (function mecca$notation$ledger_line(p__23764){
var vec__23765 = p__23764;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23765,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23765,(1),null);
...
mecca.notation.note = (function mecca$notation$note(value,p__23768){
var vec__23769 = p__23768;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23769,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23769,(1),null);
var mouseover_QMARK_ = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false);
return ((function (mouseover_QMARK_,vec__23769,x,y){
return (function (value__$1,p__23772){
var vec__23773 = p__23772;
var x__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23773,(0),null);
var y__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23773,(1),null);
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$on_DASH_mouse_DASH_over,((function (vec__23773,x__$1,y__$1,mouseover_QMARK_,vec__23769,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,true);
});})(vec__23773,x__$1,y__$1,mouseover_QMARK_,vec__23769,x,y))
,cljs.core.cst$kw$on_DASH_mouse_DASH_out,((function (vec__23773,x__$1,y__$1,mouseover_QMARK_,vec__23769,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,false);
});})(vec__23773,x__$1,y__$1,mouseover_QMARK_,vec__23769,x,y))
,cljs.core.cst$kw$on_DASH_click,((function (vec__23773,x__$1,y__$1,mouseover_QMARK_,vec__23769,x,y){
return (function (){
var G__23776 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$remove_DASH_note,x__$1,y__$1], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__23776) : re_frame.core.dispatch.call(null,G__23776));
});})(vec__23773,x__$1,y__$1,mouseover_QMARK_,vec__23769,x,y))
...
;})(mouseover_QMARK_,vec__23769,x,y))
});
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g_SHARP_lines,cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4324__auto__ = (function mecca$notation$staff_lines_$_iter__23777(s__23778){
return (new cljs.core.LazySeq(null,(function (){
var s__23778__$1 = s__23778;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__23778__$1);
if(temp__5457__auto__){
var s__23778__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__23778__$2)){
var c__4322__auto__ = cljs.core.chunk_first(s__23778__$2);
var size__4323__auto__ = cljs.core.count(c__4322__auto__);
var b__23780 = cljs.core.chunk_buffer(size__4323__auto__);
if((function (){var i__23779 = (0);
while(true){
if((i__23779 < size__4323__auto__)){
var y = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4322__auto__,i__23779);
cljs.core.chunk_append(b__23780,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$line,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$stroke_DASH_dasharray,cljs.core.cst$kw$stroke,cljs.core.cst$kw$stroke_DASH_linejoin,cljs.core.cst$kw$y1,cljs.core.cst$kw$stroke_DASH_linecap,cljs.core.cst$kw$stroke_DASH_width,cljs.core.cst$kw$x1,cljs.core.cst$kw$y2,cljs.core.cst$kw$x2,cljs.core.cst$kw$visibility],[((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.25:null),"black","bevel",y,"butt",((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.06:0.15),(1),y,(63),(((((y > (7))) && (cljs.core.even_QMARK_(y)) && ((y < (42)))))?"visible":"hidden")])], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,y], null)));

var G__23781 = (i__23779 + (1));
i__23779 = G__23781;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__23780),mecca$notation$staff_lines_$_iter__23777(cljs.core.chunk_rest(s__23778__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__23780),null);
}
} else {
var y = cljs.core.first(s__23778__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$line,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$stroke_DASH_dasharray,cljs.core.cst$kw$stroke,cljs.core.cst$kw$stroke_DASH_linejoin,cljs.core.cst$kw$y1,cljs.core.cst$kw$stroke_DASH_linecap,cljs.core.cst$kw$stroke_DASH_width,cljs.core.cst$kw$x1,cljs.core.cst$kw$y2,cljs.core.cst$kw$x2,cljs.core.cst$kw$visibility],[((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.25:null),"black","bevel",y,"butt",((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.06:0.15),(1),y,(63),(((((y > (7))) && (cljs.core.even_QMARK_(y)) && ((y < (42)))))?"visible":"hidden")])], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,y], null)),mecca$notation$staff_lines_$_iter__23777(cljs.core.rest(s__23778__$2)));
}
} else {
return null;
}
