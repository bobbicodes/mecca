...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq15379){
var G__15380 = cljs.core.first.call(null,seq15379);
var seq15379__$1 = cljs.core.next.call(null,seq15379);
var G__15381 = cljs.core.first.call(null,seq15379__$1);
var seq15379__$2 = cljs.core.next.call(null,seq15379__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15380,G__15381,seq15379__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__15385_SHARP_){
return !((cljs.core.meta.call(null,p1__15385_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__15386__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e15390){var _e__14590__auto__ = e15390;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e15392){var _e__14590__auto__ = e15392;
return false;
}}
})())){
...
var _STAR_current_state_STAR_15394 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__15395 = opts;
var map__15395__$1 = ((((!((map__15395 == null)))?(((((map__15395.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15395.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15395):map__15395);
var markup_db = cljs.core.get.call(null,map__15395__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_15394;
}});
...
;
var temp__5455__auto___15399 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___15399)){
var managed_print_level_15400 = temp__5455__auto___15399;
var _STAR_print_level_STAR_15398_15401 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_15400;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_15398_15401,managed_print_level_15400,temp__5455__auto___15399,writer,opts,job_fn){
return (function (p1__15397_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__15397_SHARP_,null);
});})(_STAR_print_level_STAR_15398_15401,managed_print_level_15400,temp__5455__auto___15399,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_15398_15401;
}} else {
job_fn.call(null);
}
