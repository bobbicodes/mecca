...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__21241_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(tag,cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__21241_SHARP_,cljs.core.cst$kw$tag));
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__21242_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(voice,mecca.xml.get_voice(p1__21242_SHARP_));
...
return new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$time,time,cljs.core.cst$kw$pitch,((mecca.xml.pitch__GT_midi(mecca.xml.get_pitch(note)) + (function (){var G__21243 = mecca.xml.get_voice(note);
switch (G__21243) {
case (5):
return (12);
...
})()) + (6)),cljs.core.cst$kw$instrument,(function (){var G__21244 = mecca.xml.get_voice(note);
switch (G__21244) {
case (5):
return (15);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21244)].join('')));
...
var G__21247 = (time + (mecca.xml.get_duration(cljs.core.first(notes)) / (6)));
var G__21248 = cljs.core.rest(notes);
var G__21249 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,mecca.xml.parse_note(cljs.core.first(notes),time));
time = G__21247;
notes = G__21248;
result = G__21249;
continue;
...
return (function (p1__21250_SHARP_){
return mecca.xml.extract_voice(p1__21250_SHARP_,voice);
});})(time))
...
var G__21251 = (time + (mecca.xml.get_duration(cljs.core.first(notes)) / (6)));
var G__21252 = cljs.core.rest(notes);
var G__21253 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,mecca.xml.parse_note(cljs.core.first(notes),time));
time = G__21251;
notes = G__21252;
result = G__21253;
continue;
