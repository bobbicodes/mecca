...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">TabStave</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">Stave</span> </span>{
  <span class="hljs-keyword">constructor</span>(x, y, width, options) {
    <span class="hljs-keyword">const</span> tab_options = {
      <span class="hljs-attr">spacing_between_lines_px</span>: <span class="hljs-number">13</span>,
      <span class="hljs-attr">num_lines</span>: <span class="hljs-number">6</span>,
      <span class="hljs-attr">top_text_position</span>: <span class="hljs-number">1</span>,
    };

    Vex.Merge(tab_options, options);
    <span class="hljs-keyword">super</span>(x, y, width, tab_options);
    <span class="hljs-keyword">this</span>.setAttribute(<span class="hljs-string">'type'</span>, <span class="hljs-string">'TabStave'</span>);
  }
