...
if((i < len)){
var k = (ks[i]);
var G__11868 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__11869 = (i + (1));
m = G__11868;
i = G__11869;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__11870 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__11870) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__11870));
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__11872 = c;
var G__11872__$1 = (((G__11872 == null))?null:G__11872.prototype);
if((G__11872__$1 == null)){
return null;
} else {
return (G__11872__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__11874 = c;
var G__11874__$1 = (((G__11874 == null))?null:G__11874.prototype);
if((G__11874__$1 == null)){
return null;
} else {
return (G__11874__$1["render"]);
}
})() == null))));
});
...
var G__11876 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__11876) : reagent.impl.component.as_element.call(null,G__11876));
};
...
var _STAR_current_component_STAR_11882 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_11882;
}});
...
return ((function (G__11883,G__11883__$1){
...
var c = this;
var G__11888_11890 = (c["cljsRatom"]);
if((G__11888_11890 == null)){
} else {
reagent.ratom.dispose_BANG_(G__11888_11890);
}
...
var renders_11892 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_11893 = cljs.core.first(cljs.core.vals(renders_11892));
if((cljs.core.count(renders_11892) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_11892))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_11893)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_11893], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__11891 = name;
switch (G__11891) {
case "":
...
var G__11896 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__11896) : reagent.impl.component.global$module$create_react_class.call(null,G__11896));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__11897 = fiber;
var G__11897__$1 = (((G__11897 == null))?null:(G__11897["type"]));
if((G__11897__$1 == null)){
return null;
} else {
return (G__11897__$1["displayName"]);
}
})();
var parent = (function (){var G__11898 = fiber;
if((G__11898 == null)){
return null;
} else {
return (G__11898["return"]);
}
})();
var path = (function (){var G__11899 = parent;
var G__11899__$1 = (((G__11899 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__11899) : reagent.impl.component.fiber_component_path.call(null,G__11899)));
if((G__11899__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11899__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3949__auto__ = (function (){var G__11901 = c;
if((G__11901 == null)){
return null;
} else {
return (G__11901["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__11902._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__11904 = c;
if((G__11904 == null)){
return null;
} else {
return (G__11904["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__11906 = c;
if((G__11906 == null)){
return null;
} else {
return G__11906._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__11908 = instance;
if((G__11908 == null)){
return null;
} else {
return (G__11908["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__11909 = instance;
if((G__11909 == null)){
return null;
} else {
return G__11909._currentElement;
}
}
})();
var name = (function (){var G__11910 = elem;
var G__11910__$1 = (((G__11910 == null))?null:(G__11910["type"]));
if((G__11910__$1 == null)){
return null;
} else {
return (G__11910__$1["displayName"]);
}
})();
var owner = (function (){var or__3949__auto__ = (function (){var G__11912 = elem;
if((G__11912 == null)){
return null;
} else {
return (G__11912["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__11913._owner;
}
}
})();
var path = (function (){var G__11914 = owner;
var G__11914__$1 = (((G__11914 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__11914) : reagent.impl.component.component_path.call(null,G__11914)));
if((G__11914__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11914__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__11915 = c;
var G__11915__$1 = (((G__11915 == null))?null:G__11915.constructor);
if((G__11915__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__11915__$1);
}
}
})();
