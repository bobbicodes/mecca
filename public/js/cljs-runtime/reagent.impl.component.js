...
if((i < len)){
var k = (ks[i]);
var G__35955 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__35956 = (i + (1));
m = G__35955;
i = G__35956;
continue;
...
var temp__5737__auto__ = (p["argv"]);
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__35721 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__35721);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35732 = c;
var G__35732__$1 = (((G__35732 == null))?null:G__35732.prototype);
if((G__35732__$1 == null)){
return null;
} else {
return (G__35732__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35743 = c;
var G__35743__$1 = (((G__35743 == null))?null:G__35743.prototype);
if((G__35743__$1 == null)){
return null;
} else {
return (G__35743__$1["render"]);
}
})() == null)))));
});
...
var G__35777 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__35777) : reagent.impl.component.as_element.call(null,G__35777));
};
...
while (G__35959__i < G__35959__a.length) {G__35959__a[G__35959__i] = arguments[G__35959__i + 0]; ++G__35959__i;}
  args = new cljs.core.IndexedSeq(G__35959__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__35778 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__35779 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__35779);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__35778);
}});
...
var G__35792 = key;
var G__35792__$1 = (((G__35792 instanceof cljs.core.Keyword))?G__35792.fqn:null);
switch (G__35792__$1) {
...
var c = this;
var G__35833_35963 = (c["cljsRatom"]);
if((G__35833_35963 == null)){
} else {
reagent.ratom.dispose_BANG_(G__35833_35963);
}
...
var renders_35968 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_35969 = cljs.core.first(cljs.core.vals(renders_35968));
if((cljs.core.count(renders_35968) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_35968))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_35969)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_35969], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__35888 = name;
switch (G__35888) {
case "":
...
var G__35898 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__35898);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__35901 = fiber;
var G__35901__$1 = (((G__35901 == null))?null:(G__35901["type"]));
if((G__35901__$1 == null)){
return null;
} else {
return (G__35901__$1["displayName"]);
}
})();
var parent = (function (){var G__35902 = fiber;
if((G__35902 == null)){
return null;
} else {
return (G__35902["return"]);
}
})();
var path = (function (){var G__35903 = parent;
var G__35903__$1 = (((G__35903 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__35903) : reagent.impl.component.fiber_component_path.call(null,G__35903)));
if((G__35903__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35903__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__35910 = c;
if((G__35910 == null)){
return null;
} else {
return (G__35910["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__35916._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__35918 = c;
if((G__35918 == null)){
return null;
} else {
return (G__35918["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__35920 = c;
if((G__35920 == null)){
return null;
} else {
return G__35920._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4185__auto__ = (function (){var G__35923 = instance;
if((G__35923 == null)){
return null;
} else {
return (G__35923["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__35924 = instance;
if((G__35924 == null)){
return null;
} else {
return G__35924._currentElement;
}
}
})();
var name = (function (){var G__35926 = elem;
var G__35926__$1 = (((G__35926 == null))?null:(G__35926["type"]));
if((G__35926__$1 == null)){
return null;
} else {
return (G__35926__$1["displayName"]);
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__35929 = elem;
if((G__35929 == null)){
return null;
} else {
return (G__35929["_owner"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__35930._owner;
}
}
})();
var path = (function (){var G__35931 = owner;
var G__35931__$1 = (((G__35931 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__35931) : reagent.impl.component.component_path.call(null,G__35931)));
if((G__35931__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35931__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__35937 = c;
var G__35937__$1 = (((G__35937 == null))?null:G__35937.constructor);
if((G__35937__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__35937__$1);
}
}
})();
