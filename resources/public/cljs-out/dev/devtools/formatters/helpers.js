...
var G__21879 = devtools.prefs.pref.call(null,v);
v = G__21879;
continue;
} else {
return v;
...
}catch (e21882){var _e__21133__auto__ = e21882;
return false;
}})();
...
}catch (e21886){var _e__21133__auto__ = e21886;
return false;
}})();
...
}catch (e21888){var _e__21133__auto__ = e21888;
return false;
}}
}
});
...
var vec__21890 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21890,(0),null);
var name = cljs.core.nth.call(null,vec__21890,(1),null);
...
return cljs.core.some.call(null,(function (p1__21893_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21893_SHARP_);
}),template);
});
