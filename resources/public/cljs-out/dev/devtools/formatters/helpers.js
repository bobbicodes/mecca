...
var G__22865 = devtools.prefs.pref.call(null,v);
v = G__22865;
continue;
} else {
return v;
...
}catch (e22868){var _e__22119__auto__ = e22868;
return false;
}})();
...
}catch (e22872){var _e__22119__auto__ = e22872;
return false;
}})();
...
}catch (e22874){var _e__22119__auto__ = e22874;
return false;
}}
}
});
...
var vec__22876 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__22876,(0),null);
var name = cljs.core.nth.call(null,vec__22876,(1),null);
...
return cljs.core.some.call(null,(function (p1__22879_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__22879_SHARP_);
}),template);
});
