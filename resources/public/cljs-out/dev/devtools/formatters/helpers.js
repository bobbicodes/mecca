...
var G__22703 = devtools.prefs.pref.call(null,v);
v = G__22703;
continue;
} else {
return v;
...
}catch (e22706){var _e__21957__auto__ = e22706;
return false;
}})();
...
}catch (e22710){var _e__21957__auto__ = e22710;
return false;
}})();
...
}catch (e22712){var _e__21957__auto__ = e22712;
return false;
}}
}
});
...
var vec__22714 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__22714,(0),null);
var name = cljs.core.nth.call(null,vec__22714,(1),null);
...
return cljs.core.some.call(null,(function (p1__22717_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__22717_SHARP_);
}),template);
});
