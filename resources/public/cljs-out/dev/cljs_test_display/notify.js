...
cljs_test_display.notify.failure = (function cljs_test_display$notify$failure(p__14375){
var map__14376 = p__14375;
var map__14376__$1 = ((((!((map__14376 == null)))?(((((map__14376.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14376.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14376):map__14376);
var error = cljs.core.get.call(null,map__14376__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var fail = cljs.core.get.call(null,map__14376__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
return cljs_test_display.notify.with_permission.call(null,"granted",((function (map__14376,map__14376__$1,error,fail){
return (function (){
...
});})(map__14376,map__14376__$1,error,fail))
);
});
