...
var G__15232 = devtools.prefs.pref.call(null,v);
v = G__15232;
continue;
} else {
return v;
...
}catch (e15235){var _e__14486__auto__ = e15235;
return false;
}})();
...
}catch (e15239){var _e__14486__auto__ = e15239;
return false;
}})();
...
}catch (e15241){var _e__14486__auto__ = e15241;
return false;
}}
}
});
...
var vec__15243 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__15243,(0),null);
var name = cljs.core.nth.call(null,vec__15243,(1),null);
...
return cljs.core.some.call(null,(function (p1__15246_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15246_SHARP_);
}),template);
});
