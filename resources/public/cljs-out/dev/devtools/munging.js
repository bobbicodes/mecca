...
var o14046 = temp__5455__auto__;
var temp__5455__auto____$1 = (o14046["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o14047 = temp__5455__auto____$1;
return (o14047["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__13866__auto__ = f;
return (o__13866__auto__["toString"]).call(o__13866__auto__);
} else {
return "";
}
}catch (e14048){var _ = e14048;
return "";
}});
...
try{var o__13866__auto___14050 = t;
(o__13866__auto___14050["cljs$lang$ctorPrWriter"]).call(o__13866__auto___14050,t,writer);
}catch (e14049){var __14051 = e14049;
}
...
var char_code = (function (){var o__13866__auto__ = (new String(char$));
return (o__13866__auto__["charCodeAt"]).call(o__13866__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__13866__auto__ = String;
return (o__13866__auto__["fromCharCode"]).call(o__13866__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__14052 = num_code;
switch (G__14052) {
case (1):
return (185);
...
var o__13866__auto__ = String;
return (o__13866__auto__["fromCharCode"]).call(o__13866__auto__,superscript_code);
});
/**
...
}catch (e14054){var _e__13873__auto__ = e14054;
return false;
}})())){
...
var vec__14055 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__14055,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o14058 = temp__5455__auto__;
var temp__5455__auto____$1 = (o14058["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o14059 = temp__5455__auto____$1;
return (o14059["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__14062){
var vec__14063 = p__14062;
var ns_detector = cljs.core.nth.call(null,vec__14063,(0),null);
...
var G__14069 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__14070 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__14069;
remaining_tokens = G__14070;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq14060){
var G__14061 = cljs.core.first.call(null,seq14060);
var seq14060__$1 = cljs.core.next.call(null,seq14060);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14061,seq14060__$1);
});
...
var vec__14074 = cljs.core.split_with.call(null,(function (p1__14073_SHARP_){
return cljs.core.not_EQ_.call(null,p1__14073_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__14074,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__14074,(1),null);
...
var vec__14077 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__14077,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__14077,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__14080 = cljs.core.rest.call(null,remaining_tokens);
var G__14081 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__14080;
name_tokens = G__14081;
continue;
} else {
...
var vec__14084 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__14084,(0),null);
var arity = cljs.core.nth.call(null,vec__14084,(1),null);
var vec__14087 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__14087,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__14087,(1),null);
var vec__14090 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__14090,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__14090,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__14090,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__14090,(3),null);
...
var vec__14096 = result;
var munged_ns = cljs.core.nth.call(null,vec__14096,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__14096,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__14096,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__14096,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__14096,(4),null);
var arity = cljs.core.nth.call(null,vec__14096,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__14100 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__14100,(0),null);
var args = cljs.core.nth.call(null,vec__14100,(1),null);
var vec__14103 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__14103,(0),null);
var name = cljs.core.nth.call(null,vec__14103,(1),null);
...
var G__14106 = (arity + (1));
var G__14107 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__14108){
var vec__14109 = p__14108;
var arity = cljs.core.nth.call(null,vec__14109,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__14109,(1),null);
...
return cljs.core.get.call(null,arities,p1__14112_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__14113_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___14120 = arguments.length;
var i__4532__auto___14121 = (0);
while(true){
if((i__4532__auto___14121 < len__4531__auto___14120)){
args__4534__auto__.push((arguments[i__4532__auto___14121]));

var G__14122 = (i__4532__auto___14121 + (1));
i__4532__auto___14121 = G__14122;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__14116){
var vec__14117 = p__14116;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__14117,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq14114){
var G__14115 = cljs.core.first.call(null,seq14114);
var seq14114__$1 = cljs.core.next.call(null,seq14114);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14115,seq14114__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__14125__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__14125__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__14125__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__14125__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__14126 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__14126,(0),null);
var fn_name = cljs.core.nth.call(null,vec__14126,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__14126,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__14126,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__14126,(4),null);
var arity = cljs.core.nth.call(null,vec__14126,(5),null);
...
var o__13866__auto__ = f;
return (o__13866__auto__["getBasis"]).call(o__13866__auto__);
});
/**
...
}catch (e14130){var _e__13873__auto__ = e14130;
...
var G__14131 = (obj[cljs.core.first.call(null,path)]);
var G__14132 = cljs.core.rest.call(null,path);
obj = G__14131;
path = G__14132;
continue;
} else {
...
return (function (accum,p__14133){
var vec__14134 = p__14133;
var bit = cljs.core.nth.call(null,vec__14134,(0),null);
var protocol = cljs.core.nth.call(null,vec__14134,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__14137){
var vec__14138 = p__14137;
var ns = cljs.core.nth.call(null,vec__14138,(0),null);
var name = cljs.core.nth.call(null,vec__14138,(1),null);
var selector = cljs.core.nth.call(null,vec__14138,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__14143,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__14143,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__14143,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__14141_SHARP_){
return (obj[cljs.core.first.call(null,p1__14141_SHARP_)]);
});})(name,sorted_matches,vec__14143,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
