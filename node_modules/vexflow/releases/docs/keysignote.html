...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">KeySigNote</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">Note</span> </span>{
  <span class="hljs-keyword">constructor</span>(keySpec, cancelKeySpec, alterKeySpec) {
    <span class="hljs-keyword">super</span>({ <span class="hljs-attr">duration</span>: <span class="hljs-string">'b'</span> });
    <span class="hljs-keyword">this</span>.setAttribute(<span class="hljs-string">'type'</span>, <span class="hljs-string">'KeySigNote'</span>);

    <span class="hljs-keyword">this</span>.keySignature = <span class="hljs-keyword">new</span> KeySignature(keySpec, cancelKeySpec, alterKeySpec);</pre></div>
  ...
  getBoundingBox() {
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">super</span>.getBoundingBox();
  }
  ...
  preFormat() {
    ...
    <span class="hljs-keyword">this</span>.keySignature.setStave(<span class="hljs-keyword">this</span>.stave);
    <span class="hljs-keyword">this</span>.keySignature.format();
    <span class="hljs-keyword">this</span>.setWidth(<span class="hljs-keyword">this</span>.keySignature.width);
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
  }

  draw() {
    <span class="hljs-keyword">this</span>.stave.checkContext();
    <span class="hljs-keyword">this</span>.setRendered();
    <span class="hljs-keyword">this</span>.keySignature.x = <span class="hljs-keyword">this</span>.getAbsoluteX();
    <span class="hljs-keyword">this</span>.keySignature.setContext(<span class="hljs-keyword">this</span>.context);
    <span class="hljs-keyword">this</span>.keySignature.draw();
  }
}</pre></div>
