...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__24354_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(tag,cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__24354_SHARP_,cljs.core.cst$kw$tag));
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__24355_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(voice,mecca.xml.get_voice(p1__24355_SHARP_));
...
return new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$time,time,cljs.core.cst$kw$pitch,((mecca.xml.pitch__GT_midi(mecca.xml.get_pitch(note)) + (function (){var G__24356 = mecca.xml.get_voice(note);
switch (G__24356) {
case (5):
return (12);
...
})()) + (6)),cljs.core.cst$kw$instrument,(function (){var G__24357 = mecca.xml.get_voice(note);
switch (G__24357) {
case (5):
return (15);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24357)].join('')));
...
var G__24360 = (time + (mecca.xml.get_duration(cljs.core.first(notes)) / (6)));
var G__24361 = cljs.core.rest(notes);
var G__24362 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,mecca.xml.parse_note(cljs.core.first(notes),time));
time = G__24360;
notes = G__24361;
result = G__24362;
continue;
...
return mecca.xml.extract_voice(p1__24363_SHARP_,voice);
});})(time))
...
var G__24364 = (time + (mecca.xml.get_duration(cljs.core.first(notes)) / (6)));
var G__24365 = cljs.core.rest(notes);
var G__24366 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,mecca.xml.parse_note(cljs.core.first(notes),time));
time = G__24364;
notes = G__24365;
result = G__24366;
continue;
