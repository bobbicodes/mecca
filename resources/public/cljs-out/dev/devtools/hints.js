...
}catch (e27260){var _e = e27260;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___27263 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___27263)){
var seen_errors_27264 = temp__5455__auto___27263;
if(cljs.core.truth_(seen_errors_27264.has(self))){
} else {
seen_errors_27264.add(self);

var temp__5457__auto___27265 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___27265)){
var sense_27266 = temp__5457__auto___27265;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_27266)].join('');
} else {
}
}
} else {
