...
var G__21909 = devtools.prefs.pref.call(null,v);
v = G__21909;
continue;
} else {
return v;
...
}catch (e21912){var _e__21163__auto__ = e21912;
return false;
}})();
...
}catch (e21916){var _e__21163__auto__ = e21916;
return false;
}})();
...
}catch (e21918){var _e__21163__auto__ = e21918;
return false;
}}
}
});
...
var vec__21920 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21920,(0),null);
var name = cljs.core.nth.call(null,vec__21920,(1),null);
...
return cljs.core.some.call(null,(function (p1__21923_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21923_SHARP_);
}),template);
});
