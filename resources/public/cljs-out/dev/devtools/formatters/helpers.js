...
var G__22845 = devtools.prefs.pref.call(null,v);
v = G__22845;
continue;
} else {
return v;
...
}catch (e22848){var _e__22099__auto__ = e22848;
return false;
}})();
...
}catch (e22852){var _e__22099__auto__ = e22852;
return false;
}})();
...
}catch (e22854){var _e__22099__auto__ = e22854;
return false;
}}
}
});
...
var vec__22856 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__22856,(0),null);
var name = cljs.core.nth.call(null,vec__22856,(1),null);
...
return cljs.core.some.call(null,(function (p1__22859_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__22859_SHARP_);
}),template);
});
