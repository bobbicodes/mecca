...
ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4205__auto__,k18716,else__4206__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k18716,else__4206__auto__);
...
ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__18715){
var self__ = this;
var G__18715__$1 = this;
return (new cljs.core.RecordIter((0),G__18715__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$status,cljs.core.cst$kw$body,cljs.core.cst$kw$status_DASH_text,cljs.core.cst$kw$headers,cljs.core.cst$kw$was_DASH_aborted], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
var h__4061__auto____$1 = (function (){var fexpr__18721 = ((function (h__4061__auto__,this__4199__auto____$1){
return (function (coll__4200__auto__){
return (-473222333 ^ cljs.core.hash_unordered_coll(coll__4200__auto__));
});})(h__4061__auto__,this__4199__auto____$1))
;
return fexpr__18721(this__4199__auto____$1);
})();
...
ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this18717,other18718){
var self__ = this;
var this18717__$1 = this;
return ((!((other18718 == null))) && ((this18717__$1.constructor === other18718.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18717__$1.status,other18718.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18717__$1.body,other18718.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18717__$1.status_text,other18718.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18717__$1.headers,other18718.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18717__$1.was_aborted,other18718.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this18717__$1.__extmap,other18718.__extmap)));
});
...
ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4210__auto__,k__4211__auto__,G__18715){
var self__ = this;
var this__4210__auto____$1 = this;
var pred__18722 = cljs.core.keyword_identical_QMARK_;
var expr__18723 = k__4211__auto__;
if(cljs.core.truth_((function (){var G__18725 = cljs.core.cst$kw$status;
var G__18726 = expr__18723;
return (pred__18722.cljs$core$IFn$_invoke$arity$2 ? pred__18722.cljs$core$IFn$_invoke$arity$2(G__18725,G__18726) : pred__18722.call(null,G__18725,G__18726));
})())){
return (new ajax.protocols.Response(G__18715,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__18727 = cljs.core.cst$kw$body;
var G__18728 = expr__18723;
return (pred__18722.cljs$core$IFn$_invoke$arity$2 ? pred__18722.cljs$core$IFn$_invoke$arity$2(G__18727,G__18728) : pred__18722.call(null,G__18727,G__18728));
})())){
return (new ajax.protocols.Response(self__.status,G__18715,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__18729 = cljs.core.cst$kw$status_DASH_text;
var G__18730 = expr__18723;
return (pred__18722.cljs$core$IFn$_invoke$arity$2 ? pred__18722.cljs$core$IFn$_invoke$arity$2(G__18729,G__18730) : pred__18722.call(null,G__18729,G__18730));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,G__18715,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__18731 = cljs.core.cst$kw$headers;
var G__18732 = expr__18723;
return (pred__18722.cljs$core$IFn$_invoke$arity$2 ? pred__18722.cljs$core$IFn$_invoke$arity$2(G__18731,G__18732) : pred__18722.call(null,G__18731,G__18732));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__18715,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__18733 = cljs.core.cst$kw$was_DASH_aborted;
var G__18734 = expr__18723;
return (pred__18722.cljs$core$IFn$_invoke$arity$2 ? pred__18722.cljs$core$IFn$_invoke$arity$2(G__18733,G__18734) : pred__18722.call(null,G__18733,G__18734));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__18715,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4211__auto__,G__18715),null));
}
}
}
}
...
ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4202__auto__,G__18715){
var self__ = this;
var this__4202__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__18715,self__.__extmap,self__.__hash));
});
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__18719){
var extmap__4236__auto__ = (function (){var G__18735 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__18719,cljs.core.cst$kw$status,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$body,cljs.core.cst$kw$status_DASH_text,cljs.core.cst$kw$headers,cljs.core.cst$kw$was_DASH_aborted], 0));
if(cljs.core.record_QMARK_(G__18719)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__18735);
} else {
return G__18735;
}
})();
return (new ajax.protocols.Response(cljs.core.cst$kw$status.cljs$core$IFn$_invoke$arity$1(G__18719),cljs.core.cst$kw$body.cljs$core$IFn$_invoke$arity$1(G__18719),cljs.core.cst$kw$status_DASH_text.cljs$core$IFn$_invoke$arity$1(G__18719),cljs.core.cst$kw$headers.cljs$core$IFn$_invoke$arity$1(G__18719),cljs.core.cst$kw$was_DASH_aborted.cljs$core$IFn$_invoke$arity$1(G__18719),null,cljs.core.not_empty(extmap__4236__auto__),null));
});
