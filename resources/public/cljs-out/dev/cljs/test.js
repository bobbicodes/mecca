...
var G__14788 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__14788,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__14788;
}
});
...
var len__4531__auto___14793 = arguments.length;
var i__4532__auto___14794 = (0);
while(true){
if((i__4532__auto___14794 < len__4531__auto___14793)){
args__4534__auto__.push((arguments[i__4532__auto___14794]));

var G__14795 = (i__4532__auto___14794 + (1));
i__4532__auto___14794 = G__14795;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq14790){
var G__14791 = cljs.core.first.call(null,seq14790);
var seq14790__$1 = cljs.core.next.call(null,seq14790);
var G__14792 = cljs.core.first.call(null,seq14790__$1);
var seq14790__$2 = cljs.core.next.call(null,seq14790__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14791,G__14792,seq14790__$2);
});
...
var file = cljs.core.get.call(null,map__14797__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__14797__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__14797__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__14797,map__14797__$1,file,line,column){
return (function (p1__14796_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__14796_SHARP_));
});})(map__14797,map__14797__$1,file,line,column))
...
var temp__5457__auto___14799 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___14799)){
var message_14800 = temp__5457__auto___14799;
cljs.core.println.call(null,message_14800);
} else {
}
...
var temp__5457__auto___14801 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___14801)){
var message_14802 = temp__5457__auto___14801;
cljs.core.println.call(null,message_14802);
} else {
}
...
var output_dir__$1 = (function (){var G__14803 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14803),"/"].join('');
} else {
return G__14803;
}
})();
...
var G__14805 = exception.stack;
var G__14805__$1 = (((G__14805 == null))?null:clojure.string.split_lines.call(null,G__14805));
var G__14805__$2 = (((G__14805__$1 == null))?null:cljs.core.get.call(null,G__14805__$1,depth));
if((G__14805__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__14805__$2);
}
} else {
...
var vec__14806 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__14806,(0),null);
var column = cljs.core.nth.call(null,vec__14806,(1),null);
var vec__14809 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__14809,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__14809,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__14809,(2),null);
...
var m__$1 = (function (){var G__14812 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__14812__$1 = (((G__14812 instanceof cljs.core.Keyword))?G__14812.fqn:null);
switch (G__14812__$1) {
case "fail":
...
var G__14816 = (function (){var G__14815 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__14815);
} else {
return G__14815;
}
})();
...
return cljs.core.vary_meta.call(null,G__14817,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__14821 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__14821,(0),null);
var types = vec__14821;
...
return cljs.core.map.call(null,(function (p__14824){
var vec__14825 = p__14824;
var ns = cljs.core.nth.call(null,vec__14825,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__14825,(1),null);
return ((function (vec__14825,ns,vars__$1){
return (function (){
...
var G__14828 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__14828,G__14828__$1,env,once_fixtures,each_fixtures,vec__14825,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__14828,G__14828__$1,env,once_fixtures,each_fixtures,vec__14825,ns,vars__$1){
return (function (){
var seq__14829 = cljs.core.seq.call(null,vars__$1);
var chunk__14830 = null;
var count__14831 = (0);
var i__14832 = (0);
while(true){
if((i__14832 < count__14831)){
var v = cljs.core._nth.call(null,chunk__14830,i__14832);
var temp__5457__auto___14834 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___14834)){
var t_14835 = temp__5457__auto___14834;
each_fixture_fn.call(null,((function (seq__14829,chunk__14830,count__14831,i__14832,t_14835,temp__5457__auto___14834,v,each_fixture_fn,G__14828,G__14828__$1,env,once_fixtures,each_fixtures,vec__14825,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14835)));
});})(seq__14829,chunk__14830,count__14831,i__14832,t_14835,temp__5457__auto___14834,v,each_fixture_fn,G__14828,G__14828__$1,env,once_fixtures,each_fixtures,vec__14825,ns,vars__$1))
);
} else {
}


var G__14836 = seq__14829;
var G__14837 = chunk__14830;
var G__14838 = count__14831;
var G__14839 = (i__14832 + (1));
seq__14829 = G__14836;
chunk__14830 = G__14837;
count__14831 = G__14838;
i__14832 = G__14839;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__14829);
if(temp__5457__auto__){
var seq__14829__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__14829__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__14829__$1);
var G__14840 = cljs.core.chunk_rest.call(null,seq__14829__$1);
var G__14841 = c__4351__auto__;
var G__14842 = cljs.core.count.call(null,c__4351__auto__);
var G__14843 = (0);
seq__14829 = G__14840;
chunk__14830 = G__14841;
count__14831 = G__14842;
i__14832 = G__14843;
continue;
} else {
var v = cljs.core.first.call(null,seq__14829__$1);
var temp__5457__auto___14844__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___14844__$1)){
var t_14845 = temp__5457__auto___14844__$1;
each_fixture_fn.call(null,((function (seq__14829,chunk__14830,count__14831,i__14832,t_14845,temp__5457__auto___14844__$1,v,seq__14829__$1,temp__5457__auto__,each_fixture_fn,G__14828,G__14828__$1,env,once_fixtures,each_fixtures,vec__14825,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14845)));
});})(seq__14829,chunk__14830,count__14831,i__14832,t_14845,temp__5457__auto___14844__$1,v,seq__14829__$1,temp__5457__auto__,each_fixture_fn,G__14828,G__14828__$1,env,once_fixtures,each_fixtures,vec__14825,ns,vars__$1))
);
} else {
}


var G__14846 = cljs.core.next.call(null,seq__14829__$1);
var G__14847 = null;
var G__14848 = (0);
var G__14849 = (0);
seq__14829 = G__14846;
chunk__14830 = G__14847;
count__14831 = G__14848;
i__14832 = G__14849;
continue;
}
} else {
...
});})(each_fixture_fn,G__14828,G__14828__$1,env,once_fixtures,each_fixtures,vec__14825,ns,vars__$1))
);
});})(each_fixture_fn,G__14828,G__14828__$1,env,once_fixtures,each_fixtures,vec__14825,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14828__$1)].join('')));

}
})());
});
;})(vec__14825,ns,vars__$1))
