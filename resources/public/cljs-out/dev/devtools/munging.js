...
var o15685 = temp__5455__auto__;
var temp__5455__auto____$1 = (o15685["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o15686 = temp__5455__auto____$1;
return (o15686["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__15505__auto__ = f;
return (o__15505__auto__["toString"]).call(o__15505__auto__);
} else {
return "";
}
}catch (e15687){var _ = e15687;
return "";
}});
...
try{var o__15505__auto___15689 = t;
(o__15505__auto___15689["cljs$lang$ctorPrWriter"]).call(o__15505__auto___15689,t,writer);
}catch (e15688){var __15690 = e15688;
}
...
var char_code = (function (){var o__15505__auto__ = (new String(char$));
return (o__15505__auto__["charCodeAt"]).call(o__15505__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__15505__auto__ = String;
return (o__15505__auto__["fromCharCode"]).call(o__15505__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__15691 = num_code;
switch (G__15691) {
case (1):
return (185);
...
var o__15505__auto__ = String;
return (o__15505__auto__["fromCharCode"]).call(o__15505__auto__,superscript_code);
});
/**
...
}catch (e15693){var _e__15512__auto__ = e15693;
return false;
}})())){
...
var vec__15694 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__15694,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o15697 = temp__5455__auto__;
var temp__5455__auto____$1 = (o15697["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o15698 = temp__5455__auto____$1;
return (o15698["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___15705 = arguments.length;
var i__4532__auto___15706 = (0);
while(true){
if((i__4532__auto___15706 < len__4531__auto___15705)){
args__4534__auto__.push((arguments[i__4532__auto___15706]));

var G__15707 = (i__4532__auto___15706 + (1));
i__4532__auto___15706 = G__15707;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15701){
var vec__15702 = p__15701;
var ns_detector = cljs.core.nth.call(null,vec__15702,(0),null);
...
var G__15708 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__15709 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__15708;
remaining_tokens = G__15709;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15699){
var G__15700 = cljs.core.first.call(null,seq15699);
var seq15699__$1 = cljs.core.next.call(null,seq15699);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15700,seq15699__$1);
});
...
var vec__15713 = cljs.core.split_with.call(null,(function (p1__15712_SHARP_){
return cljs.core.not_EQ_.call(null,p1__15712_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__15713,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__15713,(1),null);
...
var vec__15716 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__15716,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__15716,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__15719 = cljs.core.rest.call(null,remaining_tokens);
var G__15720 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__15719;
name_tokens = G__15720;
continue;
} else {
...
var vec__15723 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__15723,(0),null);
var arity = cljs.core.nth.call(null,vec__15723,(1),null);
var vec__15726 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__15726,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__15726,(1),null);
var vec__15729 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__15729,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__15729,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__15729,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__15729,(3),null);
...
var vec__15735 = result;
var munged_ns = cljs.core.nth.call(null,vec__15735,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__15735,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__15735,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__15735,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__15735,(4),null);
var arity = cljs.core.nth.call(null,vec__15735,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__15739 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__15739,(0),null);
var args = cljs.core.nth.call(null,vec__15739,(1),null);
var vec__15742 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__15742,(0),null);
var name = cljs.core.nth.call(null,vec__15742,(1),null);
...
var G__15745 = (arity + (1));
var G__15746 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__15747){
var vec__15748 = p__15747;
var arity = cljs.core.nth.call(null,vec__15748,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__15748,(1),null);
...
return (function (p1__15751_SHARP_){
return cljs.core.get.call(null,arities,p1__15751_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__15752_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___15759 = arguments.length;
var i__4532__auto___15760 = (0);
while(true){
if((i__4532__auto___15760 < len__4531__auto___15759)){
args__4534__auto__.push((arguments[i__4532__auto___15760]));

var G__15761 = (i__4532__auto___15760 + (1));
i__4532__auto___15760 = G__15761;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__15755){
var vec__15756 = p__15755;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__15756,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq15753){
var G__15754 = cljs.core.first.call(null,seq15753);
var seq15753__$1 = cljs.core.next.call(null,seq15753);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15754,seq15753__$1);
});
...
var G__15762 = arg;
var G__15762__$1 = (((G__15762 instanceof cljs.core.Keyword))?G__15762.fqn:null);
switch (G__15762__$1) {
...
var map__15764 = options;
var map__15764__$1 = ((((!((map__15764 == null)))?(((((map__15764.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15764.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15764):map__15764);
var include_ns_QMARK_ = cljs.core.get.call(null,map__15764__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__15764__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__15764__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__15764__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__15765 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__15765,(0),null);
var fn_name = cljs.core.nth.call(null,vec__15765,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__15765,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__15765,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__15765,(4),null);
var arity = cljs.core.nth.call(null,vec__15765,(5),null);
...
var o__15505__auto__ = f;
return (o__15505__auto__["getBasis"]).call(o__15505__auto__);
});
/**
...
}catch (e15769){var _e__15512__auto__ = e15769;
...
var G__15770 = (obj[cljs.core.first.call(null,path)]);
var G__15771 = cljs.core.rest.call(null,path);
obj = G__15770;
path = G__15771;
continue;
} else {
...
return (function (accum,p__15772){
var vec__15773 = p__15772;
var bit = cljs.core.nth.call(null,vec__15773,(0),null);
var protocol = cljs.core.nth.call(null,vec__15773,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__15776){
var vec__15777 = p__15776;
var ns = cljs.core.nth.call(null,vec__15777,(0),null);
var name = cljs.core.nth.call(null,vec__15777,(1),null);
var selector = cljs.core.nth.call(null,vec__15777,(2),null);
...
return (function (p__15781){
var vec__15782 = p__15781;
var munged_name = cljs.core.nth.call(null,vec__15782,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__15782,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__15782,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__15780_SHARP_){
return (obj[cljs.core.first.call(null,p1__15780_SHARP_)]);
});})(name,sorted_matches,vec__15782,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
