...
return cljs.core.map.call(null,(function (p1__21946_SHARP_){
return html_coll.item(p1__21946_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__21947_SHARP_);
...
var ctx_21948 = cvs.getContext("2d");
ctx_21948.fillStyle = color;

ctx_21948.fillRect((0),(0),size,size);
