...
var G__36060 = o;
(G__36060[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__36399__i < G__36399__a.length) {G__36399__a[G__36399__i] = arguments[G__36399__i + 0]; ++G__36399__i;}
  args = new cljs.core.IndexedSeq(G__36399__a,0,null);
} 
...
var G__36099 = o;
(G__36099[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__36402__i < G__36402__a.length) {G__36402__a[G__36402__i] = arguments[G__36402__i + 0]; ++G__36402__i;}
  args = new cljs.core.IndexedSeq(G__36402__a,0,null);
} 
...
var G__36290 = props;
var G__36290__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36290,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36290);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36290__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__36293){
...
var props = map__36294__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36294__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__36301){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36302__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var G__36325 = jsprops;
(G__36325["defaultValue"] = value);

(G__36325["onChange"] = (function (p1__36308_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__36308_SHARP_);
}));
...
var vec__36327 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36327,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36327,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36327,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___36435 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___36435 == null)){
} else {
var key_36436 = temp__5739__auto___36435;
(jsprops["key"] = key_36436);
}
...
var temp__5739__auto___36437 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___36437 == null)){
} else {
var key_36438 = temp__5739__auto___36437;
reagent.impl.template.oset(jsprops,"key",key_36438);
}
...
var G__36335 = reagent.impl.template.__GT_NativeWrapper();
(G__36335["name"] = c);
...
var G__36337 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__36337) : reagent.impl.template.as_element.call(null,G__36337));
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq36340){
var G__36341 = cljs.core.first(seq36340);
var seq36340__$1 = cljs.core.next(seq36340);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36341,seq36340__$1);
}));
...
break;
default:
var G__36444 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__36444;
continue;
...
var n__4666__auto___36445 = a.length;
var i_36446 = (0);
while(true){
if((i_36446 < n__4666__auto___36445)){
(a[i_36446] = reagent.impl.template.as_element((a[i_36446])));

var G__36447 = (i_36446 + (1));
i_36446 = G__36447;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4666__auto___36448 = a.length;
var i_36449 = (0);
while(true){
if((i_36449 < n__4666__auto___36448)){
var val_36450 = (a[i_36449]);
if(((cljs.core.vector_QMARK_(val_36450)) && ((reagent.impl.template.key_from_vec(val_36450) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_36449] = reagent.impl.template.as_element(val_36450));

var G__36452 = (i_36449 + (1));
i_36449 = G__36452;
continue;
} else {
}
...
var ctx = ({});
var vec__36345 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36345,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36345,(1),null);
...
var G__36349 = (cljs.core.count(argv) - first_child);
switch (G__36349) {
case (0):
...
case (1):
var G__36350 = comp;
var G__36351 = jsprops;
var G__36352 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__36350,G__36351,G__36352);
