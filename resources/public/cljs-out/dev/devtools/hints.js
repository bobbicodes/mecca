...
}catch (e19583){var _e = e19583;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___19586 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___19586)){
var seen_errors_19587 = temp__5455__auto___19586;
if(cljs.core.truth_(seen_errors_19587.has(self))){
} else {
seen_errors_19587.add(self);

var temp__5457__auto___19588 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___19588)){
var sense_19589 = temp__5457__auto___19588;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_19589)].join('');
} else {
}
}
} else {
