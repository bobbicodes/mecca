...
return html_coll.item(p1__13722_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__13723_SHARP_);
...
var ctx_13724 = cvs.getContext("2d");
ctx_13724.fillStyle = color;

ctx_13724.fillRect((0),(0),size,size);
