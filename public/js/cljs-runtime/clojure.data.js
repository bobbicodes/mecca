...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__47413){
...
var vec__47418 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47418,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47418,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47418,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_47444 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_47444(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_47445 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_47445(a,b);
}
});
...
var fexpr__47435 = (function (){var G__47436 = clojure.data.equality_partition(a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__47436__$1)].join('')));

}
})();
return (fexpr__47435.cljs$core$IFn$_invoke$arity$2 ? fexpr__47435.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__47435.call(null,a,b));
}));
/**
