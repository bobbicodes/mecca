...
var G__15417 = devtools.prefs.pref.call(null,v);
v = G__15417;
continue;
} else {
return v;
...
}catch (e15420){var _e__14671__auto__ = e15420;
return false;
}})();
...
}catch (e15424){var _e__14671__auto__ = e15424;
return false;
}})();
...
}catch (e15426){var _e__14671__auto__ = e15426;
return false;
}}
}
});
...
var vec__15428 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__15428,(0),null);
var name = cljs.core.nth.call(null,vec__15428,(1),null);
...
return cljs.core.some.call(null,(function (p1__15431_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15431_SHARP_);
}),template);
});
