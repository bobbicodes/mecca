...
var G__20286 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__20286,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__20286;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq20288){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20289,G__20290,seq20288__$2);
});
...
var map__20295 = m;
var map__20295__$1 = ((((!((map__20295 == null)))?(((((map__20295.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20295.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20295):map__20295);
var file = cljs.core.get.call(null,map__20295__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__20295__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__20295__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__20295,map__20295__$1,file,line,column){
return (function (p1__20294_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__20294_SHARP_));
});})(map__20295,map__20295__$1,file,line,column))
...
var temp__5457__auto___20297 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20297)){
var message_20298 = temp__5457__auto___20297;
cljs.core.println.call(null,message_20298);
} else {
}
...
var temp__5457__auto___20299 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20299)){
var message_20300 = temp__5457__auto___20299;
cljs.core.println.call(null,message_20300);
} else {
}
...
var output_dir__$1 = (function (){var G__20301 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20301),"/"].join('');
} else {
return G__20301;
}
})();
...
var G__20303 = exception.stack;
var G__20303__$1 = (((G__20303 == null))?null:clojure.string.split_lines.call(null,G__20303));
var G__20303__$2 = (((G__20303__$1 == null))?null:cljs.core.get.call(null,G__20303__$1,depth));
if((G__20303__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__20303__$2);
}
} else {
...
var vec__20304 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__20304,(0),null);
var column = cljs.core.nth.call(null,vec__20304,(1),null);
var vec__20307 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__20307,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__20307,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__20307,(2),null);
...
var m__$1 = (function (){var G__20310 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__20310__$1 = (((G__20310 instanceof cljs.core.Keyword))?G__20310.fqn:null);
switch (G__20310__$1) {
case "fail":
...
var G__20314 = (function (){var G__20313 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__20313);
} else {
return G__20313;
}
})();
...
return cljs.core.vary_meta.call(null,G__20315,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e20316){var e = e20316;
var G__20317 = e;
var G__20317__$1 = (((G__20317 instanceof cljs.core.Keyword))?G__20317.fqn:null);
switch (G__20317__$1) {
...
var vec__20319 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__20319,(0),null);
var types = vec__20319;
...
return cljs.core.map.call(null,(function (p__20322){
var vec__20323 = p__20322;
var ns = cljs.core.nth.call(null,vec__20323,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__20323,(1),null);
return ((function (vec__20323,ns,vars__$1){
return (function (){
...
var G__20326 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__20326,G__20326__$1,env,once_fixtures,each_fixtures,vec__20323,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__20326,G__20326__$1,env,once_fixtures,each_fixtures,vec__20323,ns,vars__$1){
return (function (){
var seq__20327 = cljs.core.seq.call(null,vars__$1);
var chunk__20328 = null;
var count__20329 = (0);
var i__20330 = (0);
while(true){
if((i__20330 < count__20329)){
var v = cljs.core._nth.call(null,chunk__20328,i__20330);
var temp__5457__auto___20332 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20332)){
var t_20333 = temp__5457__auto___20332;
each_fixture_fn.call(null,((function (seq__20327,chunk__20328,count__20329,i__20330,t_20333,temp__5457__auto___20332,v,each_fixture_fn,G__20326,G__20326__$1,env,once_fixtures,each_fixtures,vec__20323,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20333)));
});})(seq__20327,chunk__20328,count__20329,i__20330,t_20333,temp__5457__auto___20332,v,each_fixture_fn,G__20326,G__20326__$1,env,once_fixtures,each_fixtures,vec__20323,ns,vars__$1))
);
} else {
}


var G__20334 = seq__20327;
var G__20335 = chunk__20328;
var G__20336 = count__20329;
var G__20337 = (i__20330 + (1));
seq__20327 = G__20334;
chunk__20328 = G__20335;
count__20329 = G__20336;
i__20330 = G__20337;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__20327);
if(temp__5457__auto__){
var seq__20327__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__20327__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__20327__$1);
var G__20338 = cljs.core.chunk_rest.call(null,seq__20327__$1);
var G__20339 = c__4351__auto__;
var G__20340 = cljs.core.count.call(null,c__4351__auto__);
var G__20341 = (0);
seq__20327 = G__20338;
chunk__20328 = G__20339;
count__20329 = G__20340;
i__20330 = G__20341;
continue;
} else {
var v = cljs.core.first.call(null,seq__20327__$1);
var temp__5457__auto___20342__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20342__$1)){
var t_20343 = temp__5457__auto___20342__$1;
each_fixture_fn.call(null,((function (seq__20327,chunk__20328,count__20329,i__20330,t_20343,temp__5457__auto___20342__$1,v,seq__20327__$1,temp__5457__auto__,each_fixture_fn,G__20326,G__20326__$1,env,once_fixtures,each_fixtures,vec__20323,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20343)));
});})(seq__20327,chunk__20328,count__20329,i__20330,t_20343,temp__5457__auto___20342__$1,v,seq__20327__$1,temp__5457__auto__,each_fixture_fn,G__20326,G__20326__$1,env,once_fixtures,each_fixtures,vec__20323,ns,vars__$1))
);
} else {
}


var G__20344 = cljs.core.next.call(null,seq__20327__$1);
var G__20345 = null;
var G__20346 = (0);
var G__20347 = (0);
seq__20327 = G__20344;
chunk__20328 = G__20345;
count__20329 = G__20346;
i__20330 = G__20347;
continue;
}
} else {
...
});})(each_fixture_fn,G__20326,G__20326__$1,env,once_fixtures,each_fixtures,vec__20323,ns,vars__$1))
);
});})(each_fixture_fn,G__20326,G__20326__$1,env,once_fixtures,each_fixtures,vec__20323,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20326__$1)].join('')));

}
})());
});
;})(vec__20323,ns,vars__$1))
