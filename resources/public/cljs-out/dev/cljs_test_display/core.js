...
var len__4531__auto___21360 = arguments.length;
var i__4532__auto___21361 = (0);
while(true){
if((i__4532__auto___21361 < len__4531__auto___21360)){
args__4534__auto__.push((arguments[i__4532__auto___21361]));

var G__21362 = (i__4532__auto___21361 + (1));
i__4532__auto___21361 = G__21362;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq21357){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21358,G__21359,seq21357__$2);
});
...
var vec__21363 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__21363,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__21363,(1),null);
var G__21366 = cljs.core.PersistentArrayMap.EMPTY;
var G__21366__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__21366,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21366);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__21366__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__21366__$1;
}
} else {
...
return (function() { 
var G__21370__delegate = function (klass,contents){
var vec__21367 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__21367,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__21367,(1),null);
...
var G__21370 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__21371__i = 0, G__21371__a = new Array(arguments.length -  1);
while (G__21371__i < G__21371__a.length) {G__21371__a[G__21371__i] = arguments[G__21371__i + 1]; ++G__21371__i;}
  contents = new cljs.core.IndexedSeq(G__21371__a,0,null);
} 
return G__21370__delegate.call(this,klass,contents);};
G__21370.cljs$lang$maxFixedArity = 1;
G__21370.cljs$lang$applyTo = (function (arglist__21372){
var klass = cljs.core.first(arglist__21372);
var contents = cljs.core.rest(arglist__21372);
return G__21370__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__21376){
var map__21377 = p__21376;
var map__21377__$1 = ((((!((map__21377 == null)))?(((((map__21377.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21377.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21377):map__21377);
var ns = cljs.core.get.call(null,map__21377__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__21377__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__21379){
...
var actual = cljs.core.get.call(null,map__21380__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__21380__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__21382){
var map__21383 = p__21382;
var map__21383__$1 = ((((!((map__21383 == null)))?(((((map__21383.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21383.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21383):map__21383);
var expected = cljs.core.get.call(null,map__21383__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__21383__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__21385_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__21387 = cljs_test_display.core.current_var_info.call(null);
var map__21387__$1 = ((((!((map__21387 == null)))?(((((map__21387.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21387.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21387):map__21387);
var info = map__21387__$1;
var name = cljs.core.get.call(null,map__21387__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__21387__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__21387__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__21387,map__21387__$1,info,name,line,file,node){
return (function (p1__21386_SHARP_){
return cljs.core.cons.call(null,node,p1__21386_SHARP_);
});})(curr_node,map__21387,map__21387__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__21389){
var map__21390 = p__21389;
var map__21390__$1 = ((((!((map__21390 == null)))?(((((map__21390.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21390.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21390):map__21390);
var m = map__21390__$1;
var fail = cljs.core.get.call(null,map__21390__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__21390__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__21390__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__21390__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5457__auto___21392 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21392)){
var message_21393 = temp__5457__auto___21392;
cljs.core.println.call(null,message_21393);
} else {
}
...
var temp__5457__auto___21394 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21394)){
var message_21395 = temp__5457__auto___21394;
cljs.core.println.call(null,message_21395);
} else {
}
