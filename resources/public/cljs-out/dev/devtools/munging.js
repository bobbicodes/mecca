...
var temp__5455__auto____$1 = (o22298["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22299 = temp__5455__auto____$1;
return (o22299["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22118__auto__ = f;
return (o__22118__auto__["toString"]).call(o__22118__auto__);
} else {
return "";
}
}catch (e22300){var _ = e22300;
return "";
}});
...
try{var o__22118__auto___22302 = t;
(o__22118__auto___22302["cljs$lang$ctorPrWriter"]).call(o__22118__auto___22302,t,writer);
}catch (e22301){var __22303 = e22301;
}
...
var char_code = (function (){var o__22118__auto__ = (new String(char$));
return (o__22118__auto__["charCodeAt"]).call(o__22118__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22118__auto__ = String;
return (o__22118__auto__["fromCharCode"]).call(o__22118__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22304 = num_code;
switch (G__22304) {
case (1):
return (185);
...
var o__22118__auto__ = String;
return (o__22118__auto__["fromCharCode"]).call(o__22118__auto__,superscript_code);
});
/**
...
}catch (e22306){var _e__22125__auto__ = e22306;
return false;
}})())){
...
var vec__22307 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22307,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o22310 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22310["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22311 = temp__5455__auto____$1;
return (o22311["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22314){
var vec__22315 = p__22314;
var ns_detector = cljs.core.nth.call(null,vec__22315,(0),null);
...
var G__22321 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22322 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22321;
remaining_tokens = G__22322;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22312){
var G__22313 = cljs.core.first.call(null,seq22312);
var seq22312__$1 = cljs.core.next.call(null,seq22312);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22313,seq22312__$1);
});
...
var vec__22326 = cljs.core.split_with.call(null,(function (p1__22325_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22325_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22326,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22326,(1),null);
...
var vec__22329 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22329,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22329,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22332 = cljs.core.rest.call(null,remaining_tokens);
var G__22333 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22332;
name_tokens = G__22333;
continue;
} else {
...
var vec__22336 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22336,(0),null);
var arity = cljs.core.nth.call(null,vec__22336,(1),null);
var vec__22339 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22339,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22339,(1),null);
var vec__22342 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22342,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22342,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22342,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22342,(3),null);
...
var vec__22348 = result;
var munged_ns = cljs.core.nth.call(null,vec__22348,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22348,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22348,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22348,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22348,(4),null);
var arity = cljs.core.nth.call(null,vec__22348,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__22352 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__22352,(0),null);
var args = cljs.core.nth.call(null,vec__22352,(1),null);
var vec__22355 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22355,(0),null);
var name = cljs.core.nth.call(null,vec__22355,(1),null);
...
var G__22358 = (arity + (1));
var G__22359 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22360){
var vec__22361 = p__22360;
var arity = cljs.core.nth.call(null,vec__22361,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22361,(1),null);
...
return cljs.core.get.call(null,arities,p1__22364_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22365_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___22372 = arguments.length;
var i__4532__auto___22373 = (0);
while(true){
if((i__4532__auto___22373 < len__4531__auto___22372)){
args__4534__auto__.push((arguments[i__4532__auto___22373]));

var G__22374 = (i__4532__auto___22373 + (1));
i__4532__auto___22373 = G__22374;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22368){
var vec__22369 = p__22368;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22369,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22366){
var G__22367 = cljs.core.first.call(null,seq22366);
var seq22366__$1 = cljs.core.next.call(null,seq22366);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22367,seq22366__$1);
});
...
var G__22375 = arg;
var G__22375__$1 = (((G__22375 instanceof cljs.core.Keyword))?G__22375.fqn:null);
switch (G__22375__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22377__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22377__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22377__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22377__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22378 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22378,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22378,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22378,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22378,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22378,(4),null);
var arity = cljs.core.nth.call(null,vec__22378,(5),null);
...
var o__22118__auto__ = f;
return (o__22118__auto__["getBasis"]).call(o__22118__auto__);
});
/**
...
}catch (e22382){var _e__22125__auto__ = e22382;
...
var G__22383 = (obj[cljs.core.first.call(null,path)]);
var G__22384 = cljs.core.rest.call(null,path);
obj = G__22383;
path = G__22384;
continue;
} else {
...
return (function (accum,p__22385){
var vec__22386 = p__22385;
var bit = cljs.core.nth.call(null,vec__22386,(0),null);
var protocol = cljs.core.nth.call(null,vec__22386,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22389){
var vec__22390 = p__22389;
var ns = cljs.core.nth.call(null,vec__22390,(0),null);
var name = cljs.core.nth.call(null,vec__22390,(1),null);
var selector = cljs.core.nth.call(null,vec__22390,(2),null);
...
return (function (p__22394){
var vec__22395 = p__22394;
var munged_name = cljs.core.nth.call(null,vec__22395,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22395,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22395,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22393_SHARP_){
return (obj[cljs.core.first.call(null,p1__22393_SHARP_)]);
});})(name,sorted_matches,vec__22395,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
