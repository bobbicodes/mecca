...
var o15713 = temp__5455__auto__;
var temp__5455__auto____$1 = (o15713["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o15714 = temp__5455__auto____$1;
return (o15714["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__15533__auto__ = f;
return (o__15533__auto__["toString"]).call(o__15533__auto__);
} else {
return "";
}
}catch (e15715){var _ = e15715;
return "";
}});
...
try{var o__15533__auto___15717 = t;
(o__15533__auto___15717["cljs$lang$ctorPrWriter"]).call(o__15533__auto___15717,t,writer);
}catch (e15716){var __15718 = e15716;
}
...
var char_code = (function (){var o__15533__auto__ = (new String(char$));
return (o__15533__auto__["charCodeAt"]).call(o__15533__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__15533__auto__ = String;
return (o__15533__auto__["fromCharCode"]).call(o__15533__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__15719 = num_code;
switch (G__15719) {
case (1):
return (185);
...
var o__15533__auto__ = String;
return (o__15533__auto__["fromCharCode"]).call(o__15533__auto__,superscript_code);
});
/**
...
}catch (e15721){var _e__15540__auto__ = e15721;
return false;
}})())){
...
var vec__15722 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__15722,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o15725 = temp__5455__auto__;
var temp__5455__auto____$1 = (o15725["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o15726 = temp__5455__auto____$1;
return (o15726["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___15733 = arguments.length;
var i__4532__auto___15734 = (0);
while(true){
if((i__4532__auto___15734 < len__4531__auto___15733)){
args__4534__auto__.push((arguments[i__4532__auto___15734]));

var G__15735 = (i__4532__auto___15734 + (1));
i__4532__auto___15734 = G__15735;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15729){
var vec__15730 = p__15729;
var ns_detector = cljs.core.nth.call(null,vec__15730,(0),null);
...
var G__15736 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__15737 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__15736;
remaining_tokens = G__15737;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15727){
var G__15728 = cljs.core.first.call(null,seq15727);
var seq15727__$1 = cljs.core.next.call(null,seq15727);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15728,seq15727__$1);
});
...
var vec__15741 = cljs.core.split_with.call(null,(function (p1__15740_SHARP_){
return cljs.core.not_EQ_.call(null,p1__15740_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__15741,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__15741,(1),null);
...
var vec__15744 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__15744,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__15744,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__15747 = cljs.core.rest.call(null,remaining_tokens);
var G__15748 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__15747;
name_tokens = G__15748;
continue;
} else {
...
var vec__15751 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__15751,(0),null);
var arity = cljs.core.nth.call(null,vec__15751,(1),null);
var vec__15754 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__15754,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__15754,(1),null);
var vec__15757 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__15757,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__15757,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__15757,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__15757,(3),null);
...
var vec__15763 = result;
var munged_ns = cljs.core.nth.call(null,vec__15763,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__15763,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__15763,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__15763,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__15763,(4),null);
var arity = cljs.core.nth.call(null,vec__15763,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__15767 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__15767,(0),null);
var args = cljs.core.nth.call(null,vec__15767,(1),null);
var vec__15770 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__15770,(0),null);
var name = cljs.core.nth.call(null,vec__15770,(1),null);
...
var G__15773 = (arity + (1));
var G__15774 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__15775){
var vec__15776 = p__15775;
var arity = cljs.core.nth.call(null,vec__15776,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__15776,(1),null);
...
return cljs.core.get.call(null,arities,p1__15779_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__15780_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___15787 = arguments.length;
var i__4532__auto___15788 = (0);
while(true){
if((i__4532__auto___15788 < len__4531__auto___15787)){
args__4534__auto__.push((arguments[i__4532__auto___15788]));

var G__15789 = (i__4532__auto___15788 + (1));
i__4532__auto___15788 = G__15789;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__15783){
var vec__15784 = p__15783;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__15784,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq15781){
var G__15782 = cljs.core.first.call(null,seq15781);
var seq15781__$1 = cljs.core.next.call(null,seq15781);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15782,seq15781__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__15792__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__15792__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__15792__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__15792__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__15793 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__15793,(0),null);
var fn_name = cljs.core.nth.call(null,vec__15793,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__15793,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__15793,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__15793,(4),null);
var arity = cljs.core.nth.call(null,vec__15793,(5),null);
...
var o__15533__auto__ = f;
return (o__15533__auto__["getBasis"]).call(o__15533__auto__);
});
/**
...
}catch (e15797){var _e__15540__auto__ = e15797;
...
var G__15798 = (obj[cljs.core.first.call(null,path)]);
var G__15799 = cljs.core.rest.call(null,path);
obj = G__15798;
path = G__15799;
continue;
} else {
...
return (function (accum,p__15800){
var vec__15801 = p__15800;
var bit = cljs.core.nth.call(null,vec__15801,(0),null);
var protocol = cljs.core.nth.call(null,vec__15801,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__15804){
var vec__15805 = p__15804;
var ns = cljs.core.nth.call(null,vec__15805,(0),null);
var name = cljs.core.nth.call(null,vec__15805,(1),null);
var selector = cljs.core.nth.call(null,vec__15805,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__15810,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__15810,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__15810,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__15808_SHARP_){
return (obj[cljs.core.first.call(null,p1__15808_SHARP_)]);
});})(name,sorted_matches,vec__15810,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
