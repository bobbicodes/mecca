...
return cljs.core.chunk_cons(cljs.core.chunk(b__38082),mecca$castle$castle_arch_$_iter__38079(cljs.core.chunk_rest(s__38080__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__38082),null);
}
} else {
var vec__38097 = cljs.core.first(s__38080__$2);
var dy = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38097,(0),null);
var dx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38097,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"line","line",212345235),new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"x1","x1",-1863922247),(x + ((40) - dx)),new cljs.core.Keyword(null,"x2","x2",-1362513475),((x + (40)) + dx),new cljs.core.Keyword(null,"y1","y1",589123466),(48.5 + dy),new cljs.core.Keyword(null,"y2","y2",-718691301),(48.5 + dy),new cljs.core.Keyword(null,"stroke","stroke",1741823555),"black",new cljs.core.Keyword(null,"stroke-width","stroke-width",716836435),2.1], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dy,dx], null)], null)),mecca$castle$castle_arch_$_iter__38079(cljs.core.rest(s__38080__$2)));
}
} else {
return null;
}
