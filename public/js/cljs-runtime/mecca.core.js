...
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-result","set-result",766028711),cljs.core.str.cljs$core$IFn$_invoke$arity$1(mecca.core.eval_all(cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__85270 = cljs.core.deref(mecca.sci_editor._BANG_points);
var G__85270__$1 = (((G__85270 == null))?null:G__85270.state);
var G__85270__$2 = (((G__85270__$1 == null))?null:G__85270__$1.doc);
if((G__85270__$2 == null)){
return null;
} else {
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__85270__$2);
}
})())))], null));
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("re-pressed.core","set-keydown-rules","re-pressed.core/set-keydown-rules",1002257871),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"event-keys","event-keys",-835966631),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-result","set-result",766028711),cljs.core.str.cljs$core$IFn$_invoke$arity$1(mecca.core.eval_all(cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__85274 = cljs.core.deref(mecca.sci_editor._BANG_points);
var G__85274__$1 = (((G__85274 == null))?null:G__85274.state);
var G__85274__$2 = (((G__85274__$1 == null))?null:G__85274__$1.doc);
if((G__85274__$2 == null)){
return null;
} else {
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__85274__$2);
}
