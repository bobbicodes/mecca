...
return cljs.core.map.call(null,(function (p1__21966_SHARP_){
return html_coll.item(p1__21966_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__21967_SHARP_);
...
var ctx_21968 = cvs.getContext("2d");
ctx_21968.fillStyle = color;

ctx_21968.fillRect((0),(0),size,size);
