...
var len__4531__auto___14440 = arguments.length;
var i__4532__auto___14441 = (0);
while(true){
if((i__4532__auto___14441 < len__4531__auto___14440)){
args__4534__auto__.push((arguments[i__4532__auto___14441]));

var G__14442 = (i__4532__auto___14441 + (1));
i__4532__auto___14441 = G__14442;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq14437){
var G__14438 = cljs.core.first.call(null,seq14437);
var seq14437__$1 = cljs.core.next.call(null,seq14437);
var G__14439 = cljs.core.first.call(null,seq14437__$1);
var seq14437__$2 = cljs.core.next.call(null,seq14437__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14438,G__14439,seq14437__$2);
});
...
var vec__14443 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__14443,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__14443,(1),null);
var G__14446 = cljs.core.PersistentArrayMap.EMPTY;
var G__14446__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__14446,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__14446);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__14446__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__14446__$1;
}
} else {
...
return (function() { 
var G__14450__delegate = function (klass,contents){
var vec__14447 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__14447,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__14447,(1),null);
...
var G__14450 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__14451__i = 0, G__14451__a = new Array(arguments.length -  1);
while (G__14451__i < G__14451__a.length) {G__14451__a[G__14451__i] = arguments[G__14451__i + 1]; ++G__14451__i;}
  contents = new cljs.core.IndexedSeq(G__14451__a,0,null);
} 
return G__14450__delegate.call(this,klass,contents);};
G__14450.cljs$lang$maxFixedArity = 1;
G__14450.cljs$lang$applyTo = (function (arglist__14452){
var klass = cljs.core.first(arglist__14452);
var contents = cljs.core.rest(arglist__14452);
return G__14450__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__14456){
...
var ns = cljs.core.get.call(null,map__14457__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__14457__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__14459){
...
var actual = cljs.core.get.call(null,map__14460__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__14460__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__14462){
...
var expected = cljs.core.get.call(null,map__14463__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__14463__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__14465_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__14467 = cljs_test_display.core.current_var_info.call(null);
var map__14467__$1 = ((((!((map__14467 == null)))?(((((map__14467.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14467.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14467):map__14467);
var info = map__14467__$1;
var name = cljs.core.get.call(null,map__14467__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__14467__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__14467__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__14467,map__14467__$1,info,name,line,file,node){
return (function (p1__14466_SHARP_){
return cljs.core.cons.call(null,node,p1__14466_SHARP_);
});})(curr_node,map__14467,map__14467__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__14469){
...
var m = map__14470__$1;
var fail = cljs.core.get.call(null,map__14470__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__14470__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__14470__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__14470__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5457__auto___14472 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___14472)){
var message_14473 = temp__5457__auto___14472;
cljs.core.println.call(null,message_14473);
} else {
}
...
var temp__5457__auto___14474 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___14474)){
var message_14475 = temp__5457__auto___14474;
cljs.core.println.call(null,message_14475);
} else {
}
