...
var len__4531__auto___15468 = arguments.length;
var i__4532__auto___15469 = (0);
while(true){
if((i__4532__auto___15469 < len__4531__auto___15468)){
args__4534__auto__.push((arguments[i__4532__auto___15469]));

var G__15470 = (i__4532__auto___15469 + (1));
i__4532__auto___15469 = G__15470;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq15465){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15466,G__15467,seq15465__$2);
});
...
var vec__15471 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__15471,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__15471,(1),null);
var G__15474 = cljs.core.PersistentArrayMap.EMPTY;
var G__15474__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__15474,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__15474);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__15474__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__15474__$1;
}
} else {
...
return (function() { 
var G__15478__delegate = function (klass,contents){
var vec__15475 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__15475,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__15475,(1),null);
...
var G__15478 = function (klass,var_args){
var contents = null;
...
while (G__15479__i < G__15479__a.length) {G__15479__a[G__15479__i] = arguments[G__15479__i + 1]; ++G__15479__i;}
  contents = new cljs.core.IndexedSeq(G__15479__a,0,null);
} 
return G__15478__delegate.call(this,klass,contents);};
G__15478.cljs$lang$maxFixedArity = 1;
G__15478.cljs$lang$applyTo = (function (arglist__15480){
var klass = cljs.core.first(arglist__15480);
var contents = cljs.core.rest(arglist__15480);
return G__15478__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__15484){
...
var ns = cljs.core.get.call(null,map__15485__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__15485__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__15487){
...
var actual = cljs.core.get.call(null,map__15488__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__15488__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__15490){
...
return cljs.core.cons.call(null,new_current_node,p1__15493_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__15495 = cljs_test_display.core.current_var_info.call(null);
var map__15495__$1 = ((((!((map__15495 == null)))?(((((map__15495.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15495.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15495):map__15495);
var info = map__15495__$1;
var name = cljs.core.get.call(null,map__15495__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__15495__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__15495__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__15495,map__15495__$1,info,name,line,file,node){
return (function (p1__15494_SHARP_){
return cljs.core.cons.call(null,node,p1__15494_SHARP_);
});})(curr_node,map__15495,map__15495__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__15497){
...
var m = map__15498__$1;
var fail = cljs.core.get.call(null,map__15498__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__15498__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__15498__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__15498__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5457__auto___15500 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___15500)){
var message_15501 = temp__5457__auto___15500;
cljs.core.println.call(null,message_15501);
} else {
}
...
var temp__5457__auto___15502 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___15502)){
var message_15503 = temp__5457__auto___15502;
cljs.core.println.call(null,message_15503);
} else {
}
