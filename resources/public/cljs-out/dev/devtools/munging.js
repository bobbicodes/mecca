...
var o22130 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22130["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22131 = temp__5455__auto____$1;
return (o22131["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21950__auto__ = f;
return (o__21950__auto__["toString"]).call(o__21950__auto__);
} else {
return "";
}
}catch (e22132){var _ = e22132;
return "";
}});
...
try{var o__21950__auto___22134 = t;
(o__21950__auto___22134["cljs$lang$ctorPrWriter"]).call(o__21950__auto___22134,t,writer);
}catch (e22133){var __22135 = e22133;
}
...
var char_code = (function (){var o__21950__auto__ = (new String(char$));
return (o__21950__auto__["charCodeAt"]).call(o__21950__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21950__auto__ = String;
return (o__21950__auto__["fromCharCode"]).call(o__21950__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22136 = num_code;
switch (G__22136) {
case (1):
return (185);
...
var o__21950__auto__ = String;
return (o__21950__auto__["fromCharCode"]).call(o__21950__auto__,superscript_code);
});
/**
...
}catch (e22138){var _e__21957__auto__ = e22138;
return false;
}})())){
...
var vec__22139 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22139,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o22142 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22142["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22143 = temp__5455__auto____$1;
return (o22143["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___22150 = arguments.length;
var i__4532__auto___22151 = (0);
while(true){
if((i__4532__auto___22151 < len__4531__auto___22150)){
args__4534__auto__.push((arguments[i__4532__auto___22151]));

var G__22152 = (i__4532__auto___22151 + (1));
i__4532__auto___22151 = G__22152;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22146){
var vec__22147 = p__22146;
var ns_detector = cljs.core.nth.call(null,vec__22147,(0),null);
...
var G__22153 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22154 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22153;
remaining_tokens = G__22154;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22144){
var G__22145 = cljs.core.first.call(null,seq22144);
var seq22144__$1 = cljs.core.next.call(null,seq22144);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22145,seq22144__$1);
});
...
var vec__22158 = cljs.core.split_with.call(null,(function (p1__22157_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22157_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22158,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22158,(1),null);
...
var vec__22161 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22161,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22161,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22164 = cljs.core.rest.call(null,remaining_tokens);
var G__22165 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22164;
name_tokens = G__22165;
continue;
} else {
...
var vec__22168 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22168,(0),null);
var arity = cljs.core.nth.call(null,vec__22168,(1),null);
var vec__22171 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22171,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22171,(1),null);
var vec__22174 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22174,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22174,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22174,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22174,(3),null);
...
var vec__22180 = result;
var munged_ns = cljs.core.nth.call(null,vec__22180,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22180,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22180,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22180,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22180,(4),null);
var arity = cljs.core.nth.call(null,vec__22180,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__22184 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__22184,(0),null);
var args = cljs.core.nth.call(null,vec__22184,(1),null);
var vec__22187 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22187,(0),null);
var name = cljs.core.nth.call(null,vec__22187,(1),null);
...
var G__22190 = (arity + (1));
var G__22191 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22192){
var vec__22193 = p__22192;
var arity = cljs.core.nth.call(null,vec__22193,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22193,(1),null);
...
return cljs.core.get.call(null,arities,p1__22196_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22197_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___22204 = arguments.length;
var i__4532__auto___22205 = (0);
while(true){
if((i__4532__auto___22205 < len__4531__auto___22204)){
args__4534__auto__.push((arguments[i__4532__auto___22205]));

var G__22206 = (i__4532__auto___22205 + (1));
i__4532__auto___22205 = G__22206;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22200){
var vec__22201 = p__22200;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22201,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22198){
var G__22199 = cljs.core.first.call(null,seq22198);
var seq22198__$1 = cljs.core.next.call(null,seq22198);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22199,seq22198__$1);
});
...
var map__22209 = options;
var map__22209__$1 = ((((!((map__22209 == null)))?(((((map__22209.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22209.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22209):map__22209);
var include_ns_QMARK_ = cljs.core.get.call(null,map__22209__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22209__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22209__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22209__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22210 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22210,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22210,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22210,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22210,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22210,(4),null);
var arity = cljs.core.nth.call(null,vec__22210,(5),null);
...
var o__21950__auto__ = f;
return (o__21950__auto__["getBasis"]).call(o__21950__auto__);
});
/**
...
}catch (e22214){var _e__21957__auto__ = e22214;
...
var G__22215 = (obj[cljs.core.first.call(null,path)]);
var G__22216 = cljs.core.rest.call(null,path);
obj = G__22215;
path = G__22216;
continue;
} else {
...
return (function (accum,p__22217){
var vec__22218 = p__22217;
var bit = cljs.core.nth.call(null,vec__22218,(0),null);
var protocol = cljs.core.nth.call(null,vec__22218,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22221){
var vec__22222 = p__22221;
var ns = cljs.core.nth.call(null,vec__22222,(0),null);
var name = cljs.core.nth.call(null,vec__22222,(1),null);
var selector = cljs.core.nth.call(null,vec__22222,(2),null);
...
return (function (p__22226){
var vec__22227 = p__22226;
var munged_name = cljs.core.nth.call(null,vec__22227,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22227,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22227,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22225_SHARP_){
return (obj[cljs.core.first.call(null,p1__22225_SHARP_)]);
});})(name,sorted_matches,vec__22227,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
