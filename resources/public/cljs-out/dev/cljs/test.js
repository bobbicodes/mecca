...
var G__21114 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__21114,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__21114;
}
});
...
var len__4531__auto___21119 = arguments.length;
var i__4532__auto___21120 = (0);
while(true){
if((i__4532__auto___21120 < len__4531__auto___21119)){
args__4534__auto__.push((arguments[i__4532__auto___21120]));

var G__21121 = (i__4532__auto___21120 + (1));
i__4532__auto___21120 = G__21121;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq21116){
...
var file = cljs.core.get.call(null,map__21123__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__21123__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__21123__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__21123,map__21123__$1,file,line,column){
return (function (p1__21122_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__21122_SHARP_));
});})(map__21123,map__21123__$1,file,line,column))
...
var temp__5457__auto___21125 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21125)){
var message_21126 = temp__5457__auto___21125;
cljs.core.println.call(null,message_21126);
} else {
}
...
var output_dir__$1 = (function (){var G__21129 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21129),"/"].join('');
} else {
return G__21129;
}
})();
...
var G__21131 = exception.stack;
var G__21131__$1 = (((G__21131 == null))?null:clojure.string.split_lines.call(null,G__21131));
var G__21131__$2 = (((G__21131__$1 == null))?null:cljs.core.get.call(null,G__21131__$1,depth));
if((G__21131__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__21131__$2);
}
} else {
...
var vec__21132 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__21132,(0),null);
var column = cljs.core.nth.call(null,vec__21132,(1),null);
var vec__21135 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__21135,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__21135,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__21135,(2),null);
...
var m__$1 = (function (){var G__21138 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__21138__$1 = (((G__21138 instanceof cljs.core.Keyword))?G__21138.fqn:null);
switch (G__21138__$1) {
case "fail":
...
var G__21142 = (function (){var G__21141 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__21141);
} else {
return G__21141;
}
})();
...
return cljs.core.vary_meta.call(null,G__21143,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__21147 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__21147,(0),null);
var types = vec__21147;
...
return cljs.core.map.call(null,(function (p__21150){
var vec__21151 = p__21150;
var ns = cljs.core.nth.call(null,vec__21151,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__21151,(1),null);
return ((function (vec__21151,ns,vars__$1){
return (function (){
...
var G__21154 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__21154__$1 = (((G__21154 instanceof cljs.core.Keyword))?G__21154.fqn:null);
switch (G__21154__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__21154,G__21154__$1,env,once_fixtures,each_fixtures,vec__21151,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__21154,G__21154__$1,env,once_fixtures,each_fixtures,vec__21151,ns,vars__$1){
return (function (){
var seq__21155 = cljs.core.seq.call(null,vars__$1);
var chunk__21156 = null;
var count__21157 = (0);
var i__21158 = (0);
while(true){
if((i__21158 < count__21157)){
var v = cljs.core._nth.call(null,chunk__21156,i__21158);
var temp__5457__auto___21160 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___21160)){
var t_21161 = temp__5457__auto___21160;
each_fixture_fn.call(null,((function (seq__21155,chunk__21156,count__21157,i__21158,t_21161,temp__5457__auto___21160,v,each_fixture_fn,G__21154,G__21154__$1,env,once_fixtures,each_fixtures,vec__21151,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21161)));
});})(seq__21155,chunk__21156,count__21157,i__21158,t_21161,temp__5457__auto___21160,v,each_fixture_fn,G__21154,G__21154__$1,env,once_fixtures,each_fixtures,vec__21151,ns,vars__$1))
);
} else {
}


var G__21162 = seq__21155;
var G__21163 = chunk__21156;
var G__21164 = count__21157;
var G__21165 = (i__21158 + (1));
seq__21155 = G__21162;
chunk__21156 = G__21163;
count__21157 = G__21164;
i__21158 = G__21165;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__21155);
if(temp__5457__auto__){
var seq__21155__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__21155__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__21155__$1);
var G__21166 = cljs.core.chunk_rest.call(null,seq__21155__$1);
var G__21167 = c__4351__auto__;
var G__21168 = cljs.core.count.call(null,c__4351__auto__);
var G__21169 = (0);
seq__21155 = G__21166;
chunk__21156 = G__21167;
count__21157 = G__21168;
i__21158 = G__21169;
continue;
} else {
var v = cljs.core.first.call(null,seq__21155__$1);
var temp__5457__auto___21170__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___21170__$1)){
var t_21171 = temp__5457__auto___21170__$1;
each_fixture_fn.call(null,((function (seq__21155,chunk__21156,count__21157,i__21158,t_21171,temp__5457__auto___21170__$1,v,seq__21155__$1,temp__5457__auto__,each_fixture_fn,G__21154,G__21154__$1,env,once_fixtures,each_fixtures,vec__21151,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21171)));
});})(seq__21155,chunk__21156,count__21157,i__21158,t_21171,temp__5457__auto___21170__$1,v,seq__21155__$1,temp__5457__auto__,each_fixture_fn,G__21154,G__21154__$1,env,once_fixtures,each_fixtures,vec__21151,ns,vars__$1))
);
} else {
}


var G__21172 = cljs.core.next.call(null,seq__21155__$1);
var G__21173 = null;
var G__21174 = (0);
var G__21175 = (0);
seq__21155 = G__21172;
chunk__21156 = G__21173;
count__21157 = G__21174;
i__21158 = G__21175;
continue;
}
} else {
...
});})(each_fixture_fn,G__21154,G__21154__$1,env,once_fixtures,each_fixtures,vec__21151,ns,vars__$1))
);
});})(each_fixture_fn,G__21154,G__21154__$1,env,once_fixtures,each_fixtures,vec__21151,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21154__$1)].join('')));

}
})());
});
;})(vec__21151,ns,vars__$1))
