...
var G__15258 = devtools.prefs.pref.call(null,v);
v = G__15258;
continue;
} else {
return v;
...
}catch (e15261){var _e__14512__auto__ = e15261;
return false;
}})();
...
}catch (e15265){var _e__14512__auto__ = e15265;
return false;
}})();
...
}catch (e15267){var _e__14512__auto__ = e15267;
return false;
}}
}
});
...
var vec__15269 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__15269,(0),null);
var name = cljs.core.nth.call(null,vec__15269,(1),null);
...
return cljs.core.some.call(null,(function (p1__15272_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15272_SHARP_);
}),template);
});
