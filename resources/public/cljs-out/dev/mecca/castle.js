...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,(function (){var iter__4324__auto__ = (function mecca$castle$castle_arch_$_iter__19987(s__19988){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__19990),mecca$castle$castle_arch_$_iter__19987(cljs.core.chunk_rest(s__19988__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__19990),null);
}
} else {
var vec__19994 = cljs.core.first(s__19988__$2);
var dy = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19994,(0),null);
var dx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19994,(1),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$line,new cljs.core.PersistentArrayMap(null, 6, [cljs.core.cst$kw$x1,(x + ((40) - dx)),cljs.core.cst$kw$x2,((x + (40)) + dx),cljs.core.cst$kw$y1,(48.5 + dy),cljs.core.cst$kw$y2,(48.5 + dy),cljs.core.cst$kw$stroke,"black",cljs.core.cst$kw$stroke_DASH_width,2.1], null)], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [dy,dx], null)], null)),mecca$castle$castle_arch_$_iter__19987(cljs.core.rest(s__19988__$2)));
}
} else {
return null;
}
