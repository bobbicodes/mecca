...
var notes = (function (){var G__14371 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$notes], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__14371) : re_frame.core.subscribe.call(null,G__14371));
})();
var now = cljs.core.deref(mecca.music.audiocontext).currentTime;
var tempo = (function (){var G__14372 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$tempo], null);
...
return (((from <= cljs.core.cst$kw$time.cljs$core$IFn$_invoke$arity$1(p1__14370_SHARP_))) && ((cljs.core.cst$kw$time.cljs$core$IFn$_invoke$arity$1(p1__14370_SHARP_) <= to)));
});})(notes,now,tempo))
,cljs.core.deref(notes));
var G__14373_14382 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$reset_DASH_position], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__14373_14382) : re_frame.core.dispatch.call(null,G__14373_14382));

return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4324__auto__ = ((function (notes,now,tempo,section){
return (function mecca$music$play_section_$_iter__14374(s__14375){
return (new cljs.core.LazySeq(null,((function (notes,now,tempo,section){
return (function (){
var s__14375__$1 = s__14375;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__14375__$1);
if(temp__5457__auto__){
var s__14375__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__14375__$2)){
var c__4322__auto__ = cljs.core.chunk_first(s__14375__$2);
var size__4323__auto__ = cljs.core.count(c__4322__auto__);
var b__14377 = cljs.core.chunk_buffer(size__4323__auto__);
if((function (){var i__14376 = (0);
while(true){
if((i__14376 < size__4323__auto__)){
var map__14378 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4322__auto__,i__14376);
...
var time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14378__$1,cljs.core.cst$kw$time);
var instrument = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14378__$1,cljs.core.cst$kw$instrument);
var pitch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14378__$1,cljs.core.cst$kw$pitch);
cljs.core.chunk_append(b__14377,mecca.music.play_at(instrument,pitch,(now + (((60) / cljs.core.deref(tempo)) * time))));

var G__14383 = (i__14376 + (1));
i__14376 = G__14383;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__14377),mecca$music$play_section_$_iter__14374(cljs.core.chunk_rest(s__14375__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__14377),null);
}
} else {
var map__14380 = cljs.core.first(s__14375__$2);
...
var time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14380__$1,cljs.core.cst$kw$time);
var instrument = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14380__$1,cljs.core.cst$kw$instrument);
var pitch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14380__$1,cljs.core.cst$kw$pitch);
return cljs.core.cons(mecca.music.play_at(instrument,pitch,(now + (((60) / cljs.core.deref(tempo)) * time))),mecca$music$play_section_$_iter__14374(cljs.core.rest(s__14375__$2)));
}
} else {
return null;
}
...
var notes = (function (){var G__14384 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$notes], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__14384) : re_frame.core.subscribe.call(null,G__14384));
})();
var now = cljs.core.deref(mecca.music.audiocontext).currentTime;
var tempo = (function (){var G__14385 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$tempo], null);
...
var G__14386_14395 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$reset_DASH_position], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__14386_14395) : re_frame.core.dispatch.call(null,G__14386_14395));

return cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4324__auto__ = ((function (notes,now,tempo){
return (function mecca$music$play_song_BANG__$_iter__14387(s__14388){
return (new cljs.core.LazySeq(null,((function (notes,now,tempo){
return (function (){
var s__14388__$1 = s__14388;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__14388__$1);
if(temp__5457__auto__){
var s__14388__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__14388__$2)){
var c__4322__auto__ = cljs.core.chunk_first(s__14388__$2);
var size__4323__auto__ = cljs.core.count(c__4322__auto__);
var b__14390 = cljs.core.chunk_buffer(size__4323__auto__);
if((function (){var i__14389 = (0);
while(true){
if((i__14389 < size__4323__auto__)){
var map__14391 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4322__auto__,i__14389);
...
var instrument = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14391__$1,cljs.core.cst$kw$instrument);
var pitch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14391__$1,cljs.core.cst$kw$pitch);
cljs.core.chunk_append(b__14390,mecca.music.play_at(instrument,pitch,(now + (((60) / cljs.core.deref(tempo)) * time))));

var G__14396 = (i__14389 + (1));
i__14389 = G__14396;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__14390),mecca$music$play_song_BANG__$_iter__14387(cljs.core.chunk_rest(s__14388__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__14390),null);
}
} else {
var map__14393 = cljs.core.first(s__14388__$2);
...
var instrument = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14393__$1,cljs.core.cst$kw$instrument);
var pitch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14393__$1,cljs.core.cst$kw$pitch);
return cljs.core.cons(mecca.music.play_at(instrument,pitch,(now + (((60) / cljs.core.deref(tempo)) * time))),mecca$music$play_song_BANG__$_iter__14387(cljs.core.rest(s__14388__$2)));
}
} else {
return null;
}
