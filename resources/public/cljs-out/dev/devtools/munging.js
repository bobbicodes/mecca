...
var o21336 = temp__5455__auto__;
var temp__5455__auto____$1 = (o21336["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o21337 = temp__5455__auto____$1;
return (o21337["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21156__auto__ = f;
return (o__21156__auto__["toString"]).call(o__21156__auto__);
} else {
return "";
}
}catch (e21338){var _ = e21338;
return "";
}});
...
try{var o__21156__auto___21340 = t;
(o__21156__auto___21340["cljs$lang$ctorPrWriter"]).call(o__21156__auto___21340,t,writer);
}catch (e21339){var __21341 = e21339;
}
...
var char_code = (function (){var o__21156__auto__ = (new String(char$));
return (o__21156__auto__["charCodeAt"]).call(o__21156__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21156__auto__ = String;
return (o__21156__auto__["fromCharCode"]).call(o__21156__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21342 = num_code;
switch (G__21342) {
case (1):
return (185);
...
var o__21156__auto__ = String;
return (o__21156__auto__["fromCharCode"]).call(o__21156__auto__,superscript_code);
});
/**
...
}catch (e21344){var _e__21163__auto__ = e21344;
return false;
}})())){
...
var vec__21345 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21345,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o21348 = temp__5455__auto__;
var temp__5455__auto____$1 = (o21348["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o21349 = temp__5455__auto____$1;
return (o21349["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21352){
var vec__21353 = p__21352;
var ns_detector = cljs.core.nth.call(null,vec__21353,(0),null);
...
var G__21359 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21360 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21359;
remaining_tokens = G__21360;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21350){
var G__21351 = cljs.core.first.call(null,seq21350);
var seq21350__$1 = cljs.core.next.call(null,seq21350);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21351,seq21350__$1);
});
...
var vec__21364 = cljs.core.split_with.call(null,(function (p1__21363_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21363_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21364,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21364,(1),null);
...
var vec__21367 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21367,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21367,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__21370 = cljs.core.rest.call(null,remaining_tokens);
var G__21371 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__21370;
name_tokens = G__21371;
continue;
} else {
...
var vec__21374 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__21374,(0),null);
var arity = cljs.core.nth.call(null,vec__21374,(1),null);
var vec__21377 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__21377,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__21377,(1),null);
var vec__21380 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__21380,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__21380,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__21380,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__21380,(3),null);
...
var vec__21386 = result;
var munged_ns = cljs.core.nth.call(null,vec__21386,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__21386,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__21386,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__21386,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__21386,(4),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__21390 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__21390,(0),null);
var args = cljs.core.nth.call(null,vec__21390,(1),null);
var vec__21393 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__21393,(0),null);
var name = cljs.core.nth.call(null,vec__21393,(1),null);
...
var G__21396 = (arity + (1));
var G__21397 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21398){
var vec__21399 = p__21398;
var arity = cljs.core.nth.call(null,vec__21399,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__21399,(1),null);
...
return cljs.core.get.call(null,arities,p1__21402_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__21403_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___21410 = arguments.length;
var i__4532__auto___21411 = (0);
while(true){
if((i__4532__auto___21411 < len__4531__auto___21410)){
args__4534__auto__.push((arguments[i__4532__auto___21411]));

var G__21412 = (i__4532__auto___21411 + (1));
i__4532__auto___21411 = G__21412;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21406){
var vec__21407 = p__21406;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__21407,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21404){
var G__21405 = cljs.core.first.call(null,seq21404);
var seq21404__$1 = cljs.core.next.call(null,seq21404);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21405,seq21404__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__21415__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__21415__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__21415__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__21415__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21416 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__21416,(0),null);
var fn_name = cljs.core.nth.call(null,vec__21416,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__21416,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__21416,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__21416,(4),null);
var arity = cljs.core.nth.call(null,vec__21416,(5),null);
...
var o__21156__auto__ = f;
return (o__21156__auto__["getBasis"]).call(o__21156__auto__);
});
/**
...
}catch (e21420){var _e__21163__auto__ = e21420;
...
var G__21421 = (obj[cljs.core.first.call(null,path)]);
var G__21422 = cljs.core.rest.call(null,path);
obj = G__21421;
path = G__21422;
continue;
} else {
...
return (function (accum,p__21423){
var vec__21424 = p__21423;
var bit = cljs.core.nth.call(null,vec__21424,(0),null);
var protocol = cljs.core.nth.call(null,vec__21424,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21427){
var vec__21428 = p__21427;
var ns = cljs.core.nth.call(null,vec__21428,(0),null);
var name = cljs.core.nth.call(null,vec__21428,(1),null);
var selector = cljs.core.nth.call(null,vec__21428,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__21433,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__21433,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__21433,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__21431_SHARP_){
return (obj[cljs.core.first.call(null,p1__21431_SHARP_)]);
});})(name,sorted_matches,vec__21433,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
