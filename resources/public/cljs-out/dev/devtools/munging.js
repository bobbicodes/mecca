...
var o23183 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23183["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23184 = temp__5455__auto____$1;
return (o23184["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22113__auto__ = f;
return (o__22113__auto__["toString"]).call(o__22113__auto__);
} else {
return "";
}
}catch (e23185){var _ = e23185;
return "";
}});
...
try{var o__22113__auto___23187 = t;
(o__22113__auto___23187["cljs$lang$ctorPrWriter"]).call(o__22113__auto___23187,t,writer);
}catch (e23186){var __23188 = e23186;
}
...
var char_code = (function (){var o__22113__auto__ = (new String(char$));
return (o__22113__auto__["charCodeAt"]).call(o__22113__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22113__auto__ = String;
return (o__22113__auto__["fromCharCode"]).call(o__22113__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23189 = num_code;
switch (G__23189) {
case (1):
return (185);
...
var o__22113__auto__ = String;
return (o__22113__auto__["fromCharCode"]).call(o__22113__auto__,superscript_code);
});
/**
...
}catch (e23191){var _e__22120__auto__ = e23191;
return false;
}})())){
...
var vec__23192 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23192,(0),null);
...
var temp__5455__auto____$1 = (o23195["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23196 = temp__5455__auto____$1;
return (o23196["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___23203 = arguments.length;
var i__4532__auto___23204 = (0);
while(true){
if((i__4532__auto___23204 < len__4531__auto___23203)){
args__4534__auto__.push((arguments[i__4532__auto___23204]));

var G__23205 = (i__4532__auto___23204 + (1));
i__4532__auto___23204 = G__23205;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23199){
var vec__23200 = p__23199;
var ns_detector = cljs.core.nth.call(null,vec__23200,(0),null);
...
var G__23206 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23207 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23206;
remaining_tokens = G__23207;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23197){
...
var vec__23211 = cljs.core.split_with.call(null,(function (p1__23210_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23210_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23211,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23211,(1),null);
...
var vec__23214 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23214,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23214,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23217 = cljs.core.rest.call(null,remaining_tokens);
var G__23218 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23217;
name_tokens = G__23218;
continue;
} else {
...
var vec__23221 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23221,(0),null);
var arity = cljs.core.nth.call(null,vec__23221,(1),null);
var vec__23224 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23224,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23224,(1),null);
var vec__23227 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23227,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23227,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23227,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23227,(3),null);
...
var vec__23233 = result;
var munged_ns = cljs.core.nth.call(null,vec__23233,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23233,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23233,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23233,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23233,(4),null);
var arity = cljs.core.nth.call(null,vec__23233,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23237 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23237,(0),null);
var args = cljs.core.nth.call(null,vec__23237,(1),null);
var vec__23240 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23240,(0),null);
var name = cljs.core.nth.call(null,vec__23240,(1),null);
...
var G__23243 = (arity + (1));
var G__23244 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23245){
var vec__23246 = p__23245;
var arity = cljs.core.nth.call(null,vec__23246,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23246,(1),null);
...
return cljs.core.get.call(null,arities,p1__23249_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23250_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___23257 = arguments.length;
var i__4532__auto___23258 = (0);
while(true){
if((i__4532__auto___23258 < len__4531__auto___23257)){
args__4534__auto__.push((arguments[i__4532__auto___23258]));

var G__23259 = (i__4532__auto___23258 + (1));
i__4532__auto___23258 = G__23259;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23253){
var vec__23254 = p__23253;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23254,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23251){
var G__23252 = cljs.core.first.call(null,seq23251);
var seq23251__$1 = cljs.core.next.call(null,seq23251);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23252,seq23251__$1);
});
...
var G__23260 = arg;
var G__23260__$1 = (((G__23260 instanceof cljs.core.Keyword))?G__23260.fqn:null);
switch (G__23260__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23262__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23262__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23262__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23262__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23263 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23263,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23263,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23263,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23263,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23263,(4),null);
var arity = cljs.core.nth.call(null,vec__23263,(5),null);
...
var o__22113__auto__ = f;
return (o__22113__auto__["getBasis"]).call(o__22113__auto__);
});
/**
...
}catch (e23267){var _e__22120__auto__ = e23267;
...
var G__23268 = (obj[cljs.core.first.call(null,path)]);
var G__23269 = cljs.core.rest.call(null,path);
obj = G__23268;
path = G__23269;
continue;
} else {
...
return (function (accum,p__23270){
var vec__23271 = p__23270;
var bit = cljs.core.nth.call(null,vec__23271,(0),null);
var protocol = cljs.core.nth.call(null,vec__23271,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23274){
var vec__23275 = p__23274;
var ns = cljs.core.nth.call(null,vec__23275,(0),null);
var name = cljs.core.nth.call(null,vec__23275,(1),null);
var selector = cljs.core.nth.call(null,vec__23275,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__23280,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23280,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23280,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23278_SHARP_){
return (obj[cljs.core.first.call(null,p1__23278_SHARP_)]);
});})(name,sorted_matches,vec__23280,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
