...
var G__15310 = devtools.prefs.pref.call(null,v);
v = G__15310;
continue;
} else {
return v;
...
}catch (e15313){var _e__14564__auto__ = e15313;
return false;
}})();
...
}catch (e15317){var _e__14564__auto__ = e15317;
return false;
}})();
...
}catch (e15319){var _e__14564__auto__ = e15319;
return false;
}}
}
});
...
var vec__15321 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__15321,(0),null);
var name = cljs.core.nth.call(null,vec__15321,(1),null);
...
return cljs.core.some.call(null,(function (p1__15324_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15324_SHARP_);
}),template);
});
