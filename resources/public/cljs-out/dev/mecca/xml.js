...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__21258_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(tag,cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__21258_SHARP_,cljs.core.cst$kw$tag));
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__21259_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(voice,mecca.xml.get_voice(p1__21259_SHARP_));
...
return new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$time,time,cljs.core.cst$kw$pitch,((mecca.xml.pitch__GT_midi(mecca.xml.get_pitch(note)) + (function (){var G__21260 = mecca.xml.get_voice(note);
switch (G__21260) {
case (5):
return (12);
...
})()) + (6)),cljs.core.cst$kw$instrument,(function (){var G__21261 = mecca.xml.get_voice(note);
switch (G__21261) {
case (5):
return (15);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21261)].join('')));
...
var G__21264 = (time + (mecca.xml.get_duration(cljs.core.first(notes)) / (6)));
var G__21265 = cljs.core.rest(notes);
var G__21266 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,mecca.xml.parse_note(cljs.core.first(notes),time));
time = G__21264;
notes = G__21265;
result = G__21266;
continue;
...
return mecca.xml.extract_voice(p1__21267_SHARP_,voice);
});})(time))
...
var G__21268 = (time + (mecca.xml.get_duration(cljs.core.first(notes)) / (6)));
var G__21269 = cljs.core.rest(notes);
var G__21270 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,mecca.xml.parse_note(cljs.core.first(notes),time));
time = G__21268;
notes = G__21269;
result = G__21270;
continue;
