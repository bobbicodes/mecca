...
var o15696 = temp__5455__auto__;
var temp__5455__auto____$1 = (o15696["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o15697 = temp__5455__auto____$1;
return (o15697["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__15516__auto__ = f;
return (o__15516__auto__["toString"]).call(o__15516__auto__);
} else {
return "";
}
}catch (e15698){var _ = e15698;
return "";
}});
...
try{var o__15516__auto___15700 = t;
(o__15516__auto___15700["cljs$lang$ctorPrWriter"]).call(o__15516__auto___15700,t,writer);
}catch (e15699){var __15701 = e15699;
}
...
var char_code = (function (){var o__15516__auto__ = (new String(char$));
return (o__15516__auto__["charCodeAt"]).call(o__15516__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__15516__auto__ = String;
return (o__15516__auto__["fromCharCode"]).call(o__15516__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__15702 = num_code;
switch (G__15702) {
case (1):
return (185);
...
var o__15516__auto__ = String;
return (o__15516__auto__["fromCharCode"]).call(o__15516__auto__,superscript_code);
});
/**
...
}catch (e15704){var _e__15523__auto__ = e15704;
return false;
}})())){
...
var vec__15705 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__15705,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o15708 = temp__5455__auto__;
var temp__5455__auto____$1 = (o15708["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o15709 = temp__5455__auto____$1;
return (o15709["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__15712){
var vec__15713 = p__15712;
var ns_detector = cljs.core.nth.call(null,vec__15713,(0),null);
...
var G__15719 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__15720 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__15719;
remaining_tokens = G__15720;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq15710){
var G__15711 = cljs.core.first.call(null,seq15710);
var seq15710__$1 = cljs.core.next.call(null,seq15710);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15711,seq15710__$1);
});
...
var vec__15724 = cljs.core.split_with.call(null,(function (p1__15723_SHARP_){
return cljs.core.not_EQ_.call(null,p1__15723_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__15724,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__15724,(1),null);
...
var vec__15727 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__15727,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__15727,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__15730 = cljs.core.rest.call(null,remaining_tokens);
var G__15731 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__15730;
name_tokens = G__15731;
continue;
} else {
...
var vec__15734 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__15734,(0),null);
var arity = cljs.core.nth.call(null,vec__15734,(1),null);
var vec__15737 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__15737,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__15737,(1),null);
var vec__15740 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__15740,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__15740,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__15740,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__15740,(3),null);
...
var vec__15746 = result;
var munged_ns = cljs.core.nth.call(null,vec__15746,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__15746,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__15746,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__15746,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__15746,(4),null);
var arity = cljs.core.nth.call(null,vec__15746,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__15750 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__15750,(0),null);
var args = cljs.core.nth.call(null,vec__15750,(1),null);
var vec__15753 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__15753,(0),null);
var name = cljs.core.nth.call(null,vec__15753,(1),null);
...
var G__15756 = (arity + (1));
var G__15757 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__15758){
var vec__15759 = p__15758;
var arity = cljs.core.nth.call(null,vec__15759,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__15759,(1),null);
...
return cljs.core.get.call(null,arities,p1__15762_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__15763_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___15770 = arguments.length;
var i__4532__auto___15771 = (0);
while(true){
if((i__4532__auto___15771 < len__4531__auto___15770)){
args__4534__auto__.push((arguments[i__4532__auto___15771]));

var G__15772 = (i__4532__auto___15771 + (1));
i__4532__auto___15771 = G__15772;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__15766){
var vec__15767 = p__15766;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__15767,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq15764){
var G__15765 = cljs.core.first.call(null,seq15764);
var seq15764__$1 = cljs.core.next.call(null,seq15764);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__15765,seq15764__$1);
});
...
var map__15775 = options;
var map__15775__$1 = ((((!((map__15775 == null)))?(((((map__15775.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__15775.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15775):map__15775);
var include_ns_QMARK_ = cljs.core.get.call(null,map__15775__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__15775__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__15775__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__15775__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__15776 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__15776,(0),null);
var fn_name = cljs.core.nth.call(null,vec__15776,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__15776,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__15776,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__15776,(4),null);
var arity = cljs.core.nth.call(null,vec__15776,(5),null);
...
var o__15516__auto__ = f;
return (o__15516__auto__["getBasis"]).call(o__15516__auto__);
});
/**
...
}catch (e15780){var _e__15523__auto__ = e15780;
...
var G__15781 = (obj[cljs.core.first.call(null,path)]);
var G__15782 = cljs.core.rest.call(null,path);
obj = G__15781;
path = G__15782;
continue;
} else {
...
return (function (accum,p__15783){
var vec__15784 = p__15783;
var bit = cljs.core.nth.call(null,vec__15784,(0),null);
var protocol = cljs.core.nth.call(null,vec__15784,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__15787){
var vec__15788 = p__15787;
var ns = cljs.core.nth.call(null,vec__15788,(0),null);
var name = cljs.core.nth.call(null,vec__15788,(1),null);
var selector = cljs.core.nth.call(null,vec__15788,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__15793,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__15793,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__15793,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__15791_SHARP_){
return (obj[cljs.core.first.call(null,p1__15791_SHARP_)]);
});})(name,sorted_matches,vec__15793,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
