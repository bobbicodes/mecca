...
var G__21094 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__21094,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__21094;
}
});
...
var len__4531__auto___21099 = arguments.length;
var i__4532__auto___21100 = (0);
while(true){
if((i__4532__auto___21100 < len__4531__auto___21099)){
args__4534__auto__.push((arguments[i__4532__auto___21100]));

var G__21101 = (i__4532__auto___21100 + (1));
i__4532__auto___21100 = G__21101;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq21096){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21097,G__21098,seq21096__$2);
});
...
var map__21103 = m;
var map__21103__$1 = ((((!((map__21103 == null)))?(((((map__21103.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21103.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21103):map__21103);
var file = cljs.core.get.call(null,map__21103__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__21103__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__21103__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__21103,map__21103__$1,file,line,column){
return (function (p1__21102_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__21102_SHARP_));
});})(map__21103,map__21103__$1,file,line,column))
...
var temp__5457__auto___21105 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21105)){
var message_21106 = temp__5457__auto___21105;
cljs.core.println.call(null,message_21106);
} else {
}
...
var temp__5457__auto___21107 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21107)){
var message_21108 = temp__5457__auto___21107;
cljs.core.println.call(null,message_21108);
} else {
}
...
var output_dir__$1 = (function (){var G__21109 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21109),"/"].join('');
} else {
return G__21109;
}
})();
...
var G__21111 = exception.stack;
var G__21111__$1 = (((G__21111 == null))?null:clojure.string.split_lines.call(null,G__21111));
var G__21111__$2 = (((G__21111__$1 == null))?null:cljs.core.get.call(null,G__21111__$1,depth));
if((G__21111__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__21111__$2);
}
} else {
...
var vec__21112 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__21112,(0),null);
var column = cljs.core.nth.call(null,vec__21112,(1),null);
var vec__21115 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__21115,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__21115,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__21115,(2),null);
...
var m__$1 = (function (){var G__21118 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__21122 = (function (){var G__21121 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__21121);
} else {
return G__21121;
}
})();
...
return cljs.core.vary_meta.call(null,G__21123,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__21127 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__21127,(0),null);
var types = vec__21127;
...
return cljs.core.map.call(null,(function (p__21130){
var vec__21131 = p__21130;
var ns = cljs.core.nth.call(null,vec__21131,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__21131,(1),null);
return ((function (vec__21131,ns,vars__$1){
return (function (){
...
var G__21134 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__21134__$1 = (((G__21134 instanceof cljs.core.Keyword))?G__21134.fqn:null);
switch (G__21134__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__21134,G__21134__$1,env,once_fixtures,each_fixtures,vec__21131,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__21134,G__21134__$1,env,once_fixtures,each_fixtures,vec__21131,ns,vars__$1){
return (function (){
var seq__21135 = cljs.core.seq.call(null,vars__$1);
var chunk__21136 = null;
var count__21137 = (0);
var i__21138 = (0);
while(true){
if((i__21138 < count__21137)){
var v = cljs.core._nth.call(null,chunk__21136,i__21138);
var temp__5457__auto___21140 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___21140)){
var t_21141 = temp__5457__auto___21140;
each_fixture_fn.call(null,((function (seq__21135,chunk__21136,count__21137,i__21138,t_21141,temp__5457__auto___21140,v,each_fixture_fn,G__21134,G__21134__$1,env,once_fixtures,each_fixtures,vec__21131,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21141)));
});})(seq__21135,chunk__21136,count__21137,i__21138,t_21141,temp__5457__auto___21140,v,each_fixture_fn,G__21134,G__21134__$1,env,once_fixtures,each_fixtures,vec__21131,ns,vars__$1))
);
} else {
}


var G__21142 = seq__21135;
var G__21143 = chunk__21136;
var G__21144 = count__21137;
var G__21145 = (i__21138 + (1));
seq__21135 = G__21142;
chunk__21136 = G__21143;
count__21137 = G__21144;
i__21138 = G__21145;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__21135);
if(temp__5457__auto__){
var seq__21135__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__21135__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__21135__$1);
var G__21146 = cljs.core.chunk_rest.call(null,seq__21135__$1);
var G__21147 = c__4351__auto__;
var G__21148 = cljs.core.count.call(null,c__4351__auto__);
var G__21149 = (0);
seq__21135 = G__21146;
chunk__21136 = G__21147;
count__21137 = G__21148;
i__21138 = G__21149;
continue;
} else {
var v = cljs.core.first.call(null,seq__21135__$1);
var temp__5457__auto___21150__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___21150__$1)){
var t_21151 = temp__5457__auto___21150__$1;
each_fixture_fn.call(null,((function (seq__21135,chunk__21136,count__21137,i__21138,t_21151,temp__5457__auto___21150__$1,v,seq__21135__$1,temp__5457__auto__,each_fixture_fn,G__21134,G__21134__$1,env,once_fixtures,each_fixtures,vec__21131,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_21151)));
});})(seq__21135,chunk__21136,count__21137,i__21138,t_21151,temp__5457__auto___21150__$1,v,seq__21135__$1,temp__5457__auto__,each_fixture_fn,G__21134,G__21134__$1,env,once_fixtures,each_fixtures,vec__21131,ns,vars__$1))
);
} else {
}


var G__21152 = cljs.core.next.call(null,seq__21135__$1);
var G__21153 = null;
var G__21154 = (0);
var G__21155 = (0);
seq__21135 = G__21152;
chunk__21136 = G__21153;
count__21137 = G__21154;
i__21138 = G__21155;
continue;
}
} else {
...
});})(each_fixture_fn,G__21134,G__21134__$1,env,once_fixtures,each_fixtures,vec__21131,ns,vars__$1))
);
});})(each_fixture_fn,G__21134,G__21134__$1,env,once_fixtures,each_fixtures,vec__21131,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21134__$1)].join('')));

}
})());
});
;})(vec__21131,ns,vars__$1))
