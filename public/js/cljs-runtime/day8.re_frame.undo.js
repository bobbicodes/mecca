...
var G__40965 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__40966 = "re-frame-undo: undo-config! called within unknown keys: ";
var G__40967 = unknown_keys;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__40965,G__40966,G__40967) : re_frame.core.console.call(null,G__40965,G__40966,G__40967));
} else {
...
cljs.core.reset_BANG_(day8.re_frame.undo.undo_list,cljs.core.vec(cljs.core.take_last(day8.re_frame.undo.max_undos(),cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(day8.re_frame.undo.undo_list),(function (){var fexpr__40986 = new cljs.core.Keyword(null,"harvest-fn","harvest-fn",9140059).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(day8.re_frame.undo.config));
return (fexpr__40986.cljs$core$IFn$_invoke$arity$1 ? fexpr__40986.cljs$core$IFn$_invoke$arity$1(re_frame.db.app_db) : fexpr__40986.call(null,re_frame.db.app_db));
})()))));
...
var G__41006_41047 = cur;
var G__41007_41048 = cljs.core.last(u);
(reinstater.cljs$core$IFn$_invoke$arity$2 ? reinstater.cljs$core$IFn$_invoke$arity$2(G__41006_41047,G__41007_41048) : reinstater.call(null,G__41006_41047,G__41007_41048));
...
day8.re_frame.undo.undo_handler = (function day8$re_frame$undo$undo_handler(_,p__41009){
var vec__41010 = p__41009;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41010,(0),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41010,(1),null);
if(cljs.core.not(day8.re_frame.undo.undos_QMARK_())){
var G__41016_41051 = new cljs.core.Keyword(null,"warn","warn",-436710552);
var G__41017_41052 = "re-frame: you did a (dispatch [:undo]), but there is nothing to undo.";
(re_frame.core.console.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$2(G__41016_41051,G__41017_41052) : re_frame.core.console.call(null,G__41016_41051,G__41017_41052));
} else {
...
var G__41018_41053 = cur;
var G__41019_41054 = cljs.core.first(r);
(reinstater.cljs$core$IFn$_invoke$arity$2 ? reinstater.cljs$core$IFn$_invoke$arity$2(G__41018_41053,G__41019_41054) : reinstater.call(null,G__41018_41053,G__41019_41054));
...
day8.re_frame.undo.redo_handler = (function day8$re_frame$undo$redo_handler(_,p__41020){
var vec__41021 = p__41020;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41021,(0),null);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41021,(1),null);
if(cljs.core.not(day8.re_frame.undo.redos_QMARK_())){
var G__41024_41056 = new cljs.core.Keyword(null,"warn","warn",-436710552);
var G__41025_41057 = "re-frame: you did a (dispatch [:redo]), but there is nothing to redo.";
(re_frame.core.console.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$2(G__41024_41056,G__41025_41057) : re_frame.core.console.call(null,G__41024_41056,G__41025_41057));
} else {
...
if(cljs.core.not(day8.re_frame.undo.redos_QMARK_())){
var G__41026_41058 = new cljs.core.Keyword(null,"warn","warn",-436710552);
var G__41027_41059 = "re-frame: you did a (dispatch [:purge-redos]), but there is nothing to redo.";
(re_frame.core.console.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$2(G__41026_41058,G__41027_41059) : re_frame.core.console.call(null,G__41026_41058,G__41027_41059));
} else {
day8.re_frame.undo.clear_redos_BANG_();
}
...
var G__41030 = new cljs.core.Keyword(null,"id","id",-1388402092);
var G__41031 = new cljs.core.Keyword(null,"undoable","undoable",303475882);
var G__41032 = new cljs.core.Keyword(null,"after","after",594996914);
var G__41033 = (function (context){
var event = (function (){var G__41034 = context;
var G__41035 = new cljs.core.Keyword(null,"event","event",301435442);
return (re_frame.core.get_coeffect.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.get_coeffect.cljs$core$IFn$_invoke$arity$2(G__41034,G__41035) : re_frame.core.get_coeffect.call(null,G__41034,G__41035));
})();
var undo_effect = (function (){var G__41036 = context;
var G__41037 = new cljs.core.Keyword(null,"undo","undo",-1818036302);
return (re_frame.core.get_effect.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.get_effect.cljs$core$IFn$_invoke$arity$2(G__41036,G__41037) : re_frame.core.get_effect.call(null,G__41036,G__41037));
})();
var explanation__$1 = (((!((undo_effect == null))))?undo_effect:((cljs.core.fn_QMARK_(explanation))?(function (){var G__41038 = (function (){var G__41040 = context;
var G__41041 = new cljs.core.Keyword(null,"db","db",993250759);
return (re_frame.core.get_coeffect.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.get_coeffect.cljs$core$IFn$_invoke$arity$2(G__41040,G__41041) : re_frame.core.get_coeffect.call(null,G__41040,G__41041));
})();
var G__41039 = event;
return (explanation.cljs$core$IFn$_invoke$arity$2 ? explanation.cljs$core$IFn$_invoke$arity$2(G__41038,G__41039) : explanation.call(null,G__41038,G__41039));
})():((typeof explanation === 'string')?explanation:(((explanation == null))?"":(function (){var G__41042 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__41043 = "re-frame-undo: \"undoable\" interceptor on event ";
var G__41044 = event;
var G__41045 = " given a bad parameter. Got: ";
var G__41046 = explanation;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$5 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$5(G__41042,G__41043,G__41044,G__41045,G__41046) : re_frame.core.console.call(null,G__41042,G__41043,G__41044,G__41045,G__41046));
})()
))));
...
return (re_frame.core.__GT_interceptor.cljs$core$IFn$_invoke$arity$4 ? re_frame.core.__GT_interceptor.cljs$core$IFn$_invoke$arity$4(G__41030,G__41031,G__41032,G__41033) : re_frame.core.__GT_interceptor.call(null,G__41030,G__41031,G__41032,G__41033));
}));
