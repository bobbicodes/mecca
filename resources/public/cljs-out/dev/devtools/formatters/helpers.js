...
var G__21890 = devtools.prefs.pref.call(null,v);
v = G__21890;
continue;
} else {
return v;
...
}catch (e21893){var _e__21144__auto__ = e21893;
return false;
}})();
...
}catch (e21897){var _e__21144__auto__ = e21897;
return false;
}})();
...
}catch (e21899){var _e__21144__auto__ = e21899;
return false;
}}
}
});
...
var vec__21901 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21901,(0),null);
var name = cljs.core.nth.call(null,vec__21901,(1),null);
...
return cljs.core.some.call(null,(function (p1__21904_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21904_SHARP_);
}),template);
});
