...
return html_coll.item(p1__20989_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__20990_SHARP_);
...
var ctx_20991 = cvs.getContext("2d");
ctx_20991.fillStyle = color;

ctx_20991.fillRect((0),(0),size,size);
