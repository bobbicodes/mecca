...
var G__15336 = devtools.prefs.pref.call(null,v);
v = G__15336;
continue;
} else {
return v;
...
}catch (e15339){var _e__14590__auto__ = e15339;
return false;
}})();
...
}catch (e15343){var _e__14590__auto__ = e15343;
return false;
}})();
...
}catch (e15345){var _e__14590__auto__ = e15345;
return false;
}}
}
});
...
var vec__15347 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__15347,(0),null);
var name = cljs.core.nth.call(null,vec__15347,(1),null);
...
return cljs.core.some.call(null,(function (p1__15350_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15350_SHARP_);
}),template);
});
