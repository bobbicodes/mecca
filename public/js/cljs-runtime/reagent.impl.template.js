...
var G__39649 = o;
(G__39649[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
G__39751.cljs$lang$applyTo = (function (arglist__39755){
...
var G__39667 = o;
(G__39667[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__39669 = props;
var G__39669__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39669,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__39669);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39669__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__39671){
...
var props = map__39672__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39672__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__39680){
var map__39681 = p__39680;
var map__39681__$1 = (((((!((map__39681 == null))))?(((((map__39681.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__39681.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__39681):map__39681);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39681__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var G__39695 = jsprops;
(G__39695["defaultValue"] = value);

(G__39695["onChange"] = (function (p1__39694_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__39694_SHARP_);
}));
...
var vec__39710 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39710,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39710,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39710,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___39812 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___39812 == null)){
} else {
var key_39813 = temp__5739__auto___39812;
(jsprops["key"] = key_39813);
}
...
var temp__5739__auto___39814 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___39814 == null)){
} else {
var key_39815 = temp__5739__auto___39814;
reagent.impl.template.oset(jsprops,"key",key_39815);
}
...
var G__39717 = reagent.impl.template.__GT_NativeWrapper();
(G__39717["name"] = c);
...
var G__39718 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__39718) : reagent.impl.template.as_element.call(null,G__39718));
} else {
...
var len__4789__auto___39817 = arguments.length;
var i__4790__auto___39818 = (0);
while(true){
if((i__4790__auto___39818 < len__4789__auto___39817)){
args__4795__auto__.push((arguments[i__4790__auto___39818]));

var G__39819 = (i__4790__auto___39818 + (1));
i__4790__auto___39818 = G__39819;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq39721){
var G__39722 = cljs.core.first(seq39721);
var seq39721__$1 = cljs.core.next(seq39721);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__39722,seq39721__$1);
}));
...
break;
default:
var G__39823 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__39823;
continue;
...
var n__4666__auto___39824 = a.length;
var i_39825 = (0);
while(true){
if((i_39825 < n__4666__auto___39824)){
(a[i_39825] = reagent.impl.template.as_element((a[i_39825])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4666__auto___39827 = a.length;
var i_39828 = (0);
while(true){
if((i_39828 < n__4666__auto___39827)){
var val_39829 = (a[i_39828]);
if(((cljs.core.vector_QMARK_(val_39829)) && ((reagent.impl.template.key_from_vec(val_39829) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_39828] = reagent.impl.template.as_element(val_39829));

var G__39830 = (i_39828 + (1));
i_39828 = G__39830;
continue;
} else {
}
...
var ctx = ({});
var vec__39730 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39730,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39730,(1),null);
...
var G__39740 = (cljs.core.count(argv) - first_child);
switch (G__39740) {
case (0):
...
case (1):
var G__39741 = comp;
var G__39742 = jsprops;
var G__39743 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__39741,G__39742,G__39743);
