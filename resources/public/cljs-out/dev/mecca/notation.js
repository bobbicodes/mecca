...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$path,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$transform,["translate(",cljs.core.str.cljs$core$IFn$_invoke$arity$1((0.3 + ((24) * (n - (1))))),",",cljs.core.str.cljs$core$IFn$_invoke$arity$1(6.3),")"].join(''),cljs.core.cst$kw$d,(function (){var G__19820 = n;
switch (G__19820) {
case (0):
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__19820)].join('')));
...
mecca.notation.drum_hit = (function mecca$notation$drum_hit(duration,p__19822){
var vec__19823 = p__19822;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19823,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19823,(1),null);
var mouseover_QMARK_ = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false);
return ((function (mouseover_QMARK_,vec__19823,x,y){
return (function (color,p__19826){
var vec__19827 = p__19826;
var x__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19827,(0),null);
var y__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19827,(1),null);
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$on_DASH_mouse_DASH_over,((function (vec__19827,x__$1,y__$1,mouseover_QMARK_,vec__19823,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,true);
});})(vec__19827,x__$1,y__$1,mouseover_QMARK_,vec__19823,x,y))
,cljs.core.cst$kw$on_DASH_mouse_DASH_out,((function (vec__19827,x__$1,y__$1,mouseover_QMARK_,vec__19823,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,false);
});})(vec__19827,x__$1,y__$1,mouseover_QMARK_,vec__19823,x,y))
,cljs.core.cst$kw$on_DASH_click,((function (vec__19827,x__$1,y__$1,mouseover_QMARK_,vec__19823,x,y){
return (function (){
var G__19830 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$remove_DASH_note,x__$1,y__$1], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__19830) : re_frame.core.dispatch.call(null,G__19830));
});})(vec__19827,x__$1,y__$1,mouseover_QMARK_,vec__19823,x,y))
...
;})(mouseover_QMARK_,vec__19823,x,y))
});
mecca.notation.ledger_line = (function mecca$notation$ledger_line(p__19831){
var vec__19832 = p__19831;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19832,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19832,(1),null);
...
mecca.notation.note = (function mecca$notation$note(value,p__19835){
var vec__19836 = p__19835;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19836,(0),null);
var y = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19836,(1),null);
var mouseover_QMARK_ = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false);
return ((function (mouseover_QMARK_,vec__19836,x,y){
return (function (value__$1,p__19839){
var vec__19840 = p__19839;
var x__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19840,(0),null);
var y__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__19840,(1),null);
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g,new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$on_DASH_mouse_DASH_over,((function (vec__19840,x__$1,y__$1,mouseover_QMARK_,vec__19836,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,true);
});})(vec__19840,x__$1,y__$1,mouseover_QMARK_,vec__19836,x,y))
,cljs.core.cst$kw$on_DASH_mouse_DASH_out,((function (vec__19840,x__$1,y__$1,mouseover_QMARK_,vec__19836,x,y){
return (function (){
return cljs.core.reset_BANG_(mouseover_QMARK_,false);
});})(vec__19840,x__$1,y__$1,mouseover_QMARK_,vec__19836,x,y))
,cljs.core.cst$kw$on_DASH_click,((function (vec__19840,x__$1,y__$1,mouseover_QMARK_,vec__19836,x,y){
return (function (){
var G__19843 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$remove_DASH_note,x__$1,y__$1], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__19843) : re_frame.core.dispatch.call(null,G__19843));
});})(vec__19840,x__$1,y__$1,mouseover_QMARK_,vec__19836,x,y))
...
;})(mouseover_QMARK_,vec__19836,x,y))
});
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$g_SHARP_lines,cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4324__auto__ = (function mecca$notation$staff_lines_$_iter__19844(s__19845){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__19847),mecca$notation$staff_lines_$_iter__19844(cljs.core.chunk_rest(s__19845__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__19847),null);
}
} else {
var y = cljs.core.first(s__19845__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$line,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$stroke_DASH_dasharray,cljs.core.cst$kw$stroke,cljs.core.cst$kw$stroke_DASH_linejoin,cljs.core.cst$kw$y1,cljs.core.cst$kw$stroke_DASH_linecap,cljs.core.cst$kw$stroke_DASH_width,cljs.core.cst$kw$x1,cljs.core.cst$kw$y2,cljs.core.cst$kw$x2,cljs.core.cst$kw$visibility],[((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.25:null),"black","bevel",y,"butt",((((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(30))) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(y,(18)))))?0.06:0.15),2.25,y,(63),(((((y > (7))) && (cljs.core.even_QMARK_(y)) && ((y < (42)))))?"visible":"hidden")])], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,y], null)),mecca$notation$staff_lines_$_iter__19844(cljs.core.rest(s__19845__$2)));
}
} else {
return null;
}
