...
var o14737 = temp__5455__auto__;
var temp__5455__auto____$1 = (o14737["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o14738 = temp__5455__auto____$1;
return (o14738["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__14557__auto__ = f;
return (o__14557__auto__["toString"]).call(o__14557__auto__);
} else {
return "";
}
}catch (e14739){var _ = e14739;
return "";
}});
...
try{var o__14557__auto___14741 = t;
(o__14557__auto___14741["cljs$lang$ctorPrWriter"]).call(o__14557__auto___14741,t,writer);
}catch (e14740){var __14742 = e14740;
}
...
var char_code = (function (){var o__14557__auto__ = (new String(char$));
return (o__14557__auto__["charCodeAt"]).call(o__14557__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__14557__auto__ = String;
return (o__14557__auto__["fromCharCode"]).call(o__14557__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__14743 = num_code;
switch (G__14743) {
case (1):
return (185);
...
var o__14557__auto__ = String;
return (o__14557__auto__["fromCharCode"]).call(o__14557__auto__,superscript_code);
});
/**
...
}catch (e14745){var _e__14564__auto__ = e14745;
return false;
}})())){
...
var vec__14746 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__14746,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o14749 = temp__5455__auto__;
var temp__5455__auto____$1 = (o14749["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o14750 = temp__5455__auto____$1;
return (o14750["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___14757 = arguments.length;
var i__4532__auto___14758 = (0);
while(true){
if((i__4532__auto___14758 < len__4531__auto___14757)){
args__4534__auto__.push((arguments[i__4532__auto___14758]));

var G__14759 = (i__4532__auto___14758 + (1));
i__4532__auto___14758 = G__14759;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__14753){
var vec__14754 = p__14753;
var ns_detector = cljs.core.nth.call(null,vec__14754,(0),null);
...
var G__14760 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__14761 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__14760;
remaining_tokens = G__14761;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq14751){
var G__14752 = cljs.core.first.call(null,seq14751);
var seq14751__$1 = cljs.core.next.call(null,seq14751);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14752,seq14751__$1);
});
...
var vec__14765 = cljs.core.split_with.call(null,(function (p1__14764_SHARP_){
return cljs.core.not_EQ_.call(null,p1__14764_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__14765,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__14765,(1),null);
...
var vec__14768 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__14768,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__14768,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__14771 = cljs.core.rest.call(null,remaining_tokens);
var G__14772 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__14771;
name_tokens = G__14772;
continue;
} else {
...
var vec__14775 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__14775,(0),null);
var arity = cljs.core.nth.call(null,vec__14775,(1),null);
var vec__14778 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__14778,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__14778,(1),null);
var vec__14781 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__14781,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__14781,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__14781,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__14781,(3),null);
...
var vec__14787 = result;
var munged_ns = cljs.core.nth.call(null,vec__14787,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__14787,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__14787,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__14787,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__14787,(4),null);
var arity = cljs.core.nth.call(null,vec__14787,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__14791 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__14791,(0),null);
var args = cljs.core.nth.call(null,vec__14791,(1),null);
var vec__14794 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__14794,(0),null);
var name = cljs.core.nth.call(null,vec__14794,(1),null);
...
var G__14797 = (arity + (1));
var G__14798 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__14799){
var vec__14800 = p__14799;
var arity = cljs.core.nth.call(null,vec__14800,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__14800,(1),null);
...
return cljs.core.get.call(null,arities,p1__14803_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__14804_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___14811 = arguments.length;
var i__4532__auto___14812 = (0);
while(true){
if((i__4532__auto___14812 < len__4531__auto___14811)){
args__4534__auto__.push((arguments[i__4532__auto___14812]));

var G__14813 = (i__4532__auto___14812 + (1));
i__4532__auto___14812 = G__14813;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__14807){
var vec__14808 = p__14807;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__14808,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq14805){
var G__14806 = cljs.core.first.call(null,seq14805);
var seq14805__$1 = cljs.core.next.call(null,seq14805);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14806,seq14805__$1);
});
...
var G__14814 = arg;
var G__14814__$1 = (((G__14814 instanceof cljs.core.Keyword))?G__14814.fqn:null);
switch (G__14814__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__14816__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__14816__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__14816__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__14816__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__14817 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__14817,(0),null);
var fn_name = cljs.core.nth.call(null,vec__14817,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__14817,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__14817,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__14817,(4),null);
var arity = cljs.core.nth.call(null,vec__14817,(5),null);
...
var o__14557__auto__ = f;
return (o__14557__auto__["getBasis"]).call(o__14557__auto__);
});
/**
...
}catch (e14821){var _e__14564__auto__ = e14821;
...
var G__14822 = (obj[cljs.core.first.call(null,path)]);
var G__14823 = cljs.core.rest.call(null,path);
obj = G__14822;
path = G__14823;
continue;
} else {
...
return (function (accum,p__14824){
var vec__14825 = p__14824;
var bit = cljs.core.nth.call(null,vec__14825,(0),null);
var protocol = cljs.core.nth.call(null,vec__14825,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__14828){
var vec__14829 = p__14828;
var ns = cljs.core.nth.call(null,vec__14829,(0),null);
var name = cljs.core.nth.call(null,vec__14829,(1),null);
var selector = cljs.core.nth.call(null,vec__14829,(2),null);
...
return (function (p__14833){
var vec__14834 = p__14833;
var munged_name = cljs.core.nth.call(null,vec__14834,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__14834,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__14834,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__14832_SHARP_){
return (obj[cljs.core.first.call(null,p1__14832_SHARP_)]);
});})(name,sorted_matches,vec__14834,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
