...
return cljs.core.map.call(null,(function (p1__21962_SHARP_){
return html_coll.item(p1__21962_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__21963_SHARP_);
...
var ctx_21964 = cvs.getContext("2d");
ctx_21964.fillStyle = color;

ctx_21964.fillRect((0),(0),size,size);
