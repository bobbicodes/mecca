...
var temp__5455__auto____$1 = (o23195["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23196 = temp__5455__auto____$1;
return (o23196["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22125__auto__ = f;
return (o__22125__auto__["toString"]).call(o__22125__auto__);
} else {
return "";
}
}catch (e23197){var _ = e23197;
return "";
}});
...
try{var o__22125__auto___23199 = t;
(o__22125__auto___23199["cljs$lang$ctorPrWriter"]).call(o__22125__auto___23199,t,writer);
}catch (e23198){var __23200 = e23198;
}
...
var char_code = (function (){var o__22125__auto__ = (new String(char$));
return (o__22125__auto__["charCodeAt"]).call(o__22125__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22125__auto__ = String;
return (o__22125__auto__["fromCharCode"]).call(o__22125__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23201 = num_code;
switch (G__23201) {
case (1):
return (185);
...
var o__22125__auto__ = String;
return (o__22125__auto__["fromCharCode"]).call(o__22125__auto__,superscript_code);
});
/**
...
}catch (e23203){var _e__22132__auto__ = e23203;
return false;
}})())){
...
var vec__23204 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23204,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o23207 = temp__5455__auto__;
var temp__5455__auto____$1 = (o23207["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o23208 = temp__5455__auto____$1;
return (o23208["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23211){
var vec__23212 = p__23211;
var ns_detector = cljs.core.nth.call(null,vec__23212,(0),null);
...
var G__23218 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23219 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23218;
remaining_tokens = G__23219;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23209){
var G__23210 = cljs.core.first.call(null,seq23209);
var seq23209__$1 = cljs.core.next.call(null,seq23209);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23210,seq23209__$1);
});
...
var vec__23223 = cljs.core.split_with.call(null,(function (p1__23222_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23222_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23223,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23223,(1),null);
...
var vec__23226 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23226,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23226,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23229 = cljs.core.rest.call(null,remaining_tokens);
var G__23230 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23229;
name_tokens = G__23230;
continue;
} else {
...
var vec__23233 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23233,(0),null);
var arity = cljs.core.nth.call(null,vec__23233,(1),null);
var vec__23236 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23236,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23236,(1),null);
var vec__23239 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23239,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23239,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23239,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23239,(3),null);
...
var vec__23245 = result;
var munged_ns = cljs.core.nth.call(null,vec__23245,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23245,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23245,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23245,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23245,(4),null);
var arity = cljs.core.nth.call(null,vec__23245,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__23249 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__23249,(0),null);
var args = cljs.core.nth.call(null,vec__23249,(1),null);
var vec__23252 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23252,(0),null);
var name = cljs.core.nth.call(null,vec__23252,(1),null);
...
var G__23255 = (arity + (1));
var G__23256 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23257){
var vec__23258 = p__23257;
var arity = cljs.core.nth.call(null,vec__23258,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23258,(1),null);
...
return cljs.core.get.call(null,arities,p1__23261_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__23262_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___23269 = arguments.length;
var i__4532__auto___23270 = (0);
while(true){
if((i__4532__auto___23270 < len__4531__auto___23269)){
args__4534__auto__.push((arguments[i__4532__auto___23270]));

var G__23271 = (i__4532__auto___23270 + (1));
i__4532__auto___23270 = G__23271;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23265){
var vec__23266 = p__23265;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23266,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23263){
var G__23264 = cljs.core.first.call(null,seq23263);
var seq23263__$1 = cljs.core.next.call(null,seq23263);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23264,seq23263__$1);
});
...
var G__23272 = arg;
var G__23272__$1 = (((G__23272 instanceof cljs.core.Keyword))?G__23272.fqn:null);
switch (G__23272__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__23274__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23274__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23274__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23274__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23275 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23275,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23275,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23275,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23275,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23275,(4),null);
var arity = cljs.core.nth.call(null,vec__23275,(5),null);
...
var o__22125__auto__ = f;
return (o__22125__auto__["getBasis"]).call(o__22125__auto__);
});
/**
...
}catch (e23279){var _e__22132__auto__ = e23279;
...
var G__23280 = (obj[cljs.core.first.call(null,path)]);
var G__23281 = cljs.core.rest.call(null,path);
obj = G__23280;
path = G__23281;
continue;
} else {
...
return (function (accum,p__23282){
var vec__23283 = p__23282;
var bit = cljs.core.nth.call(null,vec__23283,(0),null);
var protocol = cljs.core.nth.call(null,vec__23283,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23286){
var vec__23287 = p__23286;
var ns = cljs.core.nth.call(null,vec__23287,(0),null);
var name = cljs.core.nth.call(null,vec__23287,(1),null);
var selector = cljs.core.nth.call(null,vec__23287,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__23292,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23292,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__23292,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__23290_SHARP_){
return (obj[cljs.core.first.call(null,p1__23290_SHARP_)]);
});})(name,sorted_matches,vec__23292,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
