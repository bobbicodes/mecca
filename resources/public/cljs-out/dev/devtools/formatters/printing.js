...
var len__4531__auto___21925 = arguments.length;
var i__4532__auto___21926 = (0);
while(true){
if((i__4532__auto___21926 < len__4531__auto___21925)){
args__4534__auto__.push((arguments[i__4532__auto___21926]));

var G__21927 = (i__4532__auto___21926 + (1));
i__4532__auto___21926 = G__21927;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq21922){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21923,G__21924,seq21922__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__21928_SHARP_){
return !((cljs.core.meta.call(null,p1__21928_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__21929__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e21933){var _e__21133__auto__ = e21933;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e21935){var _e__21133__auto__ = e21935;
return false;
}}
})())){
...
var _STAR_current_state_STAR_21937 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__21938 = opts;
...
var markup_db = cljs.core.get.call(null,map__21938__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_21937;
}});
...
;
var temp__5455__auto___21942 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___21942)){
var managed_print_level_21943 = temp__5455__auto___21942;
var _STAR_print_level_STAR_21941_21944 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_21943;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_21941_21944,managed_print_level_21943,temp__5455__auto___21942,writer,opts,job_fn){
return (function (p1__21940_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__21940_SHARP_,null);
});})(_STAR_print_level_STAR_21941_21944,managed_print_level_21943,temp__5455__auto___21942,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_21941_21944;
}} else {
job_fn.call(null);
}
