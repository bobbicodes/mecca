...
var o21209 = temp__5455__auto__;
var temp__5455__auto____$1 = (o21209["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o21210 = temp__5455__auto____$1;
return (o21210["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21029__auto__ = f;
return (o__21029__auto__["toString"]).call(o__21029__auto__);
} else {
return "";
}
}catch (e21211){var _ = e21211;
return "";
}});
...
try{var o__21029__auto___21213 = t;
(o__21029__auto___21213["cljs$lang$ctorPrWriter"]).call(o__21029__auto___21213,t,writer);
}catch (e21212){var __21214 = e21212;
}
...
var char_code = (function (){var o__21029__auto__ = (new String(char$));
return (o__21029__auto__["charCodeAt"]).call(o__21029__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21029__auto__ = String;
return (o__21029__auto__["fromCharCode"]).call(o__21029__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21215 = num_code;
switch (G__21215) {
case (1):
return (185);
...
var o__21029__auto__ = String;
return (o__21029__auto__["fromCharCode"]).call(o__21029__auto__,superscript_code);
});
/**
...
}catch (e21217){var _e__21036__auto__ = e21217;
return false;
}})())){
...
var vec__21218 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21218,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o21221 = temp__5455__auto__;
var temp__5455__auto____$1 = (o21221["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o21222 = temp__5455__auto____$1;
return (o21222["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___21229 = arguments.length;
var i__4532__auto___21230 = (0);
while(true){
if((i__4532__auto___21230 < len__4531__auto___21229)){
args__4534__auto__.push((arguments[i__4532__auto___21230]));

var G__21231 = (i__4532__auto___21230 + (1));
i__4532__auto___21230 = G__21231;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21225){
var vec__21226 = p__21225;
var ns_detector = cljs.core.nth.call(null,vec__21226,(0),null);
...
var G__21232 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21233 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21232;
remaining_tokens = G__21233;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21223){
var G__21224 = cljs.core.first.call(null,seq21223);
var seq21223__$1 = cljs.core.next.call(null,seq21223);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21224,seq21223__$1);
});
...
var vec__21237 = cljs.core.split_with.call(null,(function (p1__21236_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21236_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21237,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21237,(1),null);
...
var vec__21240 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21240,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21240,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__21243 = cljs.core.rest.call(null,remaining_tokens);
var G__21244 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__21243;
name_tokens = G__21244;
continue;
} else {
...
var vec__21247 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__21247,(0),null);
var arity = cljs.core.nth.call(null,vec__21247,(1),null);
var vec__21250 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__21250,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__21250,(1),null);
var vec__21253 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__21253,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__21253,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__21253,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__21253,(3),null);
...
var vec__21259 = result;
var munged_ns = cljs.core.nth.call(null,vec__21259,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__21259,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__21259,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__21259,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__21259,(4),null);
var arity = cljs.core.nth.call(null,vec__21259,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__21263 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__21263,(0),null);
var args = cljs.core.nth.call(null,vec__21263,(1),null);
var vec__21266 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__21266,(0),null);
var name = cljs.core.nth.call(null,vec__21266,(1),null);
...
var G__21269 = (arity + (1));
var G__21270 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21271){
var vec__21272 = p__21271;
var arity = cljs.core.nth.call(null,vec__21272,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__21272,(1),null);
...
return cljs.core.get.call(null,arities,p1__21275_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__21276_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___21283 = arguments.length;
var i__4532__auto___21284 = (0);
while(true){
if((i__4532__auto___21284 < len__4531__auto___21283)){
args__4534__auto__.push((arguments[i__4532__auto___21284]));

var G__21285 = (i__4532__auto___21284 + (1));
i__4532__auto___21284 = G__21285;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21279){
var vec__21280 = p__21279;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__21280,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21277){
var G__21278 = cljs.core.first.call(null,seq21277);
var seq21277__$1 = cljs.core.next.call(null,seq21277);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21278,seq21277__$1);
});
...
var G__21286 = arg;
var G__21286__$1 = (((G__21286 instanceof cljs.core.Keyword))?G__21286.fqn:null);
switch (G__21286__$1) {
...
var map__21288 = options;
var map__21288__$1 = ((((!((map__21288 == null)))?(((((map__21288.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21288.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21288):map__21288);
var include_ns_QMARK_ = cljs.core.get.call(null,map__21288__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__21288__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__21288__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__21288__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21289 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__21289,(0),null);
var fn_name = cljs.core.nth.call(null,vec__21289,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__21289,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__21289,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__21289,(4),null);
var arity = cljs.core.nth.call(null,vec__21289,(5),null);
...
var o__21029__auto__ = f;
return (o__21029__auto__["getBasis"]).call(o__21029__auto__);
});
/**
...
}catch (e21293){var _e__21036__auto__ = e21293;
...
var G__21294 = (obj[cljs.core.first.call(null,path)]);
var G__21295 = cljs.core.rest.call(null,path);
obj = G__21294;
path = G__21295;
continue;
} else {
...
return (function (accum,p__21296){
var vec__21297 = p__21296;
var bit = cljs.core.nth.call(null,vec__21297,(0),null);
var protocol = cljs.core.nth.call(null,vec__21297,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21300){
var vec__21301 = p__21300;
var ns = cljs.core.nth.call(null,vec__21301,(0),null);
var name = cljs.core.nth.call(null,vec__21301,(1),null);
var selector = cljs.core.nth.call(null,vec__21301,(2),null);
...
return (function (p__21305){
var vec__21306 = p__21305;
var munged_name = cljs.core.nth.call(null,vec__21306,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__21306,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__21306,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__21304_SHARP_){
return (obj[cljs.core.first.call(null,p1__21304_SHARP_)]);
});})(name,sorted_matches,vec__21306,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
