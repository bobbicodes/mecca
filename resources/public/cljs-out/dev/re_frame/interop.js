...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__9520 = cljs.core.instance_QMARK_;
var expr__9521 = reactive_val;
if(cljs.core.truth_(pred__9520.call(null,reagent.ratom.RAtom,expr__9521))){
return "ra";
} else {
if(cljs.core.truth_(pred__9520.call(null,reagent.ratom.RCursor,expr__9521))){
return "rc";
} else {
if(cljs.core.truth_(pred__9520.call(null,reagent.ratom.Reaction,expr__9521))){
return "rx";
} else {
if(cljs.core.truth_(pred__9520.call(null,reagent.ratom.Track,expr__9521))){
return "tr";
} else {
return "other";
}
