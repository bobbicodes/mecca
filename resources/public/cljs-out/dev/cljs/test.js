...
return cljs.core.assoc.call(null,G__20556,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__20556;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq20558){
var G__20559 = cljs.core.first.call(null,seq20558);
var seq20558__$1 = cljs.core.next.call(null,seq20558);
var G__20560 = cljs.core.first.call(null,seq20558__$1);
var seq20558__$2 = cljs.core.next.call(null,seq20558__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20559,G__20560,seq20558__$2);
});
...
var file = cljs.core.get.call(null,map__20565__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__20565__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__20565__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__20565,map__20565__$1,file,line,column){
return (function (p1__20564_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__20564_SHARP_));
});})(map__20565,map__20565__$1,file,line,column))
...
var temp__5457__auto___20567 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20567)){
var message_20568 = temp__5457__auto___20567;
cljs.core.println.call(null,message_20568);
} else {
}
...
var temp__5457__auto___20569 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20569)){
var message_20570 = temp__5457__auto___20569;
cljs.core.println.call(null,message_20570);
} else {
}
...
var output_dir__$1 = (function (){var G__20571 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20571),"/"].join('');
} else {
return G__20571;
}
})();
...
var G__20573 = exception.stack;
var G__20573__$1 = (((G__20573 == null))?null:clojure.string.split_lines.call(null,G__20573));
var G__20573__$2 = (((G__20573__$1 == null))?null:cljs.core.get.call(null,G__20573__$1,depth));
if((G__20573__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__20573__$2);
}
} else {
...
var vec__20574 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__20574,(0),null);
var column = cljs.core.nth.call(null,vec__20574,(1),null);
var vec__20577 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__20577,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__20577,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__20577,(2),null);
...
var m__$1 = (function (){var G__20580 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__20584 = (function (){var G__20583 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__20583);
} else {
return G__20583;
}
})();
...
return cljs.core.vary_meta.call(null,G__20585,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__20589 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__20589,(0),null);
var types = vec__20589;
...
var ns = cljs.core.nth.call(null,vec__20593,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__20593,(1),null);
return ((function (vec__20593,ns,vars__$1){
return (function (){
...
var G__20596 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__20596,G__20596__$1,env,once_fixtures,each_fixtures,vec__20593,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__20596,G__20596__$1,env,once_fixtures,each_fixtures,vec__20593,ns,vars__$1){
return (function (){
var seq__20597 = cljs.core.seq.call(null,vars__$1);
var chunk__20598 = null;
var count__20599 = (0);
var i__20600 = (0);
while(true){
if((i__20600 < count__20599)){
var v = cljs.core._nth.call(null,chunk__20598,i__20600);
var temp__5457__auto___20602 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20602)){
var t_20603 = temp__5457__auto___20602;
each_fixture_fn.call(null,((function (seq__20597,chunk__20598,count__20599,i__20600,t_20603,temp__5457__auto___20602,v,each_fixture_fn,G__20596,G__20596__$1,env,once_fixtures,each_fixtures,vec__20593,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20603)));
});})(seq__20597,chunk__20598,count__20599,i__20600,t_20603,temp__5457__auto___20602,v,each_fixture_fn,G__20596,G__20596__$1,env,once_fixtures,each_fixtures,vec__20593,ns,vars__$1))
);
} else {
}


var G__20604 = seq__20597;
var G__20605 = chunk__20598;
var G__20606 = count__20599;
var G__20607 = (i__20600 + (1));
seq__20597 = G__20604;
chunk__20598 = G__20605;
count__20599 = G__20606;
i__20600 = G__20607;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__20597);
if(temp__5457__auto__){
var seq__20597__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__20597__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__20597__$1);
var G__20608 = cljs.core.chunk_rest.call(null,seq__20597__$1);
var G__20609 = c__4351__auto__;
var G__20610 = cljs.core.count.call(null,c__4351__auto__);
var G__20611 = (0);
seq__20597 = G__20608;
chunk__20598 = G__20609;
count__20599 = G__20610;
i__20600 = G__20611;
continue;
} else {
var v = cljs.core.first.call(null,seq__20597__$1);
var temp__5457__auto___20612__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20612__$1)){
var t_20613 = temp__5457__auto___20612__$1;
each_fixture_fn.call(null,((function (seq__20597,chunk__20598,count__20599,i__20600,t_20613,temp__5457__auto___20612__$1,v,seq__20597__$1,temp__5457__auto__,each_fixture_fn,G__20596,G__20596__$1,env,once_fixtures,each_fixtures,vec__20593,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20613)));
});})(seq__20597,chunk__20598,count__20599,i__20600,t_20613,temp__5457__auto___20612__$1,v,seq__20597__$1,temp__5457__auto__,each_fixture_fn,G__20596,G__20596__$1,env,once_fixtures,each_fixtures,vec__20593,ns,vars__$1))
);
} else {
}


var G__20614 = cljs.core.next.call(null,seq__20597__$1);
var G__20615 = null;
var G__20616 = (0);
var G__20617 = (0);
seq__20597 = G__20614;
chunk__20598 = G__20615;
count__20599 = G__20616;
i__20600 = G__20617;
continue;
}
} else {
...
});})(each_fixture_fn,G__20596,G__20596__$1,env,once_fixtures,each_fixtures,vec__20593,ns,vars__$1))
);
});})(each_fixture_fn,G__20596,G__20596__$1,env,once_fixtures,each_fixtures,vec__20593,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20596__$1)].join('')));

}
})());
});
;})(vec__20593,ns,vars__$1))
