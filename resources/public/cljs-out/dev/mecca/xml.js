...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__20445_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(tag,cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__20445_SHARP_,cljs.core.cst$kw$tag));
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__20446_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(voice,mecca.xml.get_voice(p1__20446_SHARP_));
...
return new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$time,time,cljs.core.cst$kw$pitch,((mecca.xml.pitch__GT_midi(mecca.xml.get_pitch(note)) + (function (){var G__20447 = mecca.xml.get_voice(note);
switch (G__20447) {
case (5):
return (12);
...
})()) + (6)),cljs.core.cst$kw$instrument,(function (){var G__20448 = mecca.xml.get_voice(note);
switch (G__20448) {
case (5):
return (15);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20448)].join('')));
...
var G__20451 = (time + (mecca.xml.get_duration(cljs.core.first(notes)) / (6)));
var G__20452 = cljs.core.rest(notes);
var G__20453 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,mecca.xml.parse_note(cljs.core.first(notes),time));
time = G__20451;
notes = G__20452;
result = G__20453;
continue;
...
return mecca.xml.extract_voice(p1__20454_SHARP_,voice);
});})(time))
...
var G__20455 = (time + (mecca.xml.get_duration(cljs.core.first(notes)) / (6)));
var G__20456 = cljs.core.rest(notes);
var G__20457 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(result,mecca.xml.parse_note(cljs.core.first(notes),time));
time = G__20455;
notes = G__20456;
result = G__20457;
continue;
