...
if(cljs.core.truth_(pred__14091.call(null,reagent.ratom.RAtom,expr__14092))){
return "ra";
} else {
if(cljs.core.truth_(pred__14091.call(null,reagent.ratom.RCursor,expr__14092))){
return "rc";
} else {
if(cljs.core.truth_(pred__14091.call(null,reagent.ratom.Reaction,expr__14092))){
return "rx";
} else {
if(cljs.core.truth_(pred__14091.call(null,reagent.ratom.Track,expr__14092))){
return "tr";
} else {
return "other";
}
