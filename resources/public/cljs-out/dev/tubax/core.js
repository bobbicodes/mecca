...
tubax.core.xml__GT_clj.cljs$core$IFn$_invoke$arity$2 = (function (source,p__20937){
var map__20938 = p__20937;
var map__20938__$1 = ((((!((map__20938 == null)))?(((((map__20938.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20938.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__20938):map__20938);
var strict = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20938__$1,cljs.core.cst$kw$strict,true);
var trim = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20938__$1,cljs.core.cst$kw$trim,true);
var normalize = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20938__$1,cljs.core.cst$kw$normalize,false);
var lowercase = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20938__$1,cljs.core.cst$kw$lowercase,true);
var xmlns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20938__$1,cljs.core.cst$kw$xmlns);
var position = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20938__$1,cljs.core.cst$kw$position,true);
var strict_entities = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__20938__$1,cljs.core.cst$kw$strict_DASH_entities,false);
...
parser.onopentag = ((function (parser,document,result,map__20938,map__20938__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__20930_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.add_node_document,p1__20930_SHARP_));
});})(parser,document,result,map__20938,map__20938__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.onclosetag = ((function (parser,document,result,map__20938,map__20938__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__20931_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.close_node_document,p1__20931_SHARP_));
});})(parser,document,result,map__20938,map__20938__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.ontext = ((function (parser,document,result,map__20938,map__20938__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__20932_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.add_text,p1__20932_SHARP_));
});})(parser,document,result,map__20938,map__20938__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.oncdata = ((function (parser,document,result,map__20938,map__20938__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__20933_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.add_text,p1__20933_SHARP_));
});})(parser,document,result,map__20938,map__20938__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.onend = ((function (parser,document,result,map__20938,map__20938__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (){
...
parser.onerror = ((function (parser,document,result,map__20938,map__20938__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__20934_SHARP_){
return cljs.core.reset_BANG_(result,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$error,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__20934_SHARP_)].join('')], null));
});})(parser,document,result,map__20938,map__20938__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;
