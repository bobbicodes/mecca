...
var G__13806 = o;
(G__13806[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__13807__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__13807 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__13808__i = 0, G__13808__a = new Array(arguments.length -  0);
while (G__13808__i < G__13808__a.length) {G__13808__a[G__13808__i] = arguments[G__13808__i + 0]; ++G__13808__i;}
  args = new cljs.core.IndexedSeq(G__13808__a,0,null);
} 
...
var G__13810 = o;
(G__13810[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__13815 = props;
var G__13815__$1 = ((((!((id == null))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13815,cljs.core.cst$kw$id,id):G__13815);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__13815__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__13816){
...
var props = map__13817__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13817__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__13817,map__13817__$1,props,class$){
return (function (c){
...
});})(map__13817,map__13817__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__13819){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13820__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__13820,map__13820__$1,on_write){
return (function (){
...
});})(node_value,map__13820,map__13820__$1,on_write))
);
} else {
...
var G__13823 = jsprops;
(G__13823["defaultValue"] = value);

(G__13823["onChange"] = ((function (G__13823,v,value,on_change){
return (function (p1__13822_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13822_SHARP_);
});})(G__13823,v,value,on_change))
);
...
var vec__13826 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13826,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13826,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13826,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___13830 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___13830 == null)){
} else {
var key_13831 = temp__5461__auto___13830;
(jsprops["key"] = key_13831);
}
...
var temp__5461__auto___13832 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___13832 == null)){
} else {
var key_13833 = temp__5461__auto___13832;
reagent.impl.template.oset(jsprops,"key",key_13833);
}
...
var G__13834 = reagent.impl.template.__GT_NativeWrapper();
(G__13834["name"] = c);
...
var G__13835 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13835) : reagent.impl.template.as_element.call(null,G__13835));
} else {
...
var len__4531__auto___13840 = arguments.length;
var i__4532__auto___13841 = (0);
while(true){
if((i__4532__auto___13841 < len__4531__auto___13840)){
args__4534__auto__.push((arguments[i__4532__auto___13841]));

var G__13842 = (i__4532__auto___13841 + (1));
i__4532__auto___13841 = G__13842;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13838){
var G__13839 = cljs.core.first(seq13838);
var seq13838__$1 = cljs.core.next(seq13838);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13839,seq13838__$1);
});
...
break;
default:
var G__13845 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__13845;
continue;
...
var n__4408__auto___13847 = a.length;
var i_13848 = (0);
while(true){
if((i_13848 < n__4408__auto___13847)){
(a[i_13848] = reagent.impl.template.as_element((a[i_13848])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4408__auto___13850 = a.length;
var i_13851 = (0);
while(true){
if((i_13851 < n__4408__auto___13850)){
var val_13852 = (a[i_13851]);
if(((cljs.core.vector_QMARK_(val_13852)) && ((reagent.impl.template.key_from_vec(val_13852) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_13851] = reagent.impl.template.as_element(val_13852));
...
var ctx = ({});
var vec__13854 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13854,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13854,(1),null);
...
var G__13857 = (cljs.core.count(argv) - first_child);
switch (G__13857) {
case (0):
...
case (1):
var G__13858 = comp;
var G__13859 = jsprops;
var G__13860 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__13858,G__13859,G__13860) : reagent.impl.template.global$module$react.createElement.call(null,G__13858,G__13859,G__13860));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__13857){
