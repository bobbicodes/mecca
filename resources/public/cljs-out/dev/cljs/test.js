...
var G__13887 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__13887,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__13887;
}
});
...
var len__4531__auto___13892 = arguments.length;
var i__4532__auto___13893 = (0);
while(true){
if((i__4532__auto___13893 < len__4531__auto___13892)){
args__4534__auto__.push((arguments[i__4532__auto___13893]));

var G__13894 = (i__4532__auto___13893 + (1));
i__4532__auto___13893 = G__13894;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq13889){
var G__13890 = cljs.core.first.call(null,seq13889);
var seq13889__$1 = cljs.core.next.call(null,seq13889);
var G__13891 = cljs.core.first.call(null,seq13889__$1);
var seq13889__$2 = cljs.core.next.call(null,seq13889__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13890,G__13891,seq13889__$2);
});
...
var map__13896 = m;
var map__13896__$1 = ((((!((map__13896 == null)))?(((((map__13896.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__13896.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__13896):map__13896);
var file = cljs.core.get.call(null,map__13896__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__13896__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__13896__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__13896,map__13896__$1,file,line,column){
return (function (p1__13895_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__13895_SHARP_));
});})(map__13896,map__13896__$1,file,line,column))
...
var temp__5457__auto___13898 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13898)){
var message_13899 = temp__5457__auto___13898;
cljs.core.println.call(null,message_13899);
} else {
}
...
var temp__5457__auto___13900 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13900)){
var message_13901 = temp__5457__auto___13900;
cljs.core.println.call(null,message_13901);
} else {
}
...
var output_dir__$1 = (function (){var G__13902 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13902),"/"].join('');
} else {
return G__13902;
}
})();
...
var G__13904 = exception.stack;
var G__13904__$1 = (((G__13904 == null))?null:clojure.string.split_lines.call(null,G__13904));
var G__13904__$2 = (((G__13904__$1 == null))?null:cljs.core.get.call(null,G__13904__$1,depth));
if((G__13904__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__13904__$2);
}
} else {
...
var vec__13905 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__13905,(0),null);
var column = cljs.core.nth.call(null,vec__13905,(1),null);
var vec__13908 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__13908,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__13908,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__13908,(2),null);
...
var m__$1 = (function (){var G__13911 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__13915 = (function (){var G__13914 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__13914);
} else {
return G__13914;
}
})();
...
return cljs.core.vary_meta.call(null,G__13916,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__13920 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__13920,(0),null);
var types = vec__13920;
...
return cljs.core.map.call(null,(function (p__13923){
var vec__13924 = p__13923;
var ns = cljs.core.nth.call(null,vec__13924,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__13924,(1),null);
return ((function (vec__13924,ns,vars__$1){
return (function (){
...
var G__13927 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__13927,G__13927__$1,env,once_fixtures,each_fixtures,vec__13924,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__13927,G__13927__$1,env,once_fixtures,each_fixtures,vec__13924,ns,vars__$1){
return (function (){
var seq__13928 = cljs.core.seq.call(null,vars__$1);
var chunk__13929 = null;
var count__13930 = (0);
var i__13931 = (0);
while(true){
if((i__13931 < count__13930)){
var v = cljs.core._nth.call(null,chunk__13929,i__13931);
var temp__5457__auto___13933 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13933)){
var t_13934 = temp__5457__auto___13933;
each_fixture_fn.call(null,((function (seq__13928,chunk__13929,count__13930,i__13931,t_13934,temp__5457__auto___13933,v,each_fixture_fn,G__13927,G__13927__$1,env,once_fixtures,each_fixtures,vec__13924,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13934)));
});})(seq__13928,chunk__13929,count__13930,i__13931,t_13934,temp__5457__auto___13933,v,each_fixture_fn,G__13927,G__13927__$1,env,once_fixtures,each_fixtures,vec__13924,ns,vars__$1))
);
} else {
}
...
var temp__5457__auto__ = cljs.core.seq.call(null,seq__13928);
if(temp__5457__auto__){
var seq__13928__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__13928__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__13928__$1);
var G__13939 = cljs.core.chunk_rest.call(null,seq__13928__$1);
var G__13940 = c__4351__auto__;
var G__13941 = cljs.core.count.call(null,c__4351__auto__);
var G__13942 = (0);
seq__13928 = G__13939;
...
var v = cljs.core.first.call(null,seq__13928__$1);
var temp__5457__auto___13943__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13943__$1)){
var t_13944 = temp__5457__auto___13943__$1;
each_fixture_fn.call(null,((function (seq__13928,chunk__13929,count__13930,i__13931,t_13944,temp__5457__auto___13943__$1,v,seq__13928__$1,temp__5457__auto__,each_fixture_fn,G__13927,G__13927__$1,env,once_fixtures,each_fixtures,vec__13924,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13944)));
});})(seq__13928,chunk__13929,count__13930,i__13931,t_13944,temp__5457__auto___13943__$1,v,seq__13928__$1,temp__5457__auto__,each_fixture_fn,G__13927,G__13927__$1,env,once_fixtures,each_fixtures,vec__13924,ns,vars__$1))
);
} else {
}


var G__13945 = cljs.core.next.call(null,seq__13928__$1);
var G__13946 = null;
var G__13947 = (0);
var G__13948 = (0);
seq__13928 = G__13945;
chunk__13929 = G__13946;
count__13930 = G__13947;
i__13931 = G__13948;
continue;
}
} else {
...
});})(each_fixture_fn,G__13927,G__13927__$1,env,once_fixtures,each_fixtures,vec__13924,ns,vars__$1))
);
});})(each_fixture_fn,G__13927,G__13927__$1,env,once_fixtures,each_fixtures,vec__13924,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13927__$1)].join('')));

}
})());
});
;})(vec__13924,ns,vars__$1))
