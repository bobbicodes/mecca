...
var G__11991 = o;
(G__11991[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__11993__i < G__11993__a.length) {G__11993__a[G__11993__i] = arguments[G__11993__i + 0]; ++G__11993__i;}
  args = new cljs.core.IndexedSeq(G__11993__a,0,null);
} 
...
var G__11995 = o;
(G__11995[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__12000 = props;
var G__12000__$1 = ((((!((id == null))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12000,cljs.core.cst$kw$id,id):G__12000);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__12000__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__12001){
var map__12002 = p__12001;
var map__12002__$1 = ((((!((map__12002 == null)))?(((((map__12002.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12002.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__12002):map__12002);
var props = map__12002__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12002__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__12002,map__12002__$1,props,class$){
return (function (c){
...
});})(map__12002,map__12002__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__12004){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12005__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__12005,map__12005__$1,on_write){
return (function (){
...
});})(node_value,map__12005,map__12005__$1,on_write))
);
} else {
...
var G__12008 = jsprops;
(G__12008["defaultValue"] = value);

(G__12008["onChange"] = ((function (G__12008,v,value,on_change){
return (function (p1__12007_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12007_SHARP_);
});})(G__12008,v,value,on_change))
);
...
var vec__12011 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12011,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12011,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12011,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___12015 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___12015 == null)){
} else {
var key_12016 = temp__5461__auto___12015;
(jsprops["key"] = key_12016);
}
...
var temp__5461__auto___12017 = reagent.impl.template.key_from_vec(argv);
if((temp__5461__auto___12017 == null)){
} else {
var key_12018 = temp__5461__auto___12017;
reagent.impl.template.oset(jsprops,"key",key_12018);
}
...
var G__12019 = reagent.impl.template.__GT_NativeWrapper();
(G__12019["name"] = c);
...
var G__12020 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12020) : reagent.impl.template.as_element.call(null,G__12020));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12023){
...
break;
default:
var G__12030 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__12030;
continue;
...
var n__4408__auto___12032 = a.length;
var i_12033 = (0);
while(true){
if((i_12033 < n__4408__auto___12032)){
(a[i_12033] = reagent.impl.template.as_element((a[i_12033])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4408__auto___12035 = a.length;
var i_12036 = (0);
while(true){
if((i_12036 < n__4408__auto___12035)){
var val_12037 = (a[i_12036]);
if(((cljs.core.vector_QMARK_(val_12037)) && ((reagent.impl.template.key_from_vec(val_12037) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_12036] = reagent.impl.template.as_element(val_12037));
...
var ctx = ({});
var vec__12039 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12039,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12039,(1),null);
...
var G__12042 = (cljs.core.count(argv) - first_child);
switch (G__12042) {
case (0):
...
case (1):
var G__12043 = comp;
var G__12044 = jsprops;
var G__12045 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__12043,G__12044,G__12045) : reagent.impl.template.global$module$react.createElement.call(null,G__12043,G__12044,G__12045));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__12042){
