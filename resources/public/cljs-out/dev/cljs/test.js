...
var G__12034 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__12034,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__12034;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq12036){
var G__12037 = cljs.core.first.call(null,seq12036);
var seq12036__$1 = cljs.core.next.call(null,seq12036);
var G__12038 = cljs.core.first.call(null,seq12036__$1);
var seq12036__$2 = cljs.core.next.call(null,seq12036__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12037,G__12038,seq12036__$2);
});
...
var map__12043 = m;
var map__12043__$1 = ((((!((map__12043 == null)))?(((((map__12043.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__12043.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__12043):map__12043);
var file = cljs.core.get.call(null,map__12043__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__12043__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__12043__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__12043,map__12043__$1,file,line,column){
return (function (p1__12042_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__12042_SHARP_));
});})(map__12043,map__12043__$1,file,line,column))
...
var temp__5457__auto___12045 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___12045)){
var message_12046 = temp__5457__auto___12045;
cljs.core.println.call(null,message_12046);
} else {
}
...
var temp__5457__auto___12047 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___12047)){
var message_12048 = temp__5457__auto___12047;
cljs.core.println.call(null,message_12048);
} else {
}
...
var output_dir__$1 = (function (){var G__12049 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12049),"/"].join('');
} else {
return G__12049;
}
})();
...
var G__12051 = exception.stack;
var G__12051__$1 = (((G__12051 == null))?null:clojure.string.split_lines.call(null,G__12051));
var G__12051__$2 = (((G__12051__$1 == null))?null:cljs.core.get.call(null,G__12051__$1,depth));
if((G__12051__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__12051__$2);
}
} else {
...
var vec__12052 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__12052,(0),null);
var column = cljs.core.nth.call(null,vec__12052,(1),null);
var vec__12055 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__12055,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__12055,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__12055,(2),null);
...
var m__$1 = (function (){var G__12058 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__12058__$1 = (((G__12058 instanceof cljs.core.Keyword))?G__12058.fqn:null);
switch (G__12058__$1) {
case "fail":
...
var G__12062 = (function (){var G__12061 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__12061);
} else {
return G__12061;
}
})();
...
return cljs.core.vary_meta.call(null,G__12063,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__12067 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__12067,(0),null);
var types = vec__12067;
...
return cljs.core.map.call(null,(function (p__12070){
var vec__12071 = p__12070;
var ns = cljs.core.nth.call(null,vec__12071,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__12071,(1),null);
return ((function (vec__12071,ns,vars__$1){
return (function (){
...
var G__12074 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__12074,G__12074__$1,env,once_fixtures,each_fixtures,vec__12071,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__12074,G__12074__$1,env,once_fixtures,each_fixtures,vec__12071,ns,vars__$1){
return (function (){
var seq__12075 = cljs.core.seq.call(null,vars__$1);
var chunk__12076 = null;
var count__12077 = (0);
var i__12078 = (0);
while(true){
if((i__12078 < count__12077)){
var v = cljs.core._nth.call(null,chunk__12076,i__12078);
var temp__5457__auto___12080 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___12080)){
var t_12081 = temp__5457__auto___12080;
each_fixture_fn.call(null,((function (seq__12075,chunk__12076,count__12077,i__12078,t_12081,temp__5457__auto___12080,v,each_fixture_fn,G__12074,G__12074__$1,env,once_fixtures,each_fixtures,vec__12071,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12081)));
});})(seq__12075,chunk__12076,count__12077,i__12078,t_12081,temp__5457__auto___12080,v,each_fixture_fn,G__12074,G__12074__$1,env,once_fixtures,each_fixtures,vec__12071,ns,vars__$1))
);
} else {
}


var G__12082 = seq__12075;
var G__12083 = chunk__12076;
var G__12084 = count__12077;
var G__12085 = (i__12078 + (1));
seq__12075 = G__12082;
chunk__12076 = G__12083;
count__12077 = G__12084;
i__12078 = G__12085;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__12075);
if(temp__5457__auto__){
var seq__12075__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__12075__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__12075__$1);
var G__12086 = cljs.core.chunk_rest.call(null,seq__12075__$1);
var G__12087 = c__4351__auto__;
var G__12088 = cljs.core.count.call(null,c__4351__auto__);
var G__12089 = (0);
seq__12075 = G__12086;
chunk__12076 = G__12087;
count__12077 = G__12088;
i__12078 = G__12089;
continue;
} else {
var v = cljs.core.first.call(null,seq__12075__$1);
var temp__5457__auto___12090__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___12090__$1)){
var t_12091 = temp__5457__auto___12090__$1;
each_fixture_fn.call(null,((function (seq__12075,chunk__12076,count__12077,i__12078,t_12091,temp__5457__auto___12090__$1,v,seq__12075__$1,temp__5457__auto__,each_fixture_fn,G__12074,G__12074__$1,env,once_fixtures,each_fixtures,vec__12071,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12091)));
});})(seq__12075,chunk__12076,count__12077,i__12078,t_12091,temp__5457__auto___12090__$1,v,seq__12075__$1,temp__5457__auto__,each_fixture_fn,G__12074,G__12074__$1,env,once_fixtures,each_fixtures,vec__12071,ns,vars__$1))
);
} else {
}
...
});})(each_fixture_fn,G__12074,G__12074__$1,env,once_fixtures,each_fixtures,vec__12071,ns,vars__$1))
);
});})(each_fixture_fn,G__12074,G__12074__$1,env,once_fixtures,each_fixtures,vec__12071,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12074__$1)].join('')));

}
})());
});
;})(vec__12071,ns,vars__$1))
