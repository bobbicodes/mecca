...
tubax.core.xml__GT_clj.cljs$core$IFn$_invoke$arity$2 = (function (source,p__21008){
var map__21009 = p__21008;
var map__21009__$1 = ((((!((map__21009 == null)))?(((((map__21009.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21009.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__21009):map__21009);
var strict = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21009__$1,cljs.core.cst$kw$strict,true);
var trim = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21009__$1,cljs.core.cst$kw$trim,true);
var normalize = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21009__$1,cljs.core.cst$kw$normalize,false);
var lowercase = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21009__$1,cljs.core.cst$kw$lowercase,true);
var xmlns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21009__$1,cljs.core.cst$kw$xmlns);
var position = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21009__$1,cljs.core.cst$kw$position,true);
var strict_entities = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21009__$1,cljs.core.cst$kw$strict_DASH_entities,false);
...
parser.onopentag = ((function (parser,document,result,map__21009,map__21009__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__21001_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.add_node_document,p1__21001_SHARP_));
});})(parser,document,result,map__21009,map__21009__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.onclosetag = ((function (parser,document,result,map__21009,map__21009__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__21002_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.close_node_document,p1__21002_SHARP_));
});})(parser,document,result,map__21009,map__21009__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.ontext = ((function (parser,document,result,map__21009,map__21009__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__21003_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.add_text,p1__21003_SHARP_));
});})(parser,document,result,map__21009,map__21009__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.oncdata = ((function (parser,document,result,map__21009,map__21009__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__21004_SHARP_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(document,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(tubax.core.add_text,p1__21004_SHARP_));
});})(parser,document,result,map__21009,map__21009__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;

parser.onend = ((function (parser,document,result,map__21009,map__21009__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (){
...
parser.onerror = ((function (parser,document,result,map__21009,map__21009__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities){
return (function (p1__21005_SHARP_){
return cljs.core.reset_BANG_(result,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$error,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__21005_SHARP_)].join('')], null));
});})(parser,document,result,map__21009,map__21009__$1,strict,trim,normalize,lowercase,xmlns,position,strict_entities))
;
