...
var o21489 = temp__5455__auto__;
var temp__5455__auto____$1 = (o21489["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o21490 = temp__5455__auto____$1;
return (o21490["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21309__auto__ = f;
return (o__21309__auto__["toString"]).call(o__21309__auto__);
} else {
return "";
}
}catch (e21491){var _ = e21491;
return "";
}});
...
try{var o__21309__auto___21493 = t;
(o__21309__auto___21493["cljs$lang$ctorPrWriter"]).call(o__21309__auto___21493,t,writer);
}catch (e21492){var __21494 = e21492;
}
...
var char_code = (function (){var o__21309__auto__ = (new String(char$));
return (o__21309__auto__["charCodeAt"]).call(o__21309__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21309__auto__ = String;
return (o__21309__auto__["fromCharCode"]).call(o__21309__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21495 = num_code;
switch (G__21495) {
case (1):
return (185);
...
var o__21309__auto__ = String;
return (o__21309__auto__["fromCharCode"]).call(o__21309__auto__,superscript_code);
});
/**
...
}catch (e21497){var _e__21316__auto__ = e21497;
return false;
}})())){
...
var vec__21498 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21498,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o21501 = temp__5455__auto__;
var temp__5455__auto____$1 = (o21501["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o21502 = temp__5455__auto____$1;
return (o21502["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21505){
var vec__21506 = p__21505;
var ns_detector = cljs.core.nth.call(null,vec__21506,(0),null);
...
var G__21512 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21513 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21512;
remaining_tokens = G__21513;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21503){
var G__21504 = cljs.core.first.call(null,seq21503);
var seq21503__$1 = cljs.core.next.call(null,seq21503);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21504,seq21503__$1);
});
...
var vec__21517 = cljs.core.split_with.call(null,(function (p1__21516_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21516_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21517,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21517,(1),null);
...
var vec__21520 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21520,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21520,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__21523 = cljs.core.rest.call(null,remaining_tokens);
var G__21524 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__21523;
name_tokens = G__21524;
continue;
} else {
...
var vec__21527 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__21527,(0),null);
var arity = cljs.core.nth.call(null,vec__21527,(1),null);
var vec__21530 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__21530,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__21530,(1),null);
var vec__21533 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__21533,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__21533,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__21533,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__21533,(3),null);
...
var vec__21539 = result;
var munged_ns = cljs.core.nth.call(null,vec__21539,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__21539,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__21539,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__21539,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__21539,(4),null);
var arity = cljs.core.nth.call(null,vec__21539,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__21543 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__21543,(0),null);
var args = cljs.core.nth.call(null,vec__21543,(1),null);
var vec__21546 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__21546,(0),null);
var name = cljs.core.nth.call(null,vec__21546,(1),null);
...
var G__21549 = (arity + (1));
var G__21550 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21551){
var vec__21552 = p__21551;
var arity = cljs.core.nth.call(null,vec__21552,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__21552,(1),null);
...
return cljs.core.get.call(null,arities,p1__21555_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__21556_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21559){
var vec__21560 = p__21559;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__21560,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21557){
var G__21558 = cljs.core.first.call(null,seq21557);
var seq21557__$1 = cljs.core.next.call(null,seq21557);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21558,seq21557__$1);
});
...
var map__21568 = options;
var map__21568__$1 = ((((!((map__21568 == null)))?(((((map__21568.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21568.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21568):map__21568);
var include_ns_QMARK_ = cljs.core.get.call(null,map__21568__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__21568__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__21568__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__21568__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21569 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__21569,(0),null);
var fn_name = cljs.core.nth.call(null,vec__21569,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__21569,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__21569,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__21569,(4),null);
var arity = cljs.core.nth.call(null,vec__21569,(5),null);
...
var o__21309__auto__ = f;
return (o__21309__auto__["getBasis"]).call(o__21309__auto__);
});
/**
...
}catch (e21573){var _e__21316__auto__ = e21573;
...
var G__21574 = (obj[cljs.core.first.call(null,path)]);
var G__21575 = cljs.core.rest.call(null,path);
obj = G__21574;
path = G__21575;
continue;
} else {
...
return (function (accum,p__21576){
var vec__21577 = p__21576;
var bit = cljs.core.nth.call(null,vec__21577,(0),null);
var protocol = cljs.core.nth.call(null,vec__21577,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21580){
var vec__21581 = p__21580;
var ns = cljs.core.nth.call(null,vec__21581,(0),null);
var name = cljs.core.nth.call(null,vec__21581,(1),null);
var selector = cljs.core.nth.call(null,vec__21581,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__21586,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__21586,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__21586,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__21584_SHARP_){
return (obj[cljs.core.first.call(null,p1__21584_SHARP_)]);
});})(name,sorted_matches,vec__21586,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
