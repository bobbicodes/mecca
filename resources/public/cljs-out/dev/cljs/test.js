...
var G__20296 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__20296,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__20296;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq20298){
var G__20299 = cljs.core.first.call(null,seq20298);
var seq20298__$1 = cljs.core.next.call(null,seq20298);
var G__20300 = cljs.core.first.call(null,seq20298__$1);
var seq20298__$2 = cljs.core.next.call(null,seq20298__$1);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20299,G__20300,seq20298__$2);
});
...
var file = cljs.core.get.call(null,map__20305__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__20305__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__20305__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__20305,map__20305__$1,file,line,column){
return (function (p1__20304_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__20304_SHARP_));
});})(map__20305,map__20305__$1,file,line,column))
...
var temp__5457__auto___20307 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20307)){
var message_20308 = temp__5457__auto___20307;
cljs.core.println.call(null,message_20308);
} else {
}
...
var temp__5457__auto___20309 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20309)){
var message_20310 = temp__5457__auto___20309;
cljs.core.println.call(null,message_20310);
} else {
}
...
var output_dir__$1 = (function (){var G__20311 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20311),"/"].join('');
} else {
return G__20311;
}
})();
...
var G__20313 = exception.stack;
var G__20313__$1 = (((G__20313 == null))?null:clojure.string.split_lines.call(null,G__20313));
var G__20313__$2 = (((G__20313__$1 == null))?null:cljs.core.get.call(null,G__20313__$1,depth));
if((G__20313__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__20313__$2);
}
} else {
...
var vec__20314 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__20314,(0),null);
var column = cljs.core.nth.call(null,vec__20314,(1),null);
var vec__20317 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__20317,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__20317,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__20317,(2),null);
...
var m__$1 = (function (){var G__20320 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__20324 = (function (){var G__20323 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__20323);
} else {
return G__20323;
}
})();
...
return cljs.core.vary_meta.call(null,G__20325,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__20327 = e;
var G__20327__$1 = (((G__20327 instanceof cljs.core.Keyword))?G__20327.fqn:null);
switch (G__20327__$1) {
...
var vec__20329 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__20329,(0),null);
var types = vec__20329;
...
return cljs.core.map.call(null,(function (p__20332){
var vec__20333 = p__20332;
var ns = cljs.core.nth.call(null,vec__20333,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__20333,(1),null);
return ((function (vec__20333,ns,vars__$1){
return (function (){
...
var G__20336 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__20336,G__20336__$1,env,once_fixtures,each_fixtures,vec__20333,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__20336,G__20336__$1,env,once_fixtures,each_fixtures,vec__20333,ns,vars__$1){
return (function (){
var seq__20337 = cljs.core.seq.call(null,vars__$1);
var chunk__20338 = null;
var count__20339 = (0);
var i__20340 = (0);
while(true){
if((i__20340 < count__20339)){
var v = cljs.core._nth.call(null,chunk__20338,i__20340);
var temp__5457__auto___20342 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20342)){
var t_20343 = temp__5457__auto___20342;
each_fixture_fn.call(null,((function (seq__20337,chunk__20338,count__20339,i__20340,t_20343,temp__5457__auto___20342,v,each_fixture_fn,G__20336,G__20336__$1,env,once_fixtures,each_fixtures,vec__20333,ns,vars__$1){
return (function (){
...
});})(seq__20337,chunk__20338,count__20339,i__20340,t_20343,temp__5457__auto___20342,v,each_fixture_fn,G__20336,G__20336__$1,env,once_fixtures,each_fixtures,vec__20333,ns,vars__$1))
);
} else {
}


var G__20344 = seq__20337;
var G__20345 = chunk__20338;
var G__20346 = count__20339;
var G__20347 = (i__20340 + (1));
seq__20337 = G__20344;
chunk__20338 = G__20345;
count__20339 = G__20346;
i__20340 = G__20347;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__20337);
if(temp__5457__auto__){
var seq__20337__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__20337__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__20337__$1);
var G__20348 = cljs.core.chunk_rest.call(null,seq__20337__$1);
var G__20349 = c__4351__auto__;
var G__20350 = cljs.core.count.call(null,c__4351__auto__);
var G__20351 = (0);
seq__20337 = G__20348;
chunk__20338 = G__20349;
count__20339 = G__20350;
i__20340 = G__20351;
continue;
} else {
var v = cljs.core.first.call(null,seq__20337__$1);
var temp__5457__auto___20352__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20352__$1)){
var t_20353 = temp__5457__auto___20352__$1;
each_fixture_fn.call(null,((function (seq__20337,chunk__20338,count__20339,i__20340,t_20353,temp__5457__auto___20352__$1,v,seq__20337__$1,temp__5457__auto__,each_fixture_fn,G__20336,G__20336__$1,env,once_fixtures,each_fixtures,vec__20333,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20353)));
});})(seq__20337,chunk__20338,count__20339,i__20340,t_20353,temp__5457__auto___20352__$1,v,seq__20337__$1,temp__5457__auto__,each_fixture_fn,G__20336,G__20336__$1,env,once_fixtures,each_fixtures,vec__20333,ns,vars__$1))
);
} else {
}


var G__20354 = cljs.core.next.call(null,seq__20337__$1);
var G__20355 = null;
var G__20356 = (0);
var G__20357 = (0);
seq__20337 = G__20354;
chunk__20338 = G__20355;
count__20339 = G__20356;
i__20340 = G__20357;
continue;
}
} else {
...
});})(each_fixture_fn,G__20336,G__20336__$1,env,once_fixtures,each_fixtures,vec__20333,ns,vars__$1))
);
});})(each_fixture_fn,G__20336,G__20336__$1,env,once_fixtures,each_fixtures,vec__20333,ns,vars__$1))
], null);
