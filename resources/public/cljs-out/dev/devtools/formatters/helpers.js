...
var G__21782 = devtools.prefs.pref.call(null,v);
v = G__21782;
continue;
} else {
return v;
...
}catch (e21785){var _e__21036__auto__ = e21785;
return false;
}})();
...
}catch (e21789){var _e__21036__auto__ = e21789;
return false;
}})();
...
}catch (e21791){var _e__21036__auto__ = e21791;
return false;
}}
}
});
...
var vec__21793 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21793,(0),null);
var name = cljs.core.nth.call(null,vec__21793,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21796_SHARP_);
}),template);
});
