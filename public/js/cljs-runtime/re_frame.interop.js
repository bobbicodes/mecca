...
return [(function (){var pred__36483 = cljs.core.instance_QMARK_;
var expr__36484 = reactive_val;
if(cljs.core.truth_((pred__36483.cljs$core$IFn$_invoke$arity$2 ? pred__36483.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__36484) : pred__36483.call(null,reagent.ratom.RAtom,expr__36484)))){
return "ra";
} else {
if(cljs.core.truth_((pred__36483.cljs$core$IFn$_invoke$arity$2 ? pred__36483.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__36484) : pred__36483.call(null,reagent.ratom.RCursor,expr__36484)))){
return "rc";
} else {
if(cljs.core.truth_((pred__36483.cljs$core$IFn$_invoke$arity$2 ? pred__36483.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__36484) : pred__36483.call(null,reagent.ratom.Reaction,expr__36484)))){
return "rx";
} else {
if(cljs.core.truth_((pred__36483.cljs$core$IFn$_invoke$arity$2 ? pred__36483.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__36484) : pred__36483.call(null,reagent.ratom.Track,expr__36484)))){
return "tr";
} else {
return "other";
}
