...
args__4534__auto__.push((arguments[i__4532__auto___21078]));
...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq21074){
...
var vec__21080 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__21080,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__21080,(1),null);
var G__21083 = cljs.core.PersistentArrayMap.EMPTY;
var G__21083__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__21083,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21083);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__21083__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__21083__$1;
}
} else {
...
return (function() { 
var G__21087__delegate = function (klass,contents){
var vec__21084 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__21084,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__21084,(1),null);
...
var G__21087 = function (klass,var_args){
var contents = null;
if (arguments.length > 1) {
var G__21088__i = 0, G__21088__a = new Array(arguments.length -  1);
while (G__21088__i < G__21088__a.length) {G__21088__a[G__21088__i] = arguments[G__21088__i + 1]; ++G__21088__i;}
  contents = new cljs.core.IndexedSeq(G__21088__a,0,null);
} 
return G__21087__delegate.call(this,klass,contents);};
G__21087.cljs$lang$maxFixedArity = 1;
G__21087.cljs$lang$applyTo = (function (arglist__21089){
var klass = cljs.core.first(arglist__21089);
var contents = cljs.core.rest(arglist__21089);
return G__21087__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__21093){
var map__21094 = p__21093;
var map__21094__$1 = ((((!((map__21094 == null)))?(((((map__21094.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21094.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21094):map__21094);
var ns = cljs.core.get.call(null,map__21094__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
var file = cljs.core.get.call(null,map__21094__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__21096){
...
var actual = cljs.core.get.call(null,map__21097__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__21097__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__21099){
...
var expected = cljs.core.get.call(null,map__21100__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__21100__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__21102_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__21104 = cljs_test_display.core.current_var_info.call(null);
var map__21104__$1 = ((((!((map__21104 == null)))?(((((map__21104.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21104.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21104):map__21104);
var info = map__21104__$1;
var name = cljs.core.get.call(null,map__21104__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var line = cljs.core.get.call(null,map__21104__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__21104__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__21104,map__21104__$1,info,name,line,file,node){
return (function (p1__21103_SHARP_){
return cljs.core.cons.call(null,node,p1__21103_SHARP_);
});})(curr_node,map__21104,map__21104__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__21106){
var map__21107 = p__21106;
var map__21107__$1 = ((((!((map__21107 == null)))?(((((map__21107.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21107.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21107):map__21107);
var m = map__21107__$1;
var fail = cljs.core.get.call(null,map__21107__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__21107__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__21107__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__21107__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5457__auto___21109 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21109)){
var message_21110 = temp__5457__auto___21109;
cljs.core.println.call(null,message_21110);
} else {
}
...
var temp__5457__auto___21111 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___21111)){
var message_21112 = temp__5457__auto___21111;
cljs.core.println.call(null,message_21112);
} else {
}
