...
return cljs.core.assoc.call(null,G__20282,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__20282;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq20284){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20285,G__20286,seq20284__$2);
});
...
var map__20291 = m;
var map__20291__$1 = ((((!((map__20291 == null)))?(((((map__20291.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20291.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20291):map__20291);
var file = cljs.core.get.call(null,map__20291__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__20291__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__20291__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__20291,map__20291__$1,file,line,column){
return (function (p1__20290_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__20290_SHARP_));
});})(map__20291,map__20291__$1,file,line,column))
...
var temp__5457__auto___20293 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20293)){
var message_20294 = temp__5457__auto___20293;
cljs.core.println.call(null,message_20294);
} else {
}
...
var temp__5457__auto___20295 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20295)){
var message_20296 = temp__5457__auto___20295;
cljs.core.println.call(null,message_20296);
} else {
}
...
var output_dir__$1 = (function (){var G__20297 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20297),"/"].join('');
} else {
return G__20297;
}
})();
...
var G__20299 = exception.stack;
var G__20299__$1 = (((G__20299 == null))?null:clojure.string.split_lines.call(null,G__20299));
var G__20299__$2 = (((G__20299__$1 == null))?null:cljs.core.get.call(null,G__20299__$1,depth));
if((G__20299__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__20299__$2);
}
} else {
...
var vec__20300 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__20300,(0),null);
var column = cljs.core.nth.call(null,vec__20300,(1),null);
var vec__20303 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__20303,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__20303,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__20303,(2),null);
...
var m__$1 = (function (){var G__20306 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__20310 = (function (){var G__20309 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__20309);
} else {
return G__20309;
}
})();
...
return cljs.core.vary_meta.call(null,G__20311,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__20315 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__20315,(0),null);
var types = vec__20315;
...
return cljs.core.map.call(null,(function (p__20318){
var vec__20319 = p__20318;
var ns = cljs.core.nth.call(null,vec__20319,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__20319,(1),null);
return ((function (vec__20319,ns,vars__$1){
return (function (){
...
var G__20322 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__20322,G__20322__$1,env,once_fixtures,each_fixtures,vec__20319,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__20322,G__20322__$1,env,once_fixtures,each_fixtures,vec__20319,ns,vars__$1){
return (function (){
var seq__20323 = cljs.core.seq.call(null,vars__$1);
var chunk__20324 = null;
var count__20325 = (0);
var i__20326 = (0);
while(true){
if((i__20326 < count__20325)){
var v = cljs.core._nth.call(null,chunk__20324,i__20326);
var temp__5457__auto___20328 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20328)){
var t_20329 = temp__5457__auto___20328;
each_fixture_fn.call(null,((function (seq__20323,chunk__20324,count__20325,i__20326,t_20329,temp__5457__auto___20328,v,each_fixture_fn,G__20322,G__20322__$1,env,once_fixtures,each_fixtures,vec__20319,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20329)));
});})(seq__20323,chunk__20324,count__20325,i__20326,t_20329,temp__5457__auto___20328,v,each_fixture_fn,G__20322,G__20322__$1,env,once_fixtures,each_fixtures,vec__20319,ns,vars__$1))
);
} else {
}


var G__20330 = seq__20323;
var G__20331 = chunk__20324;
var G__20332 = count__20325;
var G__20333 = (i__20326 + (1));
seq__20323 = G__20330;
chunk__20324 = G__20331;
count__20325 = G__20332;
i__20326 = G__20333;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__20323);
if(temp__5457__auto__){
var seq__20323__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__20323__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__20323__$1);
var G__20334 = cljs.core.chunk_rest.call(null,seq__20323__$1);
var G__20335 = c__4351__auto__;
var G__20336 = cljs.core.count.call(null,c__4351__auto__);
var G__20337 = (0);
seq__20323 = G__20334;
chunk__20324 = G__20335;
count__20325 = G__20336;
i__20326 = G__20337;
continue;
} else {
var v = cljs.core.first.call(null,seq__20323__$1);
var temp__5457__auto___20338__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20338__$1)){
var t_20339 = temp__5457__auto___20338__$1;
each_fixture_fn.call(null,((function (seq__20323,chunk__20324,count__20325,i__20326,t_20339,temp__5457__auto___20338__$1,v,seq__20323__$1,temp__5457__auto__,each_fixture_fn,G__20322,G__20322__$1,env,once_fixtures,each_fixtures,vec__20319,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20339)));
});})(seq__20323,chunk__20324,count__20325,i__20326,t_20339,temp__5457__auto___20338__$1,v,seq__20323__$1,temp__5457__auto__,each_fixture_fn,G__20322,G__20322__$1,env,once_fixtures,each_fixtures,vec__20319,ns,vars__$1))
);
} else {
}


var G__20340 = cljs.core.next.call(null,seq__20323__$1);
var G__20341 = null;
var G__20342 = (0);
var G__20343 = (0);
seq__20323 = G__20340;
chunk__20324 = G__20341;
count__20325 = G__20342;
i__20326 = G__20343;
continue;
}
} else {
...
});})(each_fixture_fn,G__20322,G__20322__$1,env,once_fixtures,each_fixtures,vec__20319,ns,vars__$1))
);
});})(each_fixture_fn,G__20322,G__20322__$1,env,once_fixtures,each_fixtures,vec__20319,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20322__$1)].join('')));

}
})());
});
;})(vec__20319,ns,vars__$1))
