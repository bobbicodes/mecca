...
var o14757 = temp__5455__auto__;
var temp__5455__auto____$1 = (o14757["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o14758 = temp__5455__auto____$1;
return (o14758["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__14577__auto__ = f;
return (o__14577__auto__["toString"]).call(o__14577__auto__);
} else {
return "";
}
}catch (e14759){var _ = e14759;
return "";
}});
...
try{var o__14577__auto___14761 = t;
(o__14577__auto___14761["cljs$lang$ctorPrWriter"]).call(o__14577__auto___14761,t,writer);
}catch (e14760){var __14762 = e14760;
}
...
var char_code = (function (){var o__14577__auto__ = (new String(char$));
return (o__14577__auto__["charCodeAt"]).call(o__14577__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__14577__auto__ = String;
return (o__14577__auto__["fromCharCode"]).call(o__14577__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__14763 = num_code;
switch (G__14763) {
case (1):
return (185);
...
var o__14577__auto__ = String;
return (o__14577__auto__["fromCharCode"]).call(o__14577__auto__,superscript_code);
});
/**
...
}catch (e14765){var _e__14584__auto__ = e14765;
return false;
}})())){
...
var vec__14766 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__14766,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o14769 = temp__5455__auto__;
var temp__5455__auto____$1 = (o14769["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o14770 = temp__5455__auto____$1;
return (o14770["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___14777 = arguments.length;
var i__4532__auto___14778 = (0);
while(true){
if((i__4532__auto___14778 < len__4531__auto___14777)){
args__4534__auto__.push((arguments[i__4532__auto___14778]));

var G__14779 = (i__4532__auto___14778 + (1));
i__4532__auto___14778 = G__14779;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__14773){
var vec__14774 = p__14773;
var ns_detector = cljs.core.nth.call(null,vec__14774,(0),null);
...
var G__14780 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__14781 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__14780;
remaining_tokens = G__14781;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq14771){
var G__14772 = cljs.core.first.call(null,seq14771);
var seq14771__$1 = cljs.core.next.call(null,seq14771);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14772,seq14771__$1);
});
...
var vec__14785 = cljs.core.split_with.call(null,(function (p1__14784_SHARP_){
return cljs.core.not_EQ_.call(null,p1__14784_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__14785,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__14785,(1),null);
...
var vec__14788 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__14788,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__14788,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__14791 = cljs.core.rest.call(null,remaining_tokens);
var G__14792 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__14791;
name_tokens = G__14792;
continue;
} else {
...
var vec__14795 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__14795,(0),null);
var arity = cljs.core.nth.call(null,vec__14795,(1),null);
var vec__14798 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__14798,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__14798,(1),null);
var vec__14801 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__14801,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__14801,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__14801,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__14801,(3),null);
...
var vec__14807 = result;
var munged_ns = cljs.core.nth.call(null,vec__14807,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__14807,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__14807,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__14807,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__14807,(4),null);
var arity = cljs.core.nth.call(null,vec__14807,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__14811 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__14811,(0),null);
var args = cljs.core.nth.call(null,vec__14811,(1),null);
var vec__14814 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__14814,(0),null);
var name = cljs.core.nth.call(null,vec__14814,(1),null);
...
var G__14817 = (arity + (1));
var G__14818 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__14819){
var vec__14820 = p__14819;
var arity = cljs.core.nth.call(null,vec__14820,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__14820,(1),null);
...
return cljs.core.get.call(null,arities,p1__14823_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__14824_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___14831 = arguments.length;
var i__4532__auto___14832 = (0);
while(true){
if((i__4532__auto___14832 < len__4531__auto___14831)){
args__4534__auto__.push((arguments[i__4532__auto___14832]));

var G__14833 = (i__4532__auto___14832 + (1));
i__4532__auto___14832 = G__14833;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__14827){
var vec__14828 = p__14827;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__14828,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq14825){
var G__14826 = cljs.core.first.call(null,seq14825);
var seq14825__$1 = cljs.core.next.call(null,seq14825);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14826,seq14825__$1);
});
...
var G__14834 = arg;
var G__14834__$1 = (((G__14834 instanceof cljs.core.Keyword))?G__14834.fqn:null);
switch (G__14834__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__14836__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__14836__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__14836__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__14836__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__14837 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__14837,(0),null);
var fn_name = cljs.core.nth.call(null,vec__14837,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__14837,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__14837,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__14837,(4),null);
var arity = cljs.core.nth.call(null,vec__14837,(5),null);
...
var o__14577__auto__ = f;
return (o__14577__auto__["getBasis"]).call(o__14577__auto__);
});
/**
...
}catch (e14841){var _e__14584__auto__ = e14841;
...
var G__14842 = (obj[cljs.core.first.call(null,path)]);
var G__14843 = cljs.core.rest.call(null,path);
obj = G__14842;
path = G__14843;
continue;
} else {
...
return (function (accum,p__14844){
var vec__14845 = p__14844;
var bit = cljs.core.nth.call(null,vec__14845,(0),null);
var protocol = cljs.core.nth.call(null,vec__14845,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__14848){
var vec__14849 = p__14848;
var ns = cljs.core.nth.call(null,vec__14849,(0),null);
var name = cljs.core.nth.call(null,vec__14849,(1),null);
var selector = cljs.core.nth.call(null,vec__14849,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__14854,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__14854,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__14854,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__14852_SHARP_){
return (obj[cljs.core.first.call(null,p1__14852_SHARP_)]);
});})(name,sorted_matches,vec__14854,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
