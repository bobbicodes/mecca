...
var G__20281 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__20281,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__20281;
}
});
...
var len__4531__auto___20286 = arguments.length;
var i__4532__auto___20287 = (0);
while(true){
if((i__4532__auto___20287 < len__4531__auto___20286)){
args__4534__auto__.push((arguments[i__4532__auto___20287]));

var G__20288 = (i__4532__auto___20287 + (1));
i__4532__auto___20287 = G__20288;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq20283){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20284,G__20285,seq20283__$2);
});
...
var map__20290 = m;
var map__20290__$1 = ((((!((map__20290 == null)))?(((((map__20290.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20290.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20290):map__20290);
var file = cljs.core.get.call(null,map__20290__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__20290__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__20290__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__20290,map__20290__$1,file,line,column){
return (function (p1__20289_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__20289_SHARP_));
});})(map__20290,map__20290__$1,file,line,column))
...
var temp__5457__auto___20292 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20292)){
var message_20293 = temp__5457__auto___20292;
cljs.core.println.call(null,message_20293);
} else {
}
...
var temp__5457__auto___20294 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___20294)){
var message_20295 = temp__5457__auto___20294;
cljs.core.println.call(null,message_20295);
} else {
}
...
var output_dir__$1 = (function (){var G__20296 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20296),"/"].join('');
} else {
return G__20296;
}
})();
...
var G__20298 = exception.stack;
var G__20298__$1 = (((G__20298 == null))?null:clojure.string.split_lines.call(null,G__20298));
var G__20298__$2 = (((G__20298__$1 == null))?null:cljs.core.get.call(null,G__20298__$1,depth));
if((G__20298__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__20298__$2);
}
} else {
...
var vec__20299 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__20299,(0),null);
var column = cljs.core.nth.call(null,vec__20299,(1),null);
var vec__20302 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__20302,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__20302,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__20302,(2),null);
...
var m__$1 = (function (){var G__20305 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__20309 = (function (){var G__20308 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__20308);
} else {
return G__20308;
}
})();
...
return cljs.core.vary_meta.call(null,G__20310,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e20311){var e = e20311;
var G__20312 = e;
var G__20312__$1 = (((G__20312 instanceof cljs.core.Keyword))?G__20312.fqn:null);
switch (G__20312__$1) {
...
var vec__20314 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__20314,(0),null);
var types = vec__20314;
...
return cljs.core.map.call(null,(function (p__20317){
var vec__20318 = p__20317;
var ns = cljs.core.nth.call(null,vec__20318,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__20318,(1),null);
return ((function (vec__20318,ns,vars__$1){
return (function (){
...
var G__20321 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__20321__$1 = (((G__20321 instanceof cljs.core.Keyword))?G__20321.fqn:null);
switch (G__20321__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__20321,G__20321__$1,env,once_fixtures,each_fixtures,vec__20318,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__20321,G__20321__$1,env,once_fixtures,each_fixtures,vec__20318,ns,vars__$1){
return (function (){
var seq__20322 = cljs.core.seq.call(null,vars__$1);
var chunk__20323 = null;
var count__20324 = (0);
var i__20325 = (0);
while(true){
if((i__20325 < count__20324)){
var v = cljs.core._nth.call(null,chunk__20323,i__20325);
var temp__5457__auto___20327 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20327)){
var t_20328 = temp__5457__auto___20327;
each_fixture_fn.call(null,((function (seq__20322,chunk__20323,count__20324,i__20325,t_20328,temp__5457__auto___20327,v,each_fixture_fn,G__20321,G__20321__$1,env,once_fixtures,each_fixtures,vec__20318,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20328)));
});})(seq__20322,chunk__20323,count__20324,i__20325,t_20328,temp__5457__auto___20327,v,each_fixture_fn,G__20321,G__20321__$1,env,once_fixtures,each_fixtures,vec__20318,ns,vars__$1))
);
} else {
}


var G__20329 = seq__20322;
var G__20330 = chunk__20323;
var G__20331 = count__20324;
var G__20332 = (i__20325 + (1));
seq__20322 = G__20329;
chunk__20323 = G__20330;
count__20324 = G__20331;
i__20325 = G__20332;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__20322);
if(temp__5457__auto__){
var seq__20322__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__20322__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__20322__$1);
var G__20333 = cljs.core.chunk_rest.call(null,seq__20322__$1);
var G__20334 = c__4351__auto__;
var G__20335 = cljs.core.count.call(null,c__4351__auto__);
var G__20336 = (0);
seq__20322 = G__20333;
chunk__20323 = G__20334;
count__20324 = G__20335;
i__20325 = G__20336;
continue;
} else {
var v = cljs.core.first.call(null,seq__20322__$1);
var temp__5457__auto___20337__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___20337__$1)){
var t_20338 = temp__5457__auto___20337__$1;
each_fixture_fn.call(null,((function (seq__20322,chunk__20323,count__20324,i__20325,t_20338,temp__5457__auto___20337__$1,v,seq__20322__$1,temp__5457__auto__,each_fixture_fn,G__20321,G__20321__$1,env,once_fixtures,each_fixtures,vec__20318,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_20338)));
});})(seq__20322,chunk__20323,count__20324,i__20325,t_20338,temp__5457__auto___20337__$1,v,seq__20322__$1,temp__5457__auto__,each_fixture_fn,G__20321,G__20321__$1,env,once_fixtures,each_fixtures,vec__20318,ns,vars__$1))
);
} else {
}


var G__20339 = cljs.core.next.call(null,seq__20322__$1);
var G__20340 = null;
var G__20341 = (0);
var G__20342 = (0);
seq__20322 = G__20339;
chunk__20323 = G__20340;
count__20324 = G__20341;
i__20325 = G__20342;
continue;
}
} else {
...
});})(each_fixture_fn,G__20321,G__20321__$1,env,once_fixtures,each_fixtures,vec__20318,ns,vars__$1))
);
});})(each_fixture_fn,G__20321,G__20321__$1,env,once_fixtures,each_fixtures,vec__20318,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__20321__$1)].join('')));

}
})());
});
;})(vec__20318,ns,vars__$1))
