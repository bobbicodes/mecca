...
var G__15413 = devtools.prefs.pref.call(null,v);
v = G__15413;
continue;
} else {
return v;
...
}catch (e15416){var _e__14667__auto__ = e15416;
return false;
}})();
...
}catch (e15420){var _e__14667__auto__ = e15420;
return false;
}})();
...
}catch (e15422){var _e__14667__auto__ = e15422;
return false;
}}
}
});
...
var vec__15424 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__15424,(0),null);
var name = cljs.core.nth.call(null,vec__15424,(1),null);
...
return cljs.core.some.call(null,(function (p1__15427_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__15427_SHARP_);
}),template);
});
