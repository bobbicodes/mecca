...
var temp__5455__auto____$1 = (o21318["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o21319 = temp__5455__auto____$1;
return (o21319["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__21138__auto__ = f;
return (o__21138__auto__["toString"]).call(o__21138__auto__);
} else {
return "";
}
...
try{var o__21138__auto___21322 = t;
(o__21138__auto___21322["cljs$lang$ctorPrWriter"]).call(o__21138__auto___21322,t,writer);
}catch (e21321){var __21323 = e21321;
}
...
var char_code = (function (){var o__21138__auto__ = (new String(char$));
return (o__21138__auto__["charCodeAt"]).call(o__21138__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__21138__auto__ = String;
return (o__21138__auto__["fromCharCode"]).call(o__21138__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__21324 = num_code;
switch (G__21324) {
case (1):
return (185);
...
var o__21138__auto__ = String;
return (o__21138__auto__["fromCharCode"]).call(o__21138__auto__,superscript_code);
});
/**
...
}catch (e21326){var _e__21145__auto__ = e21326;
return false;
}})())){
...
var vec__21327 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__21327,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o21330 = temp__5455__auto__;
var temp__5455__auto____$1 = (o21330["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o21331 = temp__5455__auto____$1;
return (o21331["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__21334){
var vec__21335 = p__21334;
var ns_detector = cljs.core.nth.call(null,vec__21335,(0),null);
...
var G__21341 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__21342 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__21341;
remaining_tokens = G__21342;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq21332){
var G__21333 = cljs.core.first.call(null,seq21332);
var seq21332__$1 = cljs.core.next.call(null,seq21332);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21333,seq21332__$1);
});
...
var vec__21346 = cljs.core.split_with.call(null,(function (p1__21345_SHARP_){
return cljs.core.not_EQ_.call(null,p1__21345_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__21346,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__21346,(1),null);
...
var vec__21349 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__21349,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__21349,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__21352 = cljs.core.rest.call(null,remaining_tokens);
var G__21353 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__21352;
name_tokens = G__21353;
continue;
} else {
...
var vec__21356 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__21356,(0),null);
var arity = cljs.core.nth.call(null,vec__21356,(1),null);
var vec__21359 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__21359,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__21359,(1),null);
var vec__21362 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__21362,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__21362,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__21362,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__21362,(3),null);
...
var vec__21368 = result;
var munged_ns = cljs.core.nth.call(null,vec__21368,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__21368,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__21368,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__21368,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__21368,(4),null);
var arity = cljs.core.nth.call(null,vec__21368,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__21372 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__21372,(0),null);
var args = cljs.core.nth.call(null,vec__21372,(1),null);
var vec__21375 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__21375,(0),null);
var name = cljs.core.nth.call(null,vec__21375,(1),null);
...
var G__21378 = (arity + (1));
var G__21379 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__21380){
var vec__21381 = p__21380;
var arity = cljs.core.nth.call(null,vec__21381,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__21381,(1),null);
...
return cljs.core.get.call(null,arities,p1__21384_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__21385_SHARP_){
return cljs.core.drop.call(null,(2),p1__21385_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___21392 = arguments.length;
var i__4532__auto___21393 = (0);
while(true){
if((i__4532__auto___21393 < len__4531__auto___21392)){
args__4534__auto__.push((arguments[i__4532__auto___21393]));

var G__21394 = (i__4532__auto___21393 + (1));
i__4532__auto___21393 = G__21394;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__21388){
var vec__21389 = p__21388;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__21389,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq21386){
var G__21387 = cljs.core.first.call(null,seq21386);
var seq21386__$1 = cljs.core.next.call(null,seq21386);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21387,seq21386__$1);
});
...
var G__21395 = arg;
var G__21395__$1 = (((G__21395 instanceof cljs.core.Keyword))?G__21395.fqn:null);
switch (G__21395__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__21397__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__21397__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__21397__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__21397__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__21398 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__21398,(0),null);
var fn_name = cljs.core.nth.call(null,vec__21398,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__21398,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__21398,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__21398,(4),null);
var arity = cljs.core.nth.call(null,vec__21398,(5),null);
...
var o__21138__auto__ = f;
return (o__21138__auto__["getBasis"]).call(o__21138__auto__);
});
/**
...
}catch (e21402){var _e__21145__auto__ = e21402;
...
var G__21403 = (obj[cljs.core.first.call(null,path)]);
var G__21404 = cljs.core.rest.call(null,path);
obj = G__21403;
path = G__21404;
continue;
} else {
...
return (function (accum,p__21405){
var vec__21406 = p__21405;
var bit = cljs.core.nth.call(null,vec__21406,(0),null);
var protocol = cljs.core.nth.call(null,vec__21406,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__21409){
var vec__21410 = p__21409;
var ns = cljs.core.nth.call(null,vec__21410,(0),null);
var name = cljs.core.nth.call(null,vec__21410,(1),null);
var selector = cljs.core.nth.call(null,vec__21410,(2),null);
...
return (function (p__21414){
var vec__21415 = p__21414;
var munged_name = cljs.core.nth.call(null,vec__21415,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__21415,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__21415,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__21413_SHARP_){
return (obj[cljs.core.first.call(null,p1__21413_SHARP_)]);
});})(name,sorted_matches,vec__21415,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
