...
return cljs.core.map.call(null,(function (p1__20904_SHARP_){
return html_coll.item(p1__20904_SHARP_);
...
return cljs.core._EQ_.call(null,"icon",p1__20905_SHARP_);
...
var ctx_20906 = cvs.getContext("2d");
ctx_20906.fillStyle = color;

ctx_20906.fillRect((0),(0),size,size);
