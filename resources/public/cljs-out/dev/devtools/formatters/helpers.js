...
var G__21891 = devtools.prefs.pref.call(null,v);
v = G__21891;
continue;
} else {
return v;
...
}catch (e21894){var _e__21145__auto__ = e21894;
return false;
}})();
...
}catch (e21898){var _e__21145__auto__ = e21898;
return false;
}})();
...
}catch (e21900){var _e__21145__auto__ = e21900;
return false;
}}
}
});
...
var vec__21902 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21902,(0),null);
var name = cljs.core.nth.call(null,vec__21902,(1),null);
...
return cljs.core.some.call(null,(function (p1__21905_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21905_SHARP_);
}),template);
});
