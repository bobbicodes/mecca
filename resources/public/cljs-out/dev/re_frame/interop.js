...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__10870 = cljs.core.instance_QMARK_;
var expr__10871 = reactive_val;
if(cljs.core.truth_((pred__10870.cljs$core$IFn$_invoke$arity$2 ? pred__10870.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__10871) : pred__10870.call(null,reagent.ratom.RAtom,expr__10871)))){
return "ra";
} else {
if(cljs.core.truth_((pred__10870.cljs$core$IFn$_invoke$arity$2 ? pred__10870.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__10871) : pred__10870.call(null,reagent.ratom.RCursor,expr__10871)))){
return "rc";
} else {
if(cljs.core.truth_((pred__10870.cljs$core$IFn$_invoke$arity$2 ? pred__10870.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__10871) : pred__10870.call(null,reagent.ratom.Reaction,expr__10871)))){
return "rx";
} else {
if(cljs.core.truth_((pred__10870.cljs$core$IFn$_invoke$arity$2 ? pred__10870.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__10871) : pred__10870.call(null,reagent.ratom.Track,expr__10871)))){
return "tr";
} else {
return "other";
}
