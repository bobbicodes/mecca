...
var G__40582 = o;
(G__40582[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__40631__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__40631 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__40632__i = 0, G__40632__a = new Array(arguments.length -  0);
while (G__40632__i < G__40632__a.length) {G__40632__a[G__40632__i] = arguments[G__40632__i + 0]; ++G__40632__i;}
  args = new cljs.core.IndexedSeq(G__40632__a,0,null);
} 
return G__40631__delegate.call(this,args);};
G__40631.cljs$lang$maxFixedArity = 0;
G__40631.cljs$lang$applyTo = (function (arglist__40633){
var args = cljs.core.seq(arglist__40633);
return G__40631__delegate(args);
});
...
var G__40584 = o;
(G__40584[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__40587 = props;
var G__40587__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40587,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__40587);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40587__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__40588){
var map__40589 = p__40588;
var map__40589__$1 = (((((!((map__40589 == null))))?(((((map__40589.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40589.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40589):map__40589);
var props = map__40589__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40589__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__40601){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40602__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var G__40605 = jsprops;
(G__40605["defaultValue"] = value);

(G__40605["onChange"] = (function (p1__40604_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__40604_SHARP_);
}));
...
var vec__40607 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40607,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40607,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40607,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___40638 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___40638 == null)){
} else {
var key_40639 = temp__5739__auto___40638;
(jsprops["key"] = key_40639);
}
...
var temp__5739__auto___40640 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___40640 == null)){
} else {
var key_40641 = temp__5739__auto___40640;
reagent.impl.template.oset(jsprops,"key",key_40641);
}
...
var G__40611 = reagent.impl.template.__GT_NativeWrapper();
(G__40611["name"] = c);
...
var G__40613 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__40613) : reagent.impl.template.as_element.call(null,G__40613));
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq40620){
var G__40621 = cljs.core.first(seq40620);
var seq40620__$1 = cljs.core.next(seq40620);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40621,seq40620__$1);
}));
...
break;
default:
var G__40682 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__40682;
continue;
...
var n__4666__auto___40683 = a.length;
var i_40684 = (0);
while(true){
if((i_40684 < n__4666__auto___40683)){
(a[i_40684] = reagent.impl.template.as_element((a[i_40684])));

var G__40685 = (i_40684 + (1));
i_40684 = G__40685;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4666__auto___40686 = a.length;
var i_40687 = (0);
while(true){
if((i_40687 < n__4666__auto___40686)){
var val_40688 = (a[i_40687]);
if(((cljs.core.vector_QMARK_(val_40688)) && ((reagent.impl.template.key_from_vec(val_40688) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_40687] = reagent.impl.template.as_element(val_40688));

var G__40689 = (i_40687 + (1));
i_40687 = G__40689;
continue;
} else {
}
...
var ctx = ({});
var vec__40624 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40624,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40624,(1),null);
...
var G__40627 = (cljs.core.count(argv) - first_child);
switch (G__40627) {
case (0):
...
case (1):
var G__40628 = comp;
var G__40629 = jsprops;
var G__40630 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__40628,G__40629,G__40630);
