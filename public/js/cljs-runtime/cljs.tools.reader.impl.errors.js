...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_ex.cljs$lang$applyTo = (function (seq26028){
var G__26029 = cljs.core.first(seq26028);
var seq26028__$1 = cljs.core.next(seq26028);
var G__26030 = cljs.core.first(seq26028__$1);
var seq26028__$2 = cljs.core.next(seq26028__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26029,G__26030,seq26028__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___26072 = arguments.length;
var i__4790__auto___26073 = (0);
while(true){
if((i__4790__auto___26073 < len__4789__auto___26072)){
args__4795__auto__.push((arguments[i__4790__auto___26073]));

var G__26074 = (i__4790__auto___26073 + (1));
i__4790__auto___26073 = G__26074;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.reader_error.cljs$lang$applyTo = (function (seq26031){
var G__26032 = cljs.core.first(seq26031);
var seq26031__$1 = cljs.core.next(seq26031);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26032,seq26031__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___26075 = arguments.length;
var i__4790__auto___26076 = (0);
while(true){
if((i__4790__auto___26076 < len__4789__auto___26075)){
args__4795__auto__.push((arguments[i__4790__auto___26076]));

var G__26077 = (i__4790__auto___26076 + (1));
i__4790__auto___26076 = G__26077;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.illegal_arg_error.cljs$lang$applyTo = (function (seq26033){
var G__26034 = cljs.core.first(seq26033);
var seq26033__$1 = cljs.core.next(seq26033);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26034,seq26033__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___26080 = arguments.length;
var i__4790__auto___26081 = (0);
while(true){
if((i__4790__auto___26081 < len__4789__auto___26080)){
args__4795__auto__.push((arguments[i__4790__auto___26081]));

var G__26082 = (i__4790__auto___26081 + (1));
i__4790__auto___26081 = G__26082;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.eof_error.cljs$lang$applyTo = (function (seq26035){
var G__26036 = cljs.core.first(seq26035);
var seq26035__$1 = cljs.core.next(seq26035);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26036,seq26035__$1);
}));
...
args__4795__auto__.push((arguments[i__4790__auto___26091]));
...
var init = (function (){var G__26047 = kind;
var G__26047__$1 = (((G__26047 instanceof cljs.core.Keyword))?G__26047.fqn:null);
switch (G__26047__$1) {
case "regex":
return "#\"";
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26047__$1)].join('')));
...
/** @this {Function} */
(cljs.tools.reader.impl.errors.throw_eof_reading.cljs$lang$applyTo = (function (seq26044){
var G__26045 = cljs.core.first(seq26044);
var seq26044__$1 = cljs.core.next(seq26044);
var G__26046 = cljs.core.first(seq26044__$1);
var seq26044__$2 = cljs.core.next(seq26044__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26045,G__26046,seq26044__$2);
}));
...
var iter__4582__auto__ = (function cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__26058(s__26059){
return (new cljs.core.LazySeq(null,(function (){
var s__26059__$1 = s__26059;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__26059__$1);
if(temp__5735__auto__){
var s__26059__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26059__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__26059__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__26061 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__26060 = (0);
while(true){
if((i__26060 < size__4581__auto__)){
var vec__26062 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__26060);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26062,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26062,(1),null);
if((freq > (1))){
cljs.core.chunk_append(b__26061,id);

var G__26099 = (i__26060 + (1));
i__26060 = G__26099;
continue;
} else {
var G__26100 = (i__26060 + (1));
i__26060 = G__26100;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26061),cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__26058(cljs.core.chunk_rest(s__26059__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26061),null);
}
} else {
var vec__26065 = cljs.core.first(s__26059__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26065,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26065,(1),null);
if((freq > (1))){
return cljs.core.cons(id,cljs$tools$reader$impl$errors$duplicate_keys_error_$_duplicates_$_iter__26058(cljs.core.rest(s__26059__$2)));
} else {
var G__26102 = cljs.core.rest(s__26059__$2);
s__26059__$1 = G__26102;
continue;
}
}
} else {
